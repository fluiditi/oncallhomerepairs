...
export const metadata: Metadata = {
  title: "Burst Pipe Repair London | OnCall Home Repairs",
  description:
    "Fast burst pipe repair in London. 24/7 emergency response from vetted plumbers. Transparent pricing. Call 0333 240 8428.",
  alternates: {
    canonical:
      "https://oncallhomerepairs.co.uk/plumber-london/services/emergency-plumbing/burst-pipe-repair",
  },
};
...
export default function BurstPipeRepairPage() {
  return (
    <ServicePage
      ...
      h1="Burst Pipe Repair in London"
      heroIntro={
        <p>
          ...
          you with vetted, experienced plumbers in the London area who
      ...
      whatWhyContent={
        <>
          ...
          <p>
            Our network of plumbers in London arrives equipped with the
      ...
      serviceAreasHeading="Burst Pipe Repair Across London"
      serviceAreasContent={
        <p>
          We connect homeowners with burst pipe repair plumbers across London
          and the surrounding villages. Whether you are in Westminster, Camden,
          Islington, or further afield in Greenwich or Hammersmith, our
      ...
      ctaHeading="Burst Pipe in London? Act Now"
      ctaContent={
        <p>
      ...
      serviceDescription="Fast burst pipe repair in London. Emergency call-out available 24/7."
