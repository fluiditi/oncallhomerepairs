...
export const metadata: Metadata = {
  title: "Leak Detection London | OnCall Home Repairs",
  description:
    "Professional leak detection and repair in London. Find and fix hidden leaks fast. Transparent pricing. Call 0333 240 8428.",
  alternates: {
    canonical:
      "https://oncallhomerepairs.co.uk/plumber-london/services/emergency-plumbing/leak-detection-repair",
  },
};
...
export default function LeakDetectionRepairPage() {
  return (
    <ServicePage
      ...
      h1="Leak Detection and Repair in London"
      heroIntro={
        <p>
          ...
          connects you with skilled plumbers in London who specialise in
      ...
      whatWhyContent={
        <>
          ...
          <p>
            In London, many homes are built with traditional construction
          ...
          <p>
            ...
            <Link
              href="/plumber-london/services/emergency-plumbing/overflow-repair"
              className="text-primary underline underline-offset-2 hover:text-primary/80"
            >
              overflowing cistern
            </Link>{" "}
      ...
      benefits={[
        ...
        },
        {
          ...
          description: (
            <p>
              Every plumber in our London network is qualified, insured, and
      ...
      serviceAreasHeading="Leak Detection Across London"
      serviceAreasContent={
        <p>
          Our leak detection service covers London and all nearby towns and
          villages. From Victorian terraces in London centre to modern estates
          in Westminster and Camden, our plumbers are experienced with the
          property types and plumbing systems found across the area. Whether
          your leak is in a ground-floor flat in Islington or a detached house in
          Kensington, we can match you with someone local who can investigate
          promptly.
        </p>
      }
      faqs={[
      ...
      ctaHeading="Suspect a Leak in Your London Home?"
      ctaContent={
        <p>
      ...
      serviceDescription="Professional leak detection and repair in London. Find and fix hidden leaks fast."
