...
export const metadata: Metadata = {
  title: "Frozen Pipe Repair London | OnCall Home Repairs",
  description:
    "Frozen pipe repair in London. Prevent burst pipes this winter. Vetted plumbers, 24/7. Call 0333 240 8428.",
  alternates: {
    canonical:
      "https://oncallhomerepairs.co.uk/plumber-london/services/emergency-plumbing/frozen-pipe-repair",
  },
};
    ...
    <ServicePage
      breadcrumbItems={[
        ...
        { name: "Emergency Plumbing", href: "/plumber-london/services/emergency-plumbing" },
        {
          ...
          href: "/plumber-london/services/emergency-plumbing/frozen-pipe-repair",
        },
      ]}
      h1="Frozen Pipe Repair in London"
      heroIntro={
        <p>
          When temperatures across Greater London drop below freezing, pipes in
      ...
      whatWhyHeading="Why Frozen Pipes Are a Serious Risk in London"
      whatWhyContent={
        <>
          <p>
            London sits in the East Midlands where winter temperatures
          ...
          <p>
            ...
            understands the specific risks Greater London winters pose to local
      ...
      serviceAreasHeading="Frozen Pipe Repair Across London"
      serviceAreasContent={
        <p>
          Our plumbers attend frozen pipe emergencies across London, Westminster,
          Camden, Islington, and the surrounding villages. Properties in
          ...
          Greater London, we can connect you with a plumber who
      ...
      faqs={[
        ...
        {
          question:
            "How much does frozen pipe repair cost in London?",
          answer:
      ...
      ctaContent={
        <p>
          ...
          Home Repairs and we will connect you with a vetted plumber in London
      ...
      serviceDescription="Frozen pipe thawing and repair in London. Prevent burst pipes this winter with safe, professional pipe repair from vetted local plumbers."
