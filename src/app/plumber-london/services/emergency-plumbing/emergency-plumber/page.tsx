...
export const metadata: Metadata = {
  title: "Emergency Plumber London | OnCall Home Repairs",
  description:
    "24-hour emergency plumber in London. Fast response for burst pipes, leaks, flooding. Vetted, Gas Safe. Call 0333 240 8428.",
  alternates: {
    canonical:
      "https://oncallhomerepairs.co.uk/plumber-london/services/emergency-plumbing/emergency-plumber",
  },
};
...
export default function EmergencyPlumberPage() {
  return (
    <ServicePage
      ...
      h1="Emergency Plumber in London — Available 24/7"
      heroIntro={
        <p>
          ...
          London and the surrounding Greater London area. Whether it is the
      ...
      whatWhyContent={
        <>
          ...
          <p>
            ...
            plumbing firm — we are a matching network that connects London
          ...
          <p>
            ...
            to{" "}
            <Link
              href="/plumber-london/services/emergency-plumbing/flood-response"
              className="text-primary underline underline-offset-2 hover:text-primary/80"
            >
              flood response
            </Link>
        ...
        },
        {
          ...
          description: (
            <p>
              ...
              London. Because our network covers the local area, response times
      ...
      benefits={[
        ...
        },
        {
          ...
          description: (
            <p>
              Our plumbers live and work in and around London. Local knowledge
      ...
      relatedServices={[
        ...
        {
          name: "Boiler Repair",
          href: "/plumber-london/services/boiler-heating/boiler-repair",
        },
      ]}
      serviceAreasHeading="Emergency Plumber Coverage Areas"
      serviceAreasContent={
        <p>
          Our emergency plumber network covers London and all surrounding towns
          and villages across Greater London. Whether you are in the
          centre of London or in a nearby village, we can connect you with a
      ...
      faqs={[
        {
          question:
            "How much does an emergency plumber call-out in London cost?",
          answer:
        ...
        },
        {
          ...
          answer:
            "Response times depend on current demand and your exact location in the London area. In most cases, we aim to have a plumber with you within one to two hours of your call. For urgent situations such as major leaks or gas concerns, we prioritise the fastest possible dispatch.",
          answerJsx: (
            <p>
              Response times depend on current demand and your exact location in
              the London area. In most cases, we aim to have a plumber with you
      ...
      ctaHeading="Plumbing Emergency in London?"
      ctaContent={
        <p>
      ...
      serviceDescription="24-hour emergency plumber in London. Fast response for burst pipes, leaks, and flooding."
