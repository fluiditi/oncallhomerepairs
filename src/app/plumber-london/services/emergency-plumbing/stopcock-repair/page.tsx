...
export const metadata: Metadata = {
  title: "Stopcock Repair London | OnCall Home Repairs",
  description:
    "Stopcock repair and replacement in London. Regain control of your water supply. Vetted plumbers. Call 0333 240 8428.",
  alternates: {
    canonical:
      "https://oncallhomerepairs.co.uk/plumber-london/services/emergency-plumbing/stopcock-repair",
  },
};
...
export default function StopcockRepairPage() {
  return (
    <ServicePage
      ...
      h1="Stopcock Repair and Replacement in London"
      heroIntro={
        <p>
          ...
          you with vetted plumbers in London who can repair or replace faulty
      ...
      whatWhyContent={
        <>
          ...
          <p>
            In many London properties, especially those built before the 1980s,
            the internal stopcock sits under the kitchen sink and has not been
            turned in years. Mineral deposits from Greater London&rsquo;s hard
          ...
          <p>
            ...
            <a
              href="/plumber-london/services/general-plumbing/pipe-replacement"
      ...
      serviceAreasHeading="Stopcock Repair Across London"
      serviceAreasContent={
        <p>
          We connect homeowners with plumbers who carry out stopcock repairs
          across London, Westminster, Camden, Islington, and all surrounding
      ...
      ctaContent={
        <p>
          ...
          in London who can repair or replace your stopcock &mdash; often the
          same day.
        </p>
      }
      serviceName="Stopcock Repair"
      serviceSlug="stopcock-repair"
      serviceDescription="Stopcock repair and replacement in London. Regain control of your water supply with same-day service from vetted local plumbers."
