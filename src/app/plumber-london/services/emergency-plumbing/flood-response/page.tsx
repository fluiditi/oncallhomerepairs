...
export const metadata: Metadata = {
  title: "Flood Response Plumber London | OnCall Home Repairs",
  description:
    "Emergency flood response in London. Rapid water damage control by vetted plumbers, available 24/7. Call 0333 240 8428.",
  alternates: {
    canonical:
      "https://oncallhomerepairs.co.uk/plumber-london/services/emergency-plumbing/flood-response",
  },
};
...
export default function FloodResponsePage() {
  return (
    <ServicePage
      ...
      h1="Flood Response Plumber in London"
      heroIntro={
        <p>
          ...
          experienced flood response plumbers in London who can reach your
      ...
      whatWhyContent={
        <>
          ...
          <p>
            Properties across London, Westminster, and the surrounding villages
      ...
      relatedServices={[
        ...
        },
        {
          ...
          href: "/plumber-london/services/emergency-plumbing/stopcock-repair",
        },
        {
      ...
      serviceAreasHeading="Flood Response Across London and Greater London"
      serviceAreasContent={
        <p>
          Our flood response plumbers cover London town centre, Westminster,
          Camden, Islington, Hackney, and surrounding villages.
          Response times are fastest within the London and Westminster area,
          with the wider Greater London area typically reached
      ...
      ctaContent={
        <p>
          ...
          will have a vetted flood response plumber heading to your London
          property as quickly as possible.
        </p>
      }
      serviceName="Flood Response"
      serviceSlug="flood-response"
      serviceDescription="Emergency flood response plumber in London. Rapid water damage control, source isolation, and immediate repair by vetted local plumbers."
