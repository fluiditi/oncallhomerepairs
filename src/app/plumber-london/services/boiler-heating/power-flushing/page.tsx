...
export const metadata: Metadata = {
  title: "Power Flushing London | OnCall Home Repairs",
  description:
    "Power flushing in London. Remove sludge and restore heating efficiency. Gas Safe engineers, transparent pricing. Call 0333 240 8428.",
  alternates: {
    canonical:
      "https://oncallhomerepairs.co.uk/plumber-london/services/boiler-heating/power-flushing",
  },
};
    ...
    <ServicePage
      ...
      heroIntro={
        <p>
          ...
          connects you with qualified engineers in London who carry out
      ...
      whatWhyContent={
        <>
          ...
          <p>
            ...
            sludge. Greater London&rsquo;s hard water makes this worse by adding
      ...
      serviceAreasHeading="Power Flushing Across London"
      serviceAreasContent={
        <p>
          Our engineers carry out power flushing across London, Westminster, Camden,
          Islington, Greenwich, Hammersmith, and surrounding
      ...
      ctaContent={
        <p>
          ...
          Repairs and we will connect you with a qualified engineer in London
          who can carry out a professional power flush on your system.
        </p>
      }
      serviceName="Power Flushing"
      serviceSlug="power-flushing"
      serviceDescription="Power flushing in London. Remove sludge and limescale from your central heating system to restore efficiency and prevent boiler breakdowns."
