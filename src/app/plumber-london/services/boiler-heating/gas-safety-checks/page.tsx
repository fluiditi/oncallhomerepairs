...
export const metadata: Metadata = {
  title: "Gas Safety Check London | OnCall Home Repairs",
  description:
    "Gas safety checks and CP12 certificates in London. For landlords and homeowners. Gas Safe registered engineers. Call 0333 240 8428.",
  alternates: {
    canonical:
      "https://oncallhomerepairs.co.uk/plumber-london/services/boiler-heating/gas-safety-checks",
  },
};
...
export default function GasSafetyChecksPage() {
  return (
    <ServicePage
      ...
      h1="Gas Safety Checks in London"
      heroIntro={
        <p>
          ...
          London who carry out thorough inspections of your boiler, gas
      ...
      serviceAreasHeading="Gas Safety Checks Across London"
      serviceAreasContent={
        <p>
          Our Gas Safe registered engineers carry out gas safety checks across
          London, Westminster, Camden, Islington, Hackney, Kensington,
          Brent, Haringey, and all surrounding areas. Landlords with multiple
      ...
      faqs={[
        {
          question: "How much does a gas safety check cost in London?",
          answer:
      ...
      ctaContent={
        <p>
          ...
          engineer in London for your annual gas safety check.
        </p>
      }
      serviceName="Gas Safety Checks"
      serviceSlug="gas-safety-checks"
      serviceDescription="Gas safety checks and CP12 certificates in London. Annual inspections for landlords and homeowners by Gas Safe registered engineers."
