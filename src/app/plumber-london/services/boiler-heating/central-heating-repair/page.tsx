...
export const metadata: Metadata = {
  title: "Central Heating Repair London | OnCall Home Repairs",
  description:
    "Central heating repair in London. Radiators, pumps, valves, thermostats. Gas Safe engineers. Call 0333 240 8428.",
  alternates: {
    canonical:
      "https://oncallhomerepairs.co.uk/plumber-london/services/boiler-heating/central-heating-repair",
  },
};
...
export default function CentralHeatingRepairPage() {
  return (
    <ServicePage
      ...
      h1="Central Heating Repair in London"
      heroIntro={
        <p>
          When your central heating is not working properly, your home becomes
          uncomfortable fast — especially during a Greater London winter. Cold
          ...
          engineers in London who diagnose and repair central heating faults
      ...
      whatWhyContent={
        <>
          ...
          <p>
            ...
            <Link
              href="/plumber-london/services/boiler-heating/power-flushing"
              className="text-primary underline underline-offset-2 hover:text-primary/80"
            >
              power flush
            </Link>{" "}
      ...
      benefits={[
        {
          ...
          description: (
            <p>
              ...
              systems and understand the common faults found in London
              properties.
            </p>
          ),
        },
      ...
      relatedServices={[
        ...
        },
        {
          ...
          href: "/plumber-london/services/boiler-heating/radiator-repair-installation",
        },
        {
          name: "Power Flushing",
          href: "/plumber-london/services/boiler-heating/power-flushing",
        },
        {
          ...
          href: "/plumber-london/services/boiler-heating/boiler-servicing",
        },
      ]}
      serviceAreasHeading="Central Heating Repair Across London"
      serviceAreasContent={
        <p>
          Our heating engineers cover London and the surrounding towns and
          villages throughout Greater London. From older properties
          in London town centre to newer-build estates in Islington, Southwark,
          and Hackney, our engineers are familiar with the heating
      ...
      ctaContent={
        <p>
          ...
          a qualified heating engineer in London who can diagnose and fix the
      ...
      serviceDescription="Central heating repair in London. Radiators, pumps, valves, and full system diagnostics."
