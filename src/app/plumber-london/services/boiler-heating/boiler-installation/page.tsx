...
export const metadata: Metadata = {
  title: "Boiler Installation London | OnCall Home Repairs",
  description:
    "New boiler installation in London. Gas Safe engineers, competitive quotes, workmanship guarantee. Call 0333 240 8428.",
  alternates: {
    canonical:
      "https://oncallhomerepairs.co.uk/plumber-london/services/boiler-heating/boiler-installation",
  },
};
    ...
    <ServicePage
      ...
      heroIntro={
        <p>
          ...
          you with Gas Safe registered heating engineers in London who carry
      ...
      serviceAreasHeading="Boiler Installation Across London"
      serviceAreasContent={
        <p>
          We connect homeowners across London and Greater London
          with qualified boiler installers. Whether you are in the centre of
          London, in Westminster, Camden, or one of the surrounding
          ...
          of Greater London and can advise on the best boiler setup for your
          home.
        </p>
      }
      faqs={[
        {
          question: "How much does a new boiler installation cost in London?",
          answer:
      ...
      ctaHeading="Ready for a New Boiler in London?"
      ctaContent={
        <p>
      ...
      serviceDescription="New boiler installation in London. Gas Safe registered, competitive pricing."
