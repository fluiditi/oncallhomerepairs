...
export const metadata: Metadata = {
  title: "Boiler Repair London | OnCall Home Repairs",
  description:
    "Boiler repair in London by Gas Safe engineers. Same-day repairs, upfront quotes. Available 24/7. Call 0333 240 8428.",
  alternates: {
    canonical:
      "https://oncallhomerepairs.co.uk/plumber-london/services/boiler-heating/boiler-repair",
  },
};
    ...
    <ServicePage
      ...
      heroIntro={
        <p>
          ...
          with Gas Safe registered heating engineers in London who diagnose
        ...
        },
        {
          ...
          description: (
            <p>
              ...
              London. For emergency breakdowns, engineers are available 24/7.
      ...
      serviceAreasHeading="Boiler Repair Across London"
      serviceAreasContent={
        <p>
          Our network of Gas Safe heating engineers covers London and the
          surrounding area. Whether you live in Westminster, Camden, Islington,
          or one of the smaller villages like Greenwich or Wandsworth, we
          ...
          properties across Greater London.
        </p>
      }
      faqs={[
        {
      ...
      ctaContent={
        <p>
          ...
          a Gas Safe registered engineer in London. Upfront pricing,
      ...
      serviceDescription="Expert boiler repair in London. Gas Safe registered engineers available 24/7."
