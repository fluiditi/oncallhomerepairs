...
export const metadata: Metadata = {
  title: "Radiator Repair London | OnCall Home Repairs",
  description:
    "Radiator repair and installation in London. Fix cold spots, leaks, and add new radiators. Gas Safe engineers. Call 0333 240 8428.",
  alternates: {
    canonical:
      "https://oncallhomerepairs.co.uk/plumber-london/services/boiler-heating/radiator-repair-installation",
  },
};
...
export default function RadiatorRepairPage() {
  return (
    <ServicePage
      ...
      h1="Radiator Repair and Installation in London"
      heroIntro={
        <p>
          ...
          London who can diagnose radiator faults, carry out repairs, and
      ...
      whatWhyHeading="Common Radiator Problems in London Homes"
      whatWhyContent={
        <>
          <p>
          ...
          <p>
            Greater London&rsquo;s hard water accelerates the build-up of
            limescale and sludge in central heating systems. Many homes in
            London, Westminster, and the surrounding area have heating systems
      ...
      serviceAreasHeading="Radiator Repair Across London"
      serviceAreasContent={
        <p>
          Our heating engineers carry out radiator repairs and installations
          across London, Westminster, Camden, Islington, Kensington, Ealing,
          and the wider Greater London area. Whether you need a
      ...
      ctaContent={
        <p>
          ...
          in London who can get your radiators working as they should.
        </p>
      }
      serviceName="Radiator Repair and Installation"
      serviceSlug="radiator-repair-installation"
      serviceDescription="Radiator repair and installation in London. Fix cold spots, leaking valves, and add new radiators with qualified heating engineers."
