...
export const metadata: Metadata = {
  title: "Water Heater Repair London | OnCall Home Repairs",
  description:
    "Water heater repair in London. Immersion heaters, cylinders, and unvented systems. Vetted plumbers. Call 0333 240 8428.",
  alternates: {
    canonical:
      "https://oncallhomerepairs.co.uk/plumber-london/services/boiler-heating/water-heater-repair",
  },
};
    ...
    <ServicePage
      breadcrumbItems={[
        ...
        { name: "Boiler & Heating", href: "/plumber-london/services/boiler-heating" },
        {
          ...
          href: "/plumber-london/services/boiler-heating/water-heater-repair",
        },
      ]}
      h1="Water Heater Repair in London"
      heroIntro={
        <p>
          ...
          you with qualified plumbers and heating engineers in London who can
      ...
      whatWhyContent={
        <>
          <p>
            Hot water systems vary considerably across London properties.
          ...
          <p>
            ...
            areas like Greater London, and eventually stops working. The
      ...
      serviceAreasHeading="Water Heater Repair Across London"
      serviceAreasContent={
        <p>
          Our plumbers and heating engineers attend water heater repairs across
          London, Westminster, Camden, Islington, Lambeth, Southwark, and
      ...
      faqs={[
        {
          ...
          answer:
            "The most common cause is a failed heating element. Hard water areas like London accelerate limescale build-up on the element, which causes it to overheat and burn out. The thermostat can also fail independently. A plumber can test both components and replace whichever has failed.",
        },
        {
          question:
      ...
      ctaContent={
        <p>
          ...
          London who can restore your hot water supply.
        </p>
      }
      serviceName="Water Heater Repair"
      serviceSlug="water-heater-repair"
      serviceDescription="Water heater repair in London. Immersion heaters, hot water cylinders, and unvented systems repaired by qualified local plumbers."
