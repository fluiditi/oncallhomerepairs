...
export const metadata: Metadata = {
  title: "Boiler Servicing London | OnCall Home Repairs",
  description:
    "Annual boiler servicing in London. Keep your warranty valid and your boiler running efficiently. Gas Safe engineers. Call 0333 240 8428.",
  alternates: {
    canonical:
      "https://oncallhomerepairs.co.uk/plumber-london/services/boiler-heating/boiler-servicing",
  },
};
    ...
    <ServicePage
      ...
      heroIntro={
        <p>
          ...
          connects you with Gas Safe registered engineers in London who carry
      ...
      serviceAreasHeading="Boiler Servicing Across London"
      serviceAreasContent={
        <p>
          Our Gas Safe registered engineers service boilers across London,
          Westminster, Camden, Islington, Southwark, Hackney, and
      ...
      ctaContent={
        <p>
          ...
          Gas Safe registered engineer in London.
        </p>
      }
      serviceName="Boiler Servicing"
      serviceSlug="boiler-servicing"
      serviceDescription="Annual boiler servicing in London by Gas Safe registered engineers. Manufacturer warranty protection, safety checks, and efficiency testing."
