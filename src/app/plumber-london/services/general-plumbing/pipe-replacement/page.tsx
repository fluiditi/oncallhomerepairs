...
export const metadata: Metadata = {
  title: "Pipe Replacement London | OnCall Home Repairs",
  description:
    "Pipe replacement in London. Copper, plastic, and lead pipe upgrades by vetted plumbers. Transparent pricing. Call 0333 240 8428.",
  alternates: {
    canonical:
      "https://oncallhomerepairs.co.uk/plumber-london/services/general-plumbing/pipe-replacement",
  },
};
    ...
    <ServicePage
      ...
      heroIntro={
        <p>
          ...
          connects you with qualified plumbers in London who replace old
      ...
      whatWhyContent={
        <>
          <p>
            ...
            London properties &mdash; pose a health risk and should be
      ...
      serviceAreasHeading="Pipe Replacement Across London"
      serviceAreasContent={
        <p>
          Our plumbers replace pipework in properties across London, Westminster,
          Camden, Islington, Haringey, Brent, and all surrounding areas.
      ...
      ctaContent={
        <p>
          ...
          in London who can assess your pipes and carry out replacements
          that last.
        </p>
      }
      serviceName="Pipe Replacement"
      serviceSlug="pipe-replacement"
      serviceDescription="Pipe replacement in London. Copper, plastic, and lead pipe upgrades for homes and businesses by vetted local plumbers."
