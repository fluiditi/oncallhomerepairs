...
export const metadata: Metadata = {
  title: "Kitchen Plumber London | OnCall Home Repairs",
  description:
    "Kitchen plumbing in London. Sink installations, dishwasher connections, waste disposal, and repairs. Call 0333 240 8428.",
  alternates: {
    canonical:
      "https://oncallhomerepairs.co.uk/plumber-london/services/general-plumbing/kitchen-plumbing",
  },
};
    ...
    <ServicePage
      ...
      heroIntro={
        <p>
          ...
          London who install, repair, and maintain kitchen plumbing &mdash;
      ...
      whatWhyContent={
        <>
          ...
          <p>
            Blocked kitchen sinks are a regular call-out in London. Grease,
      ...
      serviceAreasHeading="Kitchen Plumbing Across London"
      serviceAreasContent={
        <p>
          Our plumbers carry out kitchen plumbing work across London,
          Westminster, Camden, Islington, Greenwich, Wandsworth, Market
      ...
      ctaContent={
        <p>
          ...
          Repairs will match you with a qualified plumber in London. Call
          for a clear, upfront quote.
        </p>
      }
      serviceName="Kitchen Plumbing"
      serviceSlug="kitchen-plumbing"
      serviceDescription="Kitchen plumbing in London. Sink installations, appliance connections, waste pipe repairs, and full kitchen plumbing by vetted local plumbers."
