...
export const metadata: Metadata = {
  title: "Bathroom Plumber London | OnCall Home Repairs",
  description:
    "Bathroom plumbing in London. Installations, repairs, full refits. Vetted plumbers, upfront quotes. Call 0333 240 8428.",
  alternates: {
    canonical:
      "https://oncallhomerepairs.co.uk/plumber-london/services/general-plumbing/bathroom-plumbing",
  },
};
...
export default function BathroomPlumbingPage() {
  return (
    <ServicePage
      ...
      h1="Bathroom Plumbing in London"
      heroIntro={
        <p>
          ...
          vetted, experienced plumbers in London who handle all aspects of
      ...
      whatWhyContent={
        <>
          ...
          <p>
            ...
            will support the{" "}
            <Link
              href="/plumber-london/services/general-plumbing/shower-installation-repair"
              className="text-primary underline underline-offset-2 hover:text-primary/80"
            >
              shower
            </Link>{" "}
        ...
        },
        {
          ...
          description: (
            <p>
              ...
              in London properties — from Victorian terraces with old lead
      ...
      relatedServices={[
        ...
        {
          name: "Toilet Repair",
          href: "/plumber-london/services/drain-services/toilet-repair",
        },
        {
          name: "Kitchen Plumbing",
          href: "/plumber-london/services/general-plumbing/kitchen-plumbing",
        },
      ]}
      serviceAreasHeading="Bathroom Plumbing Across London"
      serviceAreasContent={
        <p>
          Our bathroom plumbers serve London and all surrounding areas. From
          period properties in the town centre that need careful pipework
          modifications to new-build homes in Lambeth, Ealing, and Brent
          that need a shower upgrade or suite replacement, our plumbers have
          the experience to handle it. We cover Westminster, Camden, Islington,
          Haringey, and all villages in between.
        </p>
      }
      faqs={[
        {
      ...
      ctaHeading="Need a Bathroom Plumber in London?"
      ctaContent={
        <p>
      ...
      serviceDescription="Bathroom plumbing in London. Installations, repairs, and full bathroom fit-outs."
