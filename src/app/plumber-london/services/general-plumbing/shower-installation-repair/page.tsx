...
export const metadata: Metadata = {
  title: "Shower Installation London | OnCall Home Repairs",
  description:
    "Shower installation and repair in London. Electric, mixer, and thermostatic showers. Vetted plumbers. Call 0333 240 8428.",
  alternates: {
    canonical:
      "https://oncallhomerepairs.co.uk/plumber-london/services/general-plumbing/shower-installation-repair",
  },
};
...
export default function ShowerInstallationPage() {
  return (
    <ServicePage
      ...
      h1="Shower Installation and Repair in London"
      heroIntro={
        <p>
          ...
          in London who handle all types of shower work. From quick repairs
      ...
      whatWhyContent={
        <>
          ...
          <p>
            In London homes with hard water, limescale build-up inside
      ...
      serviceAreasHeading="Shower Installation Across London"
      serviceAreasContent={
        <p>
          Our plumbers install and repair showers across London, Westminster,
          Camden, Islington, Hackney, Lambeth, and surrounding
      ...
      ctaContent={
        <p>
          ...
          Repairs will match you with a qualified plumber in London. Call now
          for an upfront quote.
        </p>
      }
      serviceName="Shower Installation and Repair"
      serviceSlug="shower-installation-repair"
      serviceDescription="Shower installation and repair in London. Electric, mixer, and thermostatic showers fitted and repaired by vetted local plumbers."
