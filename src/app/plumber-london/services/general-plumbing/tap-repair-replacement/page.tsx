...
export const metadata: Metadata = {
  title: "Tap Repair London | OnCall Home Repairs",
  description:
    "Tap repair and replacement in London. Fix dripping taps and install new ones. Vetted plumbers, transparent pricing. Call 0333 240 8428.",
  alternates: {
    canonical:
      "https://oncallhomerepairs.co.uk/plumber-london/services/general-plumbing/tap-repair-replacement",
  },
};
    ...
    <ServicePage
      ...
      heroIntro={
        <p>
          ...
          Home Repairs connects you with plumbers in London who can fix
      ...
      whatWhyContent={
        <>
          <p>
            ...
            Greater London, the hard water supply accelerates wear on internal
      ...
      serviceAreasHeading="Tap Repair Across London"
      serviceAreasContent={
        <p>
          Our plumbers repair and replace taps across London, Westminster, Camden,
          Islington, Kensington, Ealing, and the surrounding area. Tap
      ...
      ctaContent={
        <p>
          ...
          will connect you with a plumber in London who can repair or
      ...
      serviceDescription="Tap repair and replacement in London. Fix dripping taps, replace worn components, and install new taps with vetted local plumbers."
