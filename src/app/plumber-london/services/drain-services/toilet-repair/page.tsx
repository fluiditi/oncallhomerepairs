...
export const metadata: Metadata = {
  title: "Toilet Repair London | OnCall Home Repairs",
  description:
    "Toilet repair in London. Cisterns, flush mechanisms, seals, and installations by vetted plumbers. Call 0333 240 8428.",
  alternates: {
    canonical:
      "https://oncallhomerepairs.co.uk/plumber-london/services/drain-services/toilet-repair",
  },
};
    ...
    <ServicePage
      ...
      heroIntro={
        <p>
          ...
          London who repair and replace toilet components, cisterns, and
      ...
      whatWhyContent={
        <>
          ...
          <p>
            In properties across London, hard water deposits also play a role.
      ...
      serviceAreasHeading="Toilet Repair Across London"
      serviceAreasContent={
        <p>
          Our plumbers carry out toilet repairs across London, Westminster,
          Camden, Islington, Hackney, Southwark, and all
      ...
      ctaContent={
        <p>
          ...
          London who can diagnose and fix the problem &mdash; usually in a
          single visit.
        </p>
      }
      serviceName="Toilet Repair"
      serviceSlug="toilet-repair"
      serviceDescription="Toilet repair in London. Cistern mechanisms, fill valves, flush faults, and seal replacements by vetted local plumbers."
