...
export const metadata: Metadata = {
  title: "Drain Unblocking London | OnCall Home Repairs",
  description:
    "Professional drain unblocking in London. High-pressure jetting and manual rodding. Vetted plumbers. Call 0333 240 8428.",
  alternates: {
    canonical:
      "https://oncallhomerepairs.co.uk/plumber-london/services/drain-services/drain-unblocking",
  },
};
    ...
    <ServicePage
      ...
      heroIntro={
        <p>
          ...
          experienced drain engineers in London who use professional-grade
      ...
      whatWhyContent={
        <>
          <p>
            Most drain blockages in London homes are caused by a gradual
      ...
      serviceAreasHeading="Drain Unblocking Across London"
      serviceAreasContent={
        <p>
          Our drain engineers cover London, Westminster, Camden, Islington,
          Wandsworth, Greenwich, and the surrounding area. External drain
      ...
      ctaContent={
        <p>
          ...
          London who can clear the blockage and restore full flow.
        </p>
      }
      serviceName="Drain Unblocking"
      serviceSlug="drain-unblocking"
      serviceDescription="Professional drain unblocking in London using high-pressure jetting and manual rodding. Fast, effective clearance for homes and businesses."
