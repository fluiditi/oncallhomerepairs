...
export const metadata: Metadata = {
  title: "Blocked Drains London | OnCall Home Repairs",
  description:
    "Blocked drain clearing in London. Fast, effective unblocking for homes and businesses. Call 0333 240 8428.",
  alternates: {
    canonical:
      "https://oncallhomerepairs.co.uk/plumber-london/services/drain-services/blocked-drains",
  },
};
    ...
    <ServicePage
      ...
      heroIntro={
        <p>
          ...
          drainage plumbers in London who can clear blockages quickly and
      ...
      serviceAreasHeading="Blocked Drain Clearing Across London"
      serviceAreasContent={
        <p>
          Our drainage plumbers cover London and every surrounding town and
          village. From terraced properties in London centre with shared
          drainage runs to detached homes in Westminster, Camden, and Market
      ...
      ctaHeading="Blocked Drain in London?"
      ctaContent={
        <p>
      ...
      serviceDescription="Blocked drain clearing in London. Fast, effective unblocking for homes and businesses."
