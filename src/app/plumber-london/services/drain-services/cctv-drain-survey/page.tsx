...
export const metadata: Metadata = {
  title: "CCTV Drain Survey London | OnCall Home Repairs",
  description:
    "CCTV drain survey in London. Camera inspection to diagnose drainage problems accurately. Vetted engineers. Call 0333 240 8428.",
  alternates: {
    canonical:
      "https://oncallhomerepairs.co.uk/plumber-london/services/drain-services/cctv-drain-survey",
  },
};
...
export default function CCTVDrainSurveyPage() {
  return (
    <ServicePage
      ...
      h1="CCTV Drain Survey in London"
      heroIntro={
        <p>
          ...
          engineers in London who use professional camera equipment to inspect
      ...
      whatWhyContent={
        <>
          ...
          <p>
            Homebuyers in London increasingly request drain surveys as part
      ...
      serviceAreasHeading="CCTV Drain Surveys Across London"
      serviceAreasContent={
        <p>
          Our drain engineers carry out CCTV surveys across London, Westminster,
          Camden, Islington, Hammersmith, Ealing, Brent, and all
      ...
      faqs={[
        {
          question: "How much does a CCTV drain survey cost in London?",
          answer:
      ...
      ctaContent={
        <p>
          ...
          we will connect you with a drain engineer in London who can carry
      ...
      serviceDescription="CCTV drain survey in London. Professional camera inspection to diagnose drainage problems, root intrusion, and pipe damage."
