...
export const metadata: Metadata = {
  title: "Drain Services London | OnCall Home Repairs",
  description:
    "Blocked drains, CCTV surveys, and drain unblocking in London. Fast response, fair pricing. Call 0333 240 8428.",
  alternates: {
    canonical: "https://oncallhomerepairs.co.uk/plumber-london/services/drain-services",
  },
};
  ...
  return (
    <CategoryPage
      breadcrumbItems={[
        ...
        { name: "Drain Services", href: "/plumber-london/services/drain-services" },
      ]}
      h1="Drain Services in London"
      heroIntro={
        <>
          <p>
            ...
            drainage specialists in London who can clear blockages, carry out{" "}
            <a href="/plumber-london/services/drain-services/cctv-drain-survey" className="underline hover:text-white">
              CCTV drain surveys
            </a>
      ...
      overviewHeading="Professional Drain Care for London Properties"
      overviewContent={
        <>
          <p>
          ...
          <p>
            ...
            <a href="/plumber-london/services/drain-services/blocked-drains" className="text-primary underline hover:text-primary/80">
              blocked drain
            </a>{" "}
            that needs clearing or a more involved investigation using a{" "}
            <a href="/plumber-london/services/drain-services/cctv-drain-survey" className="text-primary underline hover:text-primary/80">
              CCTV drain survey
            </a>
          ...
          <p>
            ...
            <a href="/plumber-london/services/general-plumbing" className="text-primary underline hover:text-primary/80">
              kitchen or bathroom plumbing
            </a>
            , or if a severe blockage creates an{" "}
            <a href="/plumber-london/services/emergency-plumbing" className="text-primary underline hover:text-primary/80">
        ...
        },
        {
          ...
          description: (
            <p>
              ...
              emergency and scheduled drain work across London.
            </p>
          ),
        },
        {
      ...
      serviceAreasHeading="Drain Services Across London and Surrounding Areas"
      serviceAreasContent={
        <p>
          Our network of drain specialists covers London and the nearby
          villages of Greater London. From Westminster and Islington to
          Southwark, Lambeth, and Wandsworth, we connect you with a drainage
      ...
      faqs={[
        ...
        },
        {
          ...
          answer:
            "The cost depends on the length and accessibility of the drainage run. A standard domestic survey for a typical London property is straightforward for our network plumbers. You will receive a clear quote before the camera goes in, and the survey includes a recorded video of the findings that you can keep for your records.",
        },
        {
          question:
        ...
        },
        {
          ...
          answer:
            "Yes. Our network includes plumbers available for evening and weekend drain emergencies across London and the surrounding areas. If sewage is backing up or a blockage is causing flooding, call us and we will connect you with the nearest available drainage specialist as quickly as possible.",
        },
      ]}
      ...
      ctaContent={
        <p>
          ...
          specialist in London. From blocked sinks to full CCTV surveys, our
          network of vetted plumbers is ready to help — today.
        </p>
      }
      categoryName="Drain Services"
      categoryDescription="Blocked drain clearing, CCTV drain surveys, drain unblocking, and toilet repairs in London by vetted, insured plumbers."
