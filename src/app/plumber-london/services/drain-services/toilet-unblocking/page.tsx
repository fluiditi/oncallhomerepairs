...
export const metadata: Metadata = {
  title: "Toilet Unblocking London | OnCall Home Repairs",
  description:
    "Toilet unblocking in London. Fast, hygienic clearance of blocked toilets by vetted plumbers. Call 0333 240 8428.",
  alternates: {
    canonical:
      "https://oncallhomerepairs.co.uk/plumber-london/services/drain-services/toilet-unblocking",
  },
};
    ...
    <ServicePage
      breadcrumbItems={[
        ...
        { name: "Drain Services", href: "/plumber-london/services/drain-services" },
        {
          ...
          href: "/plumber-london/services/drain-services/toilet-unblocking",
        },
      ]}
      h1="Toilet Unblocking in London"
      heroIntro={
        <p>
          ...
          London who carry out fast, hygienic toilet unblocking using
      ...
      whatWhyContent={
        <>
          ...
          <p>
            In older London properties, narrow soil pipes and ageing clay
          ...
          <p>
            ...
            <a
              href="/plumber-london/services/drain-services/drain-unblocking"
              className="text-primary underline underline-offset-2 hover:text-primary/80"
            >
      ...
      serviceAreasHeading="Toilet Unblocking Across London"
      serviceAreasContent={
        <p>
          Our plumbers attend toilet unblocking jobs across London, Westminster,
          Camden, Islington, Brent, Haringey, and all surrounding areas.
      ...
      ctaContent={
        <p>
          ...
          and we will connect you with a plumber in London who can clear it
          quickly and discreetly &mdash; same-day where possible.
        </p>
      }
      serviceName="Toilet Unblocking"
      serviceSlug="toilet-unblocking"
      serviceDescription="Fast, hygienic toilet unblocking in London. Professional clearance of blocked toilets by vetted local plumbers."
