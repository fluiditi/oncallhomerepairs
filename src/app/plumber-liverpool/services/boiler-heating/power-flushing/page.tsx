...
export const metadata: Metadata = {
  title: "Power Flushing Liverpool | OnCall Home Repairs",
  description:
    "Power flushing in Liverpool. Remove sludge and restore heating efficiency. Gas Safe engineers, transparent pricing. Call 0333 240 8428.",
  alternates: {
    canonical:
      "https://oncallhomerepairs.co.uk/plumber-liverpool/services/boiler-heating/power-flushing",
  },
};
...
export default function PowerFlushingPage() {
  return (
    <ServicePage
      ...
      h1="Power Flushing in Liverpool"
      heroIntro={
        <p>
          ...
          connects you with qualified engineers in Liverpool who carry out
      ...
      whatWhyContent={
        <>
          ...
          <p>
            ...
            sludge. Merseyside&rsquo;s hard water makes this worse by adding
      ...
      serviceAreasHeading="Power Flushing Across Liverpool"
      serviceAreasContent={
        <p>
          Our engineers carry out power flushing across Liverpool, Toxteth, Allerton,
          Woolton, Bootle, Kirkby, and surrounding
      ...
      ctaContent={
        <p>
          ...
          Repairs and we will connect you with a qualified engineer in Liverpool
          who can carry out a professional power flush on your system.
        </p>
      }
      serviceName="Power Flushing"
      serviceSlug="power-flushing"
      serviceDescription="Power flushing in Liverpool. Remove sludge and limescale from your central heating system to restore efficiency and prevent boiler breakdowns."
