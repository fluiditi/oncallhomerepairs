...
export const metadata: Metadata = {
  title: "Boiler Repair Liverpool | OnCall Home Repairs",
  description:
    "Boiler repair in Liverpool by Gas Safe engineers. Same-day repairs, upfront quotes. Available 24/7. Call 0333 240 8428.",
  alternates: {
    canonical:
      "https://oncallhomerepairs.co.uk/plumber-liverpool/services/boiler-heating/boiler-repair",
  },
};
    ...
    <ServicePage
      ...
      heroIntro={
        <p>
          ...
          with Gas Safe registered heating engineers in Liverpool who diagnose
        ...
        },
        {
          ...
          description: (
            <p>
              ...
              Liverpool. For emergency breakdowns, engineers are available 24/7.
      ...
      serviceAreasHeading="Boiler Repair Across Liverpool"
      serviceAreasContent={
        <p>
          Our network of Gas Safe heating engineers covers Liverpool and the
          surrounding area. Whether you live in Toxteth, Allerton, Woolton,
          or one of the smaller villages like Bootle or Huyton, we
      ...
      ctaContent={
        <p>
          ...
          a Gas Safe registered engineer in Liverpool. Upfront pricing,
      ...
      serviceDescription="Expert boiler repair in Liverpool. Gas Safe registered engineers available 24/7."
