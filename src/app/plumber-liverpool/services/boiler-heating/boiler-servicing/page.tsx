...
export const metadata: Metadata = {
  title: "Boiler Servicing Liverpool | OnCall Home Repairs",
  description:
    "Annual boiler servicing in Liverpool. Keep your warranty valid and your boiler running efficiently. Gas Safe engineers. Call 0333 240 8428.",
  alternates: {
    canonical:
      "https://oncallhomerepairs.co.uk/plumber-liverpool/services/boiler-heating/boiler-servicing",
  },
};
...
export default function BoilerServicingPage() {
  return (
    <ServicePage
      ...
      h1="Boiler Servicing in Liverpool"
      heroIntro={
        <p>
          ...
          connects you with Gas Safe registered engineers in Liverpool who carry
      ...
      serviceAreasHeading="Boiler Servicing Across Liverpool"
      serviceAreasContent={
        <p>
          Our Gas Safe registered engineers service boilers across Liverpool,
          Toxteth, Allerton, Woolton, Walton, Wavertree, and
      ...
      ctaContent={
        <p>
          ...
          Gas Safe registered engineer in Liverpool.
        </p>
      }
      serviceName="Boiler Servicing"
      serviceSlug="boiler-servicing"
      serviceDescription="Annual boiler servicing in Liverpool by Gas Safe registered engineers. Manufacturer warranty protection, safety checks, and efficiency testing."
