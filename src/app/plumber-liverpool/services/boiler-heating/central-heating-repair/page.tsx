...
export const metadata: Metadata = {
  title: "Central Heating Repair Liverpool | OnCall Home Repairs",
  description:
    "Central heating repair in Liverpool. Radiators, pumps, valves, thermostats. Gas Safe engineers. Call 0333 240 8428.",
  alternates: {
    canonical:
      "https://oncallhomerepairs.co.uk/plumber-liverpool/services/boiler-heating/central-heating-repair",
  },
};
...
export default function CentralHeatingRepairPage() {
  return (
    <ServicePage
      ...
      h1="Central Heating Repair in Liverpool"
      heroIntro={
        <p>
          When your central heating is not working properly, your home becomes
          uncomfortable fast — especially during a Merseyside winter. Cold
          ...
          engineers in Liverpool who diagnose and repair central heating faults
      ...
      whatWhyContent={
        <>
          ...
          <p>
            ...
            <Link
              href="/plumber-liverpool/services/boiler-heating/power-flushing"
              className="text-primary underline underline-offset-2 hover:text-primary/80"
            >
              power flush
            </Link>{" "}
      ...
      benefits={[
        {
          ...
          description: (
            <p>
              ...
              systems and understand the common faults found in Liverpool
              properties.
            </p>
          ),
        },
      ...
      relatedServices={[
        ...
        },
        {
          ...
          href: "/plumber-liverpool/services/boiler-heating/radiator-repair-installation",
        },
        {
          name: "Power Flushing",
          href: "/plumber-liverpool/services/boiler-heating/power-flushing",
        },
        {
          ...
          href: "/plumber-liverpool/services/boiler-heating/boiler-servicing",
        },
      ]}
      serviceAreasHeading="Central Heating Repair Across Liverpool"
      serviceAreasContent={
        <p>
          Our heating engineers cover Liverpool and the surrounding towns and
          villages throughout Merseyside. From older properties
          in Liverpool town centre to newer-build estates in Woolton, Walton,
          and Wavertree, our engineers are familiar with the heating
      ...
      ctaContent={
        <p>
          ...
          a qualified heating engineer in Liverpool who can diagnose and fix the
      ...
      serviceDescription="Central heating repair in Liverpool. Radiators, pumps, valves, and full system diagnostics."
