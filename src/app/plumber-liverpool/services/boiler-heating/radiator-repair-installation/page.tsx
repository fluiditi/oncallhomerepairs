...
export const metadata: Metadata = {
  title: "Radiator Repair Liverpool | OnCall Home Repairs",
  description:
    "Radiator repair and installation in Liverpool. Fix cold spots, leaks, and add new radiators. Gas Safe engineers. Call 0333 240 8428.",
  alternates: {
    canonical:
      "https://oncallhomerepairs.co.uk/plumber-liverpool/services/boiler-heating/radiator-repair-installation",
  },
};
...
export default function RadiatorRepairPage() {
  return (
    <ServicePage
      ...
      h1="Radiator Repair and Installation in Liverpool"
      heroIntro={
        <p>
          ...
          Liverpool who can diagnose radiator faults, carry out repairs, and
      ...
      whatWhyHeading="Common Radiator Problems in Liverpool Homes"
      whatWhyContent={
        <>
          <p>
          ...
          <p>
            Merseyside&rsquo;s hard water accelerates the build-up of
            limescale and sludge in central heating systems. Many homes in
            Liverpool, Toxteth, and the surrounding area have heating systems
      ...
      serviceAreasHeading="Radiator Repair Across Liverpool"
      serviceAreasContent={
        <p>
          Our heating engineers carry out radiator repairs and installations
          across Liverpool, Toxteth, Allerton, Woolton, Aigburth, Garston,
          and the wider Merseyside area. Whether you need a
      ...
      ctaContent={
        <p>
          ...
          in Liverpool who can get your radiators working as they should.
        </p>
      }
      serviceName="Radiator Repair and Installation"
      serviceSlug="radiator-repair-installation"
      serviceDescription="Radiator repair and installation in Liverpool. Fix cold spots, leaking valves, and add new radiators with qualified heating engineers."
