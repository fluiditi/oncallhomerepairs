...
export const metadata: Metadata = {
  title: "Boiler Installation Liverpool | OnCall Home Repairs",
  description:
    "New boiler installation in Liverpool. Gas Safe engineers, competitive quotes, workmanship guarantee. Call 0333 240 8428.",
  alternates: {
    canonical:
      "https://oncallhomerepairs.co.uk/plumber-liverpool/services/boiler-heating/boiler-installation",
  },
};
...
export default function BoilerInstallationPage() {
  return (
    <ServicePage
      ...
      h1="Boiler Installation in Liverpool"
      heroIntro={
        <p>
          ...
          you with Gas Safe registered heating engineers in Liverpool who carry
      ...
      serviceAreasHeading="Boiler Installation Across Liverpool"
      serviceAreasContent={
        <p>
          We connect homeowners across Liverpool and Merseyside
          with qualified boiler installers. Whether you are in the centre of
          Liverpool, in Toxteth, Allerton, or one of the surrounding
          ...
          of Merseyside and can advise on the best boiler setup for your
          home.
        </p>
      }
      faqs={[
        {
          question: "How much does a new boiler installation cost in Liverpool?",
          answer:
      ...
      ctaHeading="Ready for a New Boiler in Liverpool?"
      ctaContent={
        <p>
      ...
      serviceDescription="New boiler installation in Liverpool. Gas Safe registered, competitive pricing."
