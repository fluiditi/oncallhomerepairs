...
export const metadata: Metadata = {
  title: "Gas Safety Check Liverpool | OnCall Home Repairs",
  description:
    "Gas safety checks and CP12 certificates in Liverpool. For landlords and homeowners. Gas Safe registered engineers. Call 0333 240 8428.",
  alternates: {
    canonical:
      "https://oncallhomerepairs.co.uk/plumber-liverpool/services/boiler-heating/gas-safety-checks",
  },
};
...
export default function GasSafetyChecksPage() {
  return (
    <ServicePage
      ...
      h1="Gas Safety Checks in Liverpool"
      heroIntro={
        <p>
          ...
          Liverpool who carry out thorough inspections of your boiler, gas
      ...
      serviceAreasHeading="Gas Safety Checks Across Liverpool"
      serviceAreasContent={
        <p>
          Our Gas Safe registered engineers carry out gas safety checks across
          Liverpool, Toxteth, Allerton, Woolton, Wavertree, Aigburth,
          Childwall, West Derby, and all surrounding areas. Landlords with multiple
      ...
      faqs={[
        {
          question: "How much does a gas safety check cost in Liverpool?",
          answer:
      ...
      ctaContent={
        <p>
          ...
          engineer in Liverpool for your annual gas safety check.
        </p>
      }
      serviceName="Gas Safety Checks"
      serviceSlug="gas-safety-checks"
      serviceDescription="Gas safety checks and CP12 certificates in Liverpool. Annual inspections for landlords and homeowners by Gas Safe registered engineers."
