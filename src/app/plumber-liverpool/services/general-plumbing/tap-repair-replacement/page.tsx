...
export const metadata: Metadata = {
  title: "Tap Repair Liverpool | OnCall Home Repairs",
  description:
    "Tap repair and replacement in Liverpool. Fix dripping taps and install new ones. Vetted plumbers, transparent pricing. Call 0333 240 8428.",
  alternates: {
    canonical:
      "https://oncallhomerepairs.co.uk/plumber-liverpool/services/general-plumbing/tap-repair-replacement",
  },
};
...
export default function TapRepairPage() {
  return (
    <ServicePage
      ...
      h1="Tap Repair and Replacement in Liverpool"
      heroIntro={
        <p>
          ...
          Home Repairs connects you with plumbers in Liverpool who can fix
      ...
      whatWhyContent={
        <>
          <p>
            ...
            Merseyside, the hard water supply accelerates wear on internal
      ...
      serviceAreasHeading="Tap Repair Across Liverpool"
      serviceAreasContent={
        <p>
          Our plumbers repair and replace taps across Liverpool, Toxteth, Allerton,
          Woolton, Aigburth, Garston, and the surrounding area. Tap
      ...
      ctaContent={
        <p>
          ...
          will connect you with a plumber in Liverpool who can repair or
      ...
      serviceDescription="Tap repair and replacement in Liverpool. Fix dripping taps, replace worn components, and install new taps with vetted local plumbers."
