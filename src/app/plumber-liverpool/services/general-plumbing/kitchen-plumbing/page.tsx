...
export const metadata: Metadata = {
  title: "Kitchen Plumber Liverpool | OnCall Home Repairs",
  description:
    "Kitchen plumbing in Liverpool. Sink installations, dishwasher connections, waste disposal, and repairs. Call 0333 240 8428.",
  alternates: {
    canonical:
      "https://oncallhomerepairs.co.uk/plumber-liverpool/services/general-plumbing/kitchen-plumbing",
  },
};
...
export default function KitchenPlumbingPage() {
  return (
    <ServicePage
      ...
      h1="Kitchen Plumbing in Liverpool"
      heroIntro={
        <p>
          ...
          Liverpool who install, repair, and maintain kitchen plumbing &mdash;
      ...
      whatWhyContent={
        <>
          ...
          <p>
            Blocked kitchen sinks are a regular call-out in Liverpool. Grease,
      ...
      serviceAreasHeading="Kitchen Plumbing Across Liverpool"
      serviceAreasContent={
        <p>
          Our plumbers carry out kitchen plumbing work across Liverpool,
          Toxteth, Allerton, Woolton, Bootle, Huyton, Market
      ...
      ctaContent={
        <p>
          ...
          Repairs will match you with a qualified plumber in Liverpool. Call
          for a clear, upfront quote.
        </p>
      }
      serviceName="Kitchen Plumbing"
      serviceSlug="kitchen-plumbing"
      serviceDescription="Kitchen plumbing in Liverpool. Sink installations, appliance connections, waste pipe repairs, and full kitchen plumbing by vetted local plumbers."
