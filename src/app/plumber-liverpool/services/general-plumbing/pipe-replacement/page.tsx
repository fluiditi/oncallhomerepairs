...
export const metadata: Metadata = {
  title: "Pipe Replacement Liverpool | OnCall Home Repairs",
  description:
    "Pipe replacement in Liverpool. Copper, plastic, and lead pipe upgrades by vetted plumbers. Transparent pricing. Call 0333 240 8428.",
  alternates: {
    canonical:
      "https://oncallhomerepairs.co.uk/plumber-liverpool/services/general-plumbing/pipe-replacement",
  },
};
    ...
    <ServicePage
      breadcrumbItems={[
        ...
        { name: "General Plumbing", href: "/plumber-liverpool/services/general-plumbing" },
        {
          ...
          href: "/plumber-liverpool/services/general-plumbing/pipe-replacement",
        },
      ]}
      h1="Pipe Replacement in Liverpool"
      heroIntro={
        <p>
          ...
          connects you with qualified plumbers in Liverpool who replace old
      ...
      whatWhyContent={
        <>
          <p>
            ...
            Liverpool properties &mdash; pose a health risk and should be
      ...
      serviceAreasHeading="Pipe Replacement Across Liverpool"
      serviceAreasContent={
        <p>
          Our plumbers replace pipework in properties across Liverpool, Toxteth,
          Allerton, Woolton, West Derby, Childwall, and all surrounding areas.
      ...
      ctaContent={
        <p>
          ...
          in Liverpool who can assess your pipes and carry out replacements
          that last.
        </p>
      }
      serviceName="Pipe Replacement"
      serviceSlug="pipe-replacement"
      serviceDescription="Pipe replacement in Liverpool. Copper, plastic, and lead pipe upgrades for homes and businesses by vetted local plumbers."
