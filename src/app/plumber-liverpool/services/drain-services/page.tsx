...
export const metadata: Metadata = {
  title: "Drain Services Liverpool | OnCall Home Repairs",
  description:
    "Blocked drains, CCTV surveys, and drain unblocking in Liverpool. Fast response, fair pricing. Call 0333 240 8428.",
  alternates: {
    canonical: "https://oncallhomerepairs.co.uk/plumber-liverpool/services/drain-services",
  },
};
...
export default function DrainServicesPage() {
  return (
    <CategoryPage
      ...
      h1="Drain Services in Liverpool"
      heroIntro={
        <>
          <p>
            ...
            drainage specialists in Liverpool who can clear blockages, carry out{" "}
            <a href="/plumber-liverpool/services/drain-services/cctv-drain-survey" className="underline hover:text-white">
              CCTV drain surveys
            </a>
      ...
      overviewHeading="Professional Drain Care for Liverpool Properties"
      overviewContent={
        <>
          <p>
          ...
          <p>
            ...
            <a href="/plumber-liverpool/services/drain-services/blocked-drains" className="text-primary underline hover:text-primary/80">
              blocked drain
            </a>{" "}
            that needs clearing or a more involved investigation using a{" "}
            <a href="/plumber-liverpool/services/drain-services/cctv-drain-survey" className="text-primary underline hover:text-primary/80">
              CCTV drain survey
            </a>
          ...
          <p>
            ...
            <a href="/plumber-liverpool/services/general-plumbing" className="text-primary underline hover:text-primary/80">
              kitchen or bathroom plumbing
            </a>
            , or if a severe blockage creates an{" "}
            <a href="/plumber-liverpool/services/emergency-plumbing" className="text-primary underline hover:text-primary/80">
        ...
        },
        {
          ...
          description: (
            <p>
              ...
              emergency and scheduled drain work across Liverpool.
            </p>
          ),
        },
        {
      ...
      serviceAreasHeading="Drain Services Across Liverpool and Surrounding Areas"
      serviceAreasContent={
        <p>
          Our network of drain specialists covers Liverpool and the nearby
          villages of Merseyside. From Toxteth and Woolton to
          Walton, Crosby, and Huyton, we connect you with a drainage
      ...
      faqs={[
        ...
        {
          question:
            "How much does a CCTV drain survey cost in Liverpool?",
          answer:
            "The cost depends on the length and accessibility of the drainage run. A standard domestic survey for a typical Liverpool property is straightforward for our network plumbers. You will receive a clear quote before the camera goes in, and the survey includes a recorded video of the findings that you can keep for your records.",
        },
        {
          question:
        ...
        },
        {
          ...
          answer:
            "Yes. Our network includes plumbers available for evening and weekend drain emergencies across Liverpool and the surrounding areas. If sewage is backing up or a blockage is causing flooding, call us and we will connect you with the nearest available drainage specialist as quickly as possible.",
        },
      ]}
      ...
      ctaContent={
        <p>
          ...
          specialist in Liverpool. From blocked sinks to full CCTV surveys, our
          network of vetted plumbers is ready to help — today.
        </p>
      }
      categoryName="Drain Services"
      categoryDescription="Blocked drain clearing, CCTV drain surveys, drain unblocking, and toilet repairs in Liverpool by vetted, insured plumbers."
