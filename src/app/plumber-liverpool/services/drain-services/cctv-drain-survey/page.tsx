...
export const metadata: Metadata = {
  title: "CCTV Drain Survey Liverpool | OnCall Home Repairs",
  description:
    "CCTV drain survey in Liverpool. Camera inspection to diagnose drainage problems accurately. Vetted engineers. Call 0333 240 8428.",
  alternates: {
    canonical:
      "https://oncallhomerepairs.co.uk/plumber-liverpool/services/drain-services/cctv-drain-survey",
  },
};
...
export default function CCTVDrainSurveyPage() {
  return (
    <ServicePage
      ...
      h1="CCTV Drain Survey in Liverpool"
      heroIntro={
        <p>
          ...
          engineers in Liverpool who use professional camera equipment to inspect
      ...
      whatWhyContent={
        <>
          ...
          <p>
            Homebuyers in Liverpool increasingly request drain surveys as part
      ...
      serviceAreasHeading="CCTV Drain Surveys Across Liverpool"
      serviceAreasContent={
        <p>
          Our drain engineers carry out CCTV surveys across Liverpool, Toxteth,
          Allerton, Woolton, Kirkby, Garston, Childwall, and all
      ...
      faqs={[
        {
          question: "How much does a CCTV drain survey cost in Liverpool?",
          answer:
      ...
      ctaContent={
        <p>
          ...
          we will connect you with a drain engineer in Liverpool who can carry
      ...
      serviceDescription="CCTV drain survey in Liverpool. Professional camera inspection to diagnose drainage problems, root intrusion, and pipe damage."
