...
export const metadata: Metadata = {
  title: "Toilet Repair Liverpool | OnCall Home Repairs",
  description:
    "Toilet repair in Liverpool. Cisterns, flush mechanisms, seals, and installations by vetted plumbers. Call 0333 240 8428.",
  alternates: {
    canonical:
      "https://oncallhomerepairs.co.uk/plumber-liverpool/services/drain-services/toilet-repair",
  },
};
    ...
    <ServicePage
      ...
      heroIntro={
        <p>
          ...
          Liverpool who repair and replace toilet components, cisterns, and
      ...
      whatWhyContent={
        <>
          ...
          <p>
            In properties across Liverpool, hard water deposits also play a role.
      ...
      serviceAreasHeading="Toilet Repair Across Liverpool"
      serviceAreasContent={
        <p>
          Our plumbers carry out toilet repairs across Liverpool, Toxteth,
          Allerton, Woolton, Wavertree, Walton, and all
      ...
      ctaContent={
        <p>
          ...
          Liverpool who can diagnose and fix the problem &mdash; usually in a
          single visit.
        </p>
      }
      serviceName="Toilet Repair"
      serviceSlug="toilet-repair"
      serviceDescription="Toilet repair in Liverpool. Cistern mechanisms, fill valves, flush faults, and seal replacements by vetted local plumbers."
