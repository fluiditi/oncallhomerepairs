...
export const metadata: Metadata = {
  title: "Blocked Drains Liverpool | OnCall Home Repairs",
  description:
    "Blocked drain clearing in Liverpool. Fast, effective unblocking for homes and businesses. Call 0333 240 8428.",
  alternates: {
    canonical:
      "https://oncallhomerepairs.co.uk/plumber-liverpool/services/drain-services/blocked-drains",
  },
};
...
export default function BlockedDrainsPage() {
  return (
    <ServicePage
      ...
      h1="Blocked Drains in Liverpool"
      heroIntro={
        <p>
          ...
          drainage plumbers in Liverpool who can clear blockages quickly and
      ...
      serviceAreasHeading="Blocked Drain Clearing Across Liverpool"
      serviceAreasContent={
        <p>
          Our drainage plumbers cover Liverpool and every surrounding town and
          village. From terraced properties in Liverpool centre with shared
          drainage runs to detached homes in Toxteth, Allerton, and Market
      ...
      ctaHeading="Blocked Drain in Liverpool?"
      ctaContent={
        <p>
      ...
      serviceDescription="Blocked drain clearing in Liverpool. Fast, effective unblocking for homes and businesses."
