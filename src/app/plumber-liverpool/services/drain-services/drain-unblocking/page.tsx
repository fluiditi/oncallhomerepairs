...
export const metadata: Metadata = {
  title: "Drain Unblocking Liverpool | OnCall Home Repairs",
  description:
    "Professional drain unblocking in Liverpool. High-pressure jetting and manual rodding. Vetted plumbers. Call 0333 240 8428.",
  alternates: {
    canonical:
      "https://oncallhomerepairs.co.uk/plumber-liverpool/services/drain-services/drain-unblocking",
  },
};
...
export default function DrainUnblockingPage() {
  return (
    <ServicePage
      ...
      h1="Drain Unblocking in Liverpool"
      heroIntro={
        <p>
          ...
          experienced drain engineers in Liverpool who use professional-grade
      ...
      whatWhyContent={
        <>
          <p>
            Most drain blockages in Liverpool homes are caused by a gradual
      ...
      serviceAreasHeading="Drain Unblocking Across Liverpool"
      serviceAreasContent={
        <p>
          Our drain engineers cover Liverpool, Toxteth, Allerton, Woolton,
          Huyton, Bootle, and the surrounding area. External drain
      ...
      ctaContent={
        <p>
          ...
          Liverpool who can clear the blockage and restore full flow.
        </p>
      }
      serviceName="Drain Unblocking"
      serviceSlug="drain-unblocking"
      serviceDescription="Professional drain unblocking in Liverpool using high-pressure jetting and manual rodding. Fast, effective clearance for homes and businesses."
