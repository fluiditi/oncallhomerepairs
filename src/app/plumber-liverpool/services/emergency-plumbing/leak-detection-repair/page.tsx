...
export const metadata: Metadata = {
  title: "Leak Detection Liverpool | OnCall Home Repairs",
  description:
    "Professional leak detection and repair in Liverpool. Find and fix hidden leaks fast. Transparent pricing. Call 0333 240 8428.",
  alternates: {
    canonical:
      "https://oncallhomerepairs.co.uk/plumber-liverpool/services/emergency-plumbing/leak-detection-repair",
  },
};
...
export default function LeakDetectionRepairPage() {
  return (
    <ServicePage
      ...
      h1="Leak Detection and Repair in Liverpool"
      heroIntro={
        <p>
          ...
          connects you with skilled plumbers in Liverpool who specialise in
      ...
      whatWhyContent={
        <>
          ...
          <p>
            In Liverpool, many homes are built with traditional construction
          ...
          <p>
            ...
            <Link
              href="/plumber-liverpool/services/emergency-plumbing/overflow-repair"
              className="text-primary underline underline-offset-2 hover:text-primary/80"
            >
              overflowing cistern
            </Link>{" "}
      ...
      benefits={[
        ...
        },
        {
          ...
          description: (
            <p>
              Every plumber in our Liverpool network is qualified, insured, and
      ...
      serviceAreasHeading="Leak Detection Across Liverpool"
      serviceAreasContent={
        <p>
          Our leak detection service covers Liverpool and all nearby towns and
          villages. From Victorian terraces in Liverpool centre to modern estates
          in Toxteth and Allerton, our plumbers are experienced with the
          property types and plumbing systems found across the area. Whether
          your leak is in a ground-floor flat in Woolton or a detached house in
          Aigburth, we can match you with someone local who can investigate
          promptly.
        </p>
      }
      faqs={[
      ...
      ctaHeading="Suspect a Leak in Your Liverpool Home?"
      ctaContent={
        <p>
      ...
      serviceDescription="Professional leak detection and repair in Liverpool. Find and fix hidden leaks fast."
