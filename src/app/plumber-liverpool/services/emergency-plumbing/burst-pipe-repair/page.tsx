...
export const metadata: Metadata = {
  title: "Burst Pipe Repair Liverpool | OnCall Home Repairs",
  description:
    "Fast burst pipe repair in Liverpool. 24/7 emergency response from vetted plumbers. Transparent pricing. Call 0333 240 8428.",
  alternates: {
    canonical:
      "https://oncallhomerepairs.co.uk/plumber-liverpool/services/emergency-plumbing/burst-pipe-repair",
  },
};
...
export default function BurstPipeRepairPage() {
  return (
    <ServicePage
      ...
      h1="Burst Pipe Repair in Liverpool"
      heroIntro={
        <p>
          ...
          you with vetted, experienced plumbers in the Liverpool area who
      ...
      whatWhyContent={
        <>
          ...
          <p>
            Our network of plumbers in Liverpool arrives equipped with the
      ...
      serviceAreasHeading="Burst Pipe Repair Across Liverpool"
      serviceAreasContent={
        <p>
          We connect homeowners with burst pipe repair plumbers across Liverpool
          and the surrounding villages. Whether you are in Toxteth, Allerton,
          Woolton, or further afield in Bootle or Kirkby, our
      ...
      ctaHeading="Burst Pipe in Liverpool? Act Now"
      ctaContent={
        <p>
      ...
      serviceDescription="Fast burst pipe repair in Liverpool. Emergency call-out available 24/7."
