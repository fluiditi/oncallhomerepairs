...
export const metadata: Metadata = {
  title: "Overflow Repair Liverpool | OnCall Home Repairs",
  description:
    "Overflow pipe repair in Liverpool. Stop water leaks from tanks and cisterns. Transparent pricing. Call 0333 240 8428.",
  alternates: {
    canonical:
      "https://oncallhomerepairs.co.uk/plumber-liverpool/services/emergency-plumbing/overflow-repair",
  },
};
...
export default function OverflowRepairPage() {
  return (
    <ServicePage
      ...
      h1="Overflow Pipe Repair in Liverpool"
      heroIntro={
        <p>
          ...
          OnCall Home Repairs connects you with vetted Liverpool plumbers who
      ...
      serviceAreasHeading="Overflow Repair Across Liverpool"
      serviceAreasContent={
        <p>
          Our plumbers carry out overflow repairs across Liverpool, Toxteth,
          Allerton, Woolton, Bootle, and the wider Merseyside
      ...
      ctaContent={
        <p>
          Stop wasting water and prevent damp damage to your Liverpool home.
      ...
      serviceDescription="Overflow pipe repair in Liverpool. Diagnose and fix faulty ball valves, cisterns, and tank overflows with vetted local plumbers."
