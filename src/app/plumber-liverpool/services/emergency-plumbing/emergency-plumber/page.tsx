...
export const metadata: Metadata = {
  title: "Emergency Plumber Liverpool | OnCall Home Repairs",
  description:
    "24-hour emergency plumber in Liverpool. Fast response for burst pipes, leaks, flooding. Vetted, Gas Safe. Call 0333 240 8428.",
  alternates: {
    canonical:
      "https://oncallhomerepairs.co.uk/plumber-liverpool/services/emergency-plumbing/emergency-plumber",
  },
};
...
export default function EmergencyPlumberPage() {
  return (
    <ServicePage
      ...
      h1="Emergency Plumber in Liverpool — Available 24/7"
      heroIntro={
        <p>
          ...
          Liverpool and the surrounding Merseyside area. Whether it is the
      ...
      whatWhyContent={
        <>
          ...
          <p>
            ...
            plumbing firm — we are a matching network that connects Liverpool
        ...
        },
        {
          ...
          description: (
            <p>
              ...
              Liverpool. Because our network covers the local area, response times
      ...
      benefits={[
        ...
        },
        {
          ...
          description: (
            <p>
              Our plumbers live and work in and around Liverpool. Local knowledge
      ...
      relatedServices={[
        ...
        {
          name: "Boiler Repair",
          href: "/plumber-liverpool/services/boiler-heating/boiler-repair",
        },
      ]}
      serviceAreasHeading="Emergency Plumber Coverage Areas"
      serviceAreasContent={
        <p>
          Our emergency plumber network covers Liverpool and all surrounding towns
          and villages across Merseyside. Whether you are in the
          centre of Liverpool or in a nearby village, we can connect you with a
      ...
      faqs={[
        {
          question:
            "How much does an emergency plumber call-out in Liverpool cost?",
          answer:
        ...
        },
        {
          ...
          answer:
            "Response times depend on current demand and your exact location in the Liverpool area. In most cases, we aim to have a plumber with you within one to two hours of your call. For urgent situations such as major leaks or gas concerns, we prioritise the fastest possible dispatch.",
          answerJsx: (
            <p>
              Response times depend on current demand and your exact location in
              the Liverpool area. In most cases, we aim to have a plumber with you
      ...
      ctaHeading="Plumbing Emergency in Liverpool?"
      ctaContent={
        <p>
      ...
      serviceDescription="24-hour emergency plumber in Liverpool. Fast response for burst pipes, leaks, and flooding."
