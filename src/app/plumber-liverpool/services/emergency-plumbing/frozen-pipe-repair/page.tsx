...
export const metadata: Metadata = {
  title: "Frozen Pipe Repair Liverpool | OnCall Home Repairs",
  description:
    "Frozen pipe repair in Liverpool. Prevent burst pipes this winter. Vetted plumbers, 24/7. Call 0333 240 8428.",
  alternates: {
    canonical:
      "https://oncallhomerepairs.co.uk/plumber-liverpool/services/emergency-plumbing/frozen-pipe-repair",
  },
};
...
export default function FrozenPipeRepairPage() {
  return (
    <ServicePage
      ...
      h1="Frozen Pipe Repair in Liverpool"
      heroIntro={
        <p>
          When temperatures across Merseyside drop below freezing, pipes in
      ...
      whatWhyHeading="Why Frozen Pipes Are a Serious Risk in Liverpool"
      whatWhyContent={
        <>
          <p>
            Liverpool sits in the East Midlands where winter temperatures
          ...
          <p>
            ...
            understands the specific risks Merseyside winters pose to local
      ...
      serviceAreasHeading="Frozen Pipe Repair Across Liverpool"
      serviceAreasContent={
        <p>
          Our plumbers attend frozen pipe emergencies across Liverpool, Toxteth,
          Allerton, Woolton, and the surrounding villages. Properties in
          ...
          Merseyside, we can connect you with a plumber who
      ...
      faqs={[
        ...
        {
          question:
            "How much does frozen pipe repair cost in Liverpool?",
          answer:
      ...
      ctaContent={
        <p>
          ...
          Home Repairs and we will connect you with a vetted plumber in Liverpool
      ...
      serviceDescription="Frozen pipe thawing and repair in Liverpool. Prevent burst pipes this winter with safe, professional pipe repair from vetted local plumbers."
