...
export const metadata: Metadata = {
  title: "Frozen Pipe Repair Edinburgh | OnCall Home Repairs",
  description:
    "Frozen pipe repair in Edinburgh. Prevent burst pipes this winter. Vetted plumbers, 24/7. Call 0333 240 8428.",
  alternates: {
    canonical:
      "https://oncallhomerepairs.co.uk/plumber-edinburgh/services/emergency-plumbing/frozen-pipe-repair",
  },
};
    ...
    <ServicePage
      breadcrumbItems={[
        ...
        { name: "Emergency Plumbing", href: "/plumber-edinburgh/services/emergency-plumbing" },
        {
          ...
          href: "/plumber-edinburgh/services/emergency-plumbing/frozen-pipe-repair",
        },
      ]}
      h1="Frozen Pipe Repair in Edinburgh"
      heroIntro={
        <p>
          When temperatures across Edinburgh drop below freezing, pipes in
      ...
      whatWhyHeading="Why Frozen Pipes Are a Serious Risk in Edinburgh"
      whatWhyContent={
        <>
          <p>
            Edinburgh sits in the East Midlands where winter temperatures
          ...
          <p>
            ...
            understands the specific risks Edinburgh winters pose to local
      ...
      serviceAreasHeading="Frozen Pipe Repair Across Edinburgh"
      serviceAreasContent={
        <p>
          Our plumbers attend frozen pipe emergencies across Edinburgh, Leith,
          Morningside, Stockbridge, and the surrounding villages. Properties in
          ...
          Edinburgh, we can connect you with a plumber who
      ...
      faqs={[
        ...
        {
          question:
            "How much does frozen pipe repair cost in Edinburgh?",
          answer:
      ...
      ctaContent={
        <p>
          ...
          Home Repairs and we will connect you with a vetted plumber in Edinburgh
      ...
      serviceDescription="Frozen pipe thawing and repair in Edinburgh. Prevent burst pipes this winter with safe, professional pipe repair from vetted local plumbers."
