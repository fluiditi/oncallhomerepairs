...
export const metadata: Metadata = {
  title: "Emergency Plumber Edinburgh | OnCall Home Repairs",
  description:
    "24-hour emergency plumber in Edinburgh. Fast response for burst pipes, leaks, flooding. Vetted, Gas Safe. Call 0333 240 8428.",
  alternates: {
    canonical:
      "https://oncallhomerepairs.co.uk/plumber-edinburgh/services/emergency-plumbing/emergency-plumber",
  },
};
...
export default function EmergencyPlumberPage() {
  return (
    <ServicePage
      ...
      h1="Emergency Plumber in Edinburgh — Available 24/7"
      heroIntro={
        <p>
          ...
          Edinburgh and the surrounding Edinburgh area. Whether it is the
      ...
      whatWhyContent={
        <>
          ...
          <p>
            ...
            plumbing firm — we are a matching network that connects Edinburgh
          ...
          <p>
            ...
            to{" "}
            <Link
              href="/plumber-edinburgh/services/emergency-plumbing/flood-response"
              className="text-primary underline underline-offset-2 hover:text-primary/80"
            >
              flood response
            </Link>
        ...
        },
        {
          ...
          description: (
            <p>
              ...
              Edinburgh. Because our network covers the local area, response times
      ...
      benefits={[
        ...
        },
        {
          ...
          description: (
            <p>
              Our plumbers live and work in and around Edinburgh. Local knowledge
      ...
      relatedServices={[
        ...
        {
          name: "Boiler Repair",
          href: "/plumber-edinburgh/services/boiler-heating/boiler-repair",
        },
      ]}
      serviceAreasHeading="Emergency Plumber Coverage Areas"
      serviceAreasContent={
        <p>
          Our emergency plumber network covers Edinburgh and all surrounding towns
          and villages across Edinburgh. Whether you are in the
          centre of Edinburgh or in a nearby village, we can connect you with a
      ...
      faqs={[
        {
          question:
            "How much does an emergency plumber call-out in Edinburgh cost?",
          answer:
        ...
        },
        {
          ...
          answer:
            "Response times depend on current demand and your exact location in the Edinburgh area. In most cases, we aim to have a plumber with you within one to two hours of your call. For urgent situations such as major leaks or gas concerns, we prioritise the fastest possible dispatch.",
          answerJsx: (
            <p>
              Response times depend on current demand and your exact location in
              the Edinburgh area. In most cases, we aim to have a plumber with you
      ...
      ctaHeading="Plumbing Emergency in Edinburgh?"
      ctaContent={
        <p>
      ...
      serviceDescription="24-hour emergency plumber in Edinburgh. Fast response for burst pipes, leaks, and flooding."
