...
export const metadata: Metadata = {
  title: "Overflow Repair Edinburgh | OnCall Home Repairs",
  description:
    "Overflow pipe repair in Edinburgh. Stop water leaks from tanks and cisterns. Transparent pricing. Call 0333 240 8428.",
  alternates: {
    canonical:
      "https://oncallhomerepairs.co.uk/plumber-edinburgh/services/emergency-plumbing/overflow-repair",
  },
};
...
export default function OverflowRepairPage() {
  return (
    <ServicePage
      ...
      h1="Overflow Pipe Repair in Edinburgh"
      heroIntro={
        <p>
          ...
          OnCall Home Repairs connects you with vetted Edinburgh plumbers who
      ...
      serviceAreasHeading="Overflow Repair Across Edinburgh"
      serviceAreasContent={
        <p>
          Our plumbers carry out overflow repairs across Edinburgh, Leith,
          Morningside, Stockbridge, Corstorphine, and the wider Edinburgh
      ...
      ctaContent={
        <p>
          Stop wasting water and prevent damp damage to your Edinburgh home.
      ...
      serviceDescription="Overflow pipe repair in Edinburgh. Diagnose and fix faulty ball valves, cisterns, and tank overflows with vetted local plumbers."
