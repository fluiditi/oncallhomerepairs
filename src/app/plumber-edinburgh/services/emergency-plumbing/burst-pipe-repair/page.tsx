...
export const metadata: Metadata = {
  title: "Burst Pipe Repair Edinburgh | OnCall Home Repairs",
  description:
    "Fast burst pipe repair in Edinburgh. 24/7 emergency response from vetted plumbers. Transparent pricing. Call 0333 240 8428.",
  alternates: {
    canonical:
      "https://oncallhomerepairs.co.uk/plumber-edinburgh/services/emergency-plumbing/burst-pipe-repair",
  },
};
...
export default function BurstPipeRepairPage() {
  return (
    <ServicePage
      ...
      h1="Burst Pipe Repair in Edinburgh"
      heroIntro={
        <p>
          ...
          you with vetted, experienced plumbers in the Edinburgh area who
      ...
      whatWhyContent={
        <>
          ...
          <p>
            Our network of plumbers in Edinburgh arrives equipped with the
      ...
      serviceAreasHeading="Burst Pipe Repair Across Edinburgh"
      serviceAreasContent={
        <p>
          We connect homeowners with burst pipe repair plumbers across Edinburgh
          and the surrounding villages. Whether you are in Leith, Morningside,
          Stockbridge, or further afield in Corstorphine or Dalry, our
      ...
      ctaHeading="Burst Pipe in Edinburgh? Act Now"
      ctaContent={
        <p>
      ...
      serviceDescription="Fast burst pipe repair in Edinburgh. Emergency call-out available 24/7."
