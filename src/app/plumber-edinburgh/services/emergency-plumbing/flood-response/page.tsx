...
export const metadata: Metadata = {
  title: "Flood Response Plumber Edinburgh | OnCall Home Repairs",
  description:
    "Emergency flood response in Edinburgh. Rapid water damage control by vetted plumbers, available 24/7. Call 0333 240 8428.",
  alternates: {
    canonical:
      "https://oncallhomerepairs.co.uk/plumber-edinburgh/services/emergency-plumbing/flood-response",
  },
};
...
export default function FloodResponsePage() {
  return (
    <ServicePage
      ...
      h1="Flood Response Plumber in Edinburgh"
      heroIntro={
        <p>
          ...
          experienced flood response plumbers in Edinburgh who can reach your
      ...
      whatWhyContent={
        <>
          ...
          <p>
            Properties across Edinburgh, Leith, and the surrounding villages
      ...
      relatedServices={[
        ...
        },
        {
          ...
          href: "/plumber-edinburgh/services/emergency-plumbing/stopcock-repair",
        },
        {
      ...
      serviceAreasHeading="Flood Response Across Edinburgh and Edinburgh"
      serviceAreasContent={
        <p>
          Our flood response plumbers cover Edinburgh town centre, Leith,
          Morningside, Stockbridge, Bruntsfield, and surrounding villages.
          Response times are fastest within the Edinburgh and Leith area,
          with the wider Edinburgh area typically reached
      ...
      ctaContent={
        <p>
          ...
          will have a vetted flood response plumber heading to your Edinburgh
          property as quickly as possible.
        </p>
      }
      serviceName="Flood Response"
      serviceSlug="flood-response"
      serviceDescription="Emergency flood response plumber in Edinburgh. Rapid water damage control, source isolation, and immediate repair by vetted local plumbers."
