...
export const metadata: Metadata = {
  title: "Leak Detection Edinburgh | OnCall Home Repairs",
  description:
    "Professional leak detection and repair in Edinburgh. Find and fix hidden leaks fast. Transparent pricing. Call 0333 240 8428.",
  alternates: {
    canonical:
      "https://oncallhomerepairs.co.uk/plumber-edinburgh/services/emergency-plumbing/leak-detection-repair",
  },
};
...
export default function LeakDetectionRepairPage() {
  return (
    <ServicePage
      ...
      h1="Leak Detection and Repair in Edinburgh"
      heroIntro={
        <p>
          ...
          connects you with skilled plumbers in Edinburgh who specialise in
      ...
      whatWhyContent={
        <>
          ...
          <p>
            In Edinburgh, many homes are built with traditional construction
          ...
          <p>
            ...
            <Link
              href="/plumber-edinburgh/services/emergency-plumbing/overflow-repair"
              className="text-primary underline underline-offset-2 hover:text-primary/80"
            >
              overflowing cistern
            </Link>{" "}
      ...
      benefits={[
        ...
        },
        {
          ...
          description: (
            <p>
              Every plumber in our Edinburgh network is qualified, insured, and
      ...
      serviceAreasHeading="Leak Detection Across Edinburgh"
      serviceAreasContent={
        <p>
          Our leak detection service covers Edinburgh and all nearby towns and
          villages. From Victorian terraces in Edinburgh centre to modern estates
          in Leith and Morningside, our plumbers are experienced with the
          property types and plumbing systems found across the area. Whether
          your leak is in a ground-floor flat in Stockbridge or a detached house in
          Craigmillar, we can match you with someone local who can investigate
          promptly.
        </p>
      }
      faqs={[
      ...
      ctaHeading="Suspect a Leak in Your Edinburgh Home?"
      ctaContent={
        <p>
      ...
      serviceDescription="Professional leak detection and repair in Edinburgh. Find and fix hidden leaks fast."
