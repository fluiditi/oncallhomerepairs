...
export const metadata: Metadata = {
  title: "Tap Repair Edinburgh | OnCall Home Repairs",
  description:
    "Tap repair and replacement in Edinburgh. Fix dripping taps and install new ones. Vetted plumbers, transparent pricing. Call 0333 240 8428.",
  alternates: {
    canonical:
      "https://oncallhomerepairs.co.uk/plumber-edinburgh/services/general-plumbing/tap-repair-replacement",
  },
};
...
export default function TapRepairPage() {
  return (
    <ServicePage
      ...
      h1="Tap Repair and Replacement in Edinburgh"
      heroIntro={
        <p>
          ...
          Home Repairs connects you with plumbers in Edinburgh who can fix
      ...
      whatWhyContent={
        <>
          <p>
            ...
            Edinburgh, the hard water supply accelerates wear on internal
      ...
      serviceAreasHeading="Tap Repair Across Edinburgh"
      serviceAreasContent={
        <p>
          Our plumbers repair and replace taps across Edinburgh, Leith, Morningside,
          Stockbridge, Craigmillar, Liberton, and the surrounding area. Tap
      ...
      ctaContent={
        <p>
          ...
          will connect you with a plumber in Edinburgh who can repair or
      ...
      serviceDescription="Tap repair and replacement in Edinburgh. Fix dripping taps, replace worn components, and install new taps with vetted local plumbers."
