...
export const metadata: Metadata = {
  title: "Pipe Replacement Edinburgh | OnCall Home Repairs",
  description:
    "Pipe replacement in Edinburgh. Copper, plastic, and lead pipe upgrades by vetted plumbers. Transparent pricing. Call 0333 240 8428.",
  alternates: {
    canonical:
      "https://oncallhomerepairs.co.uk/plumber-edinburgh/services/general-plumbing/pipe-replacement",
  },
};
...
export default function PipeReplacementPage() {
  return (
    <ServicePage
      ...
      h1="Pipe Replacement in Edinburgh"
      heroIntro={
        <p>
          ...
          connects you with qualified plumbers in Edinburgh who replace old
      ...
      whatWhyContent={
        <>
          <p>
            ...
            Edinburgh properties &mdash; pose a health risk and should be
      ...
      serviceAreasHeading="Pipe Replacement Across Edinburgh"
      serviceAreasContent={
        <p>
          Our plumbers replace pipework in properties across Edinburgh, Leith,
          Morningside, Stockbridge, Haymarket, Newington, and all surrounding areas.
      ...
      ctaContent={
        <p>
          ...
          in Edinburgh who can assess your pipes and carry out replacements
          that last.
        </p>
      }
      serviceName="Pipe Replacement"
      serviceSlug="pipe-replacement"
      serviceDescription="Pipe replacement in Edinburgh. Copper, plastic, and lead pipe upgrades for homes and businesses by vetted local plumbers."
