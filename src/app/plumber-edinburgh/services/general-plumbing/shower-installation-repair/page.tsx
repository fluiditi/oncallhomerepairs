...
export const metadata: Metadata = {
  title: "Shower Installation Edinburgh | OnCall Home Repairs",
  description:
    "Shower installation and repair in Edinburgh. Electric, mixer, and thermostatic showers. Vetted plumbers. Call 0333 240 8428.",
  alternates: {
    canonical:
      "https://oncallhomerepairs.co.uk/plumber-edinburgh/services/general-plumbing/shower-installation-repair",
  },
};
...
export default function ShowerInstallationPage() {
  return (
    <ServicePage
      ...
      h1="Shower Installation and Repair in Edinburgh"
      heroIntro={
        <p>
          ...
          in Edinburgh who handle all types of shower work. From quick repairs
      ...
      whatWhyContent={
        <>
          ...
          <p>
            In Edinburgh homes with hard water, limescale build-up inside
      ...
      serviceAreasHeading="Shower Installation Across Edinburgh"
      serviceAreasContent={
        <p>
          Our plumbers install and repair showers across Edinburgh, Leith,
          Morningside, Stockbridge, Bruntsfield, Portobello, and surrounding
      ...
      ctaContent={
        <p>
          ...
          Repairs will match you with a qualified plumber in Edinburgh. Call now
          for an upfront quote.
        </p>
      }
      serviceName="Shower Installation and Repair"
      serviceSlug="shower-installation-repair"
      serviceDescription="Shower installation and repair in Edinburgh. Electric, mixer, and thermostatic showers fitted and repaired by vetted local plumbers."
