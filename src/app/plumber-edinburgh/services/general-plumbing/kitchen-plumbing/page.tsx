...
export const metadata: Metadata = {
  title: "Kitchen Plumber Edinburgh | OnCall Home Repairs",
  description:
    "Kitchen plumbing in Edinburgh. Sink installations, dishwasher connections, waste disposal, and repairs. Call 0333 240 8428.",
  alternates: {
    canonical:
      "https://oncallhomerepairs.co.uk/plumber-edinburgh/services/general-plumbing/kitchen-plumbing",
  },
};
...
export default function KitchenPlumbingPage() {
  return (
    <ServicePage
      ...
      h1="Kitchen Plumbing in Edinburgh"
      heroIntro={
        <p>
          ...
          Edinburgh who install, repair, and maintain kitchen plumbing &mdash;
      ...
      whatWhyContent={
        <>
          ...
          <p>
            Blocked kitchen sinks are a regular call-out in Edinburgh. Grease,
            ...
            <a
              href="/plumber-edinburgh/services/drain-services/drain-unblocking"
      ...
      serviceAreasHeading="Kitchen Plumbing Across Edinburgh"
      serviceAreasContent={
        <p>
          Our plumbers carry out kitchen plumbing work across Edinburgh,
          Leith, Morningside, Stockbridge, Corstorphine, Gorgie, Market
      ...
      ctaContent={
        <p>
          ...
          Repairs will match you with a qualified plumber in Edinburgh. Call
          for a clear, upfront quote.
        </p>
      }
      serviceName="Kitchen Plumbing"
      serviceSlug="kitchen-plumbing"
      serviceDescription="Kitchen plumbing in Edinburgh. Sink installations, appliance connections, waste pipe repairs, and full kitchen plumbing by vetted local plumbers."
