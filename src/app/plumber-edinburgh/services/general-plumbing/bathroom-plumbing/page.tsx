...
export const metadata: Metadata = {
  title: "Bathroom Plumber Edinburgh | OnCall Home Repairs",
  description:
    "Bathroom plumbing in Edinburgh. Installations, repairs, full refits. Vetted plumbers, upfront quotes. Call 0333 240 8428.",
  alternates: {
    canonical:
      "https://oncallhomerepairs.co.uk/plumber-edinburgh/services/general-plumbing/bathroom-plumbing",
  },
};
...
export default function BathroomPlumbingPage() {
  return (
    <ServicePage
      ...
      h1="Bathroom Plumbing in Edinburgh"
      heroIntro={
        <p>
          ...
          vetted, experienced plumbers in Edinburgh who handle all aspects of
      ...
      whatWhyContent={
        <>
          ...
          <p>
            ...
            will support the{" "}
            <Link
              href="/plumber-edinburgh/services/general-plumbing/shower-installation-repair"
              className="text-primary underline underline-offset-2 hover:text-primary/80"
            >
              shower
            </Link>{" "}
        ...
        },
        {
          ...
          description: (
            <p>
              ...
              in Edinburgh properties — from Victorian terraces with old lead
      ...
      relatedServices={[
        ...
        {
          name: "Toilet Repair",
          href: "/plumber-edinburgh/services/drain-services/toilet-repair",
        },
        {
          name: "Kitchen Plumbing",
          href: "/plumber-edinburgh/services/general-plumbing/kitchen-plumbing",
        },
      ]}
      serviceAreasHeading="Bathroom Plumbing Across Edinburgh"
      serviceAreasContent={
        <p>
          Our bathroom plumbers serve Edinburgh and all surrounding areas. From
          period properties in the town centre that need careful pipework
          modifications to new-build homes in Portobello, Liberton, and Newington
          that need a shower upgrade or suite replacement, our plumbers have
          the experience to handle it. We cover Leith, Morningside, Stockbridge,
          Haymarket, and all villages in between.
        </p>
      }
      faqs={[
        {
      ...
      ctaHeading="Need a Bathroom Plumber in Edinburgh?"
      ctaContent={
        <p>
      ...
      serviceDescription="Bathroom plumbing in Edinburgh. Installations, repairs, and full bathroom fit-outs."
