...
export const metadata: Metadata = {
  title: "Toilet Repair Edinburgh | OnCall Home Repairs",
  description:
    "Toilet repair in Edinburgh. Cisterns, flush mechanisms, seals, and installations by vetted plumbers. Call 0333 240 8428.",
  alternates: {
    canonical:
      "https://oncallhomerepairs.co.uk/plumber-edinburgh/services/drain-services/toilet-repair",
  },
};
    ...
    <ServicePage
      ...
      heroIntro={
        <p>
          ...
          Edinburgh who repair and replace toilet components, cisterns, and
      ...
      whatWhyContent={
        <>
          ...
          <p>
            In properties across Edinburgh, hard water deposits also play a role.
      ...
      serviceAreasHeading="Toilet Repair Across Edinburgh"
      serviceAreasContent={
        <p>
          Our plumbers carry out toilet repairs across Edinburgh, Leith,
          Morningside, Stockbridge, Bruntsfield, Marchmont, and all
      ...
      ctaContent={
        <p>
          ...
          Edinburgh who can diagnose and fix the problem &mdash; usually in a
          single visit.
        </p>
      }
      serviceName="Toilet Repair"
      serviceSlug="toilet-repair"
      serviceDescription="Toilet repair in Edinburgh. Cistern mechanisms, fill valves, flush faults, and seal replacements by vetted local plumbers."
