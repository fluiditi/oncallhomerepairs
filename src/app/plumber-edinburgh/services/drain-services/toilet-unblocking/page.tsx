...
export const metadata: Metadata = {
  title: "Toilet Unblocking Edinburgh | OnCall Home Repairs",
  description:
    "Toilet unblocking in Edinburgh. Fast, hygienic clearance of blocked toilets by vetted plumbers. Call 0333 240 8428.",
  alternates: {
    canonical:
      "https://oncallhomerepairs.co.uk/plumber-edinburgh/services/drain-services/toilet-unblocking",
  },
};
    ...
    <ServicePage
      breadcrumbItems={[
        ...
        { name: "Drain Services", href: "/plumber-edinburgh/services/drain-services" },
        {
          ...
          href: "/plumber-edinburgh/services/drain-services/toilet-unblocking",
        },
      ]}
      h1="Toilet Unblocking in Edinburgh"
      heroIntro={
        <p>
          ...
          Edinburgh who carry out fast, hygienic toilet unblocking using
      ...
      whatWhyContent={
        <>
          ...
          <p>
            In older Edinburgh properties, narrow soil pipes and ageing clay
      ...
      serviceAreasHeading="Toilet Unblocking Across Edinburgh"
      serviceAreasContent={
        <p>
          Our plumbers attend toilet unblocking jobs across Edinburgh, Leith,
          Morningside, Stockbridge, Newington, Haymarket, and all surrounding areas.
      ...
      ctaContent={
        <p>
          ...
          and we will connect you with a plumber in Edinburgh who can clear it
          quickly and discreetly &mdash; same-day where possible.
        </p>
      }
      serviceName="Toilet Unblocking"
      serviceSlug="toilet-unblocking"
      serviceDescription="Fast, hygienic toilet unblocking in Edinburgh. Professional clearance of blocked toilets by vetted local plumbers."
