...
export const metadata: Metadata = {
  title: "CCTV Drain Survey Edinburgh | OnCall Home Repairs",
  description:
    "CCTV drain survey in Edinburgh. Camera inspection to diagnose drainage problems accurately. Vetted engineers. Call 0333 240 8428.",
  alternates: {
    canonical:
      "https://oncallhomerepairs.co.uk/plumber-edinburgh/services/drain-services/cctv-drain-survey",
  },
};
...
export default function CCTVDrainSurveyPage() {
  return (
    <ServicePage
      ...
      h1="CCTV Drain Survey in Edinburgh"
      heroIntro={
        <p>
          ...
          engineers in Edinburgh who use professional camera equipment to inspect
      ...
      whatWhyContent={
        <>
          ...
          <p>
            Homebuyers in Edinburgh increasingly request drain surveys as part
      ...
      serviceAreasHeading="CCTV Drain Surveys Across Edinburgh"
      serviceAreasContent={
        <p>
          Our drain engineers carry out CCTV surveys across Edinburgh, Leith,
          Morningside, Stockbridge, Dalry, Liberton, Newington, and all
      ...
      faqs={[
        {
          question: "How much does a CCTV drain survey cost in Edinburgh?",
          answer:
      ...
      ctaContent={
        <p>
          ...
          we will connect you with a drain engineer in Edinburgh who can carry
      ...
      serviceDescription="CCTV drain survey in Edinburgh. Professional camera inspection to diagnose drainage problems, root intrusion, and pipe damage."
