...
export const metadata: Metadata = {
  title: "Blocked Drains Edinburgh | OnCall Home Repairs",
  description:
    "Blocked drain clearing in Edinburgh. Fast, effective unblocking for homes and businesses. Call 0333 240 8428.",
  alternates: {
    canonical:
      "https://oncallhomerepairs.co.uk/plumber-edinburgh/services/drain-services/blocked-drains",
  },
};
...
export default function BlockedDrainsPage() {
  return (
    <ServicePage
      ...
      h1="Blocked Drains in Edinburgh"
      heroIntro={
        <p>
          ...
          drainage plumbers in Edinburgh who can clear blockages quickly and
      ...
      serviceAreasHeading="Blocked Drain Clearing Across Edinburgh"
      serviceAreasContent={
        <p>
          Our drainage plumbers cover Edinburgh and every surrounding town and
          village. From terraced properties in Edinburgh centre with shared
          drainage runs to detached homes in Leith, Morningside, and Market
      ...
      ctaHeading="Blocked Drain in Edinburgh?"
      ctaContent={
        <p>
      ...
      serviceDescription="Blocked drain clearing in Edinburgh. Fast, effective unblocking for homes and businesses."
