...
export const metadata: Metadata = {
  title: "Drain Unblocking Edinburgh | OnCall Home Repairs",
  description:
    "Professional drain unblocking in Edinburgh. High-pressure jetting and manual rodding. Vetted plumbers. Call 0333 240 8428.",
  alternates: {
    canonical:
      "https://oncallhomerepairs.co.uk/plumber-edinburgh/services/drain-services/drain-unblocking",
  },
};
...
export default function DrainUnblockingPage() {
  return (
    <ServicePage
      ...
      h1="Drain Unblocking in Edinburgh"
      heroIntro={
        <p>
          ...
          experienced drain engineers in Edinburgh who use professional-grade
      ...
      whatWhyContent={
        <>
          <p>
            Most drain blockages in Edinburgh homes are caused by a gradual
      ...
      serviceAreasHeading="Drain Unblocking Across Edinburgh"
      serviceAreasContent={
        <p>
          Our drain engineers cover Edinburgh, Leith, Morningside, Stockbridge,
          Gorgie, Corstorphine, and the surrounding area. External drain
      ...
      ctaContent={
        <p>
          ...
          Edinburgh who can clear the blockage and restore full flow.
        </p>
      }
      serviceName="Drain Unblocking"
      serviceSlug="drain-unblocking"
      serviceDescription="Professional drain unblocking in Edinburgh using high-pressure jetting and manual rodding. Fast, effective clearance for homes and businesses."
