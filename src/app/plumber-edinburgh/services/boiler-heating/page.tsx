...
export const metadata: Metadata = {
  title: "Boiler & Heating Edinburgh | OnCall Home Repairs",
  description:
    "Boiler repair, installation, and heating services in Edinburgh. Gas Safe registered plumbers. Call 0333 240 8428.",
  alternates: {
    canonical: "https://oncallhomerepairs.co.uk/plumber-edinburgh/services/boiler-heating",
  },
};
  ...
  return (
    <CategoryPage
      breadcrumbItems={[
        ...
        { name: "Boiler & Heating", href: "/plumber-edinburgh/services/boiler-heating" },
      ]}
      h1="Boiler & Heating Services in Edinburgh"
      heroIntro={
        <>
          <p>
            ...
            Safe registered heating engineers across Edinburgh who can diagnose,
            repair, and install boilers and central heating systems. From an
            urgent{" "}
            <a href="/plumber-edinburgh/services/boiler-heating/boiler-repair" className="underline hover:text-white">
              boiler repair
            </a>{" "}
            to a planned{" "}
            <a href="/plumber-edinburgh/services/boiler-heating/boiler-installation" className="underline hover:text-white">
      ...
      overviewHeading="Expert Boiler and Heating Care for Edinburgh Homes"
      overviewContent={
        <>
          <p>
          ...
          <p>
            ...
            for routine{" "}
            <a href="/plumber-edinburgh/services/boiler-heating/boiler-servicing" className="text-primary underline hover:text-primary/80">
              boiler servicing
            </a>
            ,{" "}
            <a href="/plumber-edinburgh/services/boiler-heating/radiator-repair-installation" className="text-primary underline hover:text-primary/80">
              radiator repairs
            </a>
            , and{" "}
            <a href="/plumber-edinburgh/services/boiler-heating/power-flushing" className="text-primary underline hover:text-primary/80">
              power flushing
            </a>{" "}
      ...
      services={[
        {
          ...
          slug: "boiler-repair",
          description:
            "Fast boiler repair by Gas Safe engineers in Edinburgh. Fault diagnosis and repair for all major brands — Worcester Bosch, Vaillant, Baxi, Ideal, and more.",
          isCoreService: true,
        },
        {
        ...
        },
        {
          ...
          description: (
            <p>
              ...
              for urgent heating repairs in Edinburgh.
            </p>
          ),
        },
        {
      ...
      crossLinks={[
        {
          ...
          description:
            "Burst pipes, major leaks, and flooding — 24/7 emergency plumber attendance across Edinburgh.",
        },
        {
      ...
      serviceAreasHeading="Boiler & Heating Services Across Edinburgh"
      serviceAreasContent={
        <p>
          Our network of Gas Safe heating engineers covers Edinburgh and the
          surrounding areas of Edinburgh. From Leith and
          Morningside to Corstorphine, Craigmillar, and Newington, we connect you
      ...
      ctaContent={
        <p>
          ...
          registered heating engineer in Edinburgh. Whether it is a repair, a
          service, or a full boiler replacement, we match you with the right
          person for the job.
        </p>
      }
      categoryName="Boiler & Heating"
      categoryDescription="Boiler repair, installation, servicing, and central heating services in Edinburgh by Gas Safe registered engineers."
