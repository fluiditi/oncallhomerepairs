...
export const metadata: Metadata = {
  title: "Gas Safety Check Edinburgh | OnCall Home Repairs",
  description:
    "Gas safety checks and CP12 certificates in Edinburgh. For landlords and homeowners. Gas Safe registered engineers. Call 0333 240 8428.",
  alternates: {
    canonical:
      "https://oncallhomerepairs.co.uk/plumber-edinburgh/services/boiler-heating/gas-safety-checks",
  },
};
...
export default function GasSafetyChecksPage() {
  return (
    <ServicePage
      ...
      h1="Gas Safety Checks in Edinburgh"
      heroIntro={
        <p>
          ...
          Edinburgh who carry out thorough inspections of your boiler, gas
      ...
      serviceAreasHeading="Gas Safety Checks Across Edinburgh"
      serviceAreasContent={
        <p>
          Our Gas Safe registered engineers carry out gas safety checks across
          Edinburgh, Leith, Morningside, Stockbridge, Bruntsfield, Craigmillar,
          Newington, Haymarket, and all surrounding areas. Landlords with multiple
      ...
      faqs={[
        {
          question: "How much does a gas safety check cost in Edinburgh?",
          answer:
      ...
      ctaContent={
        <p>
          ...
          engineer in Edinburgh for your annual gas safety check.
        </p>
      }
      serviceName="Gas Safety Checks"
      serviceSlug="gas-safety-checks"
      serviceDescription="Gas safety checks and CP12 certificates in Edinburgh. Annual inspections for landlords and homeowners by Gas Safe registered engineers."
