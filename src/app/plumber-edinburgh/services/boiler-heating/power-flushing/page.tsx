...
export const metadata: Metadata = {
  title: "Power Flushing Edinburgh | OnCall Home Repairs",
  description:
    "Power flushing in Edinburgh. Remove sludge and restore heating efficiency. Gas Safe engineers, transparent pricing. Call 0333 240 8428.",
  alternates: {
    canonical:
      "https://oncallhomerepairs.co.uk/plumber-edinburgh/services/boiler-heating/power-flushing",
  },
};
...
export default function PowerFlushingPage() {
  return (
    <ServicePage
      ...
      h1="Power Flushing in Edinburgh"
      heroIntro={
        <p>
          ...
          connects you with qualified engineers in Edinburgh who carry out
      ...
      whatWhyContent={
        <>
          ...
          <p>
            ...
            sludge. Edinburgh&rsquo;s hard water makes this worse by adding
      ...
      serviceAreasHeading="Power Flushing Across Edinburgh"
      serviceAreasContent={
        <p>
          Our engineers carry out power flushing across Edinburgh, Leith, Morningside,
          Stockbridge, Corstorphine, Dalry, and surrounding
      ...
      ctaContent={
        <p>
          ...
          Repairs and we will connect you with a qualified engineer in Edinburgh
          who can carry out a professional power flush on your system.
        </p>
      }
      serviceName="Power Flushing"
      serviceSlug="power-flushing"
      serviceDescription="Power flushing in Edinburgh. Remove sludge and limescale from your central heating system to restore efficiency and prevent boiler breakdowns."
