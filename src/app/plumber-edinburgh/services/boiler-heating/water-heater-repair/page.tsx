...
export const metadata: Metadata = {
  title: "Water Heater Repair Edinburgh | OnCall Home Repairs",
  description:
    "Water heater repair in Edinburgh. Immersion heaters, cylinders, and unvented systems. Vetted plumbers. Call 0333 240 8428.",
  alternates: {
    canonical:
      "https://oncallhomerepairs.co.uk/plumber-edinburgh/services/boiler-heating/water-heater-repair",
  },
};
    ...
    <ServicePage
      breadcrumbItems={[
        ...
        { name: "Boiler & Heating", href: "/plumber-edinburgh/services/boiler-heating" },
        {
          ...
          href: "/plumber-edinburgh/services/boiler-heating/water-heater-repair",
        },
      ]}
      h1="Water Heater Repair in Edinburgh"
      heroIntro={
        <p>
          ...
          you with qualified plumbers and heating engineers in Edinburgh who can
      ...
      whatWhyContent={
        <>
          <p>
            Hot water systems vary considerably across Edinburgh properties.
          ...
          <p>
            ...
            areas like Edinburgh, and eventually stops working. The
      ...
      serviceAreasHeading="Water Heater Repair Across Edinburgh"
      serviceAreasContent={
        <p>
          Our plumbers and heating engineers attend water heater repairs across
          Edinburgh, Leith, Morningside, Stockbridge, Portobello, Marchmont, and
      ...
      faqs={[
        {
          ...
          answer:
            "The most common cause is a failed heating element. Hard water areas like Edinburgh accelerate limescale build-up on the element, which causes it to overheat and burn out. The thermostat can also fail independently. A plumber can test both components and replace whichever has failed.",
        },
        {
          question:
      ...
      ctaContent={
        <p>
          ...
          Edinburgh who can restore your hot water supply.
        </p>
      }
      serviceName="Water Heater Repair"
      serviceSlug="water-heater-repair"
      serviceDescription="Water heater repair in Edinburgh. Immersion heaters, hot water cylinders, and unvented systems repaired by qualified local plumbers."
