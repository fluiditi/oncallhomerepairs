...
export const metadata: Metadata = {
  title: "Boiler Installation Edinburgh | OnCall Home Repairs",
  description:
    "New boiler installation in Edinburgh. Gas Safe engineers, competitive quotes, workmanship guarantee. Call 0333 240 8428.",
  alternates: {
    canonical:
      "https://oncallhomerepairs.co.uk/plumber-edinburgh/services/boiler-heating/boiler-installation",
  },
};
...
export default function BoilerInstallationPage() {
  return (
    <ServicePage
      ...
      h1="Boiler Installation in Edinburgh"
      heroIntro={
        <p>
          ...
          you with Gas Safe registered heating engineers in Edinburgh who carry
      ...
      serviceAreasHeading="Boiler Installation Across Edinburgh"
      serviceAreasContent={
        <p>
          We connect homeowners across Edinburgh and Edinburgh
          with qualified boiler installers. Whether you are in the centre of
          Edinburgh, in Leith, Morningside, or one of the surrounding
          ...
          of Edinburgh and can advise on the best boiler setup for your
          home.
        </p>
      }
      faqs={[
        {
          question: "How much does a new boiler installation cost in Edinburgh?",
          answer:
      ...
      ctaHeading="Ready for a New Boiler in Edinburgh?"
      ctaContent={
        <p>
      ...
      serviceDescription="New boiler installation in Edinburgh. Gas Safe registered, competitive pricing."
