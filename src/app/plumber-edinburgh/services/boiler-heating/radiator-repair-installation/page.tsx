...
export const metadata: Metadata = {
  title: "Radiator Repair Edinburgh | OnCall Home Repairs",
  description:
    "Radiator repair and installation in Edinburgh. Fix cold spots, leaks, and add new radiators. Gas Safe engineers. Call 0333 240 8428.",
  alternates: {
    canonical:
      "https://oncallhomerepairs.co.uk/plumber-edinburgh/services/boiler-heating/radiator-repair-installation",
  },
};
...
export default function RadiatorRepairPage() {
  return (
    <ServicePage
      ...
      h1="Radiator Repair and Installation in Edinburgh"
      heroIntro={
        <p>
          ...
          Edinburgh who can diagnose radiator faults, carry out repairs, and
      ...
      whatWhyHeading="Common Radiator Problems in Edinburgh Homes"
      whatWhyContent={
        <>
          <p>
          ...
          <p>
            Edinburgh&rsquo;s hard water accelerates the build-up of
            limescale and sludge in central heating systems. Many homes in
            Edinburgh, Leith, and the surrounding area have heating systems
      ...
      serviceAreasHeading="Radiator Repair Across Edinburgh"
      serviceAreasContent={
        <p>
          Our heating engineers carry out radiator repairs and installations
          across Edinburgh, Leith, Morningside, Stockbridge, Craigmillar, Liberton,
          and the wider Edinburgh area. Whether you need a
      ...
      ctaContent={
        <p>
          ...
          in Edinburgh who can get your radiators working as they should.
        </p>
      }
      serviceName="Radiator Repair and Installation"
      serviceSlug="radiator-repair-installation"
      serviceDescription="Radiator repair and installation in Edinburgh. Fix cold spots, leaking valves, and add new radiators with qualified heating engineers."
