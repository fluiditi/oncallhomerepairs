...
export const metadata: Metadata = {
  title: "Boiler Repair Edinburgh | OnCall Home Repairs",
  description:
    "Boiler repair in Edinburgh by Gas Safe engineers. Same-day repairs, upfront quotes. Available 24/7. Call 0333 240 8428.",
  alternates: {
    canonical:
      "https://oncallhomerepairs.co.uk/plumber-edinburgh/services/boiler-heating/boiler-repair",
  },
};
    ...
    <ServicePage
      ...
      heroIntro={
        <p>
          ...
          with Gas Safe registered heating engineers in Edinburgh who diagnose
        ...
        },
        {
          ...
          description: (
            <p>
              ...
              Edinburgh. For emergency breakdowns, engineers are available 24/7.
      ...
      serviceAreasHeading="Boiler Repair Across Edinburgh"
      serviceAreasContent={
        <p>
          Our network of Gas Safe heating engineers covers Edinburgh and the
          surrounding area. Whether you live in Leith, Morningside, Stockbridge,
          or one of the smaller villages like Corstorphine or Gorgie, we
      ...
      ctaContent={
        <p>
          ...
          a Gas Safe registered engineer in Edinburgh. Upfront pricing,
      ...
      serviceDescription="Expert boiler repair in Edinburgh. Gas Safe registered engineers available 24/7."
