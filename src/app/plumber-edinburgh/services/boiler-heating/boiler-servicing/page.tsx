...
export const metadata: Metadata = {
  title: "Boiler Servicing Edinburgh | OnCall Home Repairs",
  description:
    "Annual boiler servicing in Edinburgh. Keep your warranty valid and your boiler running efficiently. Gas Safe engineers. Call 0333 240 8428.",
  alternates: {
    canonical:
      "https://oncallhomerepairs.co.uk/plumber-edinburgh/services/boiler-heating/boiler-servicing",
  },
};
...
export default function BoilerServicingPage() {
  return (
    <ServicePage
      ...
      h1="Boiler Servicing in Edinburgh"
      heroIntro={
        <p>
          ...
          connects you with Gas Safe registered engineers in Edinburgh who carry
      ...
      serviceAreasHeading="Boiler Servicing Across Edinburgh"
      serviceAreasContent={
        <p>
          Our Gas Safe registered engineers service boilers across Edinburgh,
          Leith, Morningside, Stockbridge, Marchmont, Bruntsfield, and
      ...
      ctaContent={
        <p>
          ...
          Gas Safe registered engineer in Edinburgh.
        </p>
      }
      serviceName="Boiler Servicing"
      serviceSlug="boiler-servicing"
      serviceDescription="Annual boiler servicing in Edinburgh by Gas Safe registered engineers. Manufacturer warranty protection, safety checks, and efficiency testing."
