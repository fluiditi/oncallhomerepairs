...
export const metadata: Metadata = {
  title: "Central Heating Repair Edinburgh | OnCall Home Repairs",
  description:
    "Central heating repair in Edinburgh. Radiators, pumps, valves, thermostats. Gas Safe engineers. Call 0333 240 8428.",
  alternates: {
    canonical:
      "https://oncallhomerepairs.co.uk/plumber-edinburgh/services/boiler-heating/central-heating-repair",
  },
};
...
export default function CentralHeatingRepairPage() {
  return (
    <ServicePage
      ...
      h1="Central Heating Repair in Edinburgh"
      heroIntro={
        <p>
          When your central heating is not working properly, your home becomes
          uncomfortable fast — especially during a Edinburgh winter. Cold
          ...
          engineers in Edinburgh who diagnose and repair central heating faults
      ...
      whatWhyContent={
        <>
          ...
          <p>
            ...
            <Link
              href="/plumber-edinburgh/services/boiler-heating/power-flushing"
              className="text-primary underline underline-offset-2 hover:text-primary/80"
            >
              power flush
            </Link>{" "}
      ...
      benefits={[
        {
          ...
          description: (
            <p>
              ...
              systems and understand the common faults found in Edinburgh
              properties.
            </p>
          ),
        },
      ...
      relatedServices={[
        ...
        },
        {
          ...
          href: "/plumber-edinburgh/services/boiler-heating/radiator-repair-installation",
        },
        {
          name: "Power Flushing",
          href: "/plumber-edinburgh/services/boiler-heating/power-flushing",
        },
        {
          ...
          href: "/plumber-edinburgh/services/boiler-heating/boiler-servicing",
        },
      ]}
      serviceAreasHeading="Central Heating Repair Across Edinburgh"
      serviceAreasContent={
        <p>
          Our heating engineers cover Edinburgh and the surrounding towns and
          villages throughout Edinburgh. From older properties
          in Edinburgh town centre to newer-build estates in Stockbridge, Marchmont,
          and Bruntsfield, our engineers are familiar with the heating
      ...
      ctaContent={
        <p>
          ...
          a qualified heating engineer in Edinburgh who can diagnose and fix the
      ...
      serviceDescription="Central heating repair in Edinburgh. Radiators, pumps, valves, and full system diagnostics."
