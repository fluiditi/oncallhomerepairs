...
export const metadata: Metadata = {
  title: "Frozen Pipe Repair Manchester | OnCall Home Repairs",
  description:
    "Frozen pipe repair in Manchester. Prevent burst pipes this winter. Vetted plumbers, 24/7. Call 0333 240 8428.",
  alternates: {
    canonical:
      "https://oncallhomerepairs.co.uk/plumber-manchester/services/emergency-plumbing/frozen-pipe-repair",
  },
};
...
export default function FrozenPipeRepairPage() {
  return (
    <ServicePage
      ...
      h1="Frozen Pipe Repair in Manchester"
      heroIntro={
        <p>
          When temperatures across Greater Manchester drop below freezing, pipes in
      ...
      whatWhyHeading="Why Frozen Pipes Are a Serious Risk in Manchester"
      whatWhyContent={
        <>
          <p>
            Manchester sits in the East Midlands where winter temperatures
          ...
          <p>
            ...
            understands the specific risks Greater Manchester winters pose to local
      ...
      serviceAreasHeading="Frozen Pipe Repair Across Manchester"
      serviceAreasContent={
        <p>
          Our plumbers attend frozen pipe emergencies across Manchester, Didsbury,
          Chorlton, Salford, and the surrounding villages. Properties in
          ...
          Greater Manchester, we can connect you with a plumber who
      ...
      faqs={[
        ...
        {
          question:
            "How much does frozen pipe repair cost in Manchester?",
          answer:
      ...
      ctaContent={
        <p>
          ...
          Home Repairs and we will connect you with a vetted plumber in Manchester
      ...
      serviceDescription="Frozen pipe thawing and repair in Manchester. Prevent burst pipes this winter with safe, professional pipe repair from vetted local plumbers."
