...
export const metadata: Metadata = {
  title: "Overflow Repair Manchester | OnCall Home Repairs",
  description:
    "Overflow pipe repair in Manchester. Stop water leaks from tanks and cisterns. Transparent pricing. Call 0333 240 8428.",
  alternates: {
    canonical:
      "https://oncallhomerepairs.co.uk/plumber-manchester/services/emergency-plumbing/overflow-repair",
  },
};
...
export default function OverflowRepairPage() {
  return (
    <ServicePage
      ...
      h1="Overflow Pipe Repair in Manchester"
      heroIntro={
        <p>
          ...
          OnCall Home Repairs connects you with vetted Manchester plumbers who
      ...
      serviceAreasHeading="Overflow Repair Across Manchester"
      serviceAreasContent={
        <p>
          Our plumbers carry out overflow repairs across Manchester, Didsbury,
          Chorlton, Salford, Sale, and the wider Greater Manchester
      ...
      ctaContent={
        <p>
          Stop wasting water and prevent damp damage to your Manchester home.
      ...
      serviceDescription="Overflow pipe repair in Manchester. Diagnose and fix faulty ball valves, cisterns, and tank overflows with vetted local plumbers."
