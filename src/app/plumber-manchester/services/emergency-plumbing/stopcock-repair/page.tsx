...
export const metadata: Metadata = {
  title: "Stopcock Repair Manchester | OnCall Home Repairs",
  description:
    "Stopcock repair and replacement in Manchester. Regain control of your water supply. Vetted plumbers. Call 0333 240 8428.",
  alternates: {
    canonical:
      "https://oncallhomerepairs.co.uk/plumber-manchester/services/emergency-plumbing/stopcock-repair",
  },
};
...
export default function StopcockRepairPage() {
  return (
    <ServicePage
      ...
      h1="Stopcock Repair and Replacement in Manchester"
      heroIntro={
        <p>
          ...
          you with vetted plumbers in Manchester who can repair or replace faulty
      ...
      whatWhyContent={
        <>
          ...
          <p>
            In many Manchester properties, especially those built before the 1980s,
            the internal stopcock sits under the kitchen sink and has not been
            turned in years. Mineral deposits from Greater Manchester&rsquo;s hard
      ...
      serviceAreasHeading="Stopcock Repair Across Manchester"
      serviceAreasContent={
        <p>
          We connect homeowners with plumbers who carry out stopcock repairs
          across Manchester, Didsbury, Chorlton, Salford, and all surrounding
      ...
      ctaContent={
        <p>
          ...
          in Manchester who can repair or replace your stopcock &mdash; often the
          same day.
        </p>
      }
      serviceName="Stopcock Repair"
      serviceSlug="stopcock-repair"
      serviceDescription="Stopcock repair and replacement in Manchester. Regain control of your water supply with same-day service from vetted local plumbers."
