...
export const metadata: Metadata = {
  title: "Leak Detection Manchester | OnCall Home Repairs",
  description:
    "Professional leak detection and repair in Manchester. Find and fix hidden leaks fast. Transparent pricing. Call 0333 240 8428.",
  alternates: {
    canonical:
      "https://oncallhomerepairs.co.uk/plumber-manchester/services/emergency-plumbing/leak-detection-repair",
  },
};
...
export default function LeakDetectionRepairPage() {
  return (
    <ServicePage
      ...
      h1="Leak Detection and Repair in Manchester"
      heroIntro={
        <p>
          ...
          connects you with skilled plumbers in Manchester who specialise in
      ...
      whatWhyContent={
        <>
          ...
          <p>
            In Manchester, many homes are built with traditional construction
          ...
          <p>
            ...
            <Link
              href="/plumber-manchester/services/emergency-plumbing/overflow-repair"
              className="text-primary underline underline-offset-2 hover:text-primary/80"
            >
              overflowing cistern
            </Link>{" "}
      ...
      benefits={[
        ...
        },
        {
          ...
          description: (
            <p>
              Every plumber in our Manchester network is qualified, insured, and
      ...
      serviceAreasHeading="Leak Detection Across Manchester"
      serviceAreasContent={
        <p>
          Our leak detection service covers Manchester and all nearby towns and
          villages. From Victorian terraces in Manchester centre to modern estates
          in Didsbury and Chorlton, our plumbers are experienced with the
          property types and plumbing systems found across the area. Whether
          your leak is in a ground-floor flat in Salford or a detached house in
          Bury, we can match you with someone local who can investigate
          promptly.
        </p>
      }
      faqs={[
      ...
      ctaHeading="Suspect a Leak in Your Manchester Home?"
      ctaContent={
        <p>
      ...
      serviceDescription="Professional leak detection and repair in Manchester. Find and fix hidden leaks fast."
