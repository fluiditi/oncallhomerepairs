...
export const metadata: Metadata = {
  title: "Burst Pipe Repair Manchester | OnCall Home Repairs",
  description:
    "Fast burst pipe repair in Manchester. 24/7 emergency response from vetted plumbers. Transparent pricing. Call 0333 240 8428.",
  alternates: {
    canonical:
      "https://oncallhomerepairs.co.uk/plumber-manchester/services/emergency-plumbing/burst-pipe-repair",
  },
};
...
export default function BurstPipeRepairPage() {
  return (
    <ServicePage
      ...
      h1="Burst Pipe Repair in Manchester"
      heroIntro={
        <p>
          ...
          you with vetted, experienced plumbers in the Manchester area who
      ...
      whatWhyContent={
        <>
          ...
          <p>
            Our network of plumbers in Manchester arrives equipped with the
      ...
      serviceAreasHeading="Burst Pipe Repair Across Manchester"
      serviceAreasContent={
        <p>
          We connect homeowners with burst pipe repair plumbers across Manchester
          and the surrounding villages. Whether you are in Didsbury, Chorlton,
          Salford, or further afield in Sale or Oldham, our
      ...
      ctaHeading="Burst Pipe in Manchester? Act Now"
      ctaContent={
        <p>
      ...
      serviceDescription="Fast burst pipe repair in Manchester. Emergency call-out available 24/7."
