...
export const metadata: Metadata = {
  title: "Drain Unblocking Manchester | OnCall Home Repairs",
  description:
    "Professional drain unblocking in Manchester. High-pressure jetting and manual rodding. Vetted plumbers. Call 0333 240 8428.",
  alternates: {
    canonical:
      "https://oncallhomerepairs.co.uk/plumber-manchester/services/drain-services/drain-unblocking",
  },
};
...
export default function DrainUnblockingPage() {
  return (
    <ServicePage
      ...
      h1="Drain Unblocking in Manchester"
      heroIntro={
        <p>
          ...
          experienced drain engineers in Manchester who use professional-grade
      ...
      whatWhyContent={
        <>
          <p>
            Most drain blockages in Manchester homes are caused by a gradual
      ...
      serviceAreasHeading="Drain Unblocking Across Manchester"
      serviceAreasContent={
        <p>
          Our drain engineers cover Manchester, Didsbury, Chorlton, Salford,
          Rochdale, Sale, and the surrounding area. External drain
      ...
      ctaContent={
        <p>
          ...
          Manchester who can clear the blockage and restore full flow.
        </p>
      }
      serviceName="Drain Unblocking"
      serviceSlug="drain-unblocking"
      serviceDescription="Professional drain unblocking in Manchester using high-pressure jetting and manual rodding. Fast, effective clearance for homes and businesses."
