...
export const metadata: Metadata = {
  title: "Blocked Drains Manchester | OnCall Home Repairs",
  description:
    "Blocked drain clearing in Manchester. Fast, effective unblocking for homes and businesses. Call 0333 240 8428.",
  alternates: {
    canonical:
      "https://oncallhomerepairs.co.uk/plumber-manchester/services/drain-services/blocked-drains",
  },
};
...
export default function BlockedDrainsPage() {
  return (
    <ServicePage
      ...
      h1="Blocked Drains in Manchester"
      heroIntro={
        <p>
          ...
          drainage plumbers in Manchester who can clear blockages quickly and
      ...
      serviceAreasHeading="Blocked Drain Clearing Across Manchester"
      serviceAreasContent={
        <p>
          Our drainage plumbers cover Manchester and every surrounding town and
          village. From terraced properties in Manchester centre with shared
          drainage runs to detached homes in Didsbury, Chorlton, and Market
      ...
      ctaHeading="Blocked Drain in Manchester?"
      ctaContent={
        <p>
      ...
      serviceDescription="Blocked drain clearing in Manchester. Fast, effective unblocking for homes and businesses."
