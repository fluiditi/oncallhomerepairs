...
export const metadata: Metadata = {
  title: "Toilet Unblocking Manchester | OnCall Home Repairs",
  description:
    "Toilet unblocking in Manchester. Fast, hygienic clearance of blocked toilets by vetted plumbers. Call 0333 240 8428.",
  alternates: {
    canonical:
      "https://oncallhomerepairs.co.uk/plumber-manchester/services/drain-services/toilet-unblocking",
  },
};
    ...
    <ServicePage
      breadcrumbItems={[
        ...
        { name: "Drain Services", href: "/plumber-manchester/services/drain-services" },
        {
          ...
          href: "/plumber-manchester/services/drain-services/toilet-unblocking",
        },
      ]}
      h1="Toilet Unblocking in Manchester"
      heroIntro={
        <p>
          ...
          Manchester who carry out fast, hygienic toilet unblocking using
      ...
      whatWhyContent={
        <>
          ...
          <p>
            In older Manchester properties, narrow soil pipes and ageing clay
          ...
          <p>
            ...
            <a
              href="/plumber-manchester/services/drain-services/drain-unblocking"
              className="text-primary underline underline-offset-2 hover:text-primary/80"
            >
      ...
      relatedServices={[
        {
          name: "Toilet Repair",
          href: "/plumber-manchester/services/drain-services/toilet-repair",
        },
        {
          name: "Blocked Drains",
      ...
      serviceAreasHeading="Toilet Unblocking Across Manchester"
      serviceAreasContent={
        <p>
          Our plumbers attend toilet unblocking jobs across Manchester, Didsbury,
          Chorlton, Salford, Ashton-under-Lyne, Trafford, and all surrounding areas.
      ...
      ctaContent={
        <p>
          ...
          and we will connect you with a plumber in Manchester who can clear it
          quickly and discreetly &mdash; same-day where possible.
        </p>
      }
      serviceName="Toilet Unblocking"
      serviceSlug="toilet-unblocking"
      serviceDescription="Fast, hygienic toilet unblocking in Manchester. Professional clearance of blocked toilets by vetted local plumbers."
