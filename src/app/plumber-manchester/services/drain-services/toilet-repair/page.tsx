...
export const metadata: Metadata = {
  title: "Toilet Repair Manchester | OnCall Home Repairs",
  description:
    "Toilet repair in Manchester. Cisterns, flush mechanisms, seals, and installations by vetted plumbers. Call 0333 240 8428.",
  alternates: {
    canonical:
      "https://oncallhomerepairs.co.uk/plumber-manchester/services/drain-services/toilet-repair",
  },
};
...
export default function ToiletRepairPage() {
  return (
    <ServicePage
      ...
      h1="Toilet Repair in Manchester"
      heroIntro={
        <p>
          ...
          Manchester who repair and replace toilet components, cisterns, and
      ...
      whatWhyContent={
        <>
          ...
          <p>
            In properties across Manchester, hard water deposits also play a role.
      ...
      serviceAreasHeading="Toilet Repair Across Manchester"
      serviceAreasContent={
        <p>
          Our plumbers carry out toilet repairs across Manchester, Didsbury,
          Chorlton, Salford, Stretford, Stockport, and all
      ...
      ctaContent={
        <p>
          ...
          Manchester who can diagnose and fix the problem &mdash; usually in a
          single visit.
        </p>
      }
      serviceName="Toilet Repair"
      serviceSlug="toilet-repair"
      serviceDescription="Toilet repair in Manchester. Cistern mechanisms, fill valves, flush faults, and seal replacements by vetted local plumbers."
