...
export const metadata: Metadata = {
  title: "CCTV Drain Survey Manchester | OnCall Home Repairs",
  description:
    "CCTV drain survey in Manchester. Camera inspection to diagnose drainage problems accurately. Vetted engineers. Call 0333 240 8428.",
  alternates: {
    canonical:
      "https://oncallhomerepairs.co.uk/plumber-manchester/services/drain-services/cctv-drain-survey",
  },
};
...
export default function CCTVDrainSurveyPage() {
  return (
    <ServicePage
      ...
      h1="CCTV Drain Survey in Manchester"
      heroIntro={
        <p>
          ...
          engineers in Manchester who use professional camera equipment to inspect
      ...
      whatWhyContent={
        <>
          ...
          <p>
            Homebuyers in Manchester increasingly request drain surveys as part
      ...
      serviceAreasHeading="CCTV Drain Surveys Across Manchester"
      serviceAreasContent={
        <p>
          Our drain engineers carry out CCTV surveys across Manchester, Didsbury,
          Chorlton, Salford, Oldham, Bolton, Ashton-under-Lyne, and all
      ...
      faqs={[
        {
          question: "How much does a CCTV drain survey cost in Manchester?",
          answer:
      ...
      ctaContent={
        <p>
          ...
          we will connect you with a drain engineer in Manchester who can carry
      ...
      serviceDescription="CCTV drain survey in Manchester. Professional camera inspection to diagnose drainage problems, root intrusion, and pipe damage."
