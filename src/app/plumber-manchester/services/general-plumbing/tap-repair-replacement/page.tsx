...
export const metadata: Metadata = {
  title: "Tap Repair Manchester | OnCall Home Repairs",
  description:
    "Tap repair and replacement in Manchester. Fix dripping taps and install new ones. Vetted plumbers, transparent pricing. Call 0333 240 8428.",
  alternates: {
    canonical:
      "https://oncallhomerepairs.co.uk/plumber-manchester/services/general-plumbing/tap-repair-replacement",
  },
};
...
export default function TapRepairPage() {
  return (
    <ServicePage
      ...
      h1="Tap Repair and Replacement in Manchester"
      heroIntro={
        <p>
          ...
          Home Repairs connects you with plumbers in Manchester who can fix
      ...
      whatWhyContent={
        <>
          <p>
            ...
            Greater Manchester, the hard water supply accelerates wear on internal
      ...
      serviceAreasHeading="Tap Repair Across Manchester"
      serviceAreasContent={
        <p>
          Our plumbers repair and replace taps across Manchester, Didsbury, Chorlton,
          Salford, Bury, Bolton, and the surrounding area. Tap
      ...
      ctaContent={
        <p>
          ...
          will connect you with a plumber in Manchester who can repair or
      ...
      serviceDescription="Tap repair and replacement in Manchester. Fix dripping taps, replace worn components, and install new taps with vetted local plumbers."
