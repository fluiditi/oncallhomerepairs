...
export const metadata: Metadata = {
  title: "Shower Installation Manchester | OnCall Home Repairs",
  description:
    "Shower installation and repair in Manchester. Electric, mixer, and thermostatic showers. Vetted plumbers. Call 0333 240 8428.",
  alternates: {
    canonical:
      "https://oncallhomerepairs.co.uk/plumber-manchester/services/general-plumbing/shower-installation-repair",
  },
};
...
export default function ShowerInstallationPage() {
  return (
    <ServicePage
      ...
      h1="Shower Installation and Repair in Manchester"
      heroIntro={
        <p>
          ...
          in Manchester who handle all types of shower work. From quick repairs
      ...
      whatWhyContent={
        <>
          ...
          <p>
            In Manchester homes with hard water, limescale build-up inside
      ...
      serviceAreasHeading="Shower Installation Across Manchester"
      serviceAreasContent={
        <p>
          Our plumbers install and repair showers across Manchester, Didsbury,
          Chorlton, Salford, Stretford, Altrincham, and surrounding
      ...
      ctaContent={
        <p>
          ...
          Repairs will match you with a qualified plumber in Manchester. Call now
          for an upfront quote.
        </p>
      }
      serviceName="Shower Installation and Repair"
      serviceSlug="shower-installation-repair"
      serviceDescription="Shower installation and repair in Manchester. Electric, mixer, and thermostatic showers fitted and repaired by vetted local plumbers."
