...
export const metadata: Metadata = {
  title: "Kitchen Plumber Manchester | OnCall Home Repairs",
  description:
    "Kitchen plumbing in Manchester. Sink installations, dishwasher connections, waste disposal, and repairs. Call 0333 240 8428.",
  alternates: {
    canonical:
      "https://oncallhomerepairs.co.uk/plumber-manchester/services/general-plumbing/kitchen-plumbing",
  },
};
...
export default function KitchenPlumbingPage() {
  return (
    <ServicePage
      ...
      h1="Kitchen Plumbing in Manchester"
      heroIntro={
        <p>
          ...
          Manchester who install, repair, and maintain kitchen plumbing &mdash;
      ...
      whatWhyContent={
        <>
          ...
          <p>
            Blocked kitchen sinks are a regular call-out in Manchester. Grease,
      ...
      serviceAreasHeading="Kitchen Plumbing Across Manchester"
      serviceAreasContent={
        <p>
          Our plumbers carry out kitchen plumbing work across Manchester,
          Didsbury, Chorlton, Salford, Sale, Rochdale, Market
      ...
      ctaContent={
        <p>
          ...
          Repairs will match you with a qualified plumber in Manchester. Call
          for a clear, upfront quote.
        </p>
      }
      serviceName="Kitchen Plumbing"
      serviceSlug="kitchen-plumbing"
      serviceDescription="Kitchen plumbing in Manchester. Sink installations, appliance connections, waste pipe repairs, and full kitchen plumbing by vetted local plumbers."
