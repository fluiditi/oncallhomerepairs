...
export const metadata: Metadata = {
  title: "General Plumbing Manchester | OnCall Home Repairs",
  description:
    "Bathroom and kitchen plumbing, tap repairs, and shower installation in Manchester. Vetted local plumbers. Call 0333 240 8428.",
  alternates: {
    canonical: "https://oncallhomerepairs.co.uk/plumber-manchester/services/general-plumbing",
  },
};
...
export default function GeneralPlumbingPage() {
  return (
    <CategoryPage
      ...
      h1="General Plumbing Services in Manchester"
      heroIntro={
        <>
          <p>
            ...
            plumbers in Manchester for all your household plumbing needs. Whether
            you are planning a{" "}
            <a href="/plumber-manchester/services/general-plumbing/bathroom-plumbing" className="underline hover:text-white">
              bathroom installation
            </a>{" "}
            or just need a{" "}
            <a href="/plumber-manchester/services/general-plumbing/tap-repair-replacement" className="underline hover:text-white">
              tap replaced
            </a>
      ...
      overviewContent={
        <>
          ...
          <p>
            Our network of plumbers in Manchester handles everything from small
            repairs to larger projects like{" "}
            <a href="/plumber-manchester/services/general-plumbing/bathroom-plumbing" className="text-primary underline hover:text-primary/80">
              bathroom fit-outs
            </a>{" "}
            and{" "}
            <a href="/plumber-manchester/services/general-plumbing/kitchen-plumbing" className="text-primary underline hover:text-primary/80">
              kitchen plumbing
            </a>
            . Every plumber is qualified, insured, and experienced in working
            with modern and older Greater Manchester properties alike. You get a
          ...
          <p>
            ...
            pipework that needs{" "}
            <a href="/plumber-manchester/services/general-plumbing/pipe-replacement" className="text-primary underline hover:text-primary/80">
              replacing
            </a>
            , or a problem that needs{" "}
            <a href="/plumber-manchester/services/drain-services" className="text-primary underline hover:text-primary/80">
              drainage investigation
            </a>{" "}
            — we can coordinate the right specialist. And if your{" "}
            <a href="/plumber-manchester/services/boiler-heating" className="text-primary underline hover:text-primary/80">
              boiler or heating
            </a>{" "}
      ...
      services={[
        ...
        },
        {
          ...
          description:
            "Copper, plastic, and lead pipe replacement for ageing Manchester properties. Upgrade old pipework to meet current standards and improve water pressure and quality.",
          isCoreService: false,
        },
      ]}
      ...
      crossLinks={[
        ...
        },
        {
          ...
          description:
            "Blocked drains, CCTV surveys, and toilet unblocking — professional drainage specialists across Manchester.",
        },
      ]}
      serviceAreasHeading="General Plumbing Across Manchester and Beyond"
      serviceAreasContent={
        <p>
          Our network of plumbers serves Manchester and the surrounding towns
          and villages across Greater Manchester. Whether your property
          is in Stretford, Bolton, Oldham, or Trafford, we
      ...
      faqs={[
        ...
        },
        {
          ...
          answer:
            "Discoloured water, frequent leaks at joints, low water pressure, and visible corrosion on exposed pipes are all signs your pipework may need attention. Properties in Manchester with original lead pipework should have it replaced for health and safety reasons. A plumber can inspect your system and advise on whether a partial or full re-pipe is needed.",
        },
      ]}
      ctaHeading="Need a Plumber in Manchester? We Will Find You One."
      ctaContent={
        <p>
          Call OnCall Home Repairs and tell us what you need. We will match you
          with a qualified, vetted plumber in Manchester who can handle the job —
          whether it is a quick repair or a bigger project.
        </p>
      }
      categoryName="General Plumbing"
      categoryDescription="Bathroom and kitchen plumbing, tap repairs, shower installations, and pipe replacements in Manchester by vetted, qualified plumbers."
