...
export const metadata: Metadata = {
  title: "Bathroom Plumber Manchester | OnCall Home Repairs",
  description:
    "Bathroom plumbing in Manchester. Installations, repairs, full refits. Vetted plumbers, upfront quotes. Call 0333 240 8428.",
  alternates: {
    canonical:
      "https://oncallhomerepairs.co.uk/plumber-manchester/services/general-plumbing/bathroom-plumbing",
  },
};
...
export default function BathroomPlumbingPage() {
  return (
    <ServicePage
      ...
      h1="Bathroom Plumbing in Manchester"
      heroIntro={
        <p>
          ...
          vetted, experienced plumbers in Manchester who handle all aspects of
      ...
      whatWhyContent={
        <>
          ...
          <p>
            ...
            will support the{" "}
            <Link
              href="/plumber-manchester/services/general-plumbing/shower-installation-repair"
              className="text-primary underline underline-offset-2 hover:text-primary/80"
            >
              shower
            </Link>{" "}
        ...
        },
        {
          ...
          description: (
            <p>
              ...
              in Manchester properties — from Victorian terraces with old lead
      ...
      relatedServices={[
        ...
        },
        {
          ...
          href: "/plumber-manchester/services/general-plumbing/kitchen-plumbing",
        },
      ]}
      serviceAreasHeading="Bathroom Plumbing Across Manchester"
      serviceAreasContent={
        <p>
          Our bathroom plumbers serve Manchester and all surrounding areas. From
          period properties in the town centre that need careful pipework
          modifications to new-build homes in Altrincham, Bolton, and Ashton-under-Lyne
          that need a shower upgrade or suite replacement, our plumbers have
          the experience to handle it. We cover Didsbury, Chorlton, Salford,
          Trafford, and all villages in between.
        </p>
      }
      faqs={[
        {
      ...
      ctaHeading="Need a Bathroom Plumber in Manchester?"
      ctaContent={
        <p>
      ...
      serviceDescription="Bathroom plumbing in Manchester. Installations, repairs, and full bathroom fit-outs."
