...
export const metadata: Metadata = {
  title: "Boiler Installation Manchester | OnCall Home Repairs",
  description:
    "New boiler installation in Manchester. Gas Safe engineers, competitive quotes, workmanship guarantee. Call 0333 240 8428.",
  alternates: {
    canonical:
      "https://oncallhomerepairs.co.uk/plumber-manchester/services/boiler-heating/boiler-installation",
  },
};
...
export default function BoilerInstallationPage() {
  return (
    <ServicePage
      ...
      h1="Boiler Installation in Manchester"
      heroIntro={
        <p>
          ...
          you with Gas Safe registered heating engineers in Manchester who carry
      ...
      serviceAreasHeading="Boiler Installation Across Manchester"
      serviceAreasContent={
        <p>
          We connect homeowners across Manchester and Greater Manchester
          with qualified boiler installers. Whether you are in the centre of
          Manchester, in Didsbury, Chorlton, or one of the surrounding
          ...
          of Greater Manchester and can advise on the best boiler setup for your
          home.
        </p>
      }
      faqs={[
        {
          question: "How much does a new boiler installation cost in Manchester?",
          answer:
      ...
      ctaHeading="Ready for a New Boiler in Manchester?"
      ctaContent={
        <p>
      ...
      serviceDescription="New boiler installation in Manchester. Gas Safe registered, competitive pricing."
