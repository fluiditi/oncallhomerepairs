...
export const metadata: Metadata = {
  title: "Power Flushing Manchester | OnCall Home Repairs",
  description:
    "Power flushing in Manchester. Remove sludge and restore heating efficiency. Gas Safe engineers, transparent pricing. Call 0333 240 8428.",
  alternates: {
    canonical:
      "https://oncallhomerepairs.co.uk/plumber-manchester/services/boiler-heating/power-flushing",
  },
};
...
export default function PowerFlushingPage() {
  return (
    <ServicePage
      ...
      h1="Power Flushing in Manchester"
      heroIntro={
        <p>
          ...
          connects you with qualified engineers in Manchester who carry out
      ...
      whatWhyContent={
        <>
          ...
          <p>
            ...
            sludge. Greater Manchester&rsquo;s hard water makes this worse by adding
      ...
      serviceAreasHeading="Power Flushing Across Manchester"
      serviceAreasContent={
        <p>
          Our engineers carry out power flushing across Manchester, Didsbury, Chorlton,
          Salford, Sale, Oldham, and surrounding
      ...
      ctaContent={
        <p>
          ...
          Repairs and we will connect you with a qualified engineer in Manchester
          who can carry out a professional power flush on your system.
        </p>
      }
      serviceName="Power Flushing"
      serviceSlug="power-flushing"
      serviceDescription="Power flushing in Manchester. Remove sludge and limescale from your central heating system to restore efficiency and prevent boiler breakdowns."
