...
export const metadata: Metadata = {
  title: "Radiator Repair Manchester | OnCall Home Repairs",
  description:
    "Radiator repair and installation in Manchester. Fix cold spots, leaks, and add new radiators. Gas Safe engineers. Call 0333 240 8428.",
  alternates: {
    canonical:
      "https://oncallhomerepairs.co.uk/plumber-manchester/services/boiler-heating/radiator-repair-installation",
  },
};
...
export default function RadiatorRepairPage() {
  return (
    <ServicePage
      ...
      h1="Radiator Repair and Installation in Manchester"
      heroIntro={
        <p>
          ...
          Manchester who can diagnose radiator faults, carry out repairs, and
      ...
      whatWhyHeading="Common Radiator Problems in Manchester Homes"
      whatWhyContent={
        <>
          <p>
          ...
          <p>
            Greater Manchester&rsquo;s hard water accelerates the build-up of
            limescale and sludge in central heating systems. Many homes in
            Manchester, Didsbury, and the surrounding area have heating systems
      ...
      serviceAreasHeading="Radiator Repair Across Manchester"
      serviceAreasContent={
        <p>
          Our heating engineers carry out radiator repairs and installations
          across Manchester, Didsbury, Chorlton, Salford, Bury, Bolton,
          and the wider Greater Manchester area. Whether you need a
      ...
      ctaContent={
        <p>
          ...
          in Manchester who can get your radiators working as they should.
        </p>
      }
      serviceName="Radiator Repair and Installation"
      serviceSlug="radiator-repair-installation"
      serviceDescription="Radiator repair and installation in Manchester. Fix cold spots, leaking valves, and add new radiators with qualified heating engineers."
