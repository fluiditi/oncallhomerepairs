...
export const metadata: Metadata = {
  title: "Central Heating Repair Manchester | OnCall Home Repairs",
  description:
    "Central heating repair in Manchester. Radiators, pumps, valves, thermostats. Gas Safe engineers. Call 0333 240 8428.",
  alternates: {
    canonical:
      "https://oncallhomerepairs.co.uk/plumber-manchester/services/boiler-heating/central-heating-repair",
  },
};
...
export default function CentralHeatingRepairPage() {
  return (
    <ServicePage
      ...
      h1="Central Heating Repair in Manchester"
      heroIntro={
        <p>
          When your central heating is not working properly, your home becomes
          uncomfortable fast — especially during a Greater Manchester winter. Cold
          ...
          engineers in Manchester who diagnose and repair central heating faults
      ...
      whatWhyContent={
        <>
          ...
          <p>
            ...
            <Link
              href="/plumber-manchester/services/boiler-heating/power-flushing"
              className="text-primary underline underline-offset-2 hover:text-primary/80"
            >
              power flush
            </Link>{" "}
      ...
      benefits={[
        {
          ...
          description: (
            <p>
              ...
              systems and understand the common faults found in Manchester
              properties.
            </p>
          ),
        },
      ...
      relatedServices={[
        ...
        },
        {
          ...
          href: "/plumber-manchester/services/boiler-heating/radiator-repair-installation",
        },
        {
          name: "Power Flushing",
          href: "/plumber-manchester/services/boiler-heating/power-flushing",
        },
        {
          ...
          href: "/plumber-manchester/services/boiler-heating/boiler-servicing",
        },
      ]}
      serviceAreasHeading="Central Heating Repair Across Manchester"
      serviceAreasContent={
        <p>
          Our heating engineers cover Manchester and the surrounding towns and
          villages throughout Greater Manchester. From older properties
          in Manchester town centre to newer-build estates in Salford, Stockport,
          and Stretford, our engineers are familiar with the heating
      ...
      ctaContent={
        <p>
          ...
          a qualified heating engineer in Manchester who can diagnose and fix the
      ...
      serviceDescription="Central heating repair in Manchester. Radiators, pumps, valves, and full system diagnostics."
