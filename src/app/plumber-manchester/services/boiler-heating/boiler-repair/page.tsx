...
export const metadata: Metadata = {
  title: "Boiler Repair Manchester | OnCall Home Repairs",
  description:
    "Boiler repair in Manchester by Gas Safe engineers. Same-day repairs, upfront quotes. Available 24/7. Call 0333 240 8428.",
  alternates: {
    canonical:
      "https://oncallhomerepairs.co.uk/plumber-manchester/services/boiler-heating/boiler-repair",
  },
};
...
export default function BoilerRepairPage() {
  return (
    <ServicePage
      ...
      h1="Boiler Repair in Manchester"
      heroIntro={
        <p>
          ...
          with Gas Safe registered heating engineers in Manchester who diagnose
        ...
        },
        {
          ...
          description: (
            <p>
              ...
              Manchester. For emergency breakdowns, engineers are available 24/7.
      ...
      serviceAreasHeading="Boiler Repair Across Manchester"
      serviceAreasContent={
        <p>
          Our network of Gas Safe heating engineers covers Manchester and the
          surrounding area. Whether you live in Didsbury, Chorlton, Salford,
          or one of the smaller villages like Sale or Rochdale, we
      ...
      ctaContent={
        <p>
          ...
          a Gas Safe registered engineer in Manchester. Upfront pricing,
      ...
      serviceDescription="Expert boiler repair in Manchester. Gas Safe registered engineers available 24/7."
