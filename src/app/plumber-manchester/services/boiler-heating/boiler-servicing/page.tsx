...
export const metadata: Metadata = {
  title: "Boiler Servicing Manchester | OnCall Home Repairs",
  description:
    "Annual boiler servicing in Manchester. Keep your warranty valid and your boiler running efficiently. Gas Safe engineers. Call 0333 240 8428.",
  alternates: {
    canonical:
      "https://oncallhomerepairs.co.uk/plumber-manchester/services/boiler-heating/boiler-servicing",
  },
};
...
export default function BoilerServicingPage() {
  return (
    <ServicePage
      ...
      h1="Boiler Servicing in Manchester"
      heroIntro={
        <p>
          ...
          connects you with Gas Safe registered engineers in Manchester who carry
      ...
      serviceAreasHeading="Boiler Servicing Across Manchester"
      serviceAreasContent={
        <p>
          Our Gas Safe registered engineers service boilers across Manchester,
          Didsbury, Chorlton, Salford, Stockport, Stretford, and
      ...
      ctaContent={
        <p>
          ...
          Gas Safe registered engineer in Manchester.
        </p>
      }
      serviceName="Boiler Servicing"
      serviceSlug="boiler-servicing"
      serviceDescription="Annual boiler servicing in Manchester by Gas Safe registered engineers. Manufacturer warranty protection, safety checks, and efficiency testing."
