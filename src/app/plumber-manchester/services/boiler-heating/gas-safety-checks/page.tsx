...
export const metadata: Metadata = {
  title: "Gas Safety Check Manchester | OnCall Home Repairs",
  description:
    "Gas safety checks and CP12 certificates in Manchester. For landlords and homeowners. Gas Safe registered engineers. Call 0333 240 8428.",
  alternates: {
    canonical:
      "https://oncallhomerepairs.co.uk/plumber-manchester/services/boiler-heating/gas-safety-checks",
  },
};
...
export default function GasSafetyChecksPage() {
  return (
    <ServicePage
      ...
      h1="Gas Safety Checks in Manchester"
      heroIntro={
        <p>
          ...
          Manchester who carry out thorough inspections of your boiler, gas
      ...
      serviceAreasHeading="Gas Safety Checks Across Manchester"
      serviceAreasContent={
        <p>
          Our Gas Safe registered engineers carry out gas safety checks across
          Manchester, Didsbury, Chorlton, Salford, Stretford, Bury,
          Ashton-under-Lyne, Trafford, and all surrounding areas. Landlords with multiple
      ...
      faqs={[
        {
          question: "How much does a gas safety check cost in Manchester?",
          answer:
      ...
      ctaContent={
        <p>
          ...
          engineer in Manchester for your annual gas safety check.
        </p>
      }
      serviceName="Gas Safety Checks"
      serviceSlug="gas-safety-checks"
      serviceDescription="Gas safety checks and CP12 certificates in Manchester. Annual inspections for landlords and homeowners by Gas Safe registered engineers."
