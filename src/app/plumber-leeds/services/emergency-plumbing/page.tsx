...
export const metadata: Metadata = {
  title: "Emergency Plumbing Leeds | OnCall Home Repairs",
  description:
    "24/7 emergency plumbing in Leeds. Burst pipes, leaks, flooding. Vetted, Gas Safe plumbers. Call 0333 240 8428.",
  alternates: {
    canonical: "https://oncallhomerepairs.co.uk/plumber-leeds/services/emergency-plumbing",
  },
};
  ...
  return (
    <CategoryPage
      breadcrumbItems={[
        ...
        { name: "Emergency Plumbing", href: "/plumber-leeds/services/emergency-plumbing" },
      ]}
      h1="Emergency Plumbing Services in Leeds"
      heroIntro={
        <>
          <p>
            ...
            registered emergency plumbers across Leeds and the surrounding
            villages, available 24 hours a day, 7 days a week. Whether it is a{" "}
            <a href="/plumber-leeds/services/emergency-plumbing/burst-pipe-repair" className="underline hover:text-white">
              burst pipe
            </a>
      ...
      overviewContent={
        <>
          <p>
            ...
            locally based plumbers who can reach properties in Leeds,
            Headingley, Chapel Allerton, and beyond — often within the hour.
          </p>
          <p>
          ...
          <p>
            From{" "}
            <a href="/plumber-leeds/services/emergency-plumbing/leak-detection-repair" className="text-primary underline hover:text-primary/80">
              leak detection and repair
            </a>{" "}
            to{" "}
            <a href="/plumber-leeds/services/emergency-plumbing/flood-response" className="text-primary underline hover:text-primary/80">
              flood response
            </a>
      ...
      services={[
        {
          ...
          description:
            "Round-the-clock emergency plumber call-out in Leeds. Fast attendance for urgent leaks, burst pipes, boiler failures, and any plumbing crisis that cannot wait until morning.",
          isCoreService: true,
        },
        {
        ...
        },
        {
          ...
          description:
            "Safe thawing and repair of frozen pipes during cold West Yorkshire winters. Prevents cracks and burst pipes before they cause costly water damage to your property.",
          isCoreService: false,
        },
        {
          name: "Flood Response",
      ...
      differentiators={[
        ...
        },
        {
          ...
          description: (
            <p>
              Our plumbers are based across Leeds and the surrounding
      ...
      serviceAreasHeading="Emergency Plumbing Across Leeds and Beyond"
      serviceAreasContent={
        <p>
          Our network of emergency plumbers covers Leeds town centre and the
          surrounding villages throughout West Yorkshire. Whether you
          are in Headingley, Chapel Allerton, Roundhay, or as far as Guiseley
          and Beeston, we can connect you with a qualified plumber who knows
      ...
      faqs={[
        {
          question:
            "How quickly can an emergency plumber reach my property in Leeds?",
          answer:
      ...
      ctaContent={
        <p>
          ...
          we will connect you with a vetted emergency plumber in Leeds —
          available 24 hours a day, every day of the year.
        </p>
      }
      categoryName="Emergency Plumbing"
      categoryDescription="24/7 emergency plumbing services in Leeds — burst pipes, leaks, floods, and urgent repairs by vetted, Gas Safe registered plumbers."
