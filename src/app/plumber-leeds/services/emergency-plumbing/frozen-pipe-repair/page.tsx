...
export const metadata: Metadata = {
  title: "Frozen Pipe Repair Leeds | OnCall Home Repairs",
  description:
    "Frozen pipe repair in Leeds. Prevent burst pipes this winter. Vetted plumbers, 24/7. Call 0333 240 8428.",
  alternates: {
    canonical:
      "https://oncallhomerepairs.co.uk/plumber-leeds/services/emergency-plumbing/frozen-pipe-repair",
  },
};
    ...
    <ServicePage
      breadcrumbItems={[
        ...
        { name: "Emergency Plumbing", href: "/plumber-leeds/services/emergency-plumbing" },
        {
          ...
          href: "/plumber-leeds/services/emergency-plumbing/frozen-pipe-repair",
        },
      ]}
      h1="Frozen Pipe Repair in Leeds"
      heroIntro={
        <p>
          When temperatures across West Yorkshire drop below freezing, pipes in
      ...
      whatWhyHeading="Why Frozen Pipes Are a Serious Risk in Leeds"
      whatWhyContent={
        <>
          <p>
            Leeds sits in the East Midlands where winter temperatures
          ...
          <p>
            ...
            understands the specific risks West Yorkshire winters pose to local
      ...
      serviceAreasHeading="Frozen Pipe Repair Across Leeds"
      serviceAreasContent={
        <p>
          Our plumbers attend frozen pipe emergencies across Leeds, Headingley,
          Chapel Allerton, Roundhay, and the surrounding villages. Properties in
          ...
          West Yorkshire, we can connect you with a plumber who
      ...
      faqs={[
        ...
        {
          question:
            "How much does frozen pipe repair cost in Leeds?",
          answer:
      ...
      ctaContent={
        <p>
          ...
          Home Repairs and we will connect you with a vetted plumber in Leeds
      ...
      serviceDescription="Frozen pipe thawing and repair in Leeds. Prevent burst pipes this winter with safe, professional pipe repair from vetted local plumbers."
