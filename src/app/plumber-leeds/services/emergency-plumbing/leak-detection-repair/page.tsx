...
export const metadata: Metadata = {
  title: "Leak Detection Leeds | OnCall Home Repairs",
  description:
    "Professional leak detection and repair in Leeds. Find and fix hidden leaks fast. Transparent pricing. Call 0333 240 8428.",
  alternates: {
    canonical:
      "https://oncallhomerepairs.co.uk/plumber-leeds/services/emergency-plumbing/leak-detection-repair",
  },
};
...
export default function LeakDetectionRepairPage() {
  return (
    <ServicePage
      ...
      h1="Leak Detection and Repair in Leeds"
      heroIntro={
        <p>
          ...
          connects you with skilled plumbers in Leeds who specialise in
      ...
      whatWhyContent={
        <>
          ...
          <p>
            In Leeds, many homes are built with traditional construction
          ...
          <p>
            ...
            <Link
              href="/plumber-leeds/services/emergency-plumbing/overflow-repair"
              className="text-primary underline underline-offset-2 hover:text-primary/80"
            >
              overflowing cistern
            </Link>{" "}
      ...
      benefits={[
        ...
        },
        {
          ...
          description: (
            <p>
              Every plumber in our Leeds network is qualified, insured, and
      ...
      serviceAreasHeading="Leak Detection Across Leeds"
      serviceAreasContent={
        <p>
          Our leak detection service covers Leeds and all nearby towns and
          villages. From Victorian terraces in Leeds centre to modern estates
          in Headingley and Chapel Allerton, our plumbers are experienced with the
          property types and plumbing systems found across the area. Whether
          your leak is in a ground-floor flat in Roundhay or a detached house in
          Yeadon, we can match you with someone local who can investigate
          promptly.
        </p>
      }
      faqs={[
      ...
      ctaHeading="Suspect a Leak in Your Leeds Home?"
      ctaContent={
        <p>
      ...
      serviceDescription="Professional leak detection and repair in Leeds. Find and fix hidden leaks fast."
