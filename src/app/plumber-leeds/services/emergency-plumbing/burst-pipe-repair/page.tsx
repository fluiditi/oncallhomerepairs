...
export const metadata: Metadata = {
  title: "Burst Pipe Repair Leeds | OnCall Home Repairs",
  description:
    "Fast burst pipe repair in Leeds. 24/7 emergency response from vetted plumbers. Transparent pricing. Call 0333 240 8428.",
  alternates: {
    canonical:
      "https://oncallhomerepairs.co.uk/plumber-leeds/services/emergency-plumbing/burst-pipe-repair",
  },
};
    ...
    <ServicePage
      ...
      heroIntro={
        <p>
          ...
          you with vetted, experienced plumbers in the Leeds area who
      ...
      whatWhyContent={
        <>
          ...
          <p>
            Our network of plumbers in Leeds arrives equipped with the
      ...
      serviceAreasHeading="Burst Pipe Repair Across Leeds"
      serviceAreasContent={
        <p>
          We connect homeowners with burst pipe repair plumbers across Leeds
          and the surrounding villages. Whether you are in Headingley, Chapel Allerton,
          Roundhay, or further afield in Otley or Guiseley, our
      ...
      ctaHeading="Burst Pipe in Leeds? Act Now"
      ctaContent={
        <p>
      ...
      serviceDescription="Fast burst pipe repair in Leeds. Emergency call-out available 24/7."
