...
export const metadata: Metadata = {
  title: "Flood Response Plumber Leeds | OnCall Home Repairs",
  description:
    "Emergency flood response in Leeds. Rapid water damage control by vetted plumbers, available 24/7. Call 0333 240 8428.",
  alternates: {
    canonical:
      "https://oncallhomerepairs.co.uk/plumber-leeds/services/emergency-plumbing/flood-response",
  },
};
...
export default function FloodResponsePage() {
  return (
    <ServicePage
      ...
      h1="Flood Response Plumber in Leeds"
      heroIntro={
        <p>
          ...
          experienced flood response plumbers in Leeds who can reach your
      ...
      whatWhyContent={
        <>
          ...
          <p>
            Properties across Leeds, Headingley, and the surrounding villages
      ...
      relatedServices={[
        ...
        },
        {
          ...
          href: "/plumber-leeds/services/emergency-plumbing/stopcock-repair",
        },
        {
      ...
      serviceAreasHeading="Flood Response Across Leeds and West Yorkshire"
      serviceAreasContent={
        <p>
          Our flood response plumbers cover Leeds town centre, Headingley,
          Chapel Allerton, Roundhay, Horsforth, and surrounding villages.
          Response times are fastest within the Leeds and Headingley area,
          with the wider West Yorkshire area typically reached
      ...
      ctaContent={
        <p>
          ...
          will have a vetted flood response plumber heading to your Leeds
          property as quickly as possible.
        </p>
      }
      serviceName="Flood Response"
      serviceSlug="flood-response"
      serviceDescription="Emergency flood response plumber in Leeds. Rapid water damage control, source isolation, and immediate repair by vetted local plumbers."
