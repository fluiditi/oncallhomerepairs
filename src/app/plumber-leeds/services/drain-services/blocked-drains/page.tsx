...
export const metadata: Metadata = {
  title: "Blocked Drains Leeds | OnCall Home Repairs",
  description:
    "Blocked drain clearing in Leeds. Fast, effective unblocking for homes and businesses. Call 0333 240 8428.",
  alternates: {
    canonical:
      "https://oncallhomerepairs.co.uk/plumber-leeds/services/drain-services/blocked-drains",
  },
};
    ...
    <ServicePage
      ...
      heroIntro={
        <p>
          ...
          drainage plumbers in Leeds who can clear blockages quickly and
      ...
      serviceAreasHeading="Blocked Drain Clearing Across Leeds"
      serviceAreasContent={
        <p>
          Our drainage plumbers cover Leeds and every surrounding town and
          village. From terraced properties in Leeds centre with shared
          drainage runs to detached homes in Headingley, Chapel Allerton, and Market
      ...
      ctaHeading="Blocked Drain in Leeds?"
      ctaContent={
        <p>
      ...
      serviceDescription="Blocked drain clearing in Leeds. Fast, effective unblocking for homes and businesses."
