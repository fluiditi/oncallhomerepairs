...
export const metadata: Metadata = {
  title: "Toilet Unblocking Leeds | OnCall Home Repairs",
  description:
    "Toilet unblocking in Leeds. Fast, hygienic clearance of blocked toilets by vetted plumbers. Call 0333 240 8428.",
  alternates: {
    canonical:
      "https://oncallhomerepairs.co.uk/plumber-leeds/services/drain-services/toilet-unblocking",
  },
};
    ...
    <ServicePage
      ...
      heroIntro={
        <p>
          ...
          Leeds who carry out fast, hygienic toilet unblocking using
      ...
      whatWhyContent={
        <>
          ...
          <p>
            In older Leeds properties, narrow soil pipes and ageing clay
      ...
      serviceAreasHeading="Toilet Unblocking Across Leeds"
      serviceAreasContent={
        <p>
          Our plumbers attend toilet unblocking jobs across Leeds, Headingley,
          Chapel Allerton, Roundhay, Rothwell, Beeston, and all surrounding areas.
      ...
      ctaContent={
        <p>
          ...
          and we will connect you with a plumber in Leeds who can clear it
          quickly and discreetly &mdash; same-day where possible.
        </p>
      }
      serviceName="Toilet Unblocking"
      serviceSlug="toilet-unblocking"
      serviceDescription="Fast, hygienic toilet unblocking in Leeds. Professional clearance of blocked toilets by vetted local plumbers."
