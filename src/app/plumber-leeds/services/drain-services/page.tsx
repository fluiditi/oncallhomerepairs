...
export const metadata: Metadata = {
  title: "Drain Services Leeds | OnCall Home Repairs",
  description:
    "Blocked drains, CCTV surveys, and drain unblocking in Leeds. Fast response, fair pricing. Call 0333 240 8428.",
  alternates: {
    canonical: "https://oncallhomerepairs.co.uk/plumber-leeds/services/drain-services",
  },
};
...
export default function DrainServicesPage() {
  return (
    <CategoryPage
      ...
      heroIntro={
        <>
          <p>
            ...
            drainage specialists in Leeds who can clear blockages, carry out{" "}
            <a href="/plumber-leeds/services/drain-services/cctv-drain-survey" className="underline hover:text-white">
              CCTV drain surveys
            </a>
      ...
      overviewHeading="Professional Drain Care for Leeds Properties"
      overviewContent={
        <>
          <p>
          ...
          <p>
            ...
            <a href="/plumber-leeds/services/drain-services/blocked-drains" className="text-primary underline hover:text-primary/80">
              blocked drain
            </a>{" "}
            that needs clearing or a more involved investigation using a{" "}
            <a href="/plumber-leeds/services/drain-services/cctv-drain-survey" className="text-primary underline hover:text-primary/80">
              CCTV drain survey
            </a>
          ...
          <p>
            ...
            <a href="/plumber-leeds/services/general-plumbing" className="text-primary underline hover:text-primary/80">
              kitchen or bathroom plumbing
            </a>
            , or if a severe blockage creates an{" "}
            <a href="/plumber-leeds/services/emergency-plumbing" className="text-primary underline hover:text-primary/80">
        ...
        },
        {
          ...
          description: (
            <p>
              ...
              emergency and scheduled drain work across Leeds.
            </p>
          ),
        },
        {
      ...
      serviceAreasHeading="Drain Services Across Leeds and Surrounding Areas"
      serviceAreasContent={
        <p>
          Our network of drain specialists covers Leeds and the nearby
          villages of West Yorkshire. From Headingley and Roundhay to
          Morley, Pudsey, and Wetherby, we connect you with a drainage
      ...
      faqs={[
        ...
        },
        {
          ...
          answer:
            "Yes. Our network includes plumbers available for evening and weekend drain emergencies across Leeds and the surrounding areas. If sewage is backing up or a blockage is causing flooding, call us and we will connect you with the nearest available drainage specialist as quickly as possible.",
        },
      ]}
      ...
      ctaContent={
        <p>
          ...
          specialist in Leeds. From blocked sinks to full CCTV surveys, our
          network of vetted plumbers is ready to help — today.
        </p>
      }
      categoryName="Drain Services"
      categoryDescription="Blocked drain clearing, CCTV drain surveys, drain unblocking, and toilet repairs in Leeds by vetted, insured plumbers."
