...
export const metadata: Metadata = {
  title: "Drain Unblocking Leeds | OnCall Home Repairs",
  description:
    "Professional drain unblocking in Leeds. High-pressure jetting and manual rodding. Vetted plumbers. Call 0333 240 8428.",
  alternates: {
    canonical:
      "https://oncallhomerepairs.co.uk/plumber-leeds/services/drain-services/drain-unblocking",
  },
};
    ...
    <ServicePage
      ...
      heroIntro={
        <p>
          ...
          experienced drain engineers in Leeds who use professional-grade
      ...
      whatWhyContent={
        <>
          <p>
            Most drain blockages in Leeds homes are caused by a gradual
      ...
      serviceAreasHeading="Drain Unblocking Across Leeds"
      serviceAreasContent={
        <p>
          Our drain engineers cover Leeds, Headingley, Chapel Allerton, Roundhay,
          Wetherby, Otley, and the surrounding area. External drain
      ...
      ctaContent={
        <p>
          ...
          Leeds who can clear the blockage and restore full flow.
        </p>
      }
      serviceName="Drain Unblocking"
      serviceSlug="drain-unblocking"
      serviceDescription="Professional drain unblocking in Leeds using high-pressure jetting and manual rodding. Fast, effective clearance for homes and businesses."
