...
export const metadata: Metadata = {
  title: "Toilet Repair Leeds | OnCall Home Repairs",
  description:
    "Toilet repair in Leeds. Cisterns, flush mechanisms, seals, and installations by vetted plumbers. Call 0333 240 8428.",
  alternates: {
    canonical:
      "https://oncallhomerepairs.co.uk/plumber-leeds/services/drain-services/toilet-repair",
  },
};
    ...
    <ServicePage
      ...
      heroIntro={
        <p>
          ...
          Leeds who repair and replace toilet components, cisterns, and
      ...
      whatWhyContent={
        <>
          ...
          <p>
            In properties across Leeds, hard water deposits also play a role.
          ...
          <p>
            ...
            <a
              href="/plumber-leeds/services/drain-services/toilet-unblocking"
              className="text-primary underline underline-offset-2 hover:text-primary/80"
            >
              toilet unblocking
            </a>{" "}
      ...
      serviceAreasHeading="Toilet Repair Across Leeds"
      serviceAreasContent={
        <p>
          Our plumbers carry out toilet repairs across Leeds, Headingley,
          Chapel Allerton, Roundhay, Horsforth, Morley, and all
      ...
      ctaContent={
        <p>
          ...
          Leeds who can diagnose and fix the problem &mdash; usually in a
          single visit.
        </p>
      }
      serviceName="Toilet Repair"
      serviceSlug="toilet-repair"
      serviceDescription="Toilet repair in Leeds. Cistern mechanisms, fill valves, flush faults, and seal replacements by vetted local plumbers."
