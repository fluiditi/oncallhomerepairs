...
export const metadata: Metadata = {
  title: "Kitchen Plumber Leeds | OnCall Home Repairs",
  description:
    "Kitchen plumbing in Leeds. Sink installations, dishwasher connections, waste disposal, and repairs. Call 0333 240 8428.",
  alternates: {
    canonical:
      "https://oncallhomerepairs.co.uk/plumber-leeds/services/general-plumbing/kitchen-plumbing",
  },
};
    ...
    <ServicePage
      ...
      heroIntro={
        <p>
          ...
          Leeds who install, repair, and maintain kitchen plumbing &mdash;
      ...
      whatWhyContent={
        <>
          ...
          <p>
            Blocked kitchen sinks are a regular call-out in Leeds. Grease,
      ...
      serviceAreasHeading="Kitchen Plumbing Across Leeds"
      serviceAreasContent={
        <p>
          Our plumbers carry out kitchen plumbing work across Leeds,
          Headingley, Chapel Allerton, Roundhay, Otley, Wetherby, Market
      ...
      ctaContent={
        <p>
          ...
          Repairs will match you with a qualified plumber in Leeds. Call
          for a clear, upfront quote.
        </p>
      }
      serviceName="Kitchen Plumbing"
      serviceSlug="kitchen-plumbing"
      serviceDescription="Kitchen plumbing in Leeds. Sink installations, appliance connections, waste pipe repairs, and full kitchen plumbing by vetted local plumbers."
