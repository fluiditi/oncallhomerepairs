...
export const metadata: Metadata = {
  title: "Bathroom Plumber Leeds | OnCall Home Repairs",
  description:
    "Bathroom plumbing in Leeds. Installations, repairs, full refits. Vetted plumbers, upfront quotes. Call 0333 240 8428.",
  alternates: {
    canonical:
      "https://oncallhomerepairs.co.uk/plumber-leeds/services/general-plumbing/bathroom-plumbing",
  },
};
    ...
    <ServicePage
      ...
      heroIntro={
        <p>
          ...
          vetted, experienced plumbers in Leeds who handle all aspects of
      ...
      whatWhyContent={
        <>
          ...
          <p>
            ...
            will support the{" "}
            <Link
              href="/plumber-leeds/services/general-plumbing/shower-installation-repair"
              className="text-primary underline underline-offset-2 hover:text-primary/80"
            >
              shower
            </Link>{" "}
        ...
        },
        {
          ...
          description: (
            <p>
              ...
              in Leeds properties — from Victorian terraces with old lead
      ...
      relatedServices={[
        ...
        {
          name: "Toilet Repair",
          href: "/plumber-leeds/services/drain-services/toilet-repair",
        },
        {
          name: "Kitchen Plumbing",
          href: "/plumber-leeds/services/general-plumbing/kitchen-plumbing",
        },
      ]}
      serviceAreasHeading="Bathroom Plumbing Across Leeds"
      serviceAreasContent={
        <p>
          Our bathroom plumbers serve Leeds and all surrounding areas. From
          period properties in the town centre that need careful pipework
          modifications to new-build homes in Pudsey, Garforth, and Rothwell
          that need a shower upgrade or suite replacement, our plumbers have
          the experience to handle it. We cover Headingley, Chapel Allerton, Roundhay,
          Beeston, and all villages in between.
        </p>
      }
      faqs={[
        {
      ...
      ctaHeading="Need a Bathroom Plumber in Leeds?"
      ctaContent={
        <p>
      ...
      serviceDescription="Bathroom plumbing in Leeds. Installations, repairs, and full bathroom fit-outs."
