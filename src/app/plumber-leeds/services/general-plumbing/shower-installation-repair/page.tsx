...
export const metadata: Metadata = {
  title: "Shower Installation Leeds | OnCall Home Repairs",
  description:
    "Shower installation and repair in Leeds. Electric, mixer, and thermostatic showers. Vetted plumbers. Call 0333 240 8428.",
  alternates: {
    canonical:
      "https://oncallhomerepairs.co.uk/plumber-leeds/services/general-plumbing/shower-installation-repair",
  },
};
...
export default function ShowerInstallationPage() {
  return (
    <ServicePage
      ...
      h1="Shower Installation and Repair in Leeds"
      heroIntro={
        <p>
          ...
          in Leeds who handle all types of shower work. From quick repairs
      ...
      whatWhyContent={
        <>
          ...
          <p>
            In Leeds homes with hard water, limescale build-up inside
      ...
      serviceAreasHeading="Shower Installation Across Leeds"
      serviceAreasContent={
        <p>
          Our plumbers install and repair showers across Leeds, Headingley,
          Chapel Allerton, Roundhay, Horsforth, Pudsey, and surrounding
      ...
      ctaContent={
        <p>
          ...
          Repairs will match you with a qualified plumber in Leeds. Call now
          for an upfront quote.
        </p>
      }
      serviceName="Shower Installation and Repair"
      serviceSlug="shower-installation-repair"
      serviceDescription="Shower installation and repair in Leeds. Electric, mixer, and thermostatic showers fitted and repaired by vetted local plumbers."
