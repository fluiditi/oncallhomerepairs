...
export const metadata: Metadata = {
  title: "Tap Repair Leeds | OnCall Home Repairs",
  description:
    "Tap repair and replacement in Leeds. Fix dripping taps and install new ones. Vetted plumbers, transparent pricing. Call 0333 240 8428.",
  alternates: {
    canonical:
      "https://oncallhomerepairs.co.uk/plumber-leeds/services/general-plumbing/tap-repair-replacement",
  },
};
...
export default function TapRepairPage() {
  return (
    <ServicePage
      ...
      h1="Tap Repair and Replacement in Leeds"
      heroIntro={
        <p>
          ...
          Home Repairs connects you with plumbers in Leeds who can fix
      ...
      whatWhyContent={
        <>
          <p>
            ...
            West Yorkshire, the hard water supply accelerates wear on internal
      ...
      serviceAreasHeading="Tap Repair Across Leeds"
      serviceAreasContent={
        <p>
          Our plumbers repair and replace taps across Leeds, Headingley, Chapel Allerton,
          Roundhay, Yeadon, Garforth, and the surrounding area. Tap
      ...
      ctaContent={
        <p>
          ...
          will connect you with a plumber in Leeds who can repair or
      ...
      serviceDescription="Tap repair and replacement in Leeds. Fix dripping taps, replace worn components, and install new taps with vetted local plumbers."
