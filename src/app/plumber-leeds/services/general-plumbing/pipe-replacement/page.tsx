...
export const metadata: Metadata = {
  title: "Pipe Replacement Leeds | OnCall Home Repairs",
  description:
    "Pipe replacement in Leeds. Copper, plastic, and lead pipe upgrades by vetted plumbers. Transparent pricing. Call 0333 240 8428.",
  alternates: {
    canonical:
      "https://oncallhomerepairs.co.uk/plumber-leeds/services/general-plumbing/pipe-replacement",
  },
};
    ...
    <ServicePage
      ...
      heroIntro={
        <p>
          ...
          connects you with qualified plumbers in Leeds who replace old
      ...
      whatWhyContent={
        <>
          <p>
            ...
            Leeds properties &mdash; pose a health risk and should be
      ...
      serviceAreasHeading="Pipe Replacement Across Leeds"
      serviceAreasContent={
        <p>
          Our plumbers replace pipework in properties across Leeds, Headingley,
          Chapel Allerton, Roundhay, Beeston, Rothwell, and all surrounding areas.
      ...
      ctaContent={
        <p>
          ...
          in Leeds who can assess your pipes and carry out replacements
          that last.
        </p>
      }
      serviceName="Pipe Replacement"
      serviceSlug="pipe-replacement"
      serviceDescription="Pipe replacement in Leeds. Copper, plastic, and lead pipe upgrades for homes and businesses by vetted local plumbers."
