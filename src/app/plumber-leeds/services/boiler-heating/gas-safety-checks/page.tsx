...
export const metadata: Metadata = {
  title: "Gas Safety Check Leeds | OnCall Home Repairs",
  description:
    "Gas safety checks and CP12 certificates in Leeds. For landlords and homeowners. Gas Safe registered engineers. Call 0333 240 8428.",
  alternates: {
    canonical:
      "https://oncallhomerepairs.co.uk/plumber-leeds/services/boiler-heating/gas-safety-checks",
  },
};
    ...
    <ServicePage
      ...
      heroIntro={
        <p>
          ...
          Leeds who carry out thorough inspections of your boiler, gas
      ...
      serviceAreasHeading="Gas Safety Checks Across Leeds"
      serviceAreasContent={
        <p>
          Our Gas Safe registered engineers carry out gas safety checks across
          Leeds, Headingley, Chapel Allerton, Roundhay, Horsforth, Yeadon,
          Rothwell, Beeston, and all surrounding areas. Landlords with multiple
      ...
      faqs={[
        {
          question: "How much does a gas safety check cost in Leeds?",
          answer:
      ...
      ctaContent={
        <p>
          ...
          engineer in Leeds for your annual gas safety check.
        </p>
      }
      serviceName="Gas Safety Checks"
      serviceSlug="gas-safety-checks"
      serviceDescription="Gas safety checks and CP12 certificates in Leeds. Annual inspections for landlords and homeowners by Gas Safe registered engineers."
