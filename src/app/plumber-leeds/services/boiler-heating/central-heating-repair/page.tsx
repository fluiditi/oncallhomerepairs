...
export const metadata: Metadata = {
  title: "Central Heating Repair Leeds | OnCall Home Repairs",
  description:
    "Central heating repair in Leeds. Radiators, pumps, valves, thermostats. Gas Safe engineers. Call 0333 240 8428.",
  alternates: {
    canonical:
      "https://oncallhomerepairs.co.uk/plumber-leeds/services/boiler-heating/central-heating-repair",
  },
};
...
export default function CentralHeatingRepairPage() {
  return (
    <ServicePage
      ...
      h1="Central Heating Repair in Leeds"
      heroIntro={
        <p>
          ...
          engineers in Leeds who diagnose and repair central heating faults
      ...
      benefits={[
        {
          ...
          description: (
            <p>
              ...
              systems and understand the common faults found in Leeds
              properties.
            </p>
          ),
        },
      ...
      serviceAreasHeading="Central Heating Repair Across Leeds"
      serviceAreasContent={
        <p>
          Our heating engineers cover Leeds and the surrounding towns and
          villages throughout West Yorkshire. From older properties
          in Leeds town centre to newer-build estates in Roundhay, Morley,
          and Horsforth, our engineers are familiar with the heating
      ...
      ctaContent={
        <p>
          ...
          a qualified heating engineer in Leeds who can diagnose and fix the
      ...
      serviceDescription="Central heating repair in Leeds. Radiators, pumps, valves, and full system diagnostics."
