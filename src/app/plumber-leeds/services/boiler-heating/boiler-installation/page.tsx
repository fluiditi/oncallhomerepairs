...
export const metadata: Metadata = {
  title: "Boiler Installation Leeds | OnCall Home Repairs",
  description:
    "New boiler installation in Leeds. Gas Safe engineers, competitive quotes, workmanship guarantee. Call 0333 240 8428.",
  alternates: {
    canonical:
      "https://oncallhomerepairs.co.uk/plumber-leeds/services/boiler-heating/boiler-installation",
  },
};
...
export default function BoilerInstallationPage() {
  return (
    <ServicePage
      ...
      h1="Boiler Installation in Leeds"
      heroIntro={
        <p>
          ...
          you with Gas Safe registered heating engineers in Leeds who carry
      ...
      serviceAreasHeading="Boiler Installation Across Leeds"
      serviceAreasContent={
        <p>
          We connect homeowners across Leeds and West Yorkshire
          with qualified boiler installers. Whether you are in the centre of
          Leeds, in Headingley, Chapel Allerton, or one of the surrounding
      ...
      faqs={[
        {
          question: "How much does a new boiler installation cost in Leeds?",
          answer:
      ...
      ctaHeading="Ready for a New Boiler in Leeds?"
      ctaContent={
        <p>
      ...
      serviceDescription="New boiler installation in Leeds. Gas Safe registered, competitive pricing."
