...
export const metadata: Metadata = {
  title: "Radiator Repair Leeds | OnCall Home Repairs",
  description:
    "Radiator repair and installation in Leeds. Fix cold spots, leaks, and add new radiators. Gas Safe engineers. Call 0333 240 8428.",
  alternates: {
    canonical:
      "https://oncallhomerepairs.co.uk/plumber-leeds/services/boiler-heating/radiator-repair-installation",
  },
};
...
export default function RadiatorRepairPage() {
  return (
    <ServicePage
      ...
      h1="Radiator Repair and Installation in Leeds"
      heroIntro={
        <p>
          ...
          Leeds who can diagnose radiator faults, carry out repairs, and
      ...
      whatWhyHeading="Common Radiator Problems in Leeds Homes"
      whatWhyContent={
        <>
          <p>
          ...
          <p>
            ...
            Leeds, Headingley, and the surrounding area have heating systems
      ...
      serviceAreasHeading="Radiator Repair Across Leeds"
      serviceAreasContent={
        <p>
          Our heating engineers carry out radiator repairs and installations
          across Leeds, Headingley, Chapel Allerton, Roundhay, Yeadon, Garforth,
      ...
      ctaContent={
        <p>
          ...
          in Leeds who can get your radiators working as they should.
        </p>
      }
      serviceName="Radiator Repair and Installation"
      serviceSlug="radiator-repair-installation"
      serviceDescription="Radiator repair and installation in Leeds. Fix cold spots, leaking valves, and add new radiators with qualified heating engineers."
