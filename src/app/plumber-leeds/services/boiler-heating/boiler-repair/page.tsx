...
export const metadata: Metadata = {
  title: "Boiler Repair Leeds | OnCall Home Repairs",
  description:
    "Boiler repair in Leeds by Gas Safe engineers. Same-day repairs, upfront quotes. Available 24/7. Call 0333 240 8428.",
  alternates: {
    canonical:
      "https://oncallhomerepairs.co.uk/plumber-leeds/services/boiler-heating/boiler-repair",
  },
};
    ...
    <ServicePage
      ...
      heroIntro={
        <p>
          ...
          with Gas Safe registered heating engineers in Leeds who diagnose
        ...
        },
        {
          ...
          description: (
            <p>
              ...
              Leeds. For emergency breakdowns, engineers are available 24/7.
      ...
      serviceAreasHeading="Boiler Repair Across Leeds"
      serviceAreasContent={
        <p>
          Our network of Gas Safe heating engineers covers Leeds and the
          surrounding area. Whether you live in Headingley, Chapel Allerton, Roundhay,
          or one of the smaller villages like Otley or Wetherby, we
      ...
      ctaContent={
        <p>
          ...
          a Gas Safe registered engineer in Leeds. Upfront pricing,
      ...
      serviceDescription="Expert boiler repair in Leeds. Gas Safe registered engineers available 24/7."
