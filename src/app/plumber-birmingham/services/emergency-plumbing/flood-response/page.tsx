...
export const metadata: Metadata = {
  title: "Flood Response Plumber Birmingham | OnCall Home Repairs",
  description:
    "Emergency flood response in Birmingham. Rapid water damage control by vetted plumbers, available 24/7. Call 0333 240 8428.",
  alternates: {
    canonical:
      "https://oncallhomerepairs.co.uk/plumber-birmingham/services/emergency-plumbing/flood-response",
  },
};
...
export default function FloodResponsePage() {
  return (
    <ServicePage
      ...
      h1="Flood Response Plumber in Birmingham"
      heroIntro={
        <p>
          ...
          experienced flood response plumbers in Birmingham who can reach your
      ...
      whatWhyContent={
        <>
          ...
          <p>
            Properties across Birmingham, Edgbaston, and the surrounding villages
            are particularly vulnerable during winter months when{" "}
            <a
              href="/plumber-birmingham/services/emergency-plumbing/frozen-pipe-repair"
              className="text-primary underline underline-offset-2 hover:text-primary/80"
            >
              frozen pipes
            </a>{" "}
      ...
      relatedServices={[
        ...
        },
        {
          ...
          href: "/plumber-birmingham/services/emergency-plumbing/stopcock-repair",
        },
        {
      ...
      serviceAreasHeading="Flood Response Across Birmingham and West Midlands"
      serviceAreasContent={
        <p>
          Our flood response plumbers cover Birmingham town centre, Edgbaston,
          Moseley, Kings Heath, Harborne, and surrounding villages.
          Response times are fastest within the Birmingham and Edgbaston area,
          with the wider West Midlands area typically reached
      ...
      ctaContent={
        <p>
          ...
          will have a vetted flood response plumber heading to your Birmingham
          property as quickly as possible.
        </p>
      }
      serviceName="Flood Response"
      serviceSlug="flood-response"
      serviceDescription="Emergency flood response plumber in Birmingham. Rapid water damage control, source isolation, and immediate repair by vetted local plumbers."
