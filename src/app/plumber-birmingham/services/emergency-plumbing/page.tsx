...
export const metadata: Metadata = {
  title: "Emergency Plumbing Birmingham | OnCall Home Repairs",
  description:
    "24/7 emergency plumbing in Birmingham. Burst pipes, leaks, flooding. Vetted, Gas Safe plumbers. Call 0333 240 8428.",
  alternates: {
    canonical: "https://oncallhomerepairs.co.uk/plumber-birmingham/services/emergency-plumbing",
  },
};
  ...
  return (
    <CategoryPage
      breadcrumbItems={[
        ...
        { name: "Emergency Plumbing", href: "/plumber-birmingham/services/emergency-plumbing" },
      ]}
      h1="Emergency Plumbing Services in Birmingham"
      heroIntro={
        <>
          <p>
            ...
            registered emergency plumbers across Birmingham and the surrounding
            villages, available 24 hours a day, 7 days a week. Whether it is a{" "}
            <a href="/plumber-birmingham/services/emergency-plumbing/burst-pipe-repair" className="underline hover:text-white">
              burst pipe
            </a>
      ...
      overviewContent={
        <>
          <p>
            ...
            locally based plumbers who can reach properties in Birmingham,
            Edgbaston, Moseley, and beyond — often within the hour.
          </p>
          <p>
          ...
          <p>
            From{" "}
            <a href="/plumber-birmingham/services/emergency-plumbing/leak-detection-repair" className="text-primary underline hover:text-primary/80">
              leak detection and repair
            </a>{" "}
            to{" "}
            <a href="/plumber-birmingham/services/emergency-plumbing/flood-response" className="text-primary underline hover:text-primary/80">
              flood response
            </a>
      ...
      services={[
        {
          ...
          description:
            "Round-the-clock emergency plumber call-out in Birmingham. Fast attendance for urgent leaks, burst pipes, boiler failures, and any plumbing crisis that cannot wait until morning.",
          isCoreService: true,
        },
        {
        ...
        },
        {
          ...
          description:
            "Safe thawing and repair of frozen pipes during cold West Midlands winters. Prevents cracks and burst pipes before they cause costly water damage to your property.",
          isCoreService: false,
        },
        {
          name: "Flood Response",
      ...
      differentiators={[
        ...
        },
        {
          ...
          description: (
            <p>
              Our plumbers are based across Birmingham and the surrounding
      ...
      serviceAreasHeading="Emergency Plumbing Across Birmingham and Beyond"
      serviceAreasContent={
        <p>
          Our network of emergency plumbers covers Birmingham town centre and the
          surrounding villages throughout West Midlands. Whether you
          are in Edgbaston, Moseley, Kings Heath, or as far as Hall Green
          and Small Heath, we can connect you with a qualified plumber who knows
      ...
      faqs={[
        {
          question:
            "How quickly can an emergency plumber reach my property in Birmingham?",
          answer:
      ...
      ctaContent={
        <p>
          ...
          we will connect you with a vetted emergency plumber in Birmingham —
          available 24 hours a day, every day of the year.
        </p>
      }
      categoryName="Emergency Plumbing"
      categoryDescription="24/7 emergency plumbing services in Birmingham — burst pipes, leaks, floods, and urgent repairs by vetted, Gas Safe registered plumbers."
