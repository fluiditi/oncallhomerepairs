...
export const metadata: Metadata = {
  title: "Frozen Pipe Repair Birmingham | OnCall Home Repairs",
  description:
    "Frozen pipe repair in Birmingham. Prevent burst pipes this winter. Vetted plumbers, 24/7. Call 0333 240 8428.",
  alternates: {
    canonical:
      "https://oncallhomerepairs.co.uk/plumber-birmingham/services/emergency-plumbing/frozen-pipe-repair",
  },
};
...
export default function FrozenPipeRepairPage() {
  return (
    <ServicePage
      ...
      h1="Frozen Pipe Repair in Birmingham"
      heroIntro={
        <p>
          When temperatures across West Midlands drop below freezing, pipes in
      ...
      whatWhyHeading="Why Frozen Pipes Are a Serious Risk in Birmingham"
      whatWhyContent={
        <>
          <p>
            Birmingham sits in the East Midlands where winter temperatures
          ...
          <p>
            ...
            understands the specific risks West Midlands winters pose to local
      ...
      serviceAreasHeading="Frozen Pipe Repair Across Birmingham"
      serviceAreasContent={
        <p>
          Our plumbers attend frozen pipe emergencies across Birmingham, Edgbaston,
          Moseley, Kings Heath, and the surrounding villages. Properties in
          ...
          West Midlands, we can connect you with a plumber who
      ...
      faqs={[
        ...
        {
          question:
            "How much does frozen pipe repair cost in Birmingham?",
          answer:
      ...
      ctaContent={
        <p>
          ...
          Home Repairs and we will connect you with a vetted plumber in Birmingham
      ...
      serviceDescription="Frozen pipe thawing and repair in Birmingham. Prevent burst pipes this winter with safe, professional pipe repair from vetted local plumbers."
