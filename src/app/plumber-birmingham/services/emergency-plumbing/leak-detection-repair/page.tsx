...
export const metadata: Metadata = {
  title: "Leak Detection Birmingham | OnCall Home Repairs",
  description:
    "Professional leak detection and repair in Birmingham. Find and fix hidden leaks fast. Transparent pricing. Call 0333 240 8428.",
  alternates: {
    canonical:
      "https://oncallhomerepairs.co.uk/plumber-birmingham/services/emergency-plumbing/leak-detection-repair",
  },
};
...
export default function LeakDetectionRepairPage() {
  return (
    <ServicePage
      ...
      h1="Leak Detection and Repair in Birmingham"
      heroIntro={
        <p>
          ...
          connects you with skilled plumbers in Birmingham who specialise in
      ...
      whatWhyContent={
        <>
          ...
          <p>
            In Birmingham, many homes are built with traditional construction
      ...
      benefits={[
        ...
        },
        {
          ...
          description: (
            <p>
              Every plumber in our Birmingham network is qualified, insured, and
      ...
      serviceAreasHeading="Leak Detection Across Birmingham"
      serviceAreasContent={
        <p>
          Our leak detection service covers Birmingham and all nearby towns and
          villages. From Victorian terraces in Birmingham centre to modern estates
          in Edgbaston and Moseley, our plumbers are experienced with the
          property types and plumbing systems found across the area. Whether
          your leak is in a ground-floor flat in Kings Heath or a detached house in
          Handsworth, we can match you with someone local who can investigate
          promptly.
        </p>
      }
      faqs={[
      ...
      ctaHeading="Suspect a Leak in Your Birmingham Home?"
      ctaContent={
        <p>
      ...
      serviceDescription="Professional leak detection and repair in Birmingham. Find and fix hidden leaks fast."
