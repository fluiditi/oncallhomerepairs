...
export const metadata: Metadata = {
  title: "Burst Pipe Repair Birmingham | OnCall Home Repairs",
  description:
    "Fast burst pipe repair in Birmingham. 24/7 emergency response from vetted plumbers. Transparent pricing. Call 0333 240 8428.",
  alternates: {
    canonical:
      "https://oncallhomerepairs.co.uk/plumber-birmingham/services/emergency-plumbing/burst-pipe-repair",
  },
};
...
export default function BurstPipeRepairPage() {
  return (
    <ServicePage
      ...
      h1="Burst Pipe Repair in Birmingham"
      heroIntro={
        <p>
          ...
          you with vetted, experienced plumbers in the Birmingham area who
      ...
      whatWhyContent={
        <>
          ...
          <p>
            Our network of plumbers in Birmingham arrives equipped with the
      ...
      serviceAreasHeading="Burst Pipe Repair Across Birmingham"
      serviceAreasContent={
        <p>
          We connect homeowners with burst pipe repair plumbers across Birmingham
          and the surrounding villages. Whether you are in Edgbaston, Moseley,
          Kings Heath, or further afield in Sutton Coldfield or Hall Green, our
      ...
      ctaHeading="Burst Pipe in Birmingham? Act Now"
      ctaContent={
        <p>
      ...
      serviceDescription="Fast burst pipe repair in Birmingham. Emergency call-out available 24/7."
