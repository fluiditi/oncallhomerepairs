...
export const metadata: Metadata = {
  title: "Overflow Repair Birmingham | OnCall Home Repairs",
  description:
    "Overflow pipe repair in Birmingham. Stop water leaks from tanks and cisterns. Transparent pricing. Call 0333 240 8428.",
  alternates: {
    canonical:
      "https://oncallhomerepairs.co.uk/plumber-birmingham/services/emergency-plumbing/overflow-repair",
  },
};
...
export default function OverflowRepairPage() {
  return (
    <ServicePage
      ...
      h1="Overflow Pipe Repair in Birmingham"
      heroIntro={
        <p>
          ...
          OnCall Home Repairs connects you with vetted Birmingham plumbers who
      ...
      serviceAreasHeading="Overflow Repair Across Birmingham"
      serviceAreasContent={
        <p>
          Our plumbers carry out overflow repairs across Birmingham, Edgbaston,
          Moseley, Kings Heath, Sutton Coldfield, and the wider West Midlands
      ...
      ctaContent={
        <p>
          Stop wasting water and prevent damp damage to your Birmingham home.
      ...
      serviceDescription="Overflow pipe repair in Birmingham. Diagnose and fix faulty ball valves, cisterns, and tank overflows with vetted local plumbers."
