...
export const metadata: Metadata = {
  title: "Blocked Drains Birmingham | OnCall Home Repairs",
  description:
    "Blocked drain clearing in Birmingham. Fast, effective unblocking for homes and businesses. Call 0333 240 8428.",
  alternates: {
    canonical:
      "https://oncallhomerepairs.co.uk/plumber-birmingham/services/drain-services/blocked-drains",
  },
};
...
export default function BlockedDrainsPage() {
  return (
    <ServicePage
      ...
      h1="Blocked Drains in Birmingham"
      heroIntro={
        <p>
          ...
          drainage plumbers in Birmingham who can clear blockages quickly and
      ...
      serviceAreasHeading="Blocked Drain Clearing Across Birmingham"
      serviceAreasContent={
        <p>
          Our drainage plumbers cover Birmingham and every surrounding town and
          village. From terraced properties in Birmingham centre with shared
          drainage runs to detached homes in Edgbaston, Moseley, and Market
      ...
      ctaHeading="Blocked Drain in Birmingham?"
      ctaContent={
        <p>
      ...
      serviceDescription="Blocked drain clearing in Birmingham. Fast, effective unblocking for homes and businesses."
