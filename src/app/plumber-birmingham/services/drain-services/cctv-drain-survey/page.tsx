...
export const metadata: Metadata = {
  title: "CCTV Drain Survey Birmingham | OnCall Home Repairs",
  description:
    "CCTV drain survey in Birmingham. Camera inspection to diagnose drainage problems accurately. Vetted engineers. Call 0333 240 8428.",
  alternates: {
    canonical:
      "https://oncallhomerepairs.co.uk/plumber-birmingham/services/drain-services/cctv-drain-survey",
  },
};
...
export default function CCTVDrainSurveyPage() {
  return (
    <ServicePage
      ...
      h1="CCTV Drain Survey in Birmingham"
      heroIntro={
        <p>
          ...
          engineers in Birmingham who use professional camera equipment to inspect
      ...
      whatWhyContent={
        <>
          ...
          <p>
            Homebuyers in Birmingham increasingly request drain surveys as part
      ...
      serviceAreasHeading="CCTV Drain Surveys Across Birmingham"
      serviceAreasContent={
        <p>
          Our drain engineers carry out CCTV surveys across Birmingham, Edgbaston,
          Moseley, Kings Heath, Hall Green, Aston, Perry Barr, and all
      ...
      faqs={[
        {
          question: "How much does a CCTV drain survey cost in Birmingham?",
          answer:
      ...
      ctaContent={
        <p>
          ...
          we will connect you with a drain engineer in Birmingham who can carry
      ...
      serviceDescription="CCTV drain survey in Birmingham. Professional camera inspection to diagnose drainage problems, root intrusion, and pipe damage."
