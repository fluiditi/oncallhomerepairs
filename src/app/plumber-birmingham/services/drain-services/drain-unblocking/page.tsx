...
export const metadata: Metadata = {
  title: "Drain Unblocking Birmingham | OnCall Home Repairs",
  description:
    "Professional drain unblocking in Birmingham. High-pressure jetting and manual rodding. Vetted plumbers. Call 0333 240 8428.",
  alternates: {
    canonical:
      "https://oncallhomerepairs.co.uk/plumber-birmingham/services/drain-services/drain-unblocking",
  },
};
...
export default function DrainUnblockingPage() {
  return (
    <ServicePage
      ...
      h1="Drain Unblocking in Birmingham"
      heroIntro={
        <p>
          ...
          experienced drain engineers in Birmingham who use professional-grade
      ...
      whatWhyContent={
        <>
          <p>
            Most drain blockages in Birmingham homes are caused by a gradual
      ...
      serviceAreasHeading="Drain Unblocking Across Birmingham"
      serviceAreasContent={
        <p>
          Our drain engineers cover Birmingham, Edgbaston, Moseley, Kings Heath,
          Solihull, Sutton Coldfield, and the surrounding area. External drain
      ...
      ctaContent={
        <p>
          ...
          Birmingham who can clear the blockage and restore full flow.
        </p>
      }
      serviceName="Drain Unblocking"
      serviceSlug="drain-unblocking"
      serviceDescription="Professional drain unblocking in Birmingham using high-pressure jetting and manual rodding. Fast, effective clearance for homes and businesses."
