...
export const metadata: Metadata = {
  title: "Toilet Unblocking Birmingham | OnCall Home Repairs",
  description:
    "Toilet unblocking in Birmingham. Fast, hygienic clearance of blocked toilets by vetted plumbers. Call 0333 240 8428.",
  alternates: {
    canonical:
      "https://oncallhomerepairs.co.uk/plumber-birmingham/services/drain-services/toilet-unblocking",
  },
};
...
export default function ToiletUnblockingPage() {
  return (
    <ServicePage
      ...
      h1="Toilet Unblocking in Birmingham"
      heroIntro={
        <p>
          ...
          Birmingham who carry out fast, hygienic toilet unblocking using
      ...
      whatWhyContent={
        <>
          ...
          <p>
            In older Birmingham properties, narrow soil pipes and ageing clay
      ...
      serviceAreasHeading="Toilet Unblocking Across Birmingham"
      serviceAreasContent={
        <p>
          Our plumbers attend toilet unblocking jobs across Birmingham, Edgbaston,
          Moseley, Kings Heath, Perry Barr, Small Heath, and all surrounding areas.
      ...
      ctaContent={
        <p>
          ...
          and we will connect you with a plumber in Birmingham who can clear it
          quickly and discreetly &mdash; same-day where possible.
        </p>
      }
      serviceName="Toilet Unblocking"
      serviceSlug="toilet-unblocking"
      serviceDescription="Fast, hygienic toilet unblocking in Birmingham. Professional clearance of blocked toilets by vetted local plumbers."
