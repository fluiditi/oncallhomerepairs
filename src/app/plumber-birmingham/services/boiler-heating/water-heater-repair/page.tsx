...
export const metadata: Metadata = {
  title: "Water Heater Repair Birmingham | OnCall Home Repairs",
  description:
    "Water heater repair in Birmingham. Immersion heaters, cylinders, and unvented systems. Vetted plumbers. Call 0333 240 8428.",
  alternates: {
    canonical:
      "https://oncallhomerepairs.co.uk/plumber-birmingham/services/boiler-heating/water-heater-repair",
  },
};
    ...
    <ServicePage
      breadcrumbItems={[
        ...
        { name: "Boiler & Heating", href: "/plumber-birmingham/services/boiler-heating" },
        {
          ...
          href: "/plumber-birmingham/services/boiler-heating/water-heater-repair",
        },
      ]}
      h1="Water Heater Repair in Birmingham"
      heroIntro={
        <p>
          ...
          you with qualified plumbers and heating engineers in Birmingham who can
      ...
      whatWhyContent={
        <>
          <p>
            Hot water systems vary considerably across Birmingham properties.
          ...
          <p>
            ...
            areas like West Midlands, and eventually stops working. The
      ...
      serviceAreasHeading="Water Heater Repair Across Birmingham"
      serviceAreasContent={
        <p>
          Our plumbers and heating engineers attend water heater repairs across
          Birmingham, Edgbaston, Moseley, Kings Heath, Erdington, Selly Oak, and
      ...
      faqs={[
        {
          ...
          answer:
            "The most common cause is a failed heating element. Hard water areas like Birmingham accelerate limescale build-up on the element, which causes it to overheat and burn out. The thermostat can also fail independently. A plumber can test both components and replace whichever has failed.",
        },
        {
          question:
      ...
      ctaContent={
        <p>
          ...
          Birmingham who can restore your hot water supply.
        </p>
      }
      serviceName="Water Heater Repair"
      serviceSlug="water-heater-repair"
      serviceDescription="Water heater repair in Birmingham. Immersion heaters, hot water cylinders, and unvented systems repaired by qualified local plumbers."
