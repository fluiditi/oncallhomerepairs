...
export const metadata: Metadata = {
  title: "Gas Safety Check Birmingham | OnCall Home Repairs",
  description:
    "Gas safety checks and CP12 certificates in Birmingham. For landlords and homeowners. Gas Safe registered engineers. Call 0333 240 8428.",
  alternates: {
    canonical:
      "https://oncallhomerepairs.co.uk/plumber-birmingham/services/boiler-heating/gas-safety-checks",
  },
};
...
export default function GasSafetyChecksPage() {
  return (
    <ServicePage
      ...
      h1="Gas Safety Checks in Birmingham"
      heroIntro={
        <p>
          ...
          Birmingham who carry out thorough inspections of your boiler, gas
      ...
      serviceAreasHeading="Gas Safety Checks Across Birmingham"
      serviceAreasContent={
        <p>
          Our Gas Safe registered engineers carry out gas safety checks across
          Birmingham, Edgbaston, Moseley, Kings Heath, Harborne, Handsworth,
          Perry Barr, Small Heath, and all surrounding areas. Landlords with multiple
      ...
      faqs={[
        {
          question: "How much does a gas safety check cost in Birmingham?",
          answer:
      ...
      ctaContent={
        <p>
          ...
          engineer in Birmingham for your annual gas safety check.
        </p>
      }
      serviceName="Gas Safety Checks"
      serviceSlug="gas-safety-checks"
      serviceDescription="Gas safety checks and CP12 certificates in Birmingham. Annual inspections for landlords and homeowners by Gas Safe registered engineers."
