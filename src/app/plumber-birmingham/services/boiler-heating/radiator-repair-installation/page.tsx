...
export const metadata: Metadata = {
  title: "Radiator Repair Birmingham | OnCall Home Repairs",
  description:
    "Radiator repair and installation in Birmingham. Fix cold spots, leaks, and add new radiators. Gas Safe engineers. Call 0333 240 8428.",
  alternates: {
    canonical:
      "https://oncallhomerepairs.co.uk/plumber-birmingham/services/boiler-heating/radiator-repair-installation",
  },
};
...
export default function RadiatorRepairPage() {
  return (
    <ServicePage
      ...
      h1="Radiator Repair and Installation in Birmingham"
      heroIntro={
        <p>
          ...
          Birmingham who can diagnose radiator faults, carry out repairs, and
      ...
      whatWhyHeading="Common Radiator Problems in Birmingham Homes"
      whatWhyContent={
        <>
          <p>
          ...
          <p>
            West Midlands&rsquo;s hard water accelerates the build-up of
            limescale and sludge in central heating systems. Many homes in
            Birmingham, Edgbaston, and the surrounding area have heating systems
      ...
      serviceAreasHeading="Radiator Repair Across Birmingham"
      serviceAreasContent={
        <p>
          Our heating engineers carry out radiator repairs and installations
          across Birmingham, Edgbaston, Moseley, Kings Heath, Handsworth, Aston,
          and the wider West Midlands area. Whether you need a
      ...
      ctaContent={
        <p>
          ...
          in Birmingham who can get your radiators working as they should.
        </p>
      }
      serviceName="Radiator Repair and Installation"
      serviceSlug="radiator-repair-installation"
      serviceDescription="Radiator repair and installation in Birmingham. Fix cold spots, leaking valves, and add new radiators with qualified heating engineers."
