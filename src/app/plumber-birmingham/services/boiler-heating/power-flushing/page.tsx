...
export const metadata: Metadata = {
  title: "Power Flushing Birmingham | OnCall Home Repairs",
  description:
    "Power flushing in Birmingham. Remove sludge and restore heating efficiency. Gas Safe engineers, transparent pricing. Call 0333 240 8428.",
  alternates: {
    canonical:
      "https://oncallhomerepairs.co.uk/plumber-birmingham/services/boiler-heating/power-flushing",
  },
};
...
export default function PowerFlushingPage() {
  return (
    <ServicePage
      ...
      h1="Power Flushing in Birmingham"
      heroIntro={
        <p>
          ...
          connects you with qualified engineers in Birmingham who carry out
      ...
      whatWhyContent={
        <>
          ...
          <p>
            ...
            sludge. West Midlands&rsquo;s hard water makes this worse by adding
      ...
      serviceAreasHeading="Power Flushing Across Birmingham"
      serviceAreasContent={
        <p>
          Our engineers carry out power flushing across Birmingham, Edgbaston, Moseley,
          Kings Heath, Sutton Coldfield, Hall Green, and surrounding
      ...
      ctaContent={
        <p>
          ...
          Repairs and we will connect you with a qualified engineer in Birmingham
          who can carry out a professional power flush on your system.
        </p>
      }
      serviceName="Power Flushing"
      serviceSlug="power-flushing"
      serviceDescription="Power flushing in Birmingham. Remove sludge and limescale from your central heating system to restore efficiency and prevent boiler breakdowns."
