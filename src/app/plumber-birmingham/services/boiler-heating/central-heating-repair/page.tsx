...
export const metadata: Metadata = {
  title: "Central Heating Repair Birmingham | OnCall Home Repairs",
  description:
    "Central heating repair in Birmingham. Radiators, pumps, valves, thermostats. Gas Safe engineers. Call 0333 240 8428.",
  alternates: {
    canonical:
      "https://oncallhomerepairs.co.uk/plumber-birmingham/services/boiler-heating/central-heating-repair",
  },
};
...
export default function CentralHeatingRepairPage() {
  return (
    <ServicePage
      ...
      h1="Central Heating Repair in Birmingham"
      heroIntro={
        <p>
          When your central heating is not working properly, your home becomes
          uncomfortable fast — especially during a West Midlands winter. Cold
          ...
          engineers in Birmingham who diagnose and repair central heating faults
      ...
      whatWhyContent={
        <>
          ...
          <p>
            ...
            <Link
              href="/plumber-birmingham/services/boiler-heating/power-flushing"
              className="text-primary underline underline-offset-2 hover:text-primary/80"
            >
              power flush
            </Link>{" "}
      ...
      benefits={[
        {
          ...
          description: (
            <p>
              ...
              systems and understand the common faults found in Birmingham
              properties.
            </p>
          ),
        },
      ...
      relatedServices={[
        ...
        },
        {
          ...
          href: "/plumber-birmingham/services/boiler-heating/radiator-repair-installation",
        },
        {
          name: "Power Flushing",
          href: "/plumber-birmingham/services/boiler-heating/power-flushing",
      ...
      serviceAreasHeading="Central Heating Repair Across Birmingham"
      serviceAreasContent={
        <p>
          Our heating engineers cover Birmingham and the surrounding towns and
          villages throughout West Midlands. From older properties
          in Birmingham town centre to newer-build estates in Kings Heath, Selly Oak,
          and Harborne, our engineers are familiar with the heating
      ...
      ctaContent={
        <p>
          ...
          a qualified heating engineer in Birmingham who can diagnose and fix the
      ...
      serviceDescription="Central heating repair in Birmingham. Radiators, pumps, valves, and full system diagnostics."
