...
export const metadata: Metadata = {
  title: "Boiler Servicing Birmingham | OnCall Home Repairs",
  description:
    "Annual boiler servicing in Birmingham. Keep your warranty valid and your boiler running efficiently. Gas Safe engineers. Call 0333 240 8428.",
  alternates: {
    canonical:
      "https://oncallhomerepairs.co.uk/plumber-birmingham/services/boiler-heating/boiler-servicing",
  },
};
...
export default function BoilerServicingPage() {
  return (
    <ServicePage
      ...
      h1="Boiler Servicing in Birmingham"
      heroIntro={
        <p>
          ...
          connects you with Gas Safe registered engineers in Birmingham who carry
      ...
      serviceAreasHeading="Boiler Servicing Across Birmingham"
      serviceAreasContent={
        <p>
          Our Gas Safe registered engineers service boilers across Birmingham,
          Edgbaston, Moseley, Kings Heath, Selly Oak, Harborne, and
      ...
      serviceDescription="Annual boiler servicing in Birmingham by Gas Safe registered engineers. Manufacturer warranty protection, safety checks, and efficiency testing."
