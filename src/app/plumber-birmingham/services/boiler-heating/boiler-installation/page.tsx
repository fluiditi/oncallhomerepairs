...
export const metadata: Metadata = {
  title: "Boiler Installation Birmingham | OnCall Home Repairs",
  description:
    "New boiler installation in Birmingham. Gas Safe engineers, competitive quotes, workmanship guarantee. Call 0333 240 8428.",
  alternates: {
    canonical:
      "https://oncallhomerepairs.co.uk/plumber-birmingham/services/boiler-heating/boiler-installation",
  },
};
...
export default function BoilerInstallationPage() {
  return (
    <ServicePage
      ...
      h1="Boiler Installation in Birmingham"
      heroIntro={
        <p>
          ...
          you with Gas Safe registered heating engineers in Birmingham who carry
      ...
      serviceAreasHeading="Boiler Installation Across Birmingham"
      serviceAreasContent={
        <p>
          We connect homeowners across Birmingham and West Midlands
          with qualified boiler installers. Whether you are in the centre of
          Birmingham, in Edgbaston, Moseley, or one of the surrounding
          ...
          of West Midlands and can advise on the best boiler setup for your
          home.
        </p>
      }
      faqs={[
        {
          question: "How much does a new boiler installation cost in Birmingham?",
          answer:
      ...
      ctaHeading="Ready for a New Boiler in Birmingham?"
      ctaContent={
        <p>
      ...
      serviceDescription="New boiler installation in Birmingham. Gas Safe registered, competitive pricing."
