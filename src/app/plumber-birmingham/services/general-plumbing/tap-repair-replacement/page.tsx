...
export const metadata: Metadata = {
  title: "Tap Repair Birmingham | OnCall Home Repairs",
  description:
    "Tap repair and replacement in Birmingham. Fix dripping taps and install new ones. Vetted plumbers, transparent pricing. Call 0333 240 8428.",
  alternates: {
    canonical:
      "https://oncallhomerepairs.co.uk/plumber-birmingham/services/general-plumbing/tap-repair-replacement",
  },
};
...
export default function TapRepairPage() {
  return (
    <ServicePage
      ...
      h1="Tap Repair and Replacement in Birmingham"
      heroIntro={
        <p>
          ...
          Home Repairs connects you with plumbers in Birmingham who can fix
      ...
      whatWhyContent={
        <>
          <p>
            ...
            West Midlands, the hard water supply accelerates wear on internal
      ...
      serviceAreasHeading="Tap Repair Across Birmingham"
      serviceAreasContent={
        <p>
          Our plumbers repair and replace taps across Birmingham, Edgbaston, Moseley,
          Kings Heath, Handsworth, Aston, and the surrounding area. Tap
      ...
      ctaContent={
        <p>
          ...
          will connect you with a plumber in Birmingham who can repair or
      ...
      serviceDescription="Tap repair and replacement in Birmingham. Fix dripping taps, replace worn components, and install new taps with vetted local plumbers."
