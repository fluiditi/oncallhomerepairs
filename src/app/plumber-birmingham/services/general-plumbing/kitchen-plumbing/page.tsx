...
export const metadata: Metadata = {
  title: "Kitchen Plumber Birmingham | OnCall Home Repairs",
  description:
    "Kitchen plumbing in Birmingham. Sink installations, dishwasher connections, waste disposal, and repairs. Call 0333 240 8428.",
  alternates: {
    canonical:
      "https://oncallhomerepairs.co.uk/plumber-birmingham/services/general-plumbing/kitchen-plumbing",
  },
};
    ...
    <ServicePage
      breadcrumbItems={[
        ...
        { name: "General Plumbing", href: "/plumber-birmingham/services/general-plumbing" },
        {
          ...
          href: "/plumber-birmingham/services/general-plumbing/kitchen-plumbing",
        },
      ]}
      h1="Kitchen Plumbing in Birmingham"
      heroIntro={
        <p>
          ...
          Birmingham who install, repair, and maintain kitchen plumbing &mdash;
      ...
      whatWhyContent={
        <>
          ...
          <p>
            Blocked kitchen sinks are a regular call-out in Birmingham. Grease,
            ...
            <a
              href="/plumber-birmingham/services/drain-services/drain-unblocking"
      ...
      relatedServices={[
        ...
        },
        {
          ...
          href: "/plumber-birmingham/services/general-plumbing/pipe-replacement",
        },
      ]}
      serviceAreasHeading="Kitchen Plumbing Across Birmingham"
      serviceAreasContent={
        <p>
          Our plumbers carry out kitchen plumbing work across Birmingham,
          Edgbaston, Moseley, Kings Heath, Sutton Coldfield, Solihull, Market
      ...
      ctaContent={
        <p>
          ...
          Repairs will match you with a qualified plumber in Birmingham. Call
          for a clear, upfront quote.
        </p>
      }
      serviceName="Kitchen Plumbing"
      serviceSlug="kitchen-plumbing"
      serviceDescription="Kitchen plumbing in Birmingham. Sink installations, appliance connections, waste pipe repairs, and full kitchen plumbing by vetted local plumbers."
