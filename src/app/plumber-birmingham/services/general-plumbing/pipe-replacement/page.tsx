...
export const metadata: Metadata = {
  title: "Pipe Replacement Birmingham | OnCall Home Repairs",
  description:
    "Pipe replacement in Birmingham. Copper, plastic, and lead pipe upgrades by vetted plumbers. Transparent pricing. Call 0333 240 8428.",
  alternates: {
    canonical:
      "https://oncallhomerepairs.co.uk/plumber-birmingham/services/general-plumbing/pipe-replacement",
  },
};
...
export default function PipeReplacementPage() {
  return (
    <ServicePage
      ...
      h1="Pipe Replacement in Birmingham"
      heroIntro={
        <p>
          ...
          connects you with qualified plumbers in Birmingham who replace old
      ...
      whatWhyContent={
        <>
          <p>
            ...
            Birmingham properties &mdash; pose a health risk and should be
      ...
      serviceAreasHeading="Pipe Replacement Across Birmingham"
      serviceAreasContent={
        <p>
          Our plumbers replace pipework in properties across Birmingham, Edgbaston,
          Moseley, Kings Heath, Small Heath, Perry Barr, and all surrounding areas.
      ...
      ctaContent={
        <p>
          ...
          in Birmingham who can assess your pipes and carry out replacements
          that last.
        </p>
      }
      serviceName="Pipe Replacement"
      serviceSlug="pipe-replacement"
      serviceDescription="Pipe replacement in Birmingham. Copper, plastic, and lead pipe upgrades for homes and businesses by vetted local plumbers."
