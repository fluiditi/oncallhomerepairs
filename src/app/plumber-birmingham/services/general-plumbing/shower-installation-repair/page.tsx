...
export const metadata: Metadata = {
  title: "Shower Installation Birmingham | OnCall Home Repairs",
  description:
    "Shower installation and repair in Birmingham. Electric, mixer, and thermostatic showers. Vetted plumbers. Call 0333 240 8428.",
  alternates: {
    canonical:
      "https://oncallhomerepairs.co.uk/plumber-birmingham/services/general-plumbing/shower-installation-repair",
  },
};
...
export default function ShowerInstallationPage() {
  return (
    <ServicePage
      ...
      h1="Shower Installation and Repair in Birmingham"
      heroIntro={
        <p>
          ...
          in Birmingham who handle all types of shower work. From quick repairs
      ...
      whatWhyContent={
        <>
          ...
          <p>
            In Birmingham homes with hard water, limescale build-up inside
      ...
      serviceAreasHeading="Shower Installation Across Birmingham"
      serviceAreasContent={
        <p>
          Our plumbers install and repair showers across Birmingham, Edgbaston,
          Moseley, Kings Heath, Harborne, Erdington, and surrounding
      ...
      ctaContent={
        <p>
          ...
          Repairs will match you with a qualified plumber in Birmingham. Call now
          for an upfront quote.
        </p>
      }
      serviceName="Shower Installation and Repair"
      serviceSlug="shower-installation-repair"
      serviceDescription="Shower installation and repair in Birmingham. Electric, mixer, and thermostatic showers fitted and repaired by vetted local plumbers."
