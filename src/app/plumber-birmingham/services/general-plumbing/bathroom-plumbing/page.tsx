...
export const metadata: Metadata = {
  title: "Bathroom Plumber Birmingham | OnCall Home Repairs",
  description:
    "Bathroom plumbing in Birmingham. Installations, repairs, full refits. Vetted plumbers, upfront quotes. Call 0333 240 8428.",
  alternates: {
    canonical:
      "https://oncallhomerepairs.co.uk/plumber-birmingham/services/general-plumbing/bathroom-plumbing",
  },
};
...
export default function BathroomPlumbingPage() {
  return (
    <ServicePage
      ...
      h1="Bathroom Plumbing in Birmingham"
      heroIntro={
        <p>
          ...
          vetted, experienced plumbers in Birmingham who handle all aspects of
      ...
      whatWhyContent={
        <>
          ...
          <p>
            ...
            will support the{" "}
            <Link
              href="/plumber-birmingham/services/general-plumbing/shower-installation-repair"
              className="text-primary underline underline-offset-2 hover:text-primary/80"
            >
              shower
            </Link>{" "}
        ...
        },
        {
          ...
          description: (
            <p>
              ...
              in Birmingham properties — from Victorian terraces with old lead
      ...
      serviceAreasHeading="Bathroom Plumbing Across Birmingham"
      serviceAreasContent={
        <p>
          Our bathroom plumbers serve Birmingham and all surrounding areas. From
          period properties in the town centre that need careful pipework
          modifications to new-build homes in Erdington, Aston, and Perry Barr
          that need a shower upgrade or suite replacement, our plumbers have
          the experience to handle it. We cover Edgbaston, Moseley, Kings Heath,
          Small Heath, and all villages in between.
        </p>
      }
      faqs={[
        {
      ...
      ctaHeading="Need a Bathroom Plumber in Birmingham?"
      ctaContent={
        <p>
      ...
      serviceDescription="Bathroom plumbing in Birmingham. Installations, repairs, and full bathroom fit-outs."
