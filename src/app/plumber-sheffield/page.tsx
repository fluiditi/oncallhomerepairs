...
const faqs = [
  {
    question: "How much does a plumber cost in Sheffield?",
    answer:
      "Plumbing costs in Sheffield vary depending on the job. A straightforward tap repair might cost between \u00a380 and \u00a3150, while a full boiler installation typically ranges from \u00a31,500 to \u00a33,500. Emergency callouts outside normal hours may carry a higher rate. Every job through OnCall Home Repairs starts with a clear, upfront quote \u2014 so you\u2019ll always know the cost before work begins.",
    answerJsx: (
      <>
        Plumbing costs in Sheffield vary depending on the job. A straightforward{" "}
        <a
          href="/plumber-sheffield/services/general-plumbing/tap-repair-replacement"
        ...
        <a
          href="/plumber-sheffield/services/boiler-heating/boiler-installation"
          className="text-primary underline underline-offset-2 hover:text-primary/80"
        >
          boiler installation
        </a>{" "}
  ...
  {
    question: "Do you offer 24-hour emergency plumbing in Sheffield?",
    answer:
  ...
  {
    question: "How quickly can a plumber get to my home in Sheffield?",
    answer:
      "For emergencies in Sheffield town centre and Ecclesall, a plumber can typically reach your property within an hour. For the wider service area including Crookes, Hillsborough, and surrounding villages, response times are usually within 90 minutes. Non-emergency appointments are scheduled at a time that works for you.",
    answerJsx: null,
  },
  {
  ...
  {
    question: "What areas near Sheffield do you cover?",
    answer:
      "We cover Sheffield and 18 surrounding towns and villages: Ecclesall, Crookes, Hillsborough, Dore, Totley, Woodseats, Walkley, Broomhill, Nether Edge, Fulwood, Chapeltown, Stocksbridge, Dronfield, Oughtibridge, Meadowhall, Ecclesall, Crookes, and Hillsborough. If you\u2019re not sure whether your area is covered, call 0333 240 8428 and we\u2019ll confirm.",
    answerJsx: (
      <>
        We cover Sheffield and 18 surrounding towns and villages: Ecclesall, Crookes,
        Hillsborough, Dore, Totley, Woodseats, Walkley,
        Broomhill, Nether Edge, Fulwood, Chapeltown, Stocksbridge, Dronfield,
        Oughtibridge, Meadowhall, Ecclesall, Crookes, and Hillsborough. If
...
const services = [
    ...
    keyServices: [
      {
        ...
        href: "/plumber-sheffield/services/emergency-plumbing/emergency-plumber",
      },
      {
        name: "Burst pipe repair",
        href: "/plumber-sheffield/services/emergency-plumbing/burst-pipe-repair",
      },
      {
        name: "Leak detection",
        href: "/plumber-sheffield/services/emergency-plumbing/leak-detection-repair",
      },
    ],
    href: "/plumber-sheffield/services/emergency-plumbing",
  ...
  },
  {
    ...
    keyServices: [
      { name: "Boiler repair", href: "/plumber-sheffield/services/boiler-heating/boiler-repair" },
      {
      ...
      },
      {
        ...
        href: "/plumber-sheffield/services/boiler-heating/central-heating-repair",
      },
    ],
  ...
  },
  {
    ...
    keyServices: [
      {
        name: "Blocked drains",
        href: "/plumber-sheffield/services/drain-services/blocked-drains",
      },
      {
        name: "CCTV drain survey",
        href: "/plumber-sheffield/services/drain-services/cctv-drain-survey",
      },
    ],
    ...
    keyServices: [
      {
        ...
        href: "/plumber-sheffield/services/general-plumbing/bathroom-plumbing",
      },
      {
        name: "Tap repair",
        href: "/plumber-sheffield/services/general-plumbing/tap-repair-replacement",
...
const differentiators = [
  {
    ...
    description:
      "Plumbing emergencies don\u2019t wait for office hours. Our network of Sheffield plumbers is available around the clock \u2014 at 3am on a Wednesday, on Christmas Day, on a bank holiday Monday. When you call 0333 240 8428, a real person answers and gets a plumber moving toward your property.",
  },
  {
    icon: ShieldCheck,
  ...
  },
  {
    ...
    link: {
      ...
      href: "/plumber-sheffield/services/boiler-heating/gas-safety-checks",
    },
  },
  {
    icon: Award,
  ...
  {
    icon: MapPin,
    title: "Local to Sheffield",
    description:
      "This isn\u2019t a faceless national company routing calls to whoever\u2019s cheapest. Our plumbers live and work in and around Sheffield. They know the local housing stock, the common problems with South Yorkshire properties, and they can reach your home quickly.",
  },
];
...
const steps = [
  ...
  },
  {
    ...
    description:
      "Based on your location, the type of job, and availability, we match you with a vetted, qualified plumber from our Sheffield network. For emergencies, this happens immediately.",
  },
  {
    number: "03",
    ...
    <main>
        ...
        <div className="relative mx-auto max-w-7xl px-4 py-20 sm:px-6 sm:py-28 lg:px-8 lg:py-36">
          ...
          >
            ...
            >
              ...
              Sheffield home, OnCall Home Repairs connects you with a vetted,
            ...
            >
              ...
              >
                <a href="/plumber-sheffield/contact">
                  Get a Plumber Now
        ...
        >
          <div className="mx-auto max-w-3xl">
            <h2 className="font-heading text-3xl font-bold tracking-tight text-navy sm:text-4xl">
              Dealing With a Plumbing Emergency in Sheffield?
            </h2>
            ...
            <div className="mt-8 space-y-6 text-base leading-relaxed text-muted-foreground sm:text-lg">
              ...
              <p>
                If you live in Sheffield, you know the frustration. Many of the
                town&rsquo;s older Victorian and Edwardian properties run on
                ageing pipework that wasn&rsquo;t built for modern demands.
                South Yorkshire&rsquo;s hard water accelerates limescale build-up
              ...
              <p>
                ...
                Sheffield homeowners with{" "}
                <a
                  href="/plumber-sheffield/about"
      ...
      <section className="bg-blue-soft py-20 sm:py-28">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          >
            <h2 className="font-heading text-3xl font-bold tracking-tight text-navy sm:text-4xl">
              Our Plumbing Services in Sheffield
            </h2>
          ...
          >
            <Button asChild variant="outline" size="lg" className="rounded-xl">
              <a href="/plumber-sheffield/services">
                View All Services
      ...
      <section className="bg-white py-20 sm:py-28">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          >
            <h2 className="font-heading text-3xl font-bold tracking-tight text-navy sm:text-4xl">
              Why Sheffield Homeowners Choose OnCall Home Repairs
            </h2>
          </motion.div>
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="mx-auto mt-4 max-w-xl text-base text-muted-foreground sm:text-lg">
              Getting a qualified plumber to your Sheffield home is simple.
            </p>
          </motion.div>
      ...
      <section className="bg-white py-20 sm:py-28">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          >
            <h2 className="font-heading text-3xl font-bold tracking-tight text-navy sm:text-4xl">
              What Our Sheffield Customers Say
            </h2>
          </motion.div>
        ...
        >
          <div className="mx-auto max-w-3xl">
            <div className="mb-6 flex items-center justify-center">
              ...
              <h2 className="font-heading text-3xl font-bold tracking-tight text-navy sm:text-4xl">
                Plumber Covering Sheffield and South Yorkshire
              </h2>
            </div>

            <div className="mt-8 space-y-6 text-base leading-relaxed text-muted-foreground sm:text-lg">
              <p>
                OnCall Home Repairs connects homeowners across Sheffield and the
                surrounding South Yorkshire towns and villages with qualified
                local plumbers. Our network covers Ecclesall, Crookes, and
                Hillsborough to the south, as well as the villages of Dore,
                Totley, and Woodseats.
              </p>
              <p>
                To the west, we serve Walkley and Broomhill, and our
                coverage extends north to Nether Edge and Fulwood. We also
                cover Chapeltown, Stocksbridge, Dronfield, Oughtibridge, Meadowhall,
                Ecclesall, Crookes, and Hillsborough.
              </p>
              <p>
                Wherever you are in the Sheffield area, a vetted plumber from our
                network can reach your home quickly. For emergencies, response
                times are fastest within Sheffield town centre and Ecclesall, with
            ...
            <div className="mt-10 text-center">
              <p className="text-base font-medium text-navy sm:text-lg">
                Need a plumber in Sheffield or any of these areas?
              </p>
              <Button
                asChild
                size="lg"
