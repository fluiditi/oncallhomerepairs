...
export const metadata: Metadata = {
  title: "CCTV Drain Survey Sheffield | OnCall Home Repairs",
  description:
    "CCTV drain survey in Sheffield. Camera inspection to diagnose drainage problems accurately. Vetted engineers. Call 0333 240 8428.",
  alternates: {
    canonical:
      "https://oncallhomerepairs.co.uk/plumber-sheffield/services/drain-services/cctv-drain-survey",
  },
};
...
export default function CCTVDrainSurveyPage() {
  return (
    <ServicePage
      ...
      h1="CCTV Drain Survey in Sheffield"
      heroIntro={
        <p>
          ...
          engineers in Sheffield who use professional camera equipment to inspect
      ...
      whatWhyContent={
        <>
          ...
          <p>
            Homebuyers in Sheffield increasingly request drain surveys as part
      ...
      serviceAreasHeading="CCTV Drain Surveys Across Sheffield"
      serviceAreasContent={
        <p>
          Our drain engineers carry out CCTV surveys across Sheffield, Ecclesall,
          Crookes, Hillsborough, Nether Edge, Chapeltown, Stocksbridge, and all
      ...
      faqs={[
        {
          question: "How much does a CCTV drain survey cost in Sheffield?",
          answer:
      ...
      ctaContent={
        <p>
          ...
          we will connect you with a drain engineer in Sheffield who can carry
      ...
      serviceDescription="CCTV drain survey in Sheffield. Professional camera inspection to diagnose drainage problems, root intrusion, and pipe damage."
