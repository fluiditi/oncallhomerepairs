...
export const metadata: Metadata = {
  title: "Toilet Repair Sheffield | OnCall Home Repairs",
  description:
    "Toilet repair in Sheffield. Cisterns, flush mechanisms, seals, and installations by vetted plumbers. Call 0333 240 8428.",
  alternates: {
    canonical:
      "https://oncallhomerepairs.co.uk/plumber-sheffield/services/drain-services/toilet-repair",
  },
};
    ...
    <ServicePage
      ...
      heroIntro={
        <p>
          ...
          Sheffield who repair and replace toilet components, cisterns, and
      ...
      whatWhyContent={
        <>
          ...
          <p>
            In properties across Sheffield, hard water deposits also play a role.
      ...
      serviceAreasHeading="Toilet Repair Across Sheffield"
      serviceAreasContent={
        <p>
          Our plumbers carry out toilet repairs across Sheffield, Ecclesall,
          Crookes, Hillsborough, Dore, Totley, and all
      ...
      ctaContent={
        <p>
          ...
          Sheffield who can diagnose and fix the problem &mdash; usually in a
          single visit.
        </p>
      }
      serviceName="Toilet Repair"
      serviceSlug="toilet-repair"
      serviceDescription="Toilet repair in Sheffield. Cistern mechanisms, fill valves, flush faults, and seal replacements by vetted local plumbers."
