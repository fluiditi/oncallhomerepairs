...
export const metadata: Metadata = {
  title: "Blocked Drains Sheffield | OnCall Home Repairs",
  description:
    "Blocked drain clearing in Sheffield. Fast, effective unblocking for homes and businesses. Call 0333 240 8428.",
  alternates: {
    canonical:
      "https://oncallhomerepairs.co.uk/plumber-sheffield/services/drain-services/blocked-drains",
  },
};
...
export default function BlockedDrainsPage() {
  return (
    <ServicePage
      ...
      h1="Blocked Drains in Sheffield"
      heroIntro={
        <p>
          ...
          drainage plumbers in Sheffield who can clear blockages quickly and
      ...
      serviceAreasHeading="Blocked Drain Clearing Across Sheffield"
      serviceAreasContent={
        <p>
          Our drainage plumbers cover Sheffield and every surrounding town and
          village. From terraced properties in Sheffield centre with shared
          drainage runs to detached homes in Ecclesall, Crookes, and Market
      ...
      ctaHeading="Blocked Drain in Sheffield?"
      ctaContent={
        <p>
      ...
      serviceDescription="Blocked drain clearing in Sheffield. Fast, effective unblocking for homes and businesses."
