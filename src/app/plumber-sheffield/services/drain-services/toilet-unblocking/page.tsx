...
export const metadata: Metadata = {
  title: "Toilet Unblocking Sheffield | OnCall Home Repairs",
  description:
    "Toilet unblocking in Sheffield. Fast, hygienic clearance of blocked toilets by vetted plumbers. Call 0333 240 8428.",
  alternates: {
    canonical:
      "https://oncallhomerepairs.co.uk/plumber-sheffield/services/drain-services/toilet-unblocking",
  },
};
    ...
    <ServicePage
      breadcrumbItems={[
        ...
        { name: "Drain Services", href: "/plumber-sheffield/services/drain-services" },
        {
          ...
          href: "/plumber-sheffield/services/drain-services/toilet-unblocking",
        },
      ]}
      h1="Toilet Unblocking in Sheffield"
      heroIntro={
        <p>
          ...
          Sheffield who carry out fast, hygienic toilet unblocking using
      ...
      whatWhyContent={
        <>
          ...
          <p>
            In older Sheffield properties, narrow soil pipes and ageing clay
          ...
          <p>
            ...
            <a
              href="/plumber-sheffield/services/drain-services/drain-unblocking"
              className="text-primary underline underline-offset-2 hover:text-primary/80"
            >
      ...
      serviceAreasHeading="Toilet Unblocking Across Sheffield"
      serviceAreasContent={
        <p>
          Our plumbers attend toilet unblocking jobs across Sheffield, Ecclesall,
          Crookes, Hillsborough, Stocksbridge, Dronfield, and all surrounding areas.
      ...
      ctaContent={
        <p>
          ...
          and we will connect you with a plumber in Sheffield who can clear it
          quickly and discreetly &mdash; same-day where possible.
        </p>
      }
      serviceName="Toilet Unblocking"
      serviceSlug="toilet-unblocking"
      serviceDescription="Fast, hygienic toilet unblocking in Sheffield. Professional clearance of blocked toilets by vetted local plumbers."
