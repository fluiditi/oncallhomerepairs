...
export const metadata: Metadata = {
  title: "Drain Unblocking Sheffield | OnCall Home Repairs",
  description:
    "Professional drain unblocking in Sheffield. High-pressure jetting and manual rodding. Vetted plumbers. Call 0333 240 8428.",
  alternates: {
    canonical:
      "https://oncallhomerepairs.co.uk/plumber-sheffield/services/drain-services/drain-unblocking",
  },
};
...
export default function DrainUnblockingPage() {
  return (
    <ServicePage
      ...
      h1="Drain Unblocking in Sheffield"
      heroIntro={
        <p>
          ...
          experienced drain engineers in Sheffield who use professional-grade
      ...
      whatWhyContent={
        <>
          <p>
            Most drain blockages in Sheffield homes are caused by a gradual
      ...
      serviceAreasHeading="Drain Unblocking Across Sheffield"
      serviceAreasContent={
        <p>
          Our drain engineers cover Sheffield, Ecclesall, Crookes, Hillsborough,
          Broomhill, Walkley, and the surrounding area. External drain
      ...
      ctaContent={
        <p>
          ...
          Sheffield who can clear the blockage and restore full flow.
        </p>
      }
      serviceName="Drain Unblocking"
      serviceSlug="drain-unblocking"
      serviceDescription="Professional drain unblocking in Sheffield using high-pressure jetting and manual rodding. Fast, effective clearance for homes and businesses."
