...
export const metadata: Metadata = {
  title: "Flood Response Plumber Sheffield | OnCall Home Repairs",
  description:
    "Emergency flood response in Sheffield. Rapid water damage control by vetted plumbers, available 24/7. Call 0333 240 8428.",
  alternates: {
    canonical:
      "https://oncallhomerepairs.co.uk/plumber-sheffield/services/emergency-plumbing/flood-response",
  },
};
...
export default function FloodResponsePage() {
  return (
    <ServicePage
      ...
      h1="Flood Response Plumber in Sheffield"
      heroIntro={
        <p>
          ...
          experienced flood response plumbers in Sheffield who can reach your
      ...
      whatWhyContent={
        <>
          ...
          <p>
            Properties across Sheffield, Ecclesall, and the surrounding villages
            are particularly vulnerable during winter months when{" "}
            <a
              href="/plumber-sheffield/services/emergency-plumbing/frozen-pipe-repair"
              className="text-primary underline underline-offset-2 hover:text-primary/80"
            >
              frozen pipes
            </a>{" "}
      ...
      relatedServices={[
        ...
        },
        {
          ...
          href: "/plumber-sheffield/services/emergency-plumbing/stopcock-repair",
        },
        {
      ...
      serviceAreasHeading="Flood Response Across Sheffield and South Yorkshire"
      serviceAreasContent={
        <p>
          Our flood response plumbers cover Sheffield town centre, Ecclesall,
          Crookes, Hillsborough, Dore, and surrounding villages.
          Response times are fastest within the Sheffield and Ecclesall area,
          with the wider South Yorkshire area typically reached
      ...
      ctaContent={
        <p>
          ...
          will have a vetted flood response plumber heading to your Sheffield
          property as quickly as possible.
        </p>
      }
      serviceName="Flood Response"
      serviceSlug="flood-response"
      serviceDescription="Emergency flood response plumber in Sheffield. Rapid water damage control, source isolation, and immediate repair by vetted local plumbers."
