...
export const metadata: Metadata = {
  title: "Burst Pipe Repair Sheffield | OnCall Home Repairs",
  description:
    "Fast burst pipe repair in Sheffield. 24/7 emergency response from vetted plumbers. Transparent pricing. Call 0333 240 8428.",
  alternates: {
    canonical:
      "https://oncallhomerepairs.co.uk/plumber-sheffield/services/emergency-plumbing/burst-pipe-repair",
  },
};
...
export default function BurstPipeRepairPage() {
  return (
    <ServicePage
      ...
      h1="Burst Pipe Repair in Sheffield"
      heroIntro={
        <p>
          ...
          you with vetted, experienced plumbers in the Sheffield area who
      ...
      whatWhyContent={
        <>
          ...
          <p>
            Our network of plumbers in Sheffield arrives equipped with the
      ...
      serviceAreasHeading="Burst Pipe Repair Across Sheffield"
      serviceAreasContent={
        <p>
          We connect homeowners with burst pipe repair plumbers across Sheffield
          and the surrounding villages. Whether you are in Ecclesall, Crookes,
          Hillsborough, or further afield in Walkley or Nether Edge, our
      ...
      ctaHeading="Burst Pipe in Sheffield? Act Now"
      ctaContent={
        <p>
      ...
      serviceDescription="Fast burst pipe repair in Sheffield. Emergency call-out available 24/7."
