...
export const metadata: Metadata = {
  title: "Emergency Plumbing Sheffield | OnCall Home Repairs",
  description:
    "24/7 emergency plumbing in Sheffield. Burst pipes, leaks, flooding. Vetted, Gas Safe plumbers. Call 0333 240 8428.",
  alternates: {
    canonical: "https://oncallhomerepairs.co.uk/plumber-sheffield/services/emergency-plumbing",
  },
};
  ...
  return (
    <CategoryPage
      breadcrumbItems={[
        ...
        { name: "Emergency Plumbing", href: "/plumber-sheffield/services/emergency-plumbing" },
      ]}
      h1="Emergency Plumbing Services in Sheffield"
      heroIntro={
        <>
          <p>
            ...
            registered emergency plumbers across Sheffield and the surrounding
            villages, available 24 hours a day, 7 days a week. Whether it is a{" "}
            <a href="/plumber-sheffield/services/emergency-plumbing/burst-pipe-repair" className="underline hover:text-white">
              burst pipe
            </a>
      ...
      overviewContent={
        <>
          <p>
            ...
            locally based plumbers who can reach properties in Sheffield,
            Ecclesall, Crookes, and beyond — often within the hour.
          </p>
          <p>
          ...
          <p>
            From{" "}
            <a href="/plumber-sheffield/services/emergency-plumbing/leak-detection-repair" className="text-primary underline hover:text-primary/80">
              leak detection and repair
            </a>{" "}
            to{" "}
            <a href="/plumber-sheffield/services/emergency-plumbing/flood-response" className="text-primary underline hover:text-primary/80">
              flood response
            </a>
      ...
      services={[
        {
          ...
          description:
            "Round-the-clock emergency plumber call-out in Sheffield. Fast attendance for urgent leaks, burst pipes, boiler failures, and any plumbing crisis that cannot wait until morning.",
          isCoreService: true,
        },
        {
        ...
        },
        {
          ...
          description:
            "Safe thawing and repair of frozen pipes during cold South Yorkshire winters. Prevents cracks and burst pipes before they cause costly water damage to your property.",
          isCoreService: false,
        },
        {
          name: "Flood Response",
      ...
      differentiators={[
        ...
        },
        {
          ...
          description: (
            <p>
              Our plumbers are based across Sheffield and the surrounding
      ...
      serviceAreasHeading="Emergency Plumbing Across Sheffield and Beyond"
      serviceAreasContent={
        <p>
          Our network of emergency plumbers covers Sheffield town centre and the
          surrounding villages throughout South Yorkshire. Whether you
          are in Ecclesall, Crookes, Hillsborough, or as far as Nether Edge
          and Dronfield, we can connect you with a qualified plumber who knows
      ...
      faqs={[
        {
          question:
            "How quickly can an emergency plumber reach my property in Sheffield?",
          answer:
      ...
      ctaContent={
        <p>
          ...
          we will connect you with a vetted emergency plumber in Sheffield —
          available 24 hours a day, every day of the year.
        </p>
      }
      categoryName="Emergency Plumbing"
      categoryDescription="24/7 emergency plumbing services in Sheffield — burst pipes, leaks, floods, and urgent repairs by vetted, Gas Safe registered plumbers."
