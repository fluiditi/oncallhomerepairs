...
export const metadata: Metadata = {
  title: "Frozen Pipe Repair Sheffield | OnCall Home Repairs",
  description:
    "Frozen pipe repair in Sheffield. Prevent burst pipes this winter. Vetted plumbers, 24/7. Call 0333 240 8428.",
  alternates: {
    canonical:
      "https://oncallhomerepairs.co.uk/plumber-sheffield/services/emergency-plumbing/frozen-pipe-repair",
  },
};
...
export default function FrozenPipeRepairPage() {
  return (
    <ServicePage
      ...
      h1="Frozen Pipe Repair in Sheffield"
      heroIntro={
        <p>
          When temperatures across South Yorkshire drop below freezing, pipes in
      ...
      whatWhyHeading="Why Frozen Pipes Are a Serious Risk in Sheffield"
      whatWhyContent={
        <>
          <p>
            Sheffield sits in the East Midlands where winter temperatures
          ...
          <p>
            ...
            understands the specific risks South Yorkshire winters pose to local
      ...
      serviceAreasHeading="Frozen Pipe Repair Across Sheffield"
      serviceAreasContent={
        <p>
          Our plumbers attend frozen pipe emergencies across Sheffield, Ecclesall,
          Crookes, Hillsborough, and the surrounding villages. Properties in
          ...
          South Yorkshire, we can connect you with a plumber who
      ...
      faqs={[
        ...
        {
          question:
            "How much does frozen pipe repair cost in Sheffield?",
          answer:
      ...
      ctaContent={
        <p>
          ...
          Home Repairs and we will connect you with a vetted plumber in Sheffield
      ...
      serviceDescription="Frozen pipe thawing and repair in Sheffield. Prevent burst pipes this winter with safe, professional pipe repair from vetted local plumbers."
