...
export const metadata: Metadata = {
  title: "Leak Detection Sheffield | OnCall Home Repairs",
  description:
    "Professional leak detection and repair in Sheffield. Find and fix hidden leaks fast. Transparent pricing. Call 0333 240 8428.",
  alternates: {
    canonical:
      "https://oncallhomerepairs.co.uk/plumber-sheffield/services/emergency-plumbing/leak-detection-repair",
  },
};
...
export default function LeakDetectionRepairPage() {
  return (
    <ServicePage
      ...
      h1="Leak Detection and Repair in Sheffield"
      heroIntro={
        <p>
          ...
          connects you with skilled plumbers in Sheffield who specialise in
      ...
      whatWhyContent={
        <>
          ...
          <p>
            In Sheffield, many homes are built with traditional construction
          ...
          <p>
            ...
            <Link
              href="/plumber-sheffield/services/emergency-plumbing/overflow-repair"
              className="text-primary underline underline-offset-2 hover:text-primary/80"
            >
              overflowing cistern
            </Link>{" "}
      ...
      benefits={[
        ...
        },
        {
          ...
          description: (
            <p>
              Every plumber in our Sheffield network is qualified, insured, and
      ...
      serviceAreasHeading="Leak Detection Across Sheffield"
      serviceAreasContent={
        <p>
          Our leak detection service covers Sheffield and all nearby towns and
          villages. From Victorian terraces in Sheffield centre to modern estates
          in Ecclesall and Crookes, our plumbers are experienced with the
          property types and plumbing systems found across the area. Whether
          your leak is in a ground-floor flat in Hillsborough or a detached house in
          Fulwood, we can match you with someone local who can investigate
          promptly.
        </p>
      }
      faqs={[
      ...
      ctaHeading="Suspect a Leak in Your Sheffield Home?"
      ctaContent={
        <p>
      ...
      serviceDescription="Professional leak detection and repair in Sheffield. Find and fix hidden leaks fast."
