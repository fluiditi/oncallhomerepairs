...
export const metadata: Metadata = {
  title: "Boiler Servicing Sheffield | OnCall Home Repairs",
  description:
    "Annual boiler servicing in Sheffield. Keep your warranty valid and your boiler running efficiently. Gas Safe engineers. Call 0333 240 8428.",
  alternates: {
    canonical:
      "https://oncallhomerepairs.co.uk/plumber-sheffield/services/boiler-heating/boiler-servicing",
  },
};
...
export default function BoilerServicingPage() {
  return (
    <ServicePage
      ...
      h1="Boiler Servicing in Sheffield"
      heroIntro={
        <p>
          ...
          connects you with Gas Safe registered engineers in Sheffield who carry
      ...
      serviceAreasHeading="Boiler Servicing Across Sheffield"
      serviceAreasContent={
        <p>
          Our Gas Safe registered engineers service boilers across Sheffield,
          Ecclesall, Crookes, Hillsborough, Totley, Dore, and
      ...
      ctaContent={
        <p>
          ...
          Gas Safe registered engineer in Sheffield.
        </p>
      }
      serviceName="Boiler Servicing"
      serviceSlug="boiler-servicing"
      serviceDescription="Annual boiler servicing in Sheffield by Gas Safe registered engineers. Manufacturer warranty protection, safety checks, and efficiency testing."
