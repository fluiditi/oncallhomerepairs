...
export const metadata: Metadata = {
  title: "Boiler Installation Sheffield | OnCall Home Repairs",
  description:
    "New boiler installation in Sheffield. Gas Safe engineers, competitive quotes, workmanship guarantee. Call 0333 240 8428.",
  alternates: {
    canonical:
      "https://oncallhomerepairs.co.uk/plumber-sheffield/services/boiler-heating/boiler-installation",
  },
};
...
export default function BoilerInstallationPage() {
  return (
    <ServicePage
      ...
      h1="Boiler Installation in Sheffield"
      heroIntro={
        <p>
          ...
          you with Gas Safe registered heating engineers in Sheffield who carry
      ...
      serviceAreasHeading="Boiler Installation Across Sheffield"
      serviceAreasContent={
        <p>
          We connect homeowners across Sheffield and South Yorkshire
          with qualified boiler installers. Whether you are in the centre of
          Sheffield, in Ecclesall, Crookes, or one of the surrounding
          ...
          of South Yorkshire and can advise on the best boiler setup for your
          home.
        </p>
      }
      faqs={[
        {
          question: "How much does a new boiler installation cost in Sheffield?",
          answer:
      ...
      ctaHeading="Ready for a New Boiler in Sheffield?"
      ctaContent={
        <p>
      ...
      serviceDescription="New boiler installation in Sheffield. Gas Safe registered, competitive pricing."
