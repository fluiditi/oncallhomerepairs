...
export const metadata: Metadata = {
  title: "Gas Safety Check Sheffield | OnCall Home Repairs",
  description:
    "Gas safety checks and CP12 certificates in Sheffield. For landlords and homeowners. Gas Safe registered engineers. Call 0333 240 8428.",
  alternates: {
    canonical:
      "https://oncallhomerepairs.co.uk/plumber-sheffield/services/boiler-heating/gas-safety-checks",
  },
};
...
export default function GasSafetyChecksPage() {
  return (
    <ServicePage
      ...
      h1="Gas Safety Checks in Sheffield"
      heroIntro={
        <p>
          ...
          Sheffield who carry out thorough inspections of your boiler, gas
      ...
      serviceAreasHeading="Gas Safety Checks Across Sheffield"
      serviceAreasContent={
        <p>
          Our Gas Safe registered engineers carry out gas safety checks across
          Sheffield, Ecclesall, Crookes, Hillsborough, Dore, Fulwood,
          Stocksbridge, Dronfield, and all surrounding areas. Landlords with multiple
      ...
      faqs={[
        {
          question: "How much does a gas safety check cost in Sheffield?",
          answer:
      ...
      ctaContent={
        <p>
          ...
          engineer in Sheffield for your annual gas safety check.
        </p>
      }
      serviceName="Gas Safety Checks"
      serviceSlug="gas-safety-checks"
      serviceDescription="Gas safety checks and CP12 certificates in Sheffield. Annual inspections for landlords and homeowners by Gas Safe registered engineers."
