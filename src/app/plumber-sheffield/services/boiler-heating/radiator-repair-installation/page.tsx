...
export const metadata: Metadata = {
  title: "Radiator Repair Sheffield | OnCall Home Repairs",
  description:
    "Radiator repair and installation in Sheffield. Fix cold spots, leaks, and add new radiators. Gas Safe engineers. Call 0333 240 8428.",
  alternates: {
    canonical:
      "https://oncallhomerepairs.co.uk/plumber-sheffield/services/boiler-heating/radiator-repair-installation",
  },
};
...
export default function RadiatorRepairPage() {
  return (
    <ServicePage
      ...
      h1="Radiator Repair and Installation in Sheffield"
      heroIntro={
        <p>
          ...
          Sheffield who can diagnose radiator faults, carry out repairs, and
      ...
      whatWhyHeading="Common Radiator Problems in Sheffield Homes"
      whatWhyContent={
        <>
          <p>
          ...
          <p>
            South Yorkshire&rsquo;s hard water accelerates the build-up of
            limescale and sludge in central heating systems. Many homes in
            Sheffield, Ecclesall, and the surrounding area have heating systems
      ...
      serviceAreasHeading="Radiator Repair Across Sheffield"
      serviceAreasContent={
        <p>
          Our heating engineers carry out radiator repairs and installations
          across Sheffield, Ecclesall, Crookes, Hillsborough, Fulwood, Chapeltown,
          and the wider South Yorkshire area. Whether you need a
      ...
      ctaContent={
        <p>
          ...
          in Sheffield who can get your radiators working as they should.
        </p>
      }
      serviceName="Radiator Repair and Installation"
      serviceSlug="radiator-repair-installation"
      serviceDescription="Radiator repair and installation in Sheffield. Fix cold spots, leaking valves, and add new radiators with qualified heating engineers."
