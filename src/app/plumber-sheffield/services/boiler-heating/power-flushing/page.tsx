...
export const metadata: Metadata = {
  title: "Power Flushing Sheffield | OnCall Home Repairs",
  description:
    "Power flushing in Sheffield. Remove sludge and restore heating efficiency. Gas Safe engineers, transparent pricing. Call 0333 240 8428.",
  alternates: {
    canonical:
      "https://oncallhomerepairs.co.uk/plumber-sheffield/services/boiler-heating/power-flushing",
  },
};
...
export default function PowerFlushingPage() {
  return (
    <ServicePage
      ...
      h1="Power Flushing in Sheffield"
      heroIntro={
        <p>
          ...
          connects you with qualified engineers in Sheffield who carry out
      ...
      whatWhyContent={
        <>
          ...
          <p>
            ...
            sludge. South Yorkshire&rsquo;s hard water makes this worse by adding
      ...
      serviceAreasHeading="Power Flushing Across Sheffield"
      serviceAreasContent={
        <p>
          Our engineers carry out power flushing across Sheffield, Ecclesall, Crookes,
          Hillsborough, Walkley, Nether Edge, and surrounding
      ...
      ctaContent={
        <p>
          ...
          Repairs and we will connect you with a qualified engineer in Sheffield
          who can carry out a professional power flush on your system.
        </p>
      }
      serviceName="Power Flushing"
      serviceSlug="power-flushing"
      serviceDescription="Power flushing in Sheffield. Remove sludge and limescale from your central heating system to restore efficiency and prevent boiler breakdowns."
