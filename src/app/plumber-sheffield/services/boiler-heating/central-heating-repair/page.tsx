...
export const metadata: Metadata = {
  title: "Central Heating Repair Sheffield | OnCall Home Repairs",
  description:
    "Central heating repair in Sheffield. Radiators, pumps, valves, thermostats. Gas Safe engineers. Call 0333 240 8428.",
  alternates: {
    canonical:
      "https://oncallhomerepairs.co.uk/plumber-sheffield/services/boiler-heating/central-heating-repair",
  },
};
...
export default function CentralHeatingRepairPage() {
  return (
    <ServicePage
      ...
      h1="Central Heating Repair in Sheffield"
      heroIntro={
        <p>
          When your central heating is not working properly, your home becomes
          uncomfortable fast — especially during a South Yorkshire winter. Cold
          ...
          engineers in Sheffield who diagnose and repair central heating faults
      ...
      whatWhyContent={
        <>
          ...
          <p>
            ...
            <Link
              href="/plumber-sheffield/services/boiler-heating/power-flushing"
              className="text-primary underline underline-offset-2 hover:text-primary/80"
            >
              power flush
            </Link>{" "}
      ...
      benefits={[
        {
          ...
          description: (
            <p>
              ...
              systems and understand the common faults found in Sheffield
              properties.
            </p>
          ),
        },
      ...
      relatedServices={[
        ...
        },
        {
          ...
          href: "/plumber-sheffield/services/boiler-heating/radiator-repair-installation",
        },
        {
          name: "Power Flushing",
          href: "/plumber-sheffield/services/boiler-heating/power-flushing",
        },
        {
          ...
          href: "/plumber-sheffield/services/boiler-heating/boiler-servicing",
        },
      ]}
      serviceAreasHeading="Central Heating Repair Across Sheffield"
      serviceAreasContent={
        <p>
          Our heating engineers cover Sheffield and the surrounding towns and
          villages throughout South Yorkshire. From older properties
          in Sheffield town centre to newer-build estates in Hillsborough, Totley,
          and Dore, our engineers are familiar with the heating
      ...
      ctaContent={
        <p>
          ...
          a qualified heating engineer in Sheffield who can diagnose and fix the
      ...
      serviceDescription="Central heating repair in Sheffield. Radiators, pumps, valves, and full system diagnostics."
