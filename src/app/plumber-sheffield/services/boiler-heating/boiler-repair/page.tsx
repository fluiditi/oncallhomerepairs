...
export const metadata: Metadata = {
  title: "Boiler Repair Sheffield | OnCall Home Repairs",
  description:
    "Boiler repair in Sheffield by Gas Safe engineers. Same-day repairs, upfront quotes. Available 24/7. Call 0333 240 8428.",
  alternates: {
    canonical:
      "https://oncallhomerepairs.co.uk/plumber-sheffield/services/boiler-heating/boiler-repair",
  },
};
    ...
    <ServicePage
      ...
      heroIntro={
        <p>
          ...
          with Gas Safe registered heating engineers in Sheffield who diagnose
        ...
        },
        {
          ...
          description: (
            <p>
              ...
              Sheffield. For emergency breakdowns, engineers are available 24/7.
      ...
      serviceAreasHeading="Boiler Repair Across Sheffield"
      serviceAreasContent={
        <p>
          Our network of Gas Safe heating engineers covers Sheffield and the
          surrounding area. Whether you live in Ecclesall, Crookes, Hillsborough,
          or one of the smaller villages like Walkley or Broomhill, we
          ...
          properties across South Yorkshire.
        </p>
      }
      faqs={[
        {
      ...
      ctaContent={
        <p>
          ...
          a Gas Safe registered engineer in Sheffield. Upfront pricing,
      ...
      serviceDescription="Expert boiler repair in Sheffield. Gas Safe registered engineers available 24/7."
