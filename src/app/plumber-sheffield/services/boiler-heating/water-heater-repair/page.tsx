...
export const metadata: Metadata = {
  title: "Water Heater Repair Sheffield | OnCall Home Repairs",
  description:
    "Water heater repair in Sheffield. Immersion heaters, cylinders, and unvented systems. Vetted plumbers. Call 0333 240 8428.",
  alternates: {
    canonical:
      "https://oncallhomerepairs.co.uk/plumber-sheffield/services/boiler-heating/water-heater-repair",
  },
};
    ...
    <ServicePage
      breadcrumbItems={[
        ...
        { name: "Boiler & Heating", href: "/plumber-sheffield/services/boiler-heating" },
        {
          ...
          href: "/plumber-sheffield/services/boiler-heating/water-heater-repair",
        },
      ]}
      h1="Water Heater Repair in Sheffield"
      heroIntro={
        <p>
          ...
          you with qualified plumbers and heating engineers in Sheffield who can
      ...
      whatWhyContent={
        <>
          <p>
            Hot water systems vary considerably across Sheffield properties.
          ...
          <p>
            ...
            areas like South Yorkshire, and eventually stops working. The
      ...
      serviceAreasHeading="Water Heater Repair Across Sheffield"
      serviceAreasContent={
        <p>
          Our plumbers and heating engineers attend water heater repairs across
          Sheffield, Ecclesall, Crookes, Hillsborough, Woodseats, Totley, and
      ...
      faqs={[
        {
          ...
          answer:
            "The most common cause is a failed heating element. Hard water areas like Sheffield accelerate limescale build-up on the element, which causes it to overheat and burn out. The thermostat can also fail independently. A plumber can test both components and replace whichever has failed.",
        },
        {
          question:
      ...
      ctaContent={
        <p>
          ...
          Sheffield who can restore your hot water supply.
        </p>
      }
      serviceName="Water Heater Repair"
      serviceSlug="water-heater-repair"
      serviceDescription="Water heater repair in Sheffield. Immersion heaters, hot water cylinders, and unvented systems repaired by qualified local plumbers."
