...
export const metadata: Metadata = {
  title: "Boiler & Heating Sheffield | OnCall Home Repairs",
  description:
    "Boiler repair, installation, and heating services in Sheffield. Gas Safe registered plumbers. Call 0333 240 8428.",
  alternates: {
    canonical: "https://oncallhomerepairs.co.uk/plumber-sheffield/services/boiler-heating",
  },
};
  ...
  return (
    <CategoryPage
      breadcrumbItems={[
        ...
        { name: "Boiler & Heating", href: "/plumber-sheffield/services/boiler-heating" },
      ]}
      h1="Boiler & Heating Services in Sheffield"
      heroIntro={
        <>
          <p>
            ...
            Safe registered heating engineers across Sheffield who can diagnose,
            repair, and install boilers and central heating systems. From an
            urgent{" "}
            <a href="/plumber-sheffield/services/boiler-heating/boiler-repair" className="underline hover:text-white">
              boiler repair
            </a>{" "}
            to a planned{" "}
            <a href="/plumber-sheffield/services/boiler-heating/boiler-installation" className="underline hover:text-white">
      ...
      overviewHeading="Expert Boiler and Heating Care for Sheffield Homes"
      overviewContent={
        <>
          <p>
          ...
          <p>
            ...
            for routine{" "}
            <a href="/plumber-sheffield/services/boiler-heating/boiler-servicing" className="text-primary underline hover:text-primary/80">
              boiler servicing
            </a>
            ,{" "}
            <a href="/plumber-sheffield/services/boiler-heating/radiator-repair-installation" className="text-primary underline hover:text-primary/80">
              radiator repairs
            </a>
            , and{" "}
            <a href="/plumber-sheffield/services/boiler-heating/power-flushing" className="text-primary underline hover:text-primary/80">
              power flushing
            </a>{" "}
      ...
      services={[
        {
          ...
          slug: "boiler-repair",
          description:
            "Fast boiler repair by Gas Safe engineers in Sheffield. Fault diagnosis and repair for all major brands — Worcester Bosch, Vaillant, Baxi, Ideal, and more.",
          isCoreService: true,
        },
        {
        ...
        },
        {
          ...
          description: (
            <p>
              ...
              for urgent heating repairs in Sheffield.
            </p>
          ),
        },
        {
      ...
      crossLinks={[
        {
          ...
          description:
            "Burst pipes, major leaks, and flooding — 24/7 emergency plumber attendance across Sheffield.",
        },
        {
      ...
      serviceAreasHeading="Boiler & Heating Services Across Sheffield"
      serviceAreasContent={
        <p>
          Our network of Gas Safe heating engineers covers Sheffield and the
          surrounding areas of South Yorkshire. From Ecclesall and
          Crookes to Walkley, Fulwood, and Stocksbridge, we connect you
      ...
      ctaContent={
        <p>
          ...
          registered heating engineer in Sheffield. Whether it is a repair, a
          service, or a full boiler replacement, we match you with the right
          person for the job.
        </p>
      }
      categoryName="Boiler & Heating"
      categoryDescription="Boiler repair, installation, servicing, and central heating services in Sheffield by Gas Safe registered engineers."
