...
export const metadata: Metadata = {
  title: "Kitchen Plumber Sheffield | OnCall Home Repairs",
  description:
    "Kitchen plumbing in Sheffield. Sink installations, dishwasher connections, waste disposal, and repairs. Call 0333 240 8428.",
  alternates: {
    canonical:
      "https://oncallhomerepairs.co.uk/plumber-sheffield/services/general-plumbing/kitchen-plumbing",
  },
};
...
export default function KitchenPlumbingPage() {
  return (
    <ServicePage
      ...
      h1="Kitchen Plumbing in Sheffield"
      heroIntro={
        <p>
          ...
          Sheffield who install, repair, and maintain kitchen plumbing &mdash;
      ...
      whatWhyContent={
        <>
          ...
          <p>
            Blocked kitchen sinks are a regular call-out in Sheffield. Grease,
      ...
      serviceAreasHeading="Kitchen Plumbing Across Sheffield"
      serviceAreasContent={
        <p>
          Our plumbers carry out kitchen plumbing work across Sheffield,
          Ecclesall, Crookes, Hillsborough, Walkley, Broomhill, Market
      ...
      ctaContent={
        <p>
          ...
          Repairs will match you with a qualified plumber in Sheffield. Call
          for a clear, upfront quote.
        </p>
      }
      serviceName="Kitchen Plumbing"
      serviceSlug="kitchen-plumbing"
      serviceDescription="Kitchen plumbing in Sheffield. Sink installations, appliance connections, waste pipe repairs, and full kitchen plumbing by vetted local plumbers."
