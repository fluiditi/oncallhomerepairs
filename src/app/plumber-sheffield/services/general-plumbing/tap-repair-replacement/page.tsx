...
export const metadata: Metadata = {
  title: "Tap Repair Sheffield | OnCall Home Repairs",
  description:
    "Tap repair and replacement in Sheffield. Fix dripping taps and install new ones. Vetted plumbers, transparent pricing. Call 0333 240 8428.",
  alternates: {
    canonical:
      "https://oncallhomerepairs.co.uk/plumber-sheffield/services/general-plumbing/tap-repair-replacement",
  },
};
...
export default function TapRepairPage() {
  return (
    <ServicePage
      ...
      h1="Tap Repair and Replacement in Sheffield"
      heroIntro={
        <p>
          ...
          Home Repairs connects you with plumbers in Sheffield who can fix
      ...
      whatWhyContent={
        <>
          <p>
            ...
            South Yorkshire, the hard water supply accelerates wear on internal
      ...
      serviceAreasHeading="Tap Repair Across Sheffield"
      serviceAreasContent={
        <p>
          Our plumbers repair and replace taps across Sheffield, Ecclesall, Crookes,
          Hillsborough, Fulwood, Chapeltown, and the surrounding area. Tap
      ...
      ctaContent={
        <p>
          ...
          will connect you with a plumber in Sheffield who can repair or
      ...
      serviceDescription="Tap repair and replacement in Sheffield. Fix dripping taps, replace worn components, and install new taps with vetted local plumbers."
