...
export const metadata: Metadata = {
  title: "Pipe Replacement Sheffield | OnCall Home Repairs",
  description:
    "Pipe replacement in Sheffield. Copper, plastic, and lead pipe upgrades by vetted plumbers. Transparent pricing. Call 0333 240 8428.",
  alternates: {
    canonical:
      "https://oncallhomerepairs.co.uk/plumber-sheffield/services/general-plumbing/pipe-replacement",
  },
};
...
export default function PipeReplacementPage() {
  return (
    <ServicePage
      ...
      h1="Pipe Replacement in Sheffield"
      heroIntro={
        <p>
          ...
          connects you with qualified plumbers in Sheffield who replace old
      ...
      whatWhyContent={
        <>
          <p>
            ...
            Sheffield properties &mdash; pose a health risk and should be
      ...
      serviceAreasHeading="Pipe Replacement Across Sheffield"
      serviceAreasContent={
        <p>
          Our plumbers replace pipework in properties across Sheffield, Ecclesall,
          Crookes, Hillsborough, Dronfield, Stocksbridge, and all surrounding areas.
      ...
      ctaContent={
        <p>
          ...
          in Sheffield who can assess your pipes and carry out replacements
          that last.
        </p>
      }
      serviceName="Pipe Replacement"
      serviceSlug="pipe-replacement"
      serviceDescription="Pipe replacement in Sheffield. Copper, plastic, and lead pipe upgrades for homes and businesses by vetted local plumbers."
