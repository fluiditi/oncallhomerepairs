...
export const metadata: Metadata = {
  title: "Bathroom Plumber Sheffield | OnCall Home Repairs",
  description:
    "Bathroom plumbing in Sheffield. Installations, repairs, full refits. Vetted plumbers, upfront quotes. Call 0333 240 8428.",
  alternates: {
    canonical:
      "https://oncallhomerepairs.co.uk/plumber-sheffield/services/general-plumbing/bathroom-plumbing",
  },
};
...
export default function BathroomPlumbingPage() {
  return (
    <ServicePage
      ...
      h1="Bathroom Plumbing in Sheffield"
      heroIntro={
        <p>
          ...
          vetted, experienced plumbers in Sheffield who handle all aspects of
      ...
      whatWhyContent={
        <>
          ...
          <p>
            ...
            will support the{" "}
            <Link
              href="/plumber-sheffield/services/general-plumbing/shower-installation-repair"
              className="text-primary underline underline-offset-2 hover:text-primary/80"
            >
              shower
            </Link>{" "}
        ...
        },
        {
          ...
          description: (
            <p>
              ...
              in Sheffield properties — from Victorian terraces with old lead
      ...
      relatedServices={[
        ...
        {
          name: "Toilet Repair",
          href: "/plumber-sheffield/services/drain-services/toilet-repair",
        },
        {
          name: "Kitchen Plumbing",
          href: "/plumber-sheffield/services/general-plumbing/kitchen-plumbing",
        },
      ]}
      serviceAreasHeading="Bathroom Plumbing Across Sheffield"
      serviceAreasContent={
        <p>
          Our bathroom plumbers serve Sheffield and all surrounding areas. From
          period properties in the town centre that need careful pipework
          modifications to new-build homes in Woodseats, Chapeltown, and Stocksbridge
          that need a shower upgrade or suite replacement, our plumbers have
          the experience to handle it. We cover Ecclesall, Crookes, Hillsborough,
          Dronfield, and all villages in between.
        </p>
      }
      faqs={[
        {
      ...
      ctaHeading="Need a Bathroom Plumber in Sheffield?"
      ctaContent={
        <p>
      ...
      serviceDescription="Bathroom plumbing in Sheffield. Installations, repairs, and full bathroom fit-outs."
