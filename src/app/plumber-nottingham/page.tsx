...
const faqs = [
  {
    question: "How much does a plumber cost in Nottingham?",
    answer:
      "Plumbing costs in Nottingham vary depending on the job. A straightforward tap repair might cost between \u00a380 and \u00a3150, while a full boiler installation typically ranges from \u00a31,500 to \u00a33,500. Emergency callouts outside normal hours may carry a higher rate. Every job through OnCall Home Repairs starts with a clear, upfront quote \u2014 so you\u2019ll always know the cost before work begins.",
    answerJsx: (
      <>
        Plumbing costs in Nottingham vary depending on the job. A straightforward{" "}
        <a
          href="/plumber-nottingham/services/general-plumbing/tap-repair-replacement"
  ...
  {
    question: "Do you offer 24-hour emergency plumbing in Nottingham?",
    answer:
    ...
    answerJsx: (
      <>
        Yes. Our network of{" "}
        <a
          href="/plumber-nottingham/services/emergency-plumbing"
          className="text-primary underline underline-offset-2 hover:text-primary/80"
        >
          emergency plumbers
        </a>{" "}
  ...
  {
    question: "How quickly can a plumber get to my home in Nottingham?",
    answer:
      "For emergencies in Nottingham town centre and West Bridgford, a plumber can typically reach your property within an hour. For the wider service area including Beeston, Arnold, and surrounding villages, response times are usually within 90 minutes. Non-emergency appointments are scheduled at a time that works for you.",
    answerJsx: null,
  },
  {
  ...
  {
    question: "What areas near Nottingham do you cover?",
    answer:
      "We cover Nottingham and 18 surrounding towns and villages: West Bridgford, Beeston, Arnold, Carlton, Hucknall, Mapperley, Sherwood, Bulwell, Gedling, Long Eaton, Stapleford, Ruddington, Bingham, Radcliffe-on-Trent, Netherfield, West Bridgford, Beeston, and Arnold. If you\u2019re not sure whether your area is covered, call 0333 240 8428 and we\u2019ll confirm.",
    answerJsx: (
      <>
        We cover Nottingham and 18 surrounding towns and villages: West Bridgford, Beeston,
        Arnold, Carlton, Hucknall, Mapperley, Sherwood,
        Bulwell, Gedling, Long Eaton, Stapleford, Ruddington, Bingham,
        Radcliffe-on-Trent, Netherfield, West Bridgford, Beeston, and Arnold. If
...
const services = [
    ...
    keyServices: [
      {
        ...
        href: "/plumber-nottingham/services/emergency-plumbing/emergency-plumber",
      },
      {
  ...
  },
  {
    ...
    keyServices: [
      { name: "Boiler repair", href: "/plumber-nottingham/services/boiler-heating/boiler-repair" },
      {
    ...
    href: "/plumber-nottingham/services/boiler-heating",
  ...
  },
  {
    ...
    href: "/plumber-nottingham/services/drain-services",
  ...
  },
  {
    ...
    href: "/plumber-nottingham/services/general-plumbing",
...
const differentiators = [
  {
    ...
    description:
      "Plumbing emergencies don\u2019t wait for office hours. Our network of Nottingham plumbers is available around the clock \u2014 at 3am on a Wednesday, on Christmas Day, on a bank holiday Monday. When you call 0333 240 8428, a real person answers and gets a plumber moving toward your property.",
  },
  {
    icon: ShieldCheck,
  ...
  {
    icon: MapPin,
    title: "Local to Nottingham",
    description:
      "This isn\u2019t a faceless national company routing calls to whoever\u2019s cheapest. Our plumbers live and work in and around Nottingham. They know the local housing stock, the common problems with Nottinghamshire properties, and they can reach your home quickly.",
  },
];
...
const steps = [
  ...
  },
  {
    ...
    description:
      "Based on your location, the type of job, and availability, we match you with a vetted, qualified plumber from our Nottingham network. For emergencies, this happens immediately.",
  },
  {
    number: "03",
    ...
    <main>
      ...
      <section className="relative overflow-hidden bg-navy text-white">
        ...
        <div className="relative mx-auto max-w-7xl px-4 py-20 sm:px-6 sm:py-28 lg:px-8 lg:py-36">
          ...
          >
            ...
            >
              Emergency Plumber in Nottingham{" "}
            ...
            >
              ...
              Nottingham home, OnCall Home Repairs connects you with a vetted,
            ...
            >
              ...
              >
                <a href="/plumber-nottingham/contact">
                  Get a Plumber Now
        ...
        >
          <div className="mx-auto max-w-3xl">
            <h2 className="font-heading text-3xl font-bold tracking-tight text-navy sm:text-4xl">
              Dealing With a Plumbing Emergency in Nottingham?
            </h2>
            ...
            <div className="mt-8 space-y-6 text-base leading-relaxed text-muted-foreground sm:text-lg">
              ...
              <p>
                If you live in Nottingham, you know the frustration. Many of the
                town&rsquo;s older Victorian and Edwardian properties run on
                ageing pipework that wasn&rsquo;t built for modern demands.
                Nottinghamshire&rsquo;s hard water accelerates limescale build-up
              ...
              <p>
                ...
                Nottingham homeowners with{" "}
                <a
                  href="/plumber-nottingham/about"
      ...
      <section className="bg-blue-soft py-20 sm:py-28">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          >
            <h2 className="font-heading text-3xl font-bold tracking-tight text-navy sm:text-4xl">
              Our Plumbing Services in Nottingham
            </h2>
          ...
          >
            <Button asChild variant="outline" size="lg" className="rounded-xl">
              <a href="/plumber-nottingham/services">
                View All Services
      ...
      <section className="bg-white py-20 sm:py-28">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          >
            <h2 className="font-heading text-3xl font-bold tracking-tight text-navy sm:text-4xl">
              Why Nottingham Homeowners Choose OnCall Home Repairs
            </h2>
          </motion.div>
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="mx-auto mt-4 max-w-xl text-base text-muted-foreground sm:text-lg">
              Getting a qualified plumber to your Nottingham home is simple.
            </p>
          </motion.div>
        ...
        >
          <div className="mx-auto max-w-3xl">
            <div className="mb-6 flex items-center justify-center">
              ...
              <h2 className="font-heading text-3xl font-bold tracking-tight text-navy sm:text-4xl">
                Plumber Covering Nottingham and Nottinghamshire
              </h2>
            </div>

            <div className="mt-8 space-y-6 text-base leading-relaxed text-muted-foreground sm:text-lg">
              <p>
                OnCall Home Repairs connects homeowners across Nottingham and the
                surrounding Nottinghamshire towns and villages with qualified
                local plumbers. Our network covers West Bridgford, Beeston, and
                Arnold to the south, as well as the villages of Carlton,
                Hucknall, and Mapperley.
              </p>
              <p>
                To the west, we serve Sherwood and Bulwell, and our
                coverage extends north to Gedling and Long Eaton. We also
                cover Stapleford, Ruddington, Bingham, Radcliffe-on-Trent, Netherfield,
                West Bridgford, Beeston, and Arnold.
              </p>
              <p>
                Wherever you are in the Nottingham area, a vetted plumber from our
                network can reach your home quickly. For emergencies, response
                times are fastest within Nottingham town centre and West Bridgford, with
            ...
            <div className="mt-10 text-center">
              <p className="text-base font-medium text-navy sm:text-lg">
                Need a plumber in Nottingham or any of these areas?
              </p>
              <Button
                asChild
                size="lg"
