...
export const metadata: Metadata = {
  title: "Radiator Repair Nottingham | OnCall Home Repairs",
  description:
    "Radiator repair and installation in Nottingham. Fix cold spots, leaks, and add new radiators. Gas Safe engineers. Call 0333 240 8428.",
  alternates: {
    canonical:
      "https://oncallhomerepairs.co.uk/plumber-nottingham/services/boiler-heating/radiator-repair-installation",
  },
};
...
export default function RadiatorRepairPage() {
  return (
    <ServicePage
      ...
      h1="Radiator Repair and Installation in Nottingham"
      heroIntro={
        <p>
          ...
          Nottingham who can diagnose radiator faults, carry out repairs, and
      ...
      whatWhyHeading="Common Radiator Problems in Nottingham Homes"
      whatWhyContent={
        <>
          <p>
          ...
          <p>
            Nottinghamshire&rsquo;s hard water accelerates the build-up of
            limescale and sludge in central heating systems. Many homes in
            Nottingham, West Bridgford, and the surrounding area have heating systems
      ...
      serviceAreasHeading="Radiator Repair Across Nottingham"
      serviceAreasContent={
        <p>
          Our heating engineers carry out radiator repairs and installations
          across Nottingham, West Bridgford, Beeston, Arnold, Long Eaton, Stapleford,
          and the wider Nottinghamshire area. Whether you need a
      ...
      ctaContent={
        <p>
          ...
          in Nottingham who can get your radiators working as they should.
        </p>
      }
      serviceName="Radiator Repair and Installation"
      serviceSlug="radiator-repair-installation"
      serviceDescription="Radiator repair and installation in Nottingham. Fix cold spots, leaking valves, and add new radiators with qualified heating engineers."
