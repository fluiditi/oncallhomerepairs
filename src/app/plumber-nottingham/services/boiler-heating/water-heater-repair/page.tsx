...
export const metadata: Metadata = {
  title: "Water Heater Repair Nottingham | OnCall Home Repairs",
  description:
    "Water heater repair in Nottingham. Immersion heaters, cylinders, and unvented systems. Vetted plumbers. Call 0333 240 8428.",
  alternates: {
    canonical:
      "https://oncallhomerepairs.co.uk/plumber-nottingham/services/boiler-heating/water-heater-repair",
  },
};
    ...
    <ServicePage
      breadcrumbItems={[
        ...
        { name: "Boiler & Heating", href: "/plumber-nottingham/services/boiler-heating" },
        {
          ...
          href: "/plumber-nottingham/services/boiler-heating/water-heater-repair",
        },
      ]}
      h1="Water Heater Repair in Nottingham"
      heroIntro={
        <p>
          ...
          you with qualified plumbers and heating engineers in Nottingham who can
      ...
      whatWhyContent={
        <>
          <p>
            Hot water systems vary considerably across Nottingham properties.
          ...
          <p>
            ...
            areas like Nottinghamshire, and eventually stops working. The
      ...
      serviceAreasHeading="Water Heater Repair Across Nottingham"
      serviceAreasContent={
        <p>
          Our plumbers and heating engineers attend water heater repairs across
          Nottingham, West Bridgford, Beeston, Arnold, Mapperley, Hucknall, and
      ...
      faqs={[
        {
          ...
          answer:
            "The most common cause is a failed heating element. Hard water areas like Nottingham accelerate limescale build-up on the element, which causes it to overheat and burn out. The thermostat can also fail independently. A plumber can test both components and replace whichever has failed.",
        },
        {
          question:
      ...
      ctaContent={
        <p>
          ...
          Nottingham who can restore your hot water supply.
        </p>
      }
      serviceName="Water Heater Repair"
      serviceSlug="water-heater-repair"
      serviceDescription="Water heater repair in Nottingham. Immersion heaters, hot water cylinders, and unvented systems repaired by qualified local plumbers."
