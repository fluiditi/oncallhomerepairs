...
export const metadata: Metadata = {
  title: "Power Flushing Nottingham | OnCall Home Repairs",
  description:
    "Power flushing in Nottingham. Remove sludge and restore heating efficiency. Gas Safe engineers, transparent pricing. Call 0333 240 8428.",
  alternates: {
    canonical:
      "https://oncallhomerepairs.co.uk/plumber-nottingham/services/boiler-heating/power-flushing",
  },
};
...
export default function PowerFlushingPage() {
  return (
    <ServicePage
      ...
      h1="Power Flushing in Nottingham"
      heroIntro={
        <p>
          ...
          connects you with qualified engineers in Nottingham who carry out
      ...
      whatWhyContent={
        <>
          ...
          <p>
            ...
            sludge. Nottinghamshire&rsquo;s hard water makes this worse by adding
      ...
      serviceAreasHeading="Power Flushing Across Nottingham"
      serviceAreasContent={
        <p>
          Our engineers carry out power flushing across Nottingham, West Bridgford, Beeston,
          Arnold, Sherwood, Gedling, and surrounding
      ...
      ctaContent={
        <p>
          ...
          Repairs and we will connect you with a qualified engineer in Nottingham
          who can carry out a professional power flush on your system.
        </p>
      }
      serviceName="Power Flushing"
      serviceSlug="power-flushing"
      serviceDescription="Power flushing in Nottingham. Remove sludge and limescale from your central heating system to restore efficiency and prevent boiler breakdowns."
