...
export const metadata: Metadata = {
  title: "Boiler Repair Nottingham | OnCall Home Repairs",
  description:
    "Boiler repair in Nottingham by Gas Safe engineers. Same-day repairs, upfront quotes. Available 24/7. Call 0333 240 8428.",
  alternates: {
    canonical:
      "https://oncallhomerepairs.co.uk/plumber-nottingham/services/boiler-heating/boiler-repair",
  },
};
...
export default function BoilerRepairPage() {
  return (
    <ServicePage
      ...
      h1="Boiler Repair in Nottingham"
      heroIntro={
        <p>
          ...
          with Gas Safe registered heating engineers in Nottingham who diagnose
        ...
        },
        {
          ...
          description: (
            <p>
              ...
              Nottingham. For emergency breakdowns, engineers are available 24/7.
      ...
      serviceAreasHeading="Boiler Repair Across Nottingham"
      serviceAreasContent={
        <p>
          Our network of Gas Safe heating engineers covers Nottingham and the
          surrounding area. Whether you live in West Bridgford, Beeston, Arnold,
          or one of the smaller villages like Sherwood or Bulwell, we
          ...
          properties across Nottinghamshire.
        </p>
      }
      faqs={[
        {
      ...
      ctaContent={
        <p>
          ...
          a Gas Safe registered engineer in Nottingham. Upfront pricing,
      ...
      serviceDescription="Expert boiler repair in Nottingham. Gas Safe registered engineers available 24/7."
