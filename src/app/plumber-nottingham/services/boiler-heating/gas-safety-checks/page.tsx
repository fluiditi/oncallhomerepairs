...
export const metadata: Metadata = {
  title: "Gas Safety Check Nottingham | OnCall Home Repairs",
  description:
    "Gas safety checks and CP12 certificates in Nottingham. For landlords and homeowners. Gas Safe registered engineers. Call 0333 240 8428.",
  alternates: {
    canonical:
      "https://oncallhomerepairs.co.uk/plumber-nottingham/services/boiler-heating/gas-safety-checks",
  },
};
...
export default function GasSafetyChecksPage() {
  return (
    <ServicePage
      ...
      h1="Gas Safety Checks in Nottingham"
      heroIntro={
        <p>
          ...
          Nottingham who carry out thorough inspections of your boiler, gas
      ...
      serviceAreasHeading="Gas Safety Checks Across Nottingham"
      serviceAreasContent={
        <p>
          Our Gas Safe registered engineers carry out gas safety checks across
          Nottingham, West Bridgford, Beeston, Arnold, Carlton, Long Eaton,
          Ruddington, Bingham, and all surrounding areas. Landlords with multiple
      ...
      faqs={[
        {
          question: "How much does a gas safety check cost in Nottingham?",
          answer:
      ...
      ctaContent={
        <p>
          ...
          engineer in Nottingham for your annual gas safety check.
        </p>
      }
      serviceName="Gas Safety Checks"
      serviceSlug="gas-safety-checks"
      serviceDescription="Gas safety checks and CP12 certificates in Nottingham. Annual inspections for landlords and homeowners by Gas Safe registered engineers."
