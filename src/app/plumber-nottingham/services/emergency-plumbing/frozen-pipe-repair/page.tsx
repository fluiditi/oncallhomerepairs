...
export const metadata: Metadata = {
  title: "Frozen Pipe Repair Nottingham | OnCall Home Repairs",
  description:
    "Frozen pipe repair in Nottingham. Prevent burst pipes this winter. Vetted plumbers, 24/7. Call 0333 240 8428.",
  alternates: {
    canonical:
      "https://oncallhomerepairs.co.uk/plumber-nottingham/services/emergency-plumbing/frozen-pipe-repair",
  },
};
...
export default function FrozenPipeRepairPage() {
  return (
    <ServicePage
      ...
      h1="Frozen Pipe Repair in Nottingham"
      heroIntro={
        <p>
          When temperatures across Nottinghamshire drop below freezing, pipes in
      ...
      whatWhyHeading="Why Frozen Pipes Are a Serious Risk in Nottingham"
      whatWhyContent={
        <>
          <p>
            Nottingham sits in the East Midlands where winter temperatures
          ...
          <p>
            ...
            understands the specific risks Nottinghamshire winters pose to local
      ...
      serviceAreasHeading="Frozen Pipe Repair Across Nottingham"
      serviceAreasContent={
        <p>
          Our plumbers attend frozen pipe emergencies across Nottingham, West Bridgford,
          Beeston, Arnold, and the surrounding villages. Properties in
          ...
          Nottinghamshire, we can connect you with a plumber who
      ...
      faqs={[
        ...
        {
          question:
            "How much does frozen pipe repair cost in Nottingham?",
          answer:
      ...
      ctaContent={
        <p>
          ...
          Home Repairs and we will connect you with a vetted plumber in Nottingham
      ...
      serviceDescription="Frozen pipe thawing and repair in Nottingham. Prevent burst pipes this winter with safe, professional pipe repair from vetted local plumbers."
