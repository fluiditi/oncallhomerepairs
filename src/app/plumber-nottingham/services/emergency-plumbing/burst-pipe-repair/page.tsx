...
export const metadata: Metadata = {
  title: "Burst Pipe Repair Nottingham | OnCall Home Repairs",
  description:
    "Fast burst pipe repair in Nottingham. 24/7 emergency response from vetted plumbers. Transparent pricing. Call 0333 240 8428.",
  alternates: {
    canonical:
      "https://oncallhomerepairs.co.uk/plumber-nottingham/services/emergency-plumbing/burst-pipe-repair",
  },
};
...
export default function BurstPipeRepairPage() {
  return (
    <ServicePage
      ...
      h1="Burst Pipe Repair in Nottingham"
      heroIntro={
        <p>
          ...
          you with vetted, experienced plumbers in the Nottingham area who
      ...
      whatWhyContent={
        <>
          ...
          <p>
            Our network of plumbers in Nottingham arrives equipped with the
      ...
      serviceAreasHeading="Burst Pipe Repair Across Nottingham"
      serviceAreasContent={
        <p>
          We connect homeowners with burst pipe repair plumbers across Nottingham
          and the surrounding villages. Whether you are in West Bridgford, Beeston,
          Arnold, or further afield in Sherwood or Gedling, our
      ...
      ctaHeading="Burst Pipe in Nottingham? Act Now"
      ctaContent={
        <p>
      ...
      serviceDescription="Fast burst pipe repair in Nottingham. Emergency call-out available 24/7."
