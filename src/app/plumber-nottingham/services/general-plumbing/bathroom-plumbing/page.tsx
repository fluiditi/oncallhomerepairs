...
export const metadata: Metadata = {
  title: "Bathroom Plumber Nottingham | OnCall Home Repairs",
  description:
    "Bathroom plumbing in Nottingham. Installations, repairs, full refits. Vetted plumbers, upfront quotes. Call 0333 240 8428.",
  alternates: {
    canonical:
      "https://oncallhomerepairs.co.uk/plumber-nottingham/services/general-plumbing/bathroom-plumbing",
  },
};
...
export default function BathroomPlumbingPage() {
  return (
    <ServicePage
      ...
      h1="Bathroom Plumbing in Nottingham"
      heroIntro={
        <p>
          ...
          vetted, experienced plumbers in Nottingham who handle all aspects of
      ...
      whatWhyContent={
        <>
          ...
          <p>
            ...
            will support the{" "}
            <Link
              href="/plumber-nottingham/services/general-plumbing/shower-installation-repair"
              className="text-primary underline underline-offset-2 hover:text-primary/80"
            >
              shower
            </Link>{" "}
        ...
        },
        {
          ...
          description: (
            <p>
              ...
              in Nottingham properties — from Victorian terraces with old lead
      ...
      relatedServices={[
        ...
        },
        {
          ...
          href: "/plumber-nottingham/services/general-plumbing/kitchen-plumbing",
        },
      ]}
      serviceAreasHeading="Bathroom Plumbing Across Nottingham"
      serviceAreasContent={
        <p>
          Our bathroom plumbers serve Nottingham and all surrounding areas. From
          period properties in the town centre that need careful pipework
          modifications to new-build homes in Mapperley, Stapleford, and Ruddington
          that need a shower upgrade or suite replacement, our plumbers have
          the experience to handle it. We cover West Bridgford, Beeston, Arnold,
          Bingham, and all villages in between.
        </p>
      }
      faqs={[
        {
      ...
      ctaHeading="Need a Bathroom Plumber in Nottingham?"
      ctaContent={
        <p>
      ...
      serviceDescription="Bathroom plumbing in Nottingham. Installations, repairs, and full bathroom fit-outs."
