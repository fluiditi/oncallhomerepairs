...
export const metadata: Metadata = {
  title: "Pipe Replacement Nottingham | OnCall Home Repairs",
  description:
    "Pipe replacement in Nottingham. Copper, plastic, and lead pipe upgrades by vetted plumbers. Transparent pricing. Call 0333 240 8428.",
  alternates: {
    canonical:
      "https://oncallhomerepairs.co.uk/plumber-nottingham/services/general-plumbing/pipe-replacement",
  },
};
...
export default function PipeReplacementPage() {
  return (
    <ServicePage
      ...
      h1="Pipe Replacement in Nottingham"
      heroIntro={
        <p>
          ...
          connects you with qualified plumbers in Nottingham who replace old
      ...
      whatWhyContent={
        <>
          <p>
            ...
            Nottingham properties &mdash; pose a health risk and should be
      ...
      serviceAreasHeading="Pipe Replacement Across Nottingham"
      serviceAreasContent={
        <p>
          Our plumbers replace pipework in properties across Nottingham, West Bridgford,
          Beeston, Arnold, Bingham, Ruddington, and all surrounding areas.
      ...
      ctaContent={
        <p>
          ...
          in Nottingham who can assess your pipes and carry out replacements
          that last.
        </p>
      }
      serviceName="Pipe Replacement"
      serviceSlug="pipe-replacement"
      serviceDescription="Pipe replacement in Nottingham. Copper, plastic, and lead pipe upgrades for homes and businesses by vetted local plumbers."
