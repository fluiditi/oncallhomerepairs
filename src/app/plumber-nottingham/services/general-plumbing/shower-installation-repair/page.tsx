...
export const metadata: Metadata = {
  title: "Shower Installation Nottingham | OnCall Home Repairs",
  description:
    "Shower installation and repair in Nottingham. Electric, mixer, and thermostatic showers. Vetted plumbers. Call 0333 240 8428.",
  alternates: {
    canonical:
      "https://oncallhomerepairs.co.uk/plumber-nottingham/services/general-plumbing/shower-installation-repair",
  },
};
...
export default function ShowerInstallationPage() {
  return (
    <ServicePage
      ...
      h1="Shower Installation and Repair in Nottingham"
      heroIntro={
        <p>
          ...
          in Nottingham who handle all types of shower work. From quick repairs
      ...
      whatWhyContent={
        <>
          ...
          <p>
            In Nottingham homes with hard water, limescale build-up inside
      ...
      serviceAreasHeading="Shower Installation Across Nottingham"
      serviceAreasContent={
        <p>
          Our plumbers install and repair showers across Nottingham, West Bridgford,
          Beeston, Arnold, Carlton, Mapperley, and surrounding
      ...
      ctaContent={
        <p>
          ...
          Repairs will match you with a qualified plumber in Nottingham. Call now
          for an upfront quote.
        </p>
      }
      serviceName="Shower Installation and Repair"
      serviceSlug="shower-installation-repair"
      serviceDescription="Shower installation and repair in Nottingham. Electric, mixer, and thermostatic showers fitted and repaired by vetted local plumbers."
