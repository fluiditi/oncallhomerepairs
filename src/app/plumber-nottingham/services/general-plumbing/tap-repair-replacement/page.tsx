...
export const metadata: Metadata = {
  title: "Tap Repair Nottingham | OnCall Home Repairs",
  description:
    "Tap repair and replacement in Nottingham. Fix dripping taps and install new ones. Vetted plumbers, transparent pricing. Call 0333 240 8428.",
  alternates: {
    canonical:
      "https://oncallhomerepairs.co.uk/plumber-nottingham/services/general-plumbing/tap-repair-replacement",
  },
};
...
export default function TapRepairPage() {
  return (
    <ServicePage
      ...
      h1="Tap Repair and Replacement in Nottingham"
      heroIntro={
        <p>
          ...
          Home Repairs connects you with plumbers in Nottingham who can fix
      ...
      whatWhyContent={
        <>
          <p>
            ...
            Nottinghamshire, the hard water supply accelerates wear on internal
      ...
      serviceAreasHeading="Tap Repair Across Nottingham"
      serviceAreasContent={
        <p>
          Our plumbers repair and replace taps across Nottingham, West Bridgford, Beeston,
          Arnold, Long Eaton, Stapleford, and the surrounding area. Tap
      ...
      ctaContent={
        <p>
          ...
          will connect you with a plumber in Nottingham who can repair or
      ...
      serviceDescription="Tap repair and replacement in Nottingham. Fix dripping taps, replace worn components, and install new taps with vetted local plumbers."
