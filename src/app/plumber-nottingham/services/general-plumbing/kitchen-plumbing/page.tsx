...
export const metadata: Metadata = {
  title: "Kitchen Plumber Nottingham | OnCall Home Repairs",
  description:
    "Kitchen plumbing in Nottingham. Sink installations, dishwasher connections, waste disposal, and repairs. Call 0333 240 8428.",
  alternates: {
    canonical:
      "https://oncallhomerepairs.co.uk/plumber-nottingham/services/general-plumbing/kitchen-plumbing",
  },
};
...
export default function KitchenPlumbingPage() {
  return (
    <ServicePage
      ...
      h1="Kitchen Plumbing in Nottingham"
      heroIntro={
        <p>
          ...
          Nottingham who install, repair, and maintain kitchen plumbing &mdash;
      ...
      whatWhyContent={
        <>
          ...
          <p>
            Blocked kitchen sinks are a regular call-out in Nottingham. Grease,
      ...
      relatedServices={[
        ...
        },
        {
          ...
          href: "/plumber-nottingham/services/general-plumbing/pipe-replacement",
        },
      ]}
      serviceAreasHeading="Kitchen Plumbing Across Nottingham"
      serviceAreasContent={
        <p>
          Our plumbers carry out kitchen plumbing work across Nottingham,
          West Bridgford, Beeston, Arnold, Sherwood, Bulwell, Market
      ...
      ctaContent={
        <p>
          ...
          Repairs will match you with a qualified plumber in Nottingham. Call
          for a clear, upfront quote.
        </p>
      }
      serviceName="Kitchen Plumbing"
      serviceSlug="kitchen-plumbing"
      serviceDescription="Kitchen plumbing in Nottingham. Sink installations, appliance connections, waste pipe repairs, and full kitchen plumbing by vetted local plumbers."
