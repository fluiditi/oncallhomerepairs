...
export const metadata: Metadata = {
  title: "Toilet Repair Nottingham | OnCall Home Repairs",
  description:
    "Toilet repair in Nottingham. Cisterns, flush mechanisms, seals, and installations by vetted plumbers. Call 0333 240 8428.",
  alternates: {
    canonical:
      "https://oncallhomerepairs.co.uk/plumber-nottingham/services/drain-services/toilet-repair",
  },
};
...
export default function ToiletRepairPage() {
  return (
    <ServicePage
      ...
      h1="Toilet Repair in Nottingham"
      heroIntro={
        <p>
          ...
          Nottingham who repair and replace toilet components, cisterns, and
      ...
      whatWhyContent={
        <>
          ...
          <p>
            In properties across Nottingham, hard water deposits also play a role.
      ...
      serviceAreasHeading="Toilet Repair Across Nottingham"
      serviceAreasContent={
        <p>
          Our plumbers carry out toilet repairs across Nottingham, West Bridgford,
          Beeston, Arnold, Carlton, Hucknall, and all
      ...
      ctaContent={
        <p>
          ...
          Nottingham who can diagnose and fix the problem &mdash; usually in a
          single visit.
        </p>
      }
      serviceName="Toilet Repair"
      serviceSlug="toilet-repair"
      serviceDescription="Toilet repair in Nottingham. Cistern mechanisms, fill valves, flush faults, and seal replacements by vetted local plumbers."
