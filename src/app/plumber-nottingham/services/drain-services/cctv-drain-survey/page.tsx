...
export const metadata: Metadata = {
  title: "CCTV Drain Survey Nottingham | OnCall Home Repairs",
  description:
    "CCTV drain survey in Nottingham. Camera inspection to diagnose drainage problems accurately. Vetted engineers. Call 0333 240 8428.",
  alternates: {
    canonical:
      "https://oncallhomerepairs.co.uk/plumber-nottingham/services/drain-services/cctv-drain-survey",
  },
};
...
export default function CCTVDrainSurveyPage() {
  return (
    <ServicePage
      ...
      h1="CCTV Drain Survey in Nottingham"
      heroIntro={
        <p>
          ...
          engineers in Nottingham who use professional camera equipment to inspect
      ...
      whatWhyContent={
        <>
          ...
          <p>
            Homebuyers in Nottingham increasingly request drain surveys as part
      ...
      serviceAreasHeading="CCTV Drain Surveys Across Nottingham"
      serviceAreasContent={
        <p>
          Our drain engineers carry out CCTV surveys across Nottingham, West Bridgford,
          Beeston, Arnold, Gedling, Stapleford, Ruddington, and all
      ...
      faqs={[
        {
          question: "How much does a CCTV drain survey cost in Nottingham?",
          answer:
      ...
      ctaContent={
        <p>
          ...
          we will connect you with a drain engineer in Nottingham who can carry
      ...
      serviceDescription="CCTV drain survey in Nottingham. Professional camera inspection to diagnose drainage problems, root intrusion, and pipe damage."
