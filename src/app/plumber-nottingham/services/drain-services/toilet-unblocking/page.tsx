...
export const metadata: Metadata = {
  title: "Toilet Unblocking Nottingham | OnCall Home Repairs",
  description:
    "Toilet unblocking in Nottingham. Fast, hygienic clearance of blocked toilets by vetted plumbers. Call 0333 240 8428.",
  alternates: {
    canonical:
      "https://oncallhomerepairs.co.uk/plumber-nottingham/services/drain-services/toilet-unblocking",
  },
};
...
export default function ToiletUnblockingPage() {
  return (
    <ServicePage
      ...
      h1="Toilet Unblocking in Nottingham"
      heroIntro={
        <p>
          ...
          Nottingham who carry out fast, hygienic toilet unblocking using
      ...
      whatWhyContent={
        <>
          ...
          <p>
            In older Nottingham properties, narrow soil pipes and ageing clay
      ...
      serviceAreasHeading="Toilet Unblocking Across Nottingham"
      serviceAreasContent={
        <p>
          Our plumbers attend toilet unblocking jobs across Nottingham, West Bridgford,
          Beeston, Arnold, Ruddington, Bingham, and all surrounding areas.
      ...
      ctaContent={
        <p>
          ...
          and we will connect you with a plumber in Nottingham who can clear it
          quickly and discreetly &mdash; same-day where possible.
        </p>
      }
      serviceName="Toilet Unblocking"
      serviceSlug="toilet-unblocking"
      serviceDescription="Fast, hygienic toilet unblocking in Nottingham. Professional clearance of blocked toilets by vetted local plumbers."
