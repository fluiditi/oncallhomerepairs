...
export const metadata: Metadata = {
  title: "Blocked Drains Nottingham | OnCall Home Repairs",
  description:
    "Blocked drain clearing in Nottingham. Fast, effective unblocking for homes and businesses. Call 0333 240 8428.",
  alternates: {
    canonical:
      "https://oncallhomerepairs.co.uk/plumber-nottingham/services/drain-services/blocked-drains",
  },
};
...
export default function BlockedDrainsPage() {
  return (
    <ServicePage
      ...
      h1="Blocked Drains in Nottingham"
      heroIntro={
        <p>
          ...
          drainage plumbers in Nottingham who can clear blockages quickly and
      ...
      serviceAreasHeading="Blocked Drain Clearing Across Nottingham"
      serviceAreasContent={
        <p>
          Our drainage plumbers cover Nottingham and every surrounding town and
          village. From terraced properties in Nottingham centre with shared
          drainage runs to detached homes in West Bridgford, Beeston, and Market
      ...
      ctaHeading="Blocked Drain in Nottingham?"
      ctaContent={
        <p>
      ...
      serviceDescription="Blocked drain clearing in Nottingham. Fast, effective unblocking for homes and businesses."
