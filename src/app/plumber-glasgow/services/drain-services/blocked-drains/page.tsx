...
export const metadata: Metadata = {
  title: "Blocked Drains Glasgow | OnCall Home Repairs",
  description:
    "Blocked drain clearing in Glasgow. Fast, effective unblocking for homes and businesses. Call 0333 240 8428.",
  alternates: {
    canonical:
      "https://oncallhomerepairs.co.uk/plumber-glasgow/services/drain-services/blocked-drains",
  },
};
    ...
    <ServicePage
      ...
      heroIntro={
        <p>
          ...
          drainage plumbers in Glasgow who can clear blockages quickly and
      ...
      serviceAreasHeading="Blocked Drain Clearing Across Glasgow"
      serviceAreasContent={
        <p>
          Our drainage plumbers cover Glasgow and every surrounding town and
          village. From terraced properties in Glasgow centre with shared
          drainage runs to detached homes in Partick, Hillhead, and Market
      ...
      ctaHeading="Blocked Drain in Glasgow?"
      ctaContent={
        <p>
      ...
      serviceDescription="Blocked drain clearing in Glasgow. Fast, effective unblocking for homes and businesses."
