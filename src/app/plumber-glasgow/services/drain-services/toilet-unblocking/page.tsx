...
export const metadata: Metadata = {
  title: "Toilet Unblocking Glasgow | OnCall Home Repairs",
  description:
    "Toilet unblocking in Glasgow. Fast, hygienic clearance of blocked toilets by vetted plumbers. Call 0333 240 8428.",
  alternates: {
    canonical:
      "https://oncallhomerepairs.co.uk/plumber-glasgow/services/drain-services/toilet-unblocking",
  },
};
    ...
    <ServicePage
      breadcrumbItems={[
        ...
        { name: "Drain Services", href: "/plumber-glasgow/services/drain-services" },
        {
          ...
          href: "/plumber-glasgow/services/drain-services/toilet-unblocking",
        },
      ]}
      h1="Toilet Unblocking in Glasgow"
      heroIntro={
        <p>
          ...
          Glasgow who carry out fast, hygienic toilet unblocking using
      ...
      whatWhyContent={
        <>
          ...
          <p>
            In older Glasgow properties, narrow soil pipes and ageing clay
          ...
          <p>
            ...
            <a
              href="/plumber-glasgow/services/drain-services/drain-unblocking"
              className="text-primary underline underline-offset-2 hover:text-primary/80"
            >
      ...
      relatedServices={[
        {
          name: "Toilet Repair",
          href: "/plumber-glasgow/services/drain-services/toilet-repair",
        },
        {
          name: "Blocked Drains",
      ...
      serviceAreasHeading="Toilet Unblocking Across Glasgow"
      serviceAreasContent={
        <p>
          Our plumbers attend toilet unblocking jobs across Glasgow, Partick,
          Hillhead, Govan, Bridgeton, Rutherglen, and all surrounding areas.
      ...
      ctaContent={
        <p>
          ...
          and we will connect you with a plumber in Glasgow who can clear it
          quickly and discreetly &mdash; same-day where possible.
        </p>
      }
      serviceName="Toilet Unblocking"
      serviceSlug="toilet-unblocking"
      serviceDescription="Fast, hygienic toilet unblocking in Glasgow. Professional clearance of blocked toilets by vetted local plumbers."
