...
export const metadata: Metadata = {
  title: "Toilet Repair Glasgow | OnCall Home Repairs",
  description:
    "Toilet repair in Glasgow. Cisterns, flush mechanisms, seals, and installations by vetted plumbers. Call 0333 240 8428.",
  alternates: {
    canonical:
      "https://oncallhomerepairs.co.uk/plumber-glasgow/services/drain-services/toilet-repair",
  },
};
    ...
    <ServicePage
      ...
      heroIntro={
        <p>
          ...
          Glasgow who repair and replace toilet components, cisterns, and
      ...
      whatWhyContent={
        <>
          ...
          <p>
            In properties across Glasgow, hard water deposits also play a role.
      ...
      serviceAreasHeading="Toilet Repair Across Glasgow"
      serviceAreasContent={
        <p>
          Our plumbers carry out toilet repairs across Glasgow, Partick,
          Hillhead, Govan, Shawlands, Maryhill, and all
      ...
      ctaContent={
        <p>
          ...
          Glasgow who can diagnose and fix the problem &mdash; usually in a
          single visit.
        </p>
      }
      serviceName="Toilet Repair"
      serviceSlug="toilet-repair"
      serviceDescription="Toilet repair in Glasgow. Cistern mechanisms, fill valves, flush faults, and seal replacements by vetted local plumbers."
