...
export const metadata: Metadata = {
  title: "CCTV Drain Survey Glasgow | OnCall Home Repairs",
  description:
    "CCTV drain survey in Glasgow. Camera inspection to diagnose drainage problems accurately. Vetted engineers. Call 0333 240 8428.",
  alternates: {
    canonical:
      "https://oncallhomerepairs.co.uk/plumber-glasgow/services/drain-services/cctv-drain-survey",
  },
};
...
export default function CCTVDrainSurveyPage() {
  return (
    <ServicePage
      ...
      h1="CCTV Drain Survey in Glasgow"
      heroIntro={
        <p>
          ...
          engineers in Glasgow who use professional camera equipment to inspect
      ...
      whatWhyContent={
        <>
          ...
          <p>
            Homebuyers in Glasgow increasingly request drain surveys as part
      ...
      serviceAreasHeading="CCTV Drain Surveys Across Glasgow"
      serviceAreasContent={
        <p>
          Our drain engineers carry out CCTV surveys across Glasgow, Partick,
          Hillhead, Govan, Jordanhill, Springburn, Bridgeton, and all
      ...
      faqs={[
        {
          question: "How much does a CCTV drain survey cost in Glasgow?",
          answer:
      ...
      ctaContent={
        <p>
          ...
          we will connect you with a drain engineer in Glasgow who can carry
      ...
      serviceDescription="CCTV drain survey in Glasgow. Professional camera inspection to diagnose drainage problems, root intrusion, and pipe damage."
