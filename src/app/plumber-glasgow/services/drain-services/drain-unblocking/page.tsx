...
export const metadata: Metadata = {
  title: "Drain Unblocking Glasgow | OnCall Home Repairs",
  description:
    "Professional drain unblocking in Glasgow. High-pressure jetting and manual rodding. Vetted plumbers. Call 0333 240 8428.",
  alternates: {
    canonical:
      "https://oncallhomerepairs.co.uk/plumber-glasgow/services/drain-services/drain-unblocking",
  },
};
...
export default function DrainUnblockingPage() {
  return (
    <ServicePage
      ...
      h1="Drain Unblocking in Glasgow"
      heroIntro={
        <p>
          ...
          experienced drain engineers in Glasgow who use professional-grade
      ...
      whatWhyContent={
        <>
          <p>
            Most drain blockages in Glasgow homes are caused by a gradual
      ...
      serviceAreasHeading="Drain Unblocking Across Glasgow"
      serviceAreasContent={
        <p>
          Our drain engineers cover Glasgow, Partick, Hillhead, Govan,
          Cathcart, Pollokshields, and the surrounding area. External drain
      ...
      ctaContent={
        <p>
          ...
          Glasgow who can clear the blockage and restore full flow.
        </p>
      }
      serviceName="Drain Unblocking"
      serviceSlug="drain-unblocking"
      serviceDescription="Professional drain unblocking in Glasgow using high-pressure jetting and manual rodding. Fast, effective clearance for homes and businesses."
