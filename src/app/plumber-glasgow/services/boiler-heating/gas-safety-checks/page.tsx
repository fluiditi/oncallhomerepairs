...
export const metadata: Metadata = {
  title: "Gas Safety Check Glasgow | OnCall Home Repairs",
  description:
    "Gas safety checks and CP12 certificates in Glasgow. For landlords and homeowners. Gas Safe registered engineers. Call 0333 240 8428.",
  alternates: {
    canonical:
      "https://oncallhomerepairs.co.uk/plumber-glasgow/services/boiler-heating/gas-safety-checks",
  },
};
...
export default function GasSafetyChecksPage() {
  return (
    <ServicePage
      ...
      h1="Gas Safety Checks in Glasgow"
      heroIntro={
        <p>
          ...
          Glasgow who carry out thorough inspections of your boiler, gas
      ...
      serviceAreasHeading="Gas Safety Checks Across Glasgow"
      serviceAreasContent={
        <p>
          Our Gas Safe registered engineers carry out gas safety checks across
          Glasgow, Partick, Hillhead, Govan, Shawlands, Anniesland,
          Bridgeton, Rutherglen, and all surrounding areas. Landlords with multiple
      ...
      faqs={[
        {
          question: "How much does a gas safety check cost in Glasgow?",
          answer:
      ...
      ctaContent={
        <p>
          ...
          engineer in Glasgow for your annual gas safety check.
        </p>
      }
      serviceName="Gas Safety Checks"
      serviceSlug="gas-safety-checks"
      serviceDescription="Gas safety checks and CP12 certificates in Glasgow. Annual inspections for landlords and homeowners by Gas Safe registered engineers."
