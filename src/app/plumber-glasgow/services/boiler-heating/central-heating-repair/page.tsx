...
export const metadata: Metadata = {
  title: "Central Heating Repair Glasgow | OnCall Home Repairs",
  description:
    "Central heating repair in Glasgow. Radiators, pumps, valves, thermostats. Gas Safe engineers. Call 0333 240 8428.",
  alternates: {
    canonical:
      "https://oncallhomerepairs.co.uk/plumber-glasgow/services/boiler-heating/central-heating-repair",
  },
};
...
export default function CentralHeatingRepairPage() {
  return (
    <ServicePage
      ...
      h1="Central Heating Repair in Glasgow"
      heroIntro={
        <p>
          When your central heating is not working properly, your home becomes
          uncomfortable fast — especially during a Glasgow winter. Cold
          ...
          engineers in Glasgow who diagnose and repair central heating faults
      ...
      whatWhyContent={
        <>
          ...
          <p>
            ...
            <Link
              href="/plumber-glasgow/services/boiler-heating/power-flushing"
              className="text-primary underline underline-offset-2 hover:text-primary/80"
            >
              power flush
            </Link>{" "}
      ...
      benefits={[
        {
          ...
          description: (
            <p>
              ...
              systems and understand the common faults found in Glasgow
              properties.
            </p>
          ),
        },
      ...
      relatedServices={[
        ...
        },
        {
          ...
          href: "/plumber-glasgow/services/boiler-heating/radiator-repair-installation",
        },
        {
          name: "Power Flushing",
          href: "/plumber-glasgow/services/boiler-heating/power-flushing",
        },
        {
          ...
          href: "/plumber-glasgow/services/boiler-heating/boiler-servicing",
        },
      ]}
      serviceAreasHeading="Central Heating Repair Across Glasgow"
      serviceAreasContent={
        <p>
          Our heating engineers cover Glasgow and the surrounding towns and
          villages throughout Glasgow. From older properties
          in Glasgow town centre to newer-build estates in Govan, Maryhill,
          and Shawlands, our engineers are familiar with the heating
      ...
      ctaContent={
        <p>
          ...
          a qualified heating engineer in Glasgow who can diagnose and fix the
      ...
      serviceDescription="Central heating repair in Glasgow. Radiators, pumps, valves, and full system diagnostics."
