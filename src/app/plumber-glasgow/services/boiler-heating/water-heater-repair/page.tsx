...
export const metadata: Metadata = {
  title: "Water Heater Repair Glasgow | OnCall Home Repairs",
  description:
    "Water heater repair in Glasgow. Immersion heaters, cylinders, and unvented systems. Vetted plumbers. Call 0333 240 8428.",
  alternates: {
    canonical:
      "https://oncallhomerepairs.co.uk/plumber-glasgow/services/boiler-heating/water-heater-repair",
  },
};
...
export default function WaterHeaterRepairPage() {
  return (
    <ServicePage
      ...
      h1="Water Heater Repair in Glasgow"
      heroIntro={
        <p>
          ...
          you with qualified plumbers and heating engineers in Glasgow who can
      ...
      whatWhyContent={
        <>
          <p>
            Hot water systems vary considerably across Glasgow properties.
          ...
          <p>
            ...
            areas like Glasgow, and eventually stops working. The
      ...
      serviceAreasHeading="Water Heater Repair Across Glasgow"
      serviceAreasContent={
        <p>
          Our plumbers and heating engineers attend water heater repairs across
          Glasgow, Partick, Hillhead, Govan, Dennistoun, Maryhill, and
      ...
      faqs={[
        {
          ...
          answer:
            "The most common cause is a failed heating element. Hard water areas like Glasgow accelerate limescale build-up on the element, which causes it to overheat and burn out. The thermostat can also fail independently. A plumber can test both components and replace whichever has failed.",
        },
        {
          question:
      ...
      ctaContent={
        <p>
          ...
          Glasgow who can restore your hot water supply.
        </p>
      }
      serviceName="Water Heater Repair"
      serviceSlug="water-heater-repair"
      serviceDescription="Water heater repair in Glasgow. Immersion heaters, hot water cylinders, and unvented systems repaired by qualified local plumbers."
