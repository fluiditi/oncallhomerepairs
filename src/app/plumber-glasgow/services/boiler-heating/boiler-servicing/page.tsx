...
export const metadata: Metadata = {
  title: "Boiler Servicing Glasgow | OnCall Home Repairs",
  description:
    "Annual boiler servicing in Glasgow. Keep your warranty valid and your boiler running efficiently. Gas Safe engineers. Call 0333 240 8428.",
  alternates: {
    canonical:
      "https://oncallhomerepairs.co.uk/plumber-glasgow/services/boiler-heating/boiler-servicing",
  },
};
...
export default function BoilerServicingPage() {
  return (
    <ServicePage
      ...
      h1="Boiler Servicing in Glasgow"
      heroIntro={
        <p>
          ...
          connects you with Gas Safe registered engineers in Glasgow who carry
      ...
      serviceAreasHeading="Boiler Servicing Across Glasgow"
      serviceAreasContent={
        <p>
          Our Gas Safe registered engineers service boilers across Glasgow,
          Partick, Hillhead, Govan, Maryhill, Shawlands, and
      ...
      ctaContent={
        <p>
          ...
          Gas Safe registered engineer in Glasgow.
        </p>
      }
      serviceName="Boiler Servicing"
      serviceSlug="boiler-servicing"
      serviceDescription="Annual boiler servicing in Glasgow by Gas Safe registered engineers. Manufacturer warranty protection, safety checks, and efficiency testing."
