...
export const metadata: Metadata = {
  title: "Radiator Repair Glasgow | OnCall Home Repairs",
  description:
    "Radiator repair and installation in Glasgow. Fix cold spots, leaks, and add new radiators. Gas Safe engineers. Call 0333 240 8428.",
  alternates: {
    canonical:
      "https://oncallhomerepairs.co.uk/plumber-glasgow/services/boiler-heating/radiator-repair-installation",
  },
};
...
export default function RadiatorRepairPage() {
  return (
    <ServicePage
      ...
      h1="Radiator Repair and Installation in Glasgow"
      heroIntro={
        <p>
          ...
          Glasgow who can diagnose radiator faults, carry out repairs, and
      ...
      whatWhyHeading="Common Radiator Problems in Glasgow Homes"
      whatWhyContent={
        <>
          <p>
          ...
          <p>
            Glasgow&rsquo;s hard water accelerates the build-up of
            limescale and sludge in central heating systems. Many homes in
            Glasgow, Partick, and the surrounding area have heating systems
      ...
      serviceAreasHeading="Radiator Repair Across Glasgow"
      serviceAreasContent={
        <p>
          Our heating engineers carry out radiator repairs and installations
          across Glasgow, Partick, Hillhead, Govan, Anniesland, Springburn,
          and the wider Glasgow area. Whether you need a
      ...
      ctaContent={
        <p>
          ...
          in Glasgow who can get your radiators working as they should.
        </p>
      }
      serviceName="Radiator Repair and Installation"
      serviceSlug="radiator-repair-installation"
      serviceDescription="Radiator repair and installation in Glasgow. Fix cold spots, leaking valves, and add new radiators with qualified heating engineers."
