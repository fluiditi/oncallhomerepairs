...
export const metadata: Metadata = {
  title: "Boiler Repair Glasgow | OnCall Home Repairs",
  description:
    "Boiler repair in Glasgow by Gas Safe engineers. Same-day repairs, upfront quotes. Available 24/7. Call 0333 240 8428.",
  alternates: {
    canonical:
      "https://oncallhomerepairs.co.uk/plumber-glasgow/services/boiler-heating/boiler-repair",
  },
};
    ...
    <ServicePage
      ...
      heroIntro={
        <p>
          ...
          with Gas Safe registered heating engineers in Glasgow who diagnose
        ...
        },
        {
          ...
          description: (
            <p>
              ...
              Glasgow. For emergency breakdowns, engineers are available 24/7.
      ...
      serviceAreasHeading="Boiler Repair Across Glasgow"
      serviceAreasContent={
        <p>
          Our network of Gas Safe heating engineers covers Glasgow and the
          surrounding area. Whether you live in Partick, Hillhead, Govan,
          or one of the smaller villages like Pollokshields or Cathcart, we
      ...
      ctaContent={
        <p>
          ...
          a Gas Safe registered engineer in Glasgow. Upfront pricing,
      ...
      serviceDescription="Expert boiler repair in Glasgow. Gas Safe registered engineers available 24/7."
