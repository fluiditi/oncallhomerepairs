...
export const metadata: Metadata = {
  title: "Boiler Installation Glasgow | OnCall Home Repairs",
  description:
    "New boiler installation in Glasgow. Gas Safe engineers, competitive quotes, workmanship guarantee. Call 0333 240 8428.",
  alternates: {
    canonical:
      "https://oncallhomerepairs.co.uk/plumber-glasgow/services/boiler-heating/boiler-installation",
  },
};
...
export default function BoilerInstallationPage() {
  return (
    <ServicePage
      ...
      h1="Boiler Installation in Glasgow"
      heroIntro={
        <p>
          ...
          you with Gas Safe registered heating engineers in Glasgow who carry
      ...
      serviceAreasHeading="Boiler Installation Across Glasgow"
      serviceAreasContent={
        <p>
          We connect homeowners across Glasgow and Glasgow
          with qualified boiler installers. Whether you are in the centre of
          Glasgow, in Partick, Hillhead, or one of the surrounding
          ...
          of Glasgow and can advise on the best boiler setup for your
          home.
        </p>
      }
      faqs={[
        {
          question: "How much does a new boiler installation cost in Glasgow?",
          answer:
      ...
      ctaHeading="Ready for a New Boiler in Glasgow?"
      ctaContent={
        <p>
      ...
      serviceDescription="New boiler installation in Glasgow. Gas Safe registered, competitive pricing."
