...
export const metadata: Metadata = {
  title: "Bathroom Plumber Glasgow | OnCall Home Repairs",
  description:
    "Bathroom plumbing in Glasgow. Installations, repairs, full refits. Vetted plumbers, upfront quotes. Call 0333 240 8428.",
  alternates: {
    canonical:
      "https://oncallhomerepairs.co.uk/plumber-glasgow/services/general-plumbing/bathroom-plumbing",
  },
};
...
export default function BathroomPlumbingPage() {
  return (
    <ServicePage
      ...
      h1="Bathroom Plumbing in Glasgow"
      heroIntro={
        <p>
          ...
          vetted, experienced plumbers in Glasgow who handle all aspects of
        ...
        },
        {
          ...
          description: (
            <p>
              ...
              in Glasgow properties — from Victorian terraces with old lead
      ...
      serviceAreasHeading="Bathroom Plumbing Across Glasgow"
      serviceAreasContent={
        <p>
          Our bathroom plumbers serve Glasgow and all surrounding areas. From
          period properties in the town centre that need careful pipework
          modifications to new-build homes in Dennistoun, Springburn, and Bridgeton
          that need a shower upgrade or suite replacement, our plumbers have
          the experience to handle it. We cover Partick, Hillhead, Govan,
          Rutherglen, and all villages in between.
        </p>
      }
      faqs={[
        {
      ...
      ctaHeading="Need a Bathroom Plumber in Glasgow?"
      ctaContent={
        <p>
      ...
      serviceDescription="Bathroom plumbing in Glasgow. Installations, repairs, and full bathroom fit-outs."
