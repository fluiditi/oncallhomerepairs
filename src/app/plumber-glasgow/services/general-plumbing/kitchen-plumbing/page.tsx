...
export const metadata: Metadata = {
  title: "Kitchen Plumber Glasgow | OnCall Home Repairs",
  description:
    "Kitchen plumbing in Glasgow. Sink installations, dishwasher connections, waste disposal, and repairs. Call 0333 240 8428.",
  alternates: {
    canonical:
      "https://oncallhomerepairs.co.uk/plumber-glasgow/services/general-plumbing/kitchen-plumbing",
  },
};
...
export default function KitchenPlumbingPage() {
  return (
    <ServicePage
      ...
      h1="Kitchen Plumbing in Glasgow"
      heroIntro={
        <p>
          ...
          Glasgow who install, repair, and maintain kitchen plumbing &mdash;
      ...
      whatWhyContent={
        <>
          ...
          <p>
            Blocked kitchen sinks are a regular call-out in Glasgow. Grease,
      ...
      serviceAreasHeading="Kitchen Plumbing Across Glasgow"
      serviceAreasContent={
        <p>
          Our plumbers carry out kitchen plumbing work across Glasgow,
          Partick, Hillhead, Govan, Pollokshields, Cathcart, Market
      ...
      ctaContent={
        <p>
          ...
          Repairs will match you with a qualified plumber in Glasgow. Call
          for a clear, upfront quote.
        </p>
      }
      serviceName="Kitchen Plumbing"
      serviceSlug="kitchen-plumbing"
      serviceDescription="Kitchen plumbing in Glasgow. Sink installations, appliance connections, waste pipe repairs, and full kitchen plumbing by vetted local plumbers."
