...
export const metadata: Metadata = {
  title: "Pipe Replacement Glasgow | OnCall Home Repairs",
  description:
    "Pipe replacement in Glasgow. Copper, plastic, and lead pipe upgrades by vetted plumbers. Transparent pricing. Call 0333 240 8428.",
  alternates: {
    canonical:
      "https://oncallhomerepairs.co.uk/plumber-glasgow/services/general-plumbing/pipe-replacement",
  },
};
...
export default function PipeReplacementPage() {
  return (
    <ServicePage
      ...
      h1="Pipe Replacement in Glasgow"
      heroIntro={
        <p>
          ...
          connects you with qualified plumbers in Glasgow who replace old
      ...
      whatWhyContent={
        <>
          <p>
            ...
            Glasgow properties &mdash; pose a health risk and should be
      ...
      serviceAreasHeading="Pipe Replacement Across Glasgow"
      serviceAreasContent={
        <p>
          Our plumbers replace pipework in properties across Glasgow, Partick,
          Hillhead, Govan, Rutherglen, Bridgeton, and all surrounding areas.
      ...
      ctaContent={
        <p>
          ...
          in Glasgow who can assess your pipes and carry out replacements
          that last.
        </p>
      }
      serviceName="Pipe Replacement"
      serviceSlug="pipe-replacement"
      serviceDescription="Pipe replacement in Glasgow. Copper, plastic, and lead pipe upgrades for homes and businesses by vetted local plumbers."
