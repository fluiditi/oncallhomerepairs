...
export const metadata: Metadata = {
  title: "Stopcock Repair Glasgow | OnCall Home Repairs",
  description:
    "Stopcock repair and replacement in Glasgow. Regain control of your water supply. Vetted plumbers. Call 0333 240 8428.",
  alternates: {
    canonical:
      "https://oncallhomerepairs.co.uk/plumber-glasgow/services/emergency-plumbing/stopcock-repair",
  },
};
...
export default function StopcockRepairPage() {
  return (
    <ServicePage
      ...
      h1="Stopcock Repair and Replacement in Glasgow"
      heroIntro={
        <p>
          ...
          you with vetted plumbers in Glasgow who can repair or replace faulty
      ...
      whatWhyContent={
        <>
          ...
          <p>
            In many Glasgow properties, especially those built before the 1980s,
            the internal stopcock sits under the kitchen sink and has not been
            turned in years. Mineral deposits from Glasgow&rsquo;s hard
          ...
          <p>
            ...
            <a
              href="/plumber-glasgow/services/general-plumbing/pipe-replacement"
      ...
      serviceAreasHeading="Stopcock Repair Across Glasgow"
      serviceAreasContent={
        <p>
          We connect homeowners with plumbers who carry out stopcock repairs
          across Glasgow, Partick, Hillhead, Govan, and all surrounding
      ...
      ctaContent={
        <p>
          ...
          in Glasgow who can repair or replace your stopcock &mdash; often the
          same day.
        </p>
      }
      serviceName="Stopcock Repair"
      serviceSlug="stopcock-repair"
      serviceDescription="Stopcock repair and replacement in Glasgow. Regain control of your water supply with same-day service from vetted local plumbers."
