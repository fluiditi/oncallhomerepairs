...
export const metadata: Metadata = {
  title: "Overflow Repair Glasgow | OnCall Home Repairs",
  description:
    "Overflow pipe repair in Glasgow. Stop water leaks from tanks and cisterns. Transparent pricing. Call 0333 240 8428.",
  alternates: {
    canonical:
      "https://oncallhomerepairs.co.uk/plumber-glasgow/services/emergency-plumbing/overflow-repair",
  },
};
...
export default function OverflowRepairPage() {
  return (
    <ServicePage
      ...
      h1="Overflow Pipe Repair in Glasgow"
      heroIntro={
        <p>
          ...
          OnCall Home Repairs connects you with vetted Glasgow plumbers who
      ...
      serviceAreasHeading="Overflow Repair Across Glasgow"
      serviceAreasContent={
        <p>
          Our plumbers carry out overflow repairs across Glasgow, Partick,
          Hillhead, Govan, Pollokshields, and the wider Glasgow
      ...
      ctaContent={
        <p>
          Stop wasting water and prevent damp damage to your Glasgow home.
      ...
      serviceDescription="Overflow pipe repair in Glasgow. Diagnose and fix faulty ball valves, cisterns, and tank overflows with vetted local plumbers."
