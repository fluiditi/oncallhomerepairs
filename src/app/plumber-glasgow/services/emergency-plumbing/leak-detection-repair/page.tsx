...
export const metadata: Metadata = {
  title: "Leak Detection Glasgow | OnCall Home Repairs",
  description:
    "Professional leak detection and repair in Glasgow. Find and fix hidden leaks fast. Transparent pricing. Call 0333 240 8428.",
  alternates: {
    canonical:
      "https://oncallhomerepairs.co.uk/plumber-glasgow/services/emergency-plumbing/leak-detection-repair",
  },
};
...
export default function LeakDetectionRepairPage() {
  return (
    <ServicePage
      ...
      h1="Leak Detection and Repair in Glasgow"
      heroIntro={
        <p>
          ...
          connects you with skilled plumbers in Glasgow who specialise in
      ...
      whatWhyContent={
        <>
          ...
          <p>
            In Glasgow, many homes are built with traditional construction
          ...
          <p>
            ...
            <Link
              href="/plumber-glasgow/services/emergency-plumbing/overflow-repair"
              className="text-primary underline underline-offset-2 hover:text-primary/80"
            >
              overflowing cistern
            </Link>{" "}
      ...
      benefits={[
        ...
        },
        {
          ...
          description: (
            <p>
              Every plumber in our Glasgow network is qualified, insured, and
      ...
      serviceAreasHeading="Leak Detection Across Glasgow"
      serviceAreasContent={
        <p>
          Our leak detection service covers Glasgow and all nearby towns and
          villages. From Victorian terraces in Glasgow centre to modern estates
          in Partick and Hillhead, our plumbers are experienced with the
          property types and plumbing systems found across the area. Whether
          your leak is in a ground-floor flat in Govan or a detached house in
          Anniesland, we can match you with someone local who can investigate
          promptly.
        </p>
      }
      faqs={[
      ...
      ctaHeading="Suspect a Leak in Your Glasgow Home?"
      ctaContent={
        <p>
      ...
      serviceDescription="Professional leak detection and repair in Glasgow. Find and fix hidden leaks fast."
