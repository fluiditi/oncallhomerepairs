...
export const metadata: Metadata = {
  title: "Burst Pipe Repair Glasgow | OnCall Home Repairs",
  description:
    "Fast burst pipe repair in Glasgow. 24/7 emergency response from vetted plumbers. Transparent pricing. Call 0333 240 8428.",
  alternates: {
    canonical:
      "https://oncallhomerepairs.co.uk/plumber-glasgow/services/emergency-plumbing/burst-pipe-repair",
  },
};
...
export default function BurstPipeRepairPage() {
  return (
    <ServicePage
      ...
      h1="Burst Pipe Repair in Glasgow"
      heroIntro={
        <p>
          ...
          you with vetted, experienced plumbers in the Glasgow area who
      ...
      whatWhyContent={
        <>
          ...
          <p>
            Our network of plumbers in Glasgow arrives equipped with the
      ...
      serviceAreasHeading="Burst Pipe Repair Across Glasgow"
      serviceAreasContent={
        <p>
          We connect homeowners with burst pipe repair plumbers across Glasgow
          and the surrounding villages. Whether you are in Partick, Hillhead,
          Govan, or further afield in Pollokshields or Jordanhill, our
      ...
      ctaHeading="Burst Pipe in Glasgow? Act Now"
      ctaContent={
        <p>
      ...
      serviceDescription="Fast burst pipe repair in Glasgow. Emergency call-out available 24/7."
