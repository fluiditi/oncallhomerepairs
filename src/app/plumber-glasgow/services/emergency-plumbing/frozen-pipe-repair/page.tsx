...
export const metadata: Metadata = {
  title: "Frozen Pipe Repair Glasgow | OnCall Home Repairs",
  description:
    "Frozen pipe repair in Glasgow. Prevent burst pipes this winter. Vetted plumbers, 24/7. Call 0333 240 8428.",
  alternates: {
    canonical:
      "https://oncallhomerepairs.co.uk/plumber-glasgow/services/emergency-plumbing/frozen-pipe-repair",
  },
};
    ...
    <ServicePage
      breadcrumbItems={[
        ...
        { name: "Emergency Plumbing", href: "/plumber-glasgow/services/emergency-plumbing" },
        {
          ...
          href: "/plumber-glasgow/services/emergency-plumbing/frozen-pipe-repair",
        },
      ]}
      h1="Frozen Pipe Repair in Glasgow"
      heroIntro={
        <p>
          When temperatures across Glasgow drop below freezing, pipes in
      ...
      whatWhyHeading="Why Frozen Pipes Are a Serious Risk in Glasgow"
      whatWhyContent={
        <>
          <p>
            Glasgow sits in the East Midlands where winter temperatures
          ...
          <p>
            ...
            understands the specific risks Glasgow winters pose to local
      ...
      serviceAreasHeading="Frozen Pipe Repair Across Glasgow"
      serviceAreasContent={
        <p>
          Our plumbers attend frozen pipe emergencies across Glasgow, Partick,
          Hillhead, Govan, and the surrounding villages. Properties in
          ...
          Glasgow, we can connect you with a plumber who
      ...
      faqs={[
        ...
        {
          question:
            "How much does frozen pipe repair cost in Glasgow?",
          answer:
      ...
      ctaContent={
        <p>
          ...
          Home Repairs and we will connect you with a vetted plumber in Glasgow
      ...
      serviceDescription="Frozen pipe thawing and repair in Glasgow. Prevent burst pipes this winter with safe, professional pipe repair from vetted local plumbers."
