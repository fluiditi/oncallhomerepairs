...
export const metadata: Metadata = {
  title: "Flood Response Plumber Glasgow | OnCall Home Repairs",
  description:
    "Emergency flood response in Glasgow. Rapid water damage control by vetted plumbers, available 24/7. Call 0333 240 8428.",
  alternates: {
    canonical:
      "https://oncallhomerepairs.co.uk/plumber-glasgow/services/emergency-plumbing/flood-response",
  },
};
...
export default function FloodResponsePage() {
  return (
    <ServicePage
      ...
      h1="Flood Response Plumber in Glasgow"
      heroIntro={
        <p>
          ...
          experienced flood response plumbers in Glasgow who can reach your
      ...
      whatWhyContent={
        <>
          ...
          <p>
            Properties across Glasgow, Partick, and the surrounding villages
      ...
      relatedServices={[
        ...
        },
        {
          ...
          href: "/plumber-glasgow/services/emergency-plumbing/stopcock-repair",
        },
        {
      ...
      serviceAreasHeading="Flood Response Across Glasgow and Glasgow"
      serviceAreasContent={
        <p>
          Our flood response plumbers cover Glasgow town centre, Partick,
          Hillhead, Govan, Shawlands, and surrounding villages.
          Response times are fastest within the Glasgow and Partick area,
          with the wider Glasgow area typically reached
      ...
      ctaContent={
        <p>
          ...
          will have a vetted flood response plumber heading to your Glasgow
          property as quickly as possible.
        </p>
      }
      serviceName="Flood Response"
      serviceSlug="flood-response"
      serviceDescription="Emergency flood response plumber in Glasgow. Rapid water damage control, source isolation, and immediate repair by vetted local plumbers."
