...
export const metadata: Metadata = {
  title: "Boiler Breakdown Hinckley | OnCall Home Repairs",
  description:
    "Emergency boiler repairs by Gas Safe registered engineers, 24/7. Transparent pricing. Call 0333 240 8428.",
  alternates: {
    canonical:
      "https://oncallhomerepairs.co.uk/plumber-hinckley/services/gasfitter/boiler-breakdown",
  },
};
    ...
    <ServicePage
      breadcrumbItems={[
        ...
        { name: "Gasfitter", href: "/plumber-hinckley/services/gasfitter" },
        {
          ...
          href: "/plumber-hinckley/services/gasfitter/boiler-breakdown",
        },
      ]}
      h1="Boiler Breakdown in Hinckley"
      heroIntro={
        <p>
          Need boiler breakdown in Hinckley? OnCall Home Repairs connects you with
      ...
      whatWhyHeading="Why You Need Professional Boiler Breakdown in Hinckley"
      whatWhyContent={
        <>
          <p>
      ...
      relatedServices={[
        ...
        {
          name: "Call Out",
          href: "/plumber-hinckley/services/plumber/call-out",
        },
      ]}
      serviceAreasHeading="Boiler Breakdown Across Hinckley"
      serviceAreasContent={
        <p>
      ...
      faqs={[
        {
          question: "How much does boiler breakdown cost in Hinckley?",
          answer:
      ...
      ctaHeading="Need Boiler Breakdown in Hinckley?"
      ctaContent={
        <p>
