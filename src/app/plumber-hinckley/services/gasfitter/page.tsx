...
export const metadata: Metadata = {
  title: "Gasfitter Hinckley | Gas Fitting Services | OnCall Home Repairs",
  description:
    "Gas fitting services in Hinckley. Boiler breakdowns, gas appliance installation, and emergency gas work by Gas Safe registered engineers. Call 0333 240 8428.",
  alternates: {
    canonical: "https://oncallhomerepairs.co.uk/plumber-hinckley/services/gasfitter",
  },
};
  ...
  return (
    <CategoryPage
      breadcrumbItems={[
        ...
        { name: "Gasfitter", href: "/plumber-hinckley/services/gasfitter" },
      ]}
      h1="Gasfitter in Hinckley"
      heroIntro={
        <p>
          OnCall Home Repairs connects you with Gas Safe registered gas fitters
          in Hinckley and Leicestershire. Whether your boiler has broken down
          in the middle of winter or you need gas appliance work carried out
          safely, our network of vetted, qualified gas engineers is available
          24/7. Call 0333 240 8428 for a fast response and transparent pricing.
        </p>
      }
      overviewHeading="Professional Gas Fitting Services in Hinckley"
      overviewContent={
        <>
          <p>
          ...
          <p>
            ...
            installations, our gas fitters in Hinckley handle it all. They
      ...
      servicesHeading="Gas Fitting Services in Hinckley"
      ...
      serviceAreasHeading="Gas Fitting Across Hinckley"
      serviceAreasContent={
        <p>
          Our gas fitters cover Hinckley and all surrounding areas including
          Burbage, Earl Shilton, Barwell, Stoney Stanton, and beyond. Local
          engineers who know the area and can reach you quickly.
        </p>
      }
      faqs={[
        {
      ...
      ctaHeading="Need a Gas Fitter in Hinckley?"
      ctaContent={
        <p>
          Call OnCall Home Repairs on 0333 240 8428. We will connect you with
          a Gas Safe registered gas fitter in the Hinckley area. Available 24/7
          with transparent pricing and guaranteed workmanship.
        </p>
      }
      categoryName="Gasfitter"
      categoryDescription="Gas fitting services in Hinckley — boiler breakdowns, gas appliance installation, and emergency gas work by Gas Safe engineers."
    />
  );
}
