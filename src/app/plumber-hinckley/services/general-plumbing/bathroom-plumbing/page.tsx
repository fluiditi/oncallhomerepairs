...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical:
      "https://oncallhomerepairs.co.uk/plumber-hinckley/services/general-plumbing/bathroom-plumbing",
  },
};
      ...
      whatWhyContent={
        <>
          ...
          <p>
            ...
            will support the{" "}
            <Link
              href="/plumber-hinckley/services/general-plumbing/shower-installation-repair"
              className="text-primary underline underline-offset-2 hover:text-primary/80"
            >
              shower
            </Link>{" "}
