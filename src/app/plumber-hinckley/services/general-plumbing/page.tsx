...
export const metadata: Metadata = {
  title: "General Plumbing Hinckley | OnCall Home Repairs",
  description:
    "Bathroom and kitchen plumbing, tap repairs, and shower installation in Hinckley. Vetted local plumbers. Call 0333 240 8428.",
  alternates: {
    canonical: "https://oncallhomerepairs.co.uk/plumber-hinckley/services/general-plumbing",
  },
};
  ...
  return (
    <CategoryPage
      breadcrumbItems={[
        ...
        { name: "General Plumbing", href: "/plumber-hinckley/services/general-plumbing" },
      ]}
      h1="General Plumbing Services in Hinckley"
      heroIntro={
        <>
          <p>
            ...
            plumbers in Hinckley for all your household plumbing needs. Whether
            you are planning a{" "}
            <a href="/plumber-hinckley/services/general-plumbing/bathroom-plumbing" className="underline hover:text-white">
              bathroom installation
            </a>{" "}
            or just need a{" "}
            <a href="/plumber-hinckley/services/general-plumbing/tap-repair-replacement" className="underline hover:text-white">
              tap replaced
            </a>
      ...
      overviewContent={
        <>
          ...
          <p>
            Our network of plumbers in Hinckley handles everything from small
            repairs to larger projects like{" "}
            <a href="/plumber-hinckley/services/general-plumbing/bathroom-plumbing" className="text-primary underline hover:text-primary/80">
              bathroom fit-outs
            </a>{" "}
            and{" "}
            <a href="/plumber-hinckley/services/general-plumbing/kitchen-plumbing" className="text-primary underline hover:text-primary/80">
              kitchen plumbing
            </a>
            . Every plumber is qualified, insured, and experienced in working
            with modern and older Leicestershire properties alike. You get a
          ...
          <p>
            ...
            pipework that needs{" "}
            <a href="/plumber-hinckley/services/general-plumbing/pipe-replacement" className="text-primary underline hover:text-primary/80">
              replacing
            </a>
            , or a problem that needs{" "}
            <a href="/plumber-hinckley/services/drain-services" className="text-primary underline hover:text-primary/80">
              drainage investigation
            </a>{" "}
            — we can coordinate the right specialist. And if your{" "}
            <a href="/plumber-hinckley/services/boiler-heating" className="text-primary underline hover:text-primary/80">
              boiler or heating
            </a>{" "}
      ...
      services={[
        ...
        },
        {
          ...
          description:
            "Copper, plastic, and lead pipe replacement for ageing Hinckley properties. Upgrade old pipework to meet current standards and improve water pressure and quality.",
          isCoreService: false,
        },
      ]}
      ...
      crossLinks={[
        ...
        },
        {
          ...
          description:
            "Blocked drains, CCTV surveys, and toilet unblocking — professional drainage specialists across Hinckley.",
        },
      ]}
      serviceAreasHeading="General Plumbing Across Hinckley and Beyond"
      serviceAreasContent={
        <p>
          Our network of plumbers serves Hinckley and the surrounding towns
          and villages across south-west Leicestershire. Whether your property
          is in Stoney Stanton, Ratby, Market Bosworth, or Markfield, we
      ...
      faqs={[
        ...
        },
        {
          ...
          answer:
            "Discoloured water, frequent leaks at joints, low water pressure, and visible corrosion on exposed pipes are all signs your pipework may need attention. Properties in Hinckley with original lead pipework should have it replaced for health and safety reasons. A plumber can inspect your system and advise on whether a partial or full re-pipe is needed.",
        },
      ]}
      ctaHeading="Need a Plumber in Hinckley? We Will Find You One."
      ctaContent={
        <p>
          Call OnCall Home Repairs and tell us what you need. We will match you
          with a qualified, vetted plumber in Hinckley who can handle the job —
          whether it is a quick repair or a bigger project.
        </p>
      }
      categoryName="General Plumbing"
      categoryDescription="Bathroom and kitchen plumbing, tap repairs, shower installations, and pipe replacements in Hinckley by vetted, qualified plumbers."
    />
  );
}
