...
export const metadata: Metadata = {
  title: "Kitchen Plumber Hinckley | OnCall Home Repairs",
  description:
    "Kitchen plumbing in Hinckley. Sink installations, dishwasher connections, waste disposal, and repairs. Call 0333 240 8428.",
  alternates: {
    canonical:
      "https://oncallhomerepairs.co.uk/plumber-hinckley/services/general-plumbing/kitchen-plumbing",
  },
};
    ...
    <ServicePage
      breadcrumbItems={[
        ...
        { name: "General Plumbing", href: "/plumber-hinckley/services/general-plumbing" },
        {
          ...
          href: "/plumber-hinckley/services/general-plumbing/kitchen-plumbing",
        },
      ]}
      h1="Kitchen Plumbing in Hinckley"
      heroIntro={
        <p>
          ...
          Hinckley who install, repair, and maintain kitchen plumbing &mdash;
      ...
      whatWhyContent={
        <>
          ...
          <p>
            Blocked kitchen sinks are a regular call-out in Hinckley. Grease,
            ...
            <a
              href="/plumber-hinckley/services/drain-services/drain-unblocking"
      ...
      relatedServices={[
        ...
        },
        {
          ...
          href: "/plumber-hinckley/services/general-plumbing/pipe-replacement",
        },
      ]}
      serviceAreasHeading="Kitchen Plumbing Across Hinckley"
      serviceAreasContent={
        <p>
          Our plumbers carry out kitchen plumbing work across Hinckley,
          Burbage, Earl Shilton, Barwell, Stoke Golding, Dadlington, Market
      ...
      ctaContent={
        <p>
          ...
          Repairs will match you with a qualified plumber in Hinckley. Call
          for a clear, upfront quote.
        </p>
      }
      serviceName="Kitchen Plumbing"
      serviceSlug="kitchen-plumbing"
      serviceDescription="Kitchen plumbing in Hinckley. Sink installations, appliance connections, waste pipe repairs, and full kitchen plumbing by vetted local plumbers."
