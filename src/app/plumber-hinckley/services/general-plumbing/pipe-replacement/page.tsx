...
export const metadata: Metadata = {
  title: "Pipe Replacement Hinckley | OnCall Home Repairs",
  description:
    "Pipe replacement in Hinckley. Copper, plastic, and lead pipe upgrades by vetted plumbers. Transparent pricing. Call 0333 240 8428.",
  alternates: {
    canonical:
      "https://oncallhomerepairs.co.uk/plumber-hinckley/services/general-plumbing/pipe-replacement",
  },
};
...
export default function PipeReplacementPage() {
  return (
    <ServicePage
      ...
      h1="Pipe Replacement in Hinckley"
      heroIntro={
        <p>
          ...
          connects you with qualified plumbers in Hinckley who replace old
      ...
      whatWhyContent={
        <>
          <p>
            ...
            Hinckley properties &mdash; pose a health risk and should be
      ...
      serviceAreasHeading="Pipe Replacement Across Hinckley"
      serviceAreasContent={
        <p>
          Our plumbers replace pipework in properties across Hinckley, Burbage,
          Earl Shilton, Barwell, Markfield, Groby, and all surrounding areas.
      ...
      ctaContent={
        <p>
          ...
          in Hinckley who can assess your pipes and carry out replacements
          that last.
        </p>
      }
      serviceName="Pipe Replacement"
      serviceSlug="pipe-replacement"
      serviceDescription="Pipe replacement in Hinckley. Copper, plastic, and lead pipe upgrades for homes and businesses by vetted local plumbers."
