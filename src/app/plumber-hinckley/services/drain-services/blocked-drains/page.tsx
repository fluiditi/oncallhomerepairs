...
export const metadata: Metadata = {
  title: "Blocked Drains Hinckley | OnCall Home Repairs",
  description:
    "Blocked drain clearing in Hinckley. Fast, effective unblocking for homes and businesses. Call 0333 240 8428.",
  alternates: {
    canonical:
      "https://oncallhomerepairs.co.uk/plumber-hinckley/services/drain-services/blocked-drains",
  },
};
    ...
    <ServicePage
      ...
      heroIntro={
        <p>
          ...
          drainage plumbers in Hinckley who can clear blockages quickly and
      ...
      serviceAreasHeading="Blocked Drain Clearing Across Hinckley"
      serviceAreasContent={
        <p>
          Our drainage plumbers cover Hinckley and every surrounding town and
          village. From terraced properties in Hinckley centre with shared
          drainage runs to detached homes in Burbage, Earl Shilton, and Market
      ...
      ctaHeading="Blocked Drain in Hinckley?"
      ctaContent={
        <p>
      ...
      serviceDescription="Blocked drain clearing in Hinckley. Fast, effective unblocking for homes and businesses."
