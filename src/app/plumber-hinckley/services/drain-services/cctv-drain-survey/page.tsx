...
export const metadata: Metadata = {
  title: "CCTV Drain Survey Hinckley | OnCall Home Repairs",
  description:
    "CCTV drain survey in Hinckley. Camera inspection to diagnose drainage problems accurately. Vetted engineers. Call 0333 240 8428.",
  alternates: {
    canonical:
      "https://oncallhomerepairs.co.uk/plumber-hinckley/services/drain-services/cctv-drain-survey",
  },
};
...
export default function CCTVDrainSurveyPage() {
  return (
    <ServicePage
      ...
      h1="CCTV Drain Survey in Hinckley"
      heroIntro={
        <p>
          ...
          engineers in Hinckley who use professional camera equipment to inspect
      ...
      whatWhyContent={
        <>
          ...
          <p>
            Homebuyers in Hinckley increasingly request drain surveys as part
            of their pre-purchase checks. Older properties in the town centre,
            around Argents Mead, and in the established estates off Leicester
      ...
      serviceAreasHeading="CCTV Drain Surveys Across Hinckley"
      serviceAreasContent={
        <p>
          Our drain engineers carry out CCTV surveys across Hinckley, Burbage,
          Earl Shilton, Barwell, Market Bosworth, Ratby, Groby, and all
      ...
      faqs={[
        {
          question: "How much does a CCTV drain survey cost in Hinckley?",
          answer:
      ...
      ctaContent={
        <p>
          ...
          we will connect you with a drain engineer in Hinckley who can carry
      ...
      serviceDescription="CCTV drain survey in Hinckley. Professional camera inspection to diagnose drainage problems, root intrusion, and pipe damage."
