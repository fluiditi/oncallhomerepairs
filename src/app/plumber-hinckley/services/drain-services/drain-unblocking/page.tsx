...
export const metadata: Metadata = {
  title: "Drain Unblocking Hinckley | OnCall Home Repairs",
  description:
    "Professional drain unblocking in Hinckley. High-pressure jetting and manual rodding. Vetted plumbers. Call 0333 240 8428.",
  alternates: {
    canonical:
      "https://oncallhomerepairs.co.uk/plumber-hinckley/services/drain-services/drain-unblocking",
  },
};
...
export default function DrainUnblockingPage() {
  return (
    <ServicePage
      ...
      h1="Drain Unblocking in Hinckley"
      heroIntro={
        <p>
          ...
          experienced drain engineers in Hinckley who use professional-grade
      ...
      whatWhyContent={
        <>
          <p>
            Most drain blockages in Hinckley homes are caused by a gradual
      ...
      relatedServices={[
        ...
        },
        {
          ...
          href: "/plumber-hinckley/services/drain-services/toilet-unblocking",
        },
      ]}
      serviceAreasHeading="Drain Unblocking Across Hinckley"
      serviceAreasContent={
        <p>
          Our drain engineers cover Hinckley, Burbage, Earl Shilton, Barwell,
          Dadlington, Stoke Golding, and the surrounding area. External drain
      ...
      ctaContent={
        <p>
          ...
          Hinckley who can clear the blockage and restore full flow.
        </p>
      }
      serviceName="Drain Unblocking"
      serviceSlug="drain-unblocking"
      serviceDescription="Professional drain unblocking in Hinckley using high-pressure jetting and manual rodding. Fast, effective clearance for homes and businesses."
