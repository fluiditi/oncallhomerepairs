...
export const metadata: Metadata = {
  title: "Leaking Taps Hinckley | OnCall Home Repairs",
  description:
    "Stop dripping taps fast with a vetted local plumber. Transparent pricing. Call 0333 240 8428.",
  alternates: {
    canonical:
      "https://oncallhomerepairs.co.uk/plumber-hinckley/services/plumber/leaking-taps",
  },
};
  ...
  return (
    <ServicePage
      breadcrumbItems={[
        ...
        {
          name: "Leaking Taps",
          href: "/plumber-hinckley/services/plumber/leaking-taps",
        },
      ]}
      h1="Leaking Taps in Hinckley"
      heroIntro={
        <p>
          Need leaking taps in Hinckley? OnCall Home Repairs connects you with
      ...
      whatWhyHeading="Why You Need Professional Leaking Taps in Hinckley"
      whatWhyContent={
        <>
          <p>
            Leaking Taps is not something to leave to chance. Poorly fitted or
      ...
      processHeading="How Leaking Taps Works with OnCall"
      processSteps={[
        {
      ...
      serviceAreasHeading="Leaking Taps Across Hinckley"
      serviceAreasContent={
        <p>
      ...
      faqs={[
        {
          question: "How much does leaking taps cost in Hinckley?",
          answer:
        ...
        {
          question: "How quickly can you send a plumber for leaking taps?",
          answer:
      ...
      ctaHeading="Need Leaking Taps in Hinckley?"
      ctaContent={
        <p>
      ...
      serviceName="Leaking Taps"
      serviceSlug="leaking-taps"
      serviceDescription="Stop dripping taps fast with a vetted local plumber."
