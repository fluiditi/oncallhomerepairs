...
export const metadata: Metadata = {
  title: "Boiler Servicing Hinckley | OnCall Home Repairs",
  description:
    "Annual boiler servicing in Hinckley. Keep your warranty valid and your boiler running efficiently. Gas Safe engineers. Call 0333 240 8428.",
  alternates: {
    canonical:
      "https://oncallhomerepairs.co.uk/plumber-hinckley/services/plumber/boiler-servicing",
  },
};
...
export default function BoilerServicingPage() {
  return (
    <ServicePage
      ...
      h1="Boiler Servicing in Hinckley"
      heroIntro={
        <p>
          ...
          connects you with Gas Safe registered engineers in Hinckley who carry
      ...
      serviceAreasHeading="Boiler Servicing Across Hinckley"
      serviceAreasContent={
        <p>
          Our Gas Safe registered engineers service boilers across Hinckley,
          Burbage, Earl Shilton, Barwell, Sapcote, Stoney Stanton, and
      ...
      ctaContent={
        <p>
          ...
          Gas Safe registered engineer in Hinckley.
        </p>
      }
      serviceName="Boiler Servicing"
      serviceSlug="boiler-servicing"
      serviceDescription="Annual boiler servicing in Hinckley by Gas Safe registered engineers. Manufacturer warranty protection, safety checks, and efficiency testing."
