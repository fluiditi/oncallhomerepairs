...
export const metadata: Metadata = {
  title: "Leak Detection Hinckley | OnCall Home Repairs",
  description:
    "Professional leak detection and repair in Hinckley. Find and fix hidden leaks fast. Transparent pricing. Call 0333 240 8428.",
  alternates: {
    canonical:
      "https://oncallhomerepairs.co.uk/plumber-hinckley/services/plumber/plumbing-leak-detection",
  },
};
...
export default function LeakDetectionRepairPage() {
  return (
    <ServicePage
      ...
      h1="Leak Detection and Repair in Hinckley"
      heroIntro={
        <p>
          ...
          connects you with skilled plumbers in Hinckley who specialise in
      ...
      whatWhyContent={
        <>
          ...
          <p>
            In Hinckley, many homes are built with traditional construction
      ...
      benefits={[
        ...
        },
        {
          ...
          description: (
            <p>
              Every plumber in our Hinckley network is qualified, insured, and
      ...
      serviceAreasHeading="Leak Detection Across Hinckley"
      serviceAreasContent={
        <p>
          Our leak detection service covers Hinckley and all nearby towns and
          villages. From Victorian terraces in Hinckley centre to modern estates
          in Burbage and Earl Shilton, our plumbers are experienced with the
          property types and plumbing systems found across the area. Whether
          your leak is in a ground-floor flat in Barwell or a detached house in
          Desford, we can match you with someone local who can investigate
          promptly.
        </p>
      }
      faqs={[
      ...
      ctaHeading="Suspect a Leak in Your Hinckley Home?"
      ctaContent={
        <p>
      ...
      serviceDescription="Professional leak detection and repair in Hinckley. Find and fix hidden leaks fast."
