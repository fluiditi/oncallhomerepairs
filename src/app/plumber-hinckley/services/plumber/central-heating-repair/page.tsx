...
export const metadata: Metadata = {
  title: "Central Heating Repair Hinckley | OnCall Home Repairs",
  description:
    "Central heating repair in Hinckley. Radiators, pumps, valves, thermostats. Gas Safe engineers. Call 0333 240 8428.",
  alternates: {
    canonical:
      "https://oncallhomerepairs.co.uk/plumber-hinckley/services/plumber/central-heating-repair",
  },
};
...
export default function CentralHeatingRepairPage() {
  return (
    <ServicePage
      ...
      h1="Central Heating Repair in Hinckley"
      heroIntro={
        <p>
          When your central heating is not working properly, your home becomes
          uncomfortable fast — especially during a Leicestershire winter. Cold
          ...
          engineers in Hinckley who diagnose and repair central heating faults
      ...
      whatWhyContent={
        <>
          ...
          <p>
            ...
            <Link
              href="/plumber-hinckley/services/plumber/power-flushing"
              className="text-primary underline underline-offset-2 hover:text-primary/80"
            >
              power flush
            </Link>{" "}
      ...
      benefits={[
        {
          ...
          description: (
            <p>
              ...
              systems and understand the common faults found in Hinckley
              properties.
            </p>
          ),
        },
      ...
      relatedServices={[
        ...
        },
        {
          ...
          href: "/plumber-hinckley/services/plumber/radiator-repair-installation",
        },
        {
          name: "Power Flushing",
          href: "/plumber-hinckley/services/plumber/power-flushing",
      ...
      serviceAreasHeading="Central Heating Repair Across Hinckley"
      serviceAreasContent={
        <p>
          Our heating engineers cover Hinckley and the surrounding towns and
          villages throughout south-west Leicestershire. From older properties
          in Hinckley town centre to newer-build estates in Barwell, Sapcote,
          and Stoney Stanton, our engineers are familiar with the heating
      ...
      ctaContent={
        <p>
          ...
          a qualified heating engineer in Hinckley who can diagnose and fix the
      ...
      serviceDescription="Central heating repair in Hinckley. Radiators, pumps, valves, and full system diagnostics."
