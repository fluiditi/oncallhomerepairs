...
export const metadata: Metadata = {
  title: "Water Tank Installation Hinckley | OnCall Home Repairs",
  description:
    "Cold water tanks, header tanks, and storage tank fitting. Transparent pricing. Call 0333 240 8428.",
  alternates: {
    canonical:
      "https://oncallhomerepairs.co.uk/plumber-hinckley/services/plumber/water-tank-installation",
  },
};
...
export default function WaterTankInstallationPage() {
  return (
    <ServicePage
      ...
      h1="Water Tank Installation in Hinckley"
      heroIntro={
        <p>
          Need water tank installation in Hinckley? OnCall Home Repairs connects you with
      ...
      whatWhyHeading="Why You Need Professional Water Tank Installation in Hinckley"
      whatWhyContent={
        <>
          <p>
      ...
      relatedServices={[
        ...
        },
        {
          ...
          href: "/plumber-hinckley/services/plumber/water-heater-installation",
        },
        {
        ...
        },
        {
          ...
          href: "/plumber-hinckley/services/plumber/hot-water-systems",
        },
      ]}
      serviceAreasHeading="Water Tank Installation Across Hinckley"
      serviceAreasContent={
        <p>
      ...
      faqs={[
        {
          question: "How much does water tank installation cost in Hinckley?",
          answer:
      ...
      ctaHeading="Need Water Tank Installation in Hinckley?"
      ctaContent={
        <p>
