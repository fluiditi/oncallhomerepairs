...
export const metadata: Metadata = {
  title: "Tap Installation Hinckley | OnCall Home Repairs",
  description:
    "Kitchen and bathroom taps fitted by vetted local plumbers. Transparent pricing. Call 0333 240 8428.",
  alternates: {
    canonical:
      "https://oncallhomerepairs.co.uk/plumber-hinckley/services/plumber/tap-installation",
  },
};

export default function TapInstallationPage() {
  return (
    <ServicePage
      breadcrumbItems={[
        ...
        { name: "Plumber", href: "/plumber-hinckley/services/plumber" },
        {
          ...
          href: "/plumber-hinckley/services/plumber/tap-installation",
        },
      ]}
      h1="Tap Installation in Hinckley"
      heroIntro={
        <p>
          Need tap installation in Hinckley? OnCall Home Repairs connects you with
      ...
      whatWhyHeading="Why You Need Professional Tap Installation in Hinckley"
      whatWhyContent={
        <>
          <p>
            Tap Installation is not something to leave to chance. Poorly fitted or
      ...
      processHeading="How Tap Installation Works with OnCall"
      processSteps={[
        {
      ...
      relatedServices={[
        {
          name: "Tap Repair",
          href: "/plumber-hinckley/services/plumber/tap-repair",
        },
        {
        ...
        },
        {
          ...
          href: "/plumber-hinckley/services/plumber/shower-installation",
        },
      ]}
      serviceAreasHeading="Tap Installation Across Hinckley"
      serviceAreasContent={
        <p>
      ...
      faqs={[
        {
          question: "How much does tap installation cost in Hinckley?",
          answer:
        ...
        {
          question: "How quickly can you send a plumber for tap installation?",
          answer:
      ...
      ctaHeading="Need Tap Installation in Hinckley?"
      ctaContent={
        <p>
      ...
      serviceName="Tap Installation"
      serviceSlug="tap-installation"
      serviceDescription="Kitchen and bathroom taps fitted by vetted local plumbers."
