...
export const metadata: Metadata = {
  title: "Leak Hinckley | OnCall Home Repairs",
  description:
    "Leaking pipes, toilets, radiators, and taps fixed by vetted plumbers. Transparent pricing. Call 0333 240 8428.",
  alternates: {
    canonical:
      "https://oncallhomerepairs.co.uk/plumber-hinckley/services/plumber/leak",
  },
};
...
export default function LeakPage() {
  return (
    <ServicePage
      ...
      heroIntro={
        <p>
          Need leak in Hinckley? OnCall Home Repairs connects you with
      ...
      whatWhyHeading="Why You Need Professional Leak in Hinckley"
      whatWhyContent={
        <>
          <p>
      ...
      serviceAreasHeading="Leak Across Hinckley"
      serviceAreasContent={
        <p>
      ...
      faqs={[
        {
          question: "How much does leak cost in Hinckley?",
          answer:
      ...
      ctaHeading="Need Leak in Hinckley?"
      ctaContent={
        <p>
