...
export const metadata: Metadata = {
  title: "Commercial Gas Hinckley | OnCall Home Repairs",
  description:
    "Gas Safe engineers for restaurants, offices, and commercial premises. Transparent pricing. Call 0333 240 8428.",
  alternates: {
    canonical:
      "https://oncallhomerepairs.co.uk/plumber-hinckley/services/plumber/commercial-gas",
  },
};
...
export default function CommercialGasPage() {
  return (
    <ServicePage
      ...
      h1="Commercial Gas in Hinckley"
      heroIntro={
        <p>
          Need commercial gas in Hinckley? OnCall Home Repairs connects you with
      ...
      whatWhyHeading="Why You Need Professional Commercial Gas in Hinckley"
      whatWhyContent={
        <>
          <p>
      ...
      serviceAreasHeading="Commercial Gas Across Hinckley"
      serviceAreasContent={
        <p>
      ...
      faqs={[
        {
          question: "How much does commercial gas cost in Hinckley?",
          answer:
      ...
      ctaHeading="Need Commercial Gas in Hinckley?"
      ctaContent={
        <p>
