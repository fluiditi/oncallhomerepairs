...
export const metadata: Metadata = {
  title: "Plumbing Leak Repair Hinckley | OnCall Home Repairs",
  description:
    "Fast fixes for leaking pipes, joints, and fittings. Transparent pricing. Call 0333 240 8428.",
  alternates: {
    canonical:
      "https://oncallhomerepairs.co.uk/plumber-hinckley/services/plumber/plumbing-leak-repair",
  },
};
...
export default function PlumbingLeakRepairPage() {
  return (
    <ServicePage
      ...
      h1="Plumbing Leak Repair in Hinckley"
      heroIntro={
        <p>
          Need plumbing leak repair in Hinckley? OnCall Home Repairs connects you with
      ...
      whatWhyHeading="Why You Need Professional Plumbing Leak Repair in Hinckley"
      whatWhyContent={
        <>
          <p>
      ...
      relatedServices={[
        ...
        {
          name: "Leak",
          href: "/plumber-hinckley/services/plumber/leak",
        },
        {
          name: "Burst Pipes",
      ...
      serviceAreasHeading="Plumbing Leak Repair Across Hinckley"
      serviceAreasContent={
        <p>
      ...
      faqs={[
        {
          question: "How much does plumbing leak repair cost in Hinckley?",
          answer:
      ...
      ctaHeading="Need Plumbing Leak Repair in Hinckley?"
      ctaContent={
        <p>
