...
export const metadata: Metadata = {
  title: "Landlord Certificate Hinckley | OnCall Home Repairs",
  description:
    "CP12 certificates issued by Gas Safe registered engineers. Transparent pricing. Call 0333 240 8428.",
  alternates: {
    canonical:
      "https://oncallhomerepairs.co.uk/plumber-hinckley/services/plumber/landlord-certificate",
  },
};
...
export default function LandlordCertificatePage() {
  return (
    <ServicePage
      ...
      h1="Landlord Certificate in Hinckley"
      heroIntro={
        <p>
          Need landlord certificate in Hinckley? OnCall Home Repairs connects you with
      ...
      whatWhyHeading="Why You Need Professional Landlord Certificate in Hinckley"
      whatWhyContent={
        <>
          <p>
      ...
      serviceAreasHeading="Landlord Certificate Across Hinckley"
      serviceAreasContent={
        <p>
      ...
      faqs={[
        {
          question: "How much does landlord certificate cost in Hinckley?",
          answer:
      ...
      ctaHeading="Need Landlord Certificate in Hinckley?"
      ctaContent={
        <p>
