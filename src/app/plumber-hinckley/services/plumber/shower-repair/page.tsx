...
export const metadata: Metadata = {
  title: "Shower Repair Hinckley | OnCall Home Repairs",
  description:
    "Fix leaks, low pressure, temperature issues, and broken valves. Transparent pricing. Call 0333 240 8428.",
  alternates: {
    canonical:
      "https://oncallhomerepairs.co.uk/plumber-hinckley/services/plumber/shower-repair",
  },
};

export default function ShowerRepairPage() {
  return (
    <ServicePage
      breadcrumbItems={[
        ...
        {
          name: "Shower Repair",
          href: "/plumber-hinckley/services/plumber/shower-repair",
        },
      ]}
      h1="Shower Repair in Hinckley"
      heroIntro={
        <p>
          Need shower repair in Hinckley? OnCall Home Repairs connects you with
      ...
      whatWhyHeading="Why You Need Professional Shower Repair in Hinckley"
      whatWhyContent={
        <>
          <p>
            Shower Repair is not something to leave to chance. Poorly fitted or
      ...
      processHeading="How Shower Repair Works with OnCall"
      processSteps={[
        {
      ...
      serviceAreasHeading="Shower Repair Across Hinckley"
      serviceAreasContent={
        <p>
      ...
      faqs={[
        {
          question: "How much does shower repair cost in Hinckley?",
          answer:
        ...
        {
          question: "How quickly can you send a plumber for shower repair?",
          answer:
      ...
      ctaHeading="Need Shower Repair in Hinckley?"
      ctaContent={
        <p>
      ...
      serviceName="Shower Repair"
      serviceSlug="shower-repair"
      serviceDescription="Fix leaks, low pressure, temperature issues, and broken valves."
