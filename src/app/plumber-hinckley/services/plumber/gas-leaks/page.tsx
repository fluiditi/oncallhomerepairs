...
export const metadata: Metadata = {
  title: "Gas Leaks Hinckley | OnCall Home Repairs",
  description:
    "24/7 emergency response from Gas Safe engineers for gas leaks. Transparent pricing. Call 0333 240 8428.",
  alternates: {
    canonical:
      "https://oncallhomerepairs.co.uk/plumber-hinckley/services/plumber/gas-leaks",
  },
};
  ...
  return (
    <ServicePage
      breadcrumbItems={[
        ...
        {
          name: "Gas Leaks",
          href: "/plumber-hinckley/services/plumber/gas-leaks",
        },
      ]}
      h1="Gas Leaks in Hinckley"
      heroIntro={
        <p>
          Need gas leaks in Hinckley? OnCall Home Repairs connects you with
      ...
      whatWhyHeading="Why You Need Professional Gas Leaks in Hinckley"
      whatWhyContent={
        <>
          <p>
      ...
      serviceAreasHeading="Gas Leaks Across Hinckley"
      serviceAreasContent={
        <p>
      ...
      faqs={[
        {
          question: "How much does gas leaks cost in Hinckley?",
          answer:
      ...
      ctaHeading="Need Gas Leaks in Hinckley?"
      ctaContent={
        <p>
