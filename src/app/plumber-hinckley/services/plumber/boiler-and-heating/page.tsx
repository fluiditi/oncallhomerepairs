...
export const metadata: Metadata = {
  title: "Boiler And Heating Hinckley | OnCall Home Repairs",
  description:
    "Repairs, installations, and servicing by Gas Safe engineers. Transparent pricing. Call 0333 240 8428.",
  alternates: {
    canonical:
      "https://oncallhomerepairs.co.uk/plumber-hinckley/services/plumber/boiler-and-heating",
  },
};
...
export default function BoilerAndHeatingPage() {
  return (
    <ServicePage
      ...
      h1="Boiler And Heating in Hinckley"
      heroIntro={
        <p>
          Need boiler and heating in Hinckley? OnCall Home Repairs connects you with
      ...
      whatWhyHeading="Why You Need Professional Boiler And Heating in Hinckley"
      whatWhyContent={
        <>
          <p>
      ...
      serviceAreasHeading="Boiler And Heating Across Hinckley"
      serviceAreasContent={
        <p>
      ...
      faqs={[
        {
          question: "How much does boiler and heating cost in Hinckley?",
          answer:
      ...
      ctaHeading="Need Boiler And Heating in Hinckley?"
      ctaContent={
        <p>
