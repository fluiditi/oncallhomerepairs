...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical:
      "https://oncallhomerepairs.co.uk/plumber-hinckley/services/plumber/emergency-plumbing",
  },
};
...
export default function EmergencyPlumbingPage() {
  return (
    <ServicePage
      ...
      h1="Emergency Plumbing in Hinckley"
      heroIntro={
        <p>
          Need emergency plumbing in Hinckley? OnCall Home Repairs connects you with
      ...
      whatWhyHeading="Why You Need Professional Emergency Plumbing in Hinckley"
      whatWhyContent={
        <>
          <p>
      ...
      serviceAreasHeading="Emergency Plumbing Across Hinckley"
      serviceAreasContent={
        <p>
      ...
      faqs={[
        {
          question: "How much does emergency plumbing cost in Hinckley?",
          answer:
      ...
      ctaHeading="Need Emergency Plumbing in Hinckley?"
      ctaContent={
        <p>
