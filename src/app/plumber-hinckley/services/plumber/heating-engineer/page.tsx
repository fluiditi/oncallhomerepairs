...
export const metadata: Metadata = {
  title: "Heating Engineer Hinckley | OnCall Home Repairs",
  description:
    "Central heating repairs, installations, and servicing. Transparent pricing. Call 0333 240 8428.",
  alternates: {
    canonical:
      "https://oncallhomerepairs.co.uk/plumber-hinckley/services/plumber/heating-engineer",
  },
};
...
export default function HeatingEngineerPage() {
  return (
    <ServicePage
      ...
      h1="Heating Engineer in Hinckley"
      heroIntro={
        <p>
          Need heating engineer in Hinckley? OnCall Home Repairs connects you with
      ...
      whatWhyHeading="Why You Need Professional Heating Engineer in Hinckley"
      whatWhyContent={
        <>
          <p>
      ...
      serviceAreasHeading="Heating Engineer Across Hinckley"
      serviceAreasContent={
        <p>
      ...
      faqs={[
        {
          question: "How much does heating engineer cost in Hinckley?",
          answer:
      ...
      ctaHeading="Need Heating Engineer in Hinckley?"
      ctaContent={
        <p>
