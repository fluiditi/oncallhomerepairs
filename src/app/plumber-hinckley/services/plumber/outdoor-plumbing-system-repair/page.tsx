...
export const metadata: Metadata = {
  title: "Outdoor Plumbing System Repair Hinckley | OnCall Home Repairs",
  description:
    "External pipes, garden taps, and drainage fixes. Transparent pricing. Call 0333 240 8428.",
  alternates: {
    canonical:
      "https://oncallhomerepairs.co.uk/plumber-hinckley/services/plumber/outdoor-plumbing-system-repair",
  },
};
    ...
    <ServicePage
      breadcrumbItems={[
        ...
        { name: "Plumber", href: "/plumber-hinckley/services/plumber" },
        {
          ...
          href: "/plumber-hinckley/services/plumber/outdoor-plumbing-system-repair",
        },
      ]}
      h1="Outdoor Plumbing System Repair in Hinckley"
      heroIntro={
        <p>
          Need outdoor plumbing system repair in Hinckley? OnCall Home Repairs connects you with
      ...
      whatWhyHeading="Why You Need Professional Outdoor Plumbing System Repair in Hinckley"
      whatWhyContent={
        <>
          <p>
      ...
      serviceAreasHeading="Outdoor Plumbing System Repair Across Hinckley"
      serviceAreasContent={
        <p>
      ...
      faqs={[
        {
          question: "How much does outdoor plumbing system repair cost in Hinckley?",
          answer:
      ...
      ctaHeading="Need Outdoor Plumbing System Repair in Hinckley?"
      ctaContent={
        <p>
