...
export const metadata: Metadata = {
  title: "Commercial Gas Engineers Hinckley | OnCall Home Repairs",
  description:
    "Gas Safe registered engineers for business premises. Transparent pricing. Call 0333 240 8428.",
  alternates: {
    canonical:
      "https://oncallhomerepairs.co.uk/plumber-hinckley/services/plumber/commercial-gas-engineers",
  },
};
    ...
    <ServicePage
      breadcrumbItems={[
        ...
        { name: "Plumber", href: "/plumber-hinckley/services/plumber" },
        {
          ...
          href: "/plumber-hinckley/services/plumber/commercial-gas-engineers",
        },
      ]}
      h1="Commercial Gas Engineers in Hinckley"
      heroIntro={
        <p>
          Need commercial gas engineers in Hinckley? OnCall Home Repairs connects you with
      ...
      whatWhyHeading="Why You Need Professional Commercial Gas Engineers in Hinckley"
      whatWhyContent={
        <>
          <p>
      ...
      relatedServices={[
        {
          name: "Commercial Gas",
          href: "/plumber-hinckley/services/plumber/commercial-gas",
        },
        {
          name: "Domestic And Commercial",
          href: "/plumber-hinckley/services/plumber/domestic-and-commercial",
        },
        {
          name: "Gas Safety Certificate",
          href: "/plumber-hinckley/services/plumber/gas-safety-certificate",
        },
        {
      ...
      serviceAreasHeading="Commercial Gas Engineers Across Hinckley"
      serviceAreasContent={
        <p>
      ...
      faqs={[
        {
          question: "How much does commercial gas engineers cost in Hinckley?",
          answer:
      ...
      ctaHeading="Need Commercial Gas Engineers in Hinckley?"
      ctaContent={
        <p>
