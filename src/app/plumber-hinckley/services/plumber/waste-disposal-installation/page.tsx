...
export const metadata: Metadata = {
  title: "Waste Disposal Installation Hinckley | OnCall Home Repairs",
  description:
    "Kitchen waste disposal units fitted by qualified plumbers. Transparent pricing. Call 0333 240 8428.",
  alternates: {
    canonical:
      "https://oncallhomerepairs.co.uk/plumber-hinckley/services/plumber/waste-disposal-installation",
  },
};

export default function WasteDisposalInstallationPage() {
  return (
    <ServicePage
      breadcrumbItems={[
        ...
        { name: "Plumber", href: "/plumber-hinckley/services/plumber" },
        {
          ...
          href: "/plumber-hinckley/services/plumber/waste-disposal-installation",
        },
      ]}
      h1="Waste Disposal Installation in Hinckley"
      heroIntro={
        <p>
          Need waste disposal installation in Hinckley? OnCall Home Repairs connects you with
      ...
      whatWhyHeading="Why You Need Professional Waste Disposal Installation in Hinckley"
      whatWhyContent={
        <>
          <p>
            Waste Disposal Installation is not something to leave to chance. Poorly fitted or
      ...
      processHeading="How Waste Disposal Installation Works with OnCall"
      processSteps={[
        {
      ...
      relatedServices={[
        {
          ...
          href: "/plumber-hinckley/services/plumber/kitchen-service",
        },
        {
      ...
      serviceAreasHeading="Waste Disposal Installation Across Hinckley"
      serviceAreasContent={
        <p>
      ...
      faqs={[
        {
          question: "How much does waste disposal installation cost in Hinckley?",
          answer:
        ...
        {
          question: "How quickly can you send a plumber for waste disposal installation?",
          answer:
      ...
      ctaHeading="Need Waste Disposal Installation in Hinckley?"
      ctaContent={
        <p>
      ...
      serviceName="Waste Disposal Installation"
      serviceSlug="waste-disposal-installation"
      serviceDescription="Kitchen waste disposal units fitted by qualified plumbers."
