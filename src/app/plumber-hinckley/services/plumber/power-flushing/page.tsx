...
export const metadata: Metadata = {
  title: "Power Flushing Hinckley | OnCall Home Repairs",
  description:
    "Power flushing in Hinckley. Remove sludge and restore heating efficiency. Gas Safe engineers, transparent pricing. Call 0333 240 8428.",
  alternates: {
    canonical:
      "https://oncallhomerepairs.co.uk/plumber-hinckley/services/plumber/power-flushing",
  },
};
    ...
    <ServicePage
      ...
      heroIntro={
        <p>
          ...
          connects you with qualified engineers in Hinckley who carry out
      ...
      whatWhyContent={
        <>
          ...
          <p>
            ...
            sludge. Leicestershire&rsquo;s hard water makes this worse by adding
      ...
      serviceAreasHeading="Power Flushing Across Hinckley"
      serviceAreasContent={
        <p>
          Our engineers carry out power flushing across Hinckley, Burbage, Earl
          Shilton, Barwell, Stoke Golding, Market Bosworth, and surrounding
      ...
      ctaContent={
        <p>
          ...
          Repairs and we will connect you with a qualified engineer in Hinckley
          who can carry out a professional power flush on your system.
        </p>
      }
      serviceName="Power Flushing"
      serviceSlug="power-flushing"
      serviceDescription="Power flushing in Hinckley. Remove sludge and limescale from your central heating system to restore efficiency and prevent boiler breakdowns."
