...
export const metadata: Metadata = {
  title: "Shower Installation Hinckley | OnCall Home Repairs",
  description:
    "Shower installation and repair in Hinckley. Electric, mixer, and thermostatic showers. Vetted plumbers. Call 0333 240 8428.",
  alternates: {
    canonical:
      "https://oncallhomerepairs.co.uk/plumber-hinckley/services/plumber/shower-installation",
  },
};
...
export default function ShowerInstallationPage() {
  return (
    <ServicePage
      ...
      h1="Shower Installation and Repair in Hinckley"
      heroIntro={
        <p>
          ...
          in Hinckley who handle all types of shower work. From quick repairs
      ...
      whatWhyContent={
        <>
          ...
          <p>
            In Hinckley homes with hard water, limescale build-up inside
      ...
      serviceAreasHeading="Shower Installation Across Hinckley"
      serviceAreasContent={
        <p>
          Our plumbers install and repair showers across Hinckley, Burbage,
          Earl Shilton, Barwell, Stoney Stanton, Elmesthorpe, and surrounding
      ...
      ctaContent={
        <p>
          ...
          Repairs will match you with a qualified plumber in Hinckley. Call now
          for an upfront quote.
        </p>
      }
      serviceName="Shower Installation and Repair"
      serviceSlug="shower-installation"
      serviceDescription="Shower installation and repair in Hinckley. Electric, mixer, and thermostatic showers fitted and repaired by vetted local plumbers."
