...
export const metadata: Metadata = {
  title: "Boiler Repair Hinckley | OnCall Home Repairs",
  description:
    "Boiler repair in Hinckley by Gas Safe engineers. Same-day repairs, upfront quotes. Available 24/7. Call 0333 240 8428.",
  alternates: {
    canonical:
      "https://oncallhomerepairs.co.uk/plumber-hinckley/services/plumber/boiler-repair",
  },
};
    ...
    <ServicePage
      ...
      heroIntro={
        <p>
          ...
          with Gas Safe registered heating engineers in Hinckley who diagnose
        ...
        },
        {
          ...
          description: (
            <p>
              ...
              Hinckley. For emergency breakdowns, engineers are available 24/7.
      ...
      serviceAreasHeading="Boiler Repair Across Hinckley"
      serviceAreasContent={
        <p>
          Our network of Gas Safe heating engineers covers Hinckley and the
          surrounding area. Whether you live in Burbage, Earl Shilton, Barwell,
          or one of the smaller villages like Stoke Golding or Dadlington, we
          ...
          properties across south-west Leicestershire.
        </p>
      }
      faqs={[
        {
      ...
      ctaContent={
        <p>
          ...
          a Gas Safe registered engineer in Hinckley. Upfront pricing,
      ...
      serviceDescription="Expert boiler repair in Hinckley. Gas Safe registered engineers available 24/7."
