...
export const metadata: Metadata = {
  title: "Blocked Toilets Hinckley | OnCall Home Repairs",
  description:
    "Toilet unblocking in Hinckley. Fast, hygienic clearance of blocked toilets by vetted plumbers. Call 0333 240 8428.",
  alternates: {
    canonical:
      "https://oncallhomerepairs.co.uk/plumber-hinckley/services/plumber/blocked-toilets",
  },
};
...
export default function ToiletUnblockingPage() {
  return (
    <ServicePage
      ...
      h1="Toilet Unblocking in Hinckley"
      heroIntro={
        <p>
          ...
          Hinckley who carry out fast, hygienic toilet unblocking using
      ...
      whatWhyContent={
        <>
          ...
          <p>
            In older Hinckley properties, narrow soil pipes and ageing clay
      ...
      serviceAreasHeading="Toilet Unblocking Across Hinckley"
      serviceAreasContent={
        <p>
          Our plumbers attend toilet unblocking jobs across Hinckley, Burbage,
          Earl Shilton, Barwell, Groby, Markfield, and all surrounding areas.
      ...
      ctaContent={
        <p>
          ...
          and we will connect you with a plumber in Hinckley who can clear it
          quickly and discreetly &mdash; same-day where possible.
        </p>
      }
      serviceName="Toilet Unblocking"
      serviceSlug="blocked-toilets"
      serviceDescription="Fast, hygienic toilet unblocking in Hinckley. Professional clearance of blocked toilets by vetted local plumbers."
