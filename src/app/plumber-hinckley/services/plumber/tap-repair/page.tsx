...
export const metadata: Metadata = {
  title: "Tap Repair Hinckley | OnCall Home Repairs",
  description:
    "Tap repair and replacement in Hinckley. Fix dripping taps and install new ones. Vetted plumbers, transparent pricing. Call 0333 240 8428.",
  alternates: {
    canonical:
      "https://oncallhomerepairs.co.uk/plumber-hinckley/services/plumber/tap-repair",
  },
};
...
export default function TapRepairPage() {
  return (
    <ServicePage
      ...
      h1="Tap Repair and Replacement in Hinckley"
      heroIntro={
        <p>
          ...
          Home Repairs connects you with plumbers in Hinckley who can fix
      ...
      whatWhyContent={
        <>
          <p>
            ...
            Leicestershire, the hard water supply accelerates wear on internal
      ...
      serviceAreasHeading="Tap Repair Across Hinckley"
      serviceAreasContent={
        <p>
          Our plumbers repair and replace taps across Hinckley, Burbage, Earl
          Shilton, Barwell, Desford, Ratby, and the surrounding area. Tap
      ...
      ctaContent={
        <p>
          ...
          will connect you with a plumber in Hinckley who can repair or
          replace your tap &mdash; usually within a single visit.
        </p>
      }
      serviceName="Tap Repair and Replacement"
      serviceSlug="tap-repair"
      serviceDescription="Tap repair and replacement in Hinckley. Fix dripping taps, replace worn components, and install new taps with vetted local plumbers."
