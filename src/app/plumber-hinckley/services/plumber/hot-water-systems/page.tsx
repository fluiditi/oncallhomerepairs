...
export const metadata: Metadata = {
  title: "Hot Water Systems Hinckley | OnCall Home Repairs",
  description:
    "Cylinders, immersions, and unvented systems repair and installation. Transparent pricing. Call 0333 240 8428.",
  alternates: {
    canonical:
      "https://oncallhomerepairs.co.uk/plumber-hinckley/services/plumber/hot-water-systems",
  },
};
...
export default function HotWaterSystemsPage() {
  return (
    <ServicePage
      ...
      h1="Hot Water Systems in Hinckley"
      heroIntro={
        <p>
          Need hot water systems in Hinckley? OnCall Home Repairs connects you with
      ...
      whatWhyHeading="Why You Need Professional Hot Water Systems in Hinckley"
      whatWhyContent={
        <>
          <p>
      ...
      serviceAreasHeading="Hot Water Systems Across Hinckley"
      serviceAreasContent={
        <p>
      ...
      faqs={[
        {
          question: "How much does hot water systems cost in Hinckley?",
          answer:
      ...
      ctaHeading="Need Hot Water Systems in Hinckley?"
      ctaContent={
        <p>
