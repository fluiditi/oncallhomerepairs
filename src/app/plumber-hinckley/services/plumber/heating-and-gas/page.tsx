...
export const metadata: Metadata = {
  title: "Heating And Gas Hinckley | OnCall Home Repairs",
  description:
    "Boilers, central heating, and gas appliance work by Gas Safe engineers. Transparent pricing. Call 0333 240 8428.",
  alternates: {
    canonical:
      "https://oncallhomerepairs.co.uk/plumber-hinckley/services/plumber/heating-and-gas",
  },
};
...
export default function HeatingAndGasPage() {
  return (
    <ServicePage
      ...
      h1="Heating And Gas in Hinckley"
      heroIntro={
        <p>
          Need heating and gas in Hinckley? OnCall Home Repairs connects you with
      ...
      whatWhyHeading="Why You Need Professional Heating And Gas in Hinckley"
      whatWhyContent={
        <>
          <p>
      ...
      serviceAreasHeading="Heating And Gas Across Hinckley"
      serviceAreasContent={
        <p>
      ...
      faqs={[
        {
          question: "How much does heating and gas cost in Hinckley?",
          answer:
      ...
      ctaHeading="Need Heating And Gas in Hinckley?"
      ctaContent={
        <p>
