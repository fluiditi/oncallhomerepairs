...
export const metadata: Metadata = {
  title: "Safety Certificates Hinckley | OnCall Home Repairs",
  description:
    "Gas safety, landlord CP12, and compliance certificates from Gas Safe engineers. Transparent pricing. Call 0333 240 8428.",
  alternates: {
    canonical:
      "https://oncallhomerepairs.co.uk/plumber-hinckley/services/plumber/safety-certificates",
  },
};
    ...
    <ServicePage
      breadcrumbItems={[
        ...
        { name: "Plumber", href: "/plumber-hinckley/services/plumber" },
        {
          ...
          href: "/plumber-hinckley/services/plumber/safety-certificates",
        },
      ]}
      h1="Safety Certificates in Hinckley"
      heroIntro={
        <p>
          Need safety certificates in Hinckley? OnCall Home Repairs connects you with
      ...
      whatWhyHeading="Why You Need Professional Safety Certificates in Hinckley"
      whatWhyContent={
        <>
          <p>
      ...
      relatedServices={[
        ...
        },
        {
          ...
          href: "/plumber-hinckley/services/plumber/landlord-certificate",
        },
        {
          name: "Commercial Gas",
        ...
        },
        {
          ...
          href: "/plumber-hinckley/services/plumber/boiler-servicing",
        },
      ]}
      serviceAreasHeading="Safety Certificates Across Hinckley"
      serviceAreasContent={
        <p>
      ...
      faqs={[
        {
          question: "How much does safety certificates cost in Hinckley?",
          answer:
      ...
      ctaHeading="Need Safety Certificates in Hinckley?"
      ctaContent={
        <p>
