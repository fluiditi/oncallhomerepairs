...
export const metadata: Metadata = {
  title: "Bathroom Plumber Hinckley | OnCall Home Repairs",
  description:
    "Bathroom plumbing in Hinckley. Installations, repairs, full refits. Vetted plumbers, upfront quotes. Call 0333 240 8428.",
  alternates: {
    canonical:
      "https://oncallhomerepairs.co.uk/plumber-hinckley/services/plumber/bathroom-plumbing",
  },
};
...
export default function BathroomPlumbingPage() {
  return (
    <ServicePage
      ...
      h1="Bathroom Plumbing in Hinckley"
      heroIntro={
        <p>
          ...
          vetted, experienced plumbers in Hinckley who handle all aspects of
        ...
        },
        {
          ...
          description: (
            <p>
              ...
              in Hinckley properties — from Victorian terraces with old lead
      ...
      relatedServices={[
        ...
        {
          name: "Toilet Repair",
          href: "/plumber-hinckley/services/plumber/toilet-repair",
        },
        {
      ...
      serviceAreasHeading="Bathroom Plumbing Across Hinckley"
      serviceAreasContent={
        <p>
          Our bathroom plumbers serve Hinckley and all surrounding areas. From
          period properties in the town centre that need careful pipework
          modifications to new-build homes in Elmesthorpe, Ratby, and Groby
          that need a shower upgrade or suite replacement, our plumbers have
          the experience to handle it. We cover Burbage, Earl Shilton, Barwell,
          Markfield, and all villages in between.
        </p>
      }
      faqs={[
        {
      ...
      ctaHeading="Need a Bathroom Plumber in Hinckley?"
      ctaContent={
        <p>
      ...
      serviceDescription="Bathroom plumbing in Hinckley. Installations, repairs, and full bathroom fit-outs."
