...
export const metadata: Metadata = {
  title: "Boiler Installation Hinckley | OnCall Home Repairs",
  description:
    "New boiler installation in Hinckley. Gas Safe engineers, competitive quotes, workmanship guarantee. Call 0333 240 8428.",
  alternates: {
    canonical:
      "https://oncallhomerepairs.co.uk/plumber-hinckley/services/plumber/boiler-installation",
  },
};
...
export default function BoilerInstallationPage() {
  return (
    <ServicePage
      ...
      h1="Boiler Installation in Hinckley"
      heroIntro={
        <p>
          ...
          you with Gas Safe registered heating engineers in Hinckley who carry
      ...
      serviceAreasHeading="Boiler Installation Across Hinckley"
      serviceAreasContent={
        <p>
          We connect homeowners across Hinckley and south-west Leicestershire
          with qualified boiler installers. Whether you are in the centre of
          Hinckley, in Burbage, Earl Shilton, or one of the surrounding
          ...
          of Leicestershire and can advise on the best boiler setup for your
          home.
        </p>
      }
      faqs={[
        {
          question: "How much does a new boiler installation cost in Hinckley?",
          answer:
      ...
      ctaHeading="Ready for a New Boiler in Hinckley?"
      ctaContent={
        <p>
      ...
      serviceDescription="New boiler installation in Hinckley. Gas Safe registered, competitive pricing."
