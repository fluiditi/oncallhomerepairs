...
export const metadata: Metadata = {
  title: "Toilet Repair Hinckley | OnCall Home Repairs",
  description:
    "Toilet repair in Hinckley. Cisterns, flush mechanisms, seals, and installations by vetted plumbers. Call 0333 240 8428.",
  alternates: {
    canonical:
      "https://oncallhomerepairs.co.uk/plumber-hinckley/services/plumber/toilet-repair",
  },
};
    ...
    <ServicePage
      ...
      heroIntro={
        <p>
          ...
          Hinckley who repair and replace toilet components, cisterns, and
      ...
      whatWhyContent={
        <>
          ...
          <p>
            In properties across Hinckley, hard water deposits also play a role.
      ...
      serviceAreasHeading="Toilet Repair Across Hinckley"
      serviceAreasContent={
        <p>
          Our plumbers carry out toilet repairs across Hinckley, Burbage,
          Earl Shilton, Barwell, Stoney Stanton, Sapcote, and all
      ...
      ctaContent={
        <p>
          ...
          Hinckley who can diagnose and fix the problem &mdash; usually in a
          single visit.
        </p>
      }
      serviceName="Toilet Repair"
      serviceSlug="toilet-repair"
      serviceDescription="Toilet repair in Hinckley. Cistern mechanisms, fill valves, flush faults, and seal replacements by vetted local plumbers."
