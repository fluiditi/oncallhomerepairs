...
export const metadata: Metadata = {
  title: "Gas Safety Check Hinckley | OnCall Home Repairs",
  description:
    "Gas safety checks and CP12 certificates in Hinckley. For landlords and homeowners. Gas Safe registered engineers. Call 0333 240 8428.",
  alternates: {
    canonical:
      "https://oncallhomerepairs.co.uk/plumber-hinckley/services/plumber/gas-safety-certificate",
  },
};
...
export default function GasSafetyChecksPage() {
  return (
    <ServicePage
      ...
      h1="Gas Safety Checks in Hinckley"
      heroIntro={
        <p>
          ...
          Hinckley who carry out thorough inspections of your boiler, gas
      ...
      serviceAreasHeading="Gas Safety Checks Across Hinckley"
      serviceAreasContent={
        <p>
          Our Gas Safe registered engineers carry out gas safety checks across
          Hinckley, Burbage, Earl Shilton, Barwell, Stoney Stanton, Desford,
          Groby, Markfield, and all surrounding areas. Landlords with multiple
      ...
      faqs={[
        {
          question: "How much does a gas safety check cost in Hinckley?",
          answer:
      ...
      ctaContent={
        <p>
          ...
          engineer in Hinckley for your annual gas safety check.
        </p>
      }
      serviceName="Gas Safety Checks"
      serviceSlug="gas-safety-certificate"
      serviceDescription="Gas safety checks and CP12 certificates in Hinckley. Annual inspections for landlords and homeowners by Gas Safe registered engineers."
