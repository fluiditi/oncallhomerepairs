...
export const metadata: Metadata = {
  title: "Domestic And Commercial Hinckley | OnCall Home Repairs",
  description:
    "Full plumbing services for homes and businesses. Transparent pricing. Call 0333 240 8428.",
  alternates: {
    canonical:
      "https://oncallhomerepairs.co.uk/plumber-hinckley/services/plumber/domestic-and-commercial",
  },
};

export default function DomesticAndCommercialPage() {
  return (
    <ServicePage
      breadcrumbItems={[
      ...
      h1="Domestic And Commercial in Hinckley"
      heroIntro={
        <p>
          Need domestic and commercial in Hinckley? OnCall Home Repairs connects you with
      ...
      whatWhyHeading="Why You Need Professional Domestic And Commercial in Hinckley"
      whatWhyContent={
        <>
          <p>
            Domestic And Commercial is not something to leave to chance. Poorly fitted or
      ...
      processHeading="How Domestic And Commercial Works with OnCall"
      processSteps={[
        {
      ...
      serviceAreasHeading="Domestic And Commercial Across Hinckley"
      serviceAreasContent={
        <p>
      ...
      faqs={[
        {
          question: "How much does domestic and commercial cost in Hinckley?",
          answer:
        ...
        {
          question: "How quickly can you send a plumber for domestic and commercial?",
          answer:
      ...
      ctaHeading="Need Domestic And Commercial in Hinckley?"
      ctaContent={
        <p>
      ...
      serviceName="Domestic And Commercial"
      serviceSlug="domestic-and-commercial"
      serviceDescription="Full plumbing services for homes and businesses."
