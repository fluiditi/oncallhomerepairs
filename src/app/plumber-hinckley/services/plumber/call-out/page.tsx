...
export const metadata: Metadata = {
  title: "Call Out Hinckley | OnCall Home Repairs",
  description:
    "Emergency and same-day plumber call-outs, 24/7 availability. Transparent pricing. Call 0333 240 8428.",
  alternates: {
    canonical:
      "https://oncallhomerepairs.co.uk/plumber-hinckley/services/plumber/call-out",
  },
};
...
export default function CallOutPage() {
  return (
    <ServicePage
      ...
      h1="Call Out in Hinckley"
      heroIntro={
        <p>
          Need call out in Hinckley? OnCall Home Repairs connects you with
      ...
      whatWhyHeading="Why You Need Professional Call Out in Hinckley"
      whatWhyContent={
        <>
          <p>
      ...
      serviceAreasHeading="Call Out Across Hinckley"
      serviceAreasContent={
        <p>
      ...
      faqs={[
        {
          question: "How much does call out cost in Hinckley?",
          answer:
      ...
      ctaHeading="Need Call Out in Hinckley?"
      ctaContent={
        <p>
