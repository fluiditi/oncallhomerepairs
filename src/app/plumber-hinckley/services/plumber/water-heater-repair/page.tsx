...
export const metadata: Metadata = {
  title: "Water Heater Repair Hinckley | OnCall Home Repairs",
  description:
    "Water heater repair in Hinckley. Immersion heaters, cylinders, and unvented systems. Vetted plumbers. Call 0333 240 8428.",
  alternates: {
    canonical:
      "https://oncallhomerepairs.co.uk/plumber-hinckley/services/plumber/water-heater-repair",
  },
};
    ...
    <ServicePage
      breadcrumbItems={[
        ...
        { name: "Boiler & Heating", href: "/plumber-hinckley/services/boiler-heating" },
        {
          ...
          href: "/plumber-hinckley/services/plumber/water-heater-repair",
        },
      ]}
      h1="Water Heater Repair in Hinckley"
      heroIntro={
        <p>
          ...
          you with qualified plumbers and heating engineers in Hinckley who can
      ...
      whatWhyContent={
        <>
          <p>
            Hot water systems vary considerably across Hinckley properties.
          ...
          <p>
            ...
            areas like Leicestershire, and eventually stops working. The
      ...
      serviceAreasHeading="Water Heater Repair Across Hinckley"
      serviceAreasContent={
        <p>
          Our plumbers and heating engineers attend water heater repairs across
          Hinckley, Burbage, Earl Shilton, Barwell, Elmesthorpe, Sapcote, and
      ...
      faqs={[
        {
          ...
          answer:
            "The most common cause is a failed heating element. Hard water areas like Hinckley accelerate limescale build-up on the element, which causes it to overheat and burn out. The thermostat can also fail independently. A plumber can test both components and replace whichever has failed.",
        },
        {
          question:
      ...
      ctaContent={
        <p>
          ...
          Hinckley who can restore your hot water supply.
        </p>
      }
      serviceName="Water Heater Repair"
      serviceSlug="water-heater-repair"
      serviceDescription="Water heater repair in Hinckley. Immersion heaters, hot water cylinders, and unvented systems repaired by qualified local plumbers."
