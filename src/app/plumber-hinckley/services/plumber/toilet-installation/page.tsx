...
export const metadata: Metadata = {
  title: "Toilet Installation Hinckley | OnCall Home Repairs",
  description:
    "New toilet fitting, replacements, and upgrades by qualified plumbers. Transparent pricing. Call 0333 240 8428.",
  alternates: {
    canonical:
      "https://oncallhomerepairs.co.uk/plumber-hinckley/services/plumber/toilet-installation",
  },
};
    ...
    <ServicePage
      breadcrumbItems={[
        ...
        { name: "Plumber", href: "/plumber-hinckley/services/plumber" },
        {
          ...
          href: "/plumber-hinckley/services/plumber/toilet-installation",
        },
      ]}
      h1="Toilet Installation in Hinckley"
      heroIntro={
        <p>
          Need toilet installation in Hinckley? OnCall Home Repairs connects you with
      ...
      whatWhyHeading="Why You Need Professional Toilet Installation in Hinckley"
      whatWhyContent={
        <>
          <p>
      ...
      relatedServices={[
        ...
        },
        {
          ...
          href: "/plumber-hinckley/services/plumber/blocked-toilets",
        },
        {
      ...
      serviceAreasHeading="Toilet Installation Across Hinckley"
      serviceAreasContent={
        <p>
      ...
      faqs={[
        {
          question: "How much does toilet installation cost in Hinckley?",
          answer:
      ...
      ctaHeading="Need Toilet Installation in Hinckley?"
      ctaContent={
        <p>
