...
export const metadata: Metadata = {
  title: "Water System Repairs Hinckley | OnCall Home Repairs",
  description:
    "Tanks, pipes, cylinders, and plumbing system fixes. Transparent pricing. Call 0333 240 8428.",
  alternates: {
    canonical:
      "https://oncallhomerepairs.co.uk/plumber-hinckley/services/plumber/water-system-repairs",
  },
};
...
export default function WaterSystemRepairsPage() {
  return (
    <ServicePage
      ...
      h1="Water System Repairs in Hinckley"
      heroIntro={
        <p>
          Need water system repairs in Hinckley? OnCall Home Repairs connects you with
      ...
      whatWhyHeading="Why You Need Professional Water System Repairs in Hinckley"
      whatWhyContent={
        <>
          <p>
      ...
      serviceAreasHeading="Water System Repairs Across Hinckley"
      serviceAreasContent={
        <p>
      ...
      faqs={[
        {
          question: "How much does water system repairs cost in Hinckley?",
          answer:
      ...
      ctaHeading="Need Water System Repairs in Hinckley?"
      ctaContent={
        <p>
