...
export const metadata: Metadata = {
  title: "Water Heater Installation Hinckley | OnCall Home Repairs",
  description:
    "Immersion heaters, cylinders, and unvented systems fitted. Transparent pricing. Call 0333 240 8428.",
  alternates: {
    canonical:
      "https://oncallhomerepairs.co.uk/plumber-hinckley/services/plumber/water-heater-installation",
  },
};
...
export default function WaterHeaterInstallationPage() {
  return (
    <ServicePage
      ...
      h1="Water Heater Installation in Hinckley"
      heroIntro={
        <p>
          Need water heater installation in Hinckley? OnCall Home Repairs connects you with
      ...
      whatWhyHeading="Why You Need Professional Water Heater Installation in Hinckley"
      whatWhyContent={
        <>
          <p>
      ...
      serviceAreasHeading="Water Heater Installation Across Hinckley"
      serviceAreasContent={
        <p>
      ...
      faqs={[
        {
          question: "How much does water heater installation cost in Hinckley?",
          answer:
      ...
      ctaHeading="Need Water Heater Installation in Hinckley?"
      ctaContent={
        <p>
