...
export const metadata: Metadata = {
  title: "Burst Pipe Repair Hinckley | OnCall Home Repairs",
  description:
    "Fast burst pipe repair in Hinckley. 24/7 emergency response from vetted plumbers. Transparent pricing. Call 0333 240 8428.",
  alternates: {
    canonical:
      "https://oncallhomerepairs.co.uk/plumber-hinckley/services/emergency-plumbing/burst-pipe-repair",
  },
};
...
export default function BurstPipeRepairPage() {
  return (
    <ServicePage
      ...
      h1="Burst Pipe Repair in Hinckley"
      heroIntro={
        <p>
          ...
          you with vetted, experienced plumbers in the Hinckley area who
      ...
      whatWhyContent={
        <>
          ...
          <p>
            Our network of plumbers in Hinckley arrives equipped with the
      ...
      serviceAreasHeading="Burst Pipe Repair Across Hinckley"
      serviceAreasContent={
        <p>
          We connect homeowners with burst pipe repair plumbers across Hinckley
          and the surrounding villages. Whether you are in Burbage, Earl Shilton,
          Barwell, or further afield in Stoke Golding or Market Bosworth, our
      ...
      ctaHeading="Burst Pipe in Hinckley? Act Now"
      ctaContent={
        <p>
      ...
      serviceDescription="Fast burst pipe repair in Hinckley. Emergency call-out available 24/7."
