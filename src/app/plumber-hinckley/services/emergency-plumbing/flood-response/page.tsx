...
export const metadata: Metadata = {
  title: "Flood Response Plumber Hinckley | OnCall Home Repairs",
  description:
    "Emergency flood response in Hinckley. Rapid water damage control by vetted plumbers, available 24/7. Call 0333 240 8428.",
  alternates: {
    canonical:
      "https://oncallhomerepairs.co.uk/plumber-hinckley/services/emergency-plumbing/flood-response",
  },
};
...
export default function FloodResponsePage() {
  return (
    <ServicePage
      ...
      h1="Flood Response Plumber in Hinckley"
      heroIntro={
        <p>
          ...
          experienced flood response plumbers in Hinckley who can reach your
      ...
      whatWhyContent={
        <>
          ...
          <p>
            Properties across Hinckley, Burbage, and the surrounding villages
      ...
      relatedServices={[
        ...
        },
        {
          ...
          href: "/plumber-hinckley/services/emergency-plumbing/stopcock-repair",
        },
        {
      ...
      serviceAreasHeading="Flood Response Across Hinckley and Leicestershire"
      serviceAreasContent={
        <p>
          Our flood response plumbers cover Hinckley town centre, Burbage,
          Earl Shilton, Barwell, Stoney Stanton, and surrounding villages.
          Response times are fastest within the Hinckley and Burbage area,
          with the wider south-west Leicestershire area typically reached
      ...
      ctaContent={
        <p>
          ...
          will have a vetted flood response plumber heading to your Hinckley
          property as quickly as possible.
        </p>
      }
      serviceName="Flood Response"
      serviceSlug="flood-response"
      serviceDescription="Emergency flood response plumber in Hinckley. Rapid water damage control, source isolation, and immediate repair by vetted local plumbers."
