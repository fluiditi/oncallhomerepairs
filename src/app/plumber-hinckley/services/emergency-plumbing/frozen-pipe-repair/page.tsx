...
export const metadata: Metadata = {
  title: "Frozen Pipe Repair Hinckley | OnCall Home Repairs",
  description:
    "Frozen pipe repair in Hinckley. Prevent burst pipes this winter. Vetted plumbers, 24/7. Call 0333 240 8428.",
  alternates: {
    canonical:
      "https://oncallhomerepairs.co.uk/plumber-hinckley/services/emergency-plumbing/frozen-pipe-repair",
  },
};
    ...
    <ServicePage
      breadcrumbItems={[
        ...
        { name: "Emergency Plumbing", href: "/plumber-hinckley/services/emergency-plumbing" },
        {
          ...
          href: "/plumber-hinckley/services/emergency-plumbing/frozen-pipe-repair",
        },
      ]}
      h1="Frozen Pipe Repair in Hinckley"
      heroIntro={
        <p>
          When temperatures across Leicestershire drop below freezing, pipes in
      ...
      whatWhyHeading="Why Frozen Pipes Are a Serious Risk in Hinckley"
      whatWhyContent={
        <>
          <p>
            Hinckley sits in the East Midlands where winter temperatures
            ...
            Castle Street and the Ashby Road area &mdash; have pipework routed
          ...
          <p>
            ...
            understands the specific risks Leicestershire winters pose to local
      ...
      serviceAreasHeading="Frozen Pipe Repair Across Hinckley"
      serviceAreasContent={
        <p>
          Our plumbers attend frozen pipe emergencies across Hinckley, Burbage,
          Earl Shilton, Barwell, and the surrounding villages. Properties in
          ...
          south-west Leicestershire, we can connect you with a plumber who
      ...
      faqs={[
        ...
        {
          question:
            "How much does frozen pipe repair cost in Hinckley?",
          answer:
      ...
      ctaContent={
        <p>
          ...
          Home Repairs and we will connect you with a vetted plumber in Hinckley
      ...
      serviceDescription="Frozen pipe thawing and repair in Hinckley. Prevent burst pipes this winter with safe, professional pipe repair from vetted local plumbers."
