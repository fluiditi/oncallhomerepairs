...
const faqs = [
  {
    question: "How much does a plumber cost in Hinckley?",
    answer:
      "Plumbing costs in Hinckley vary depending on the job. A straightforward tap repair might cost between \u00a380 and \u00a3150, while a full boiler installation typically ranges from \u00a31,500 to \u00a33,500. Emergency callouts outside normal hours may carry a higher rate. Every job through OnCall Home Repairs starts with a clear, upfront quote \u2014 so you\u2019ll always know the cost before work begins.",
    answerJsx: (
      <>
  ...
  {
    question: "Do you offer 24-hour emergency plumbing in Hinckley?",
    answer:
  ...
  {
    question: "How quickly can a plumber get to my home in Hinckley?",
    answer:
      "For emergencies in Hinckley town centre and Burbage, a plumber can typically reach your property within an hour. For the wider service area including Earl Shilton, Barwell, and surrounding villages, response times are usually within 90 minutes. Non-emergency appointments are scheduled at a time that works for you.",
    answerJsx: null,
  },
  {
  ...
  {
    question: "What areas near Hinckley do you cover?",
    answer:
      "We cover Hinckley and 13 surrounding towns and villages: Burbage, Earl Shilton, Barwell, Stoney Stanton, Sapcote, Elmesthorpe, Stoke Golding, Dadlington, Market Bosworth, Desford, Ratby, Groby, and Markfield. If you\u2019re not sure whether your area is covered, call 0333 240 8428 and we\u2019ll confirm.",
    answerJsx: (
      <>
        We cover Hinckley and 13 surrounding towns and villages: Burbage, Earl
        Shilton, Barwell, Stoney Stanton, Sapcote, Elmesthorpe, Stoke Golding,
        Dadlington, Market Bosworth, Desford, Ratby, Groby, and Markfield. If
...
const differentiators = [
  {
    ...
    description:
      "Plumbing emergencies don\u2019t wait for office hours. Our network of Hinckley plumbers is available around the clock \u2014 at 3am on a Wednesday, on Christmas Day, on a bank holiday Monday. When you call 0333 240 8428, a real person answers and gets a plumber moving toward your property.",
  },
  {
    icon: ShieldCheck,
  ...
  {
    icon: MapPin,
    title: "Local to Hinckley",
    description:
      "This isn\u2019t a faceless national company routing calls to whoever\u2019s cheapest. Our plumbers live and work in and around Hinckley. They know the local housing stock, the common problems with Leicestershire properties, and they can reach your home quickly.",
  },
];
...
const steps = [
  ...
  },
  {
    ...
    description:
      "Based on your location, the type of job, and availability, we match you with a vetted, qualified plumber from our Hinckley network. For emergencies, this happens immediately.",
  },
  {
    number: "03",
    ...
    <main>
        ...
        <div className="relative mx-auto max-w-7xl px-4 py-20 sm:px-6 sm:py-28 lg:px-8 lg:py-36">
          ...
          >
            ...
            >
              ...
              Hinckley home, OnCall Home Repairs connects you with a vetted,
            ...
            >
              ...
              >
                <a href="/plumber-hinckley/contact">
                  Get a Plumber Now
        ...
        >
          <div className="mx-auto max-w-3xl">
            <h2 className="font-heading text-3xl font-bold tracking-tight text-navy sm:text-4xl">
              Dealing With a Plumbing Emergency in Hinckley?
            </h2>
            ...
            <div className="mt-8 space-y-6 text-base leading-relaxed text-muted-foreground sm:text-lg">
              ...
              <p>
                If you live in Hinckley, you know the frustration. Many of the
                town&rsquo;s older Victorian and Edwardian properties run on
                ageing pipework that wasn&rsquo;t built for modern demands.
                Leicestershire&rsquo;s hard water accelerates limescale build-up
              ...
              <p>
                ...
                Hinckley homeowners with{" "}
                <a
                  href="/plumber-hinckley/about"
      ...
      <section className="bg-blue-soft py-20 sm:py-28">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          >
            <h2 className="font-heading text-3xl font-bold tracking-tight text-navy sm:text-4xl">
              Our Plumbing Services in Hinckley
            </h2>
          ...
          >
            <Button asChild variant="outline" size="lg" className="rounded-xl">
              <a href="/plumber-hinckley/services">
                View All Services
      ...
      <section className="bg-white py-20 sm:py-28">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          >
            <h2 className="font-heading text-3xl font-bold tracking-tight text-navy sm:text-4xl">
              Why Hinckley Homeowners Choose OnCall Home Repairs
            </h2>
          </motion.div>
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="mx-auto mt-4 max-w-xl text-base text-muted-foreground sm:text-lg">
              Getting a qualified plumber to your Hinckley home is simple.
            </p>
          </motion.div>
      ...
      <section className="bg-white py-20 sm:py-28">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          >
            <h2 className="font-heading text-3xl font-bold tracking-tight text-navy sm:text-4xl">
              What Our Hinckley Customers Say
            </h2>
          </motion.div>
        ...
        >
          <div className="mx-auto max-w-3xl">
            <div className="mb-6 flex items-center justify-center">
              ...
              <h2 className="font-heading text-3xl font-bold tracking-tight text-navy sm:text-4xl">
                Plumber Covering Hinckley and Leicestershire
              </h2>
            </div>

            <div className="mt-8 space-y-6 text-base leading-relaxed text-muted-foreground sm:text-lg">
              <p>
                OnCall Home Repairs connects homeowners across Hinckley and the
                surrounding Leicestershire towns and villages with qualified
                local plumbers. Our network covers Burbage, Earl Shilton, and
                Barwell to the south and east, as well as the villages of Stoney
                Stanton, Sapcote, and Elmesthorpe.
              </p>
              <p>
                To the west, we serve Stoke Golding and Dadlington, and our
                coverage extends north to Market Bosworth. Heading toward
                Leicester, our plumbers also cover Desford, Ratby, Groby, and
                Markfield.
              </p>
              <p>
                Wherever you are in the Hinckley area, a vetted plumber from our
                network can reach your home quickly. For emergencies, response
                times are fastest within Hinckley town centre and Burbage, with
            ...
            <div className="mt-10 text-center">
              <p className="text-base font-medium text-navy sm:text-lg">
                Need a plumber in Hinckley or any of these areas?
              </p>
              <Button
                asChild
                size="lg"
