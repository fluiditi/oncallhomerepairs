...
const faqs = [
  {
    question: "How much does a plumber cost in Bristol?",
    answer:
      "Plumbing costs in Bristol vary depending on the job. A straightforward tap repair might cost between \u00a380 and \u00a3150, while a full boiler installation typically ranges from \u00a31,500 to \u00a33,500. Emergency callouts outside normal hours may carry a higher rate. Every job through OnCall Home Repairs starts with a clear, upfront quote \u2014 so you\u2019ll always know the cost before work begins.",
    answerJsx: (
      <>
        Plumbing costs in Bristol vary depending on the job. A straightforward{" "}
        <a
          href="/plumber-bristol/services/general-plumbing/tap-repair-replacement"
  ...
  {
    question: "Do you offer 24-hour emergency plumbing in Bristol?",
    answer:
  ...
  {
    question: "How quickly can a plumber get to my home in Bristol?",
    answer:
      "For emergencies in Bristol town centre and Clifton, a plumber can typically reach your property within an hour. For the wider service area including Redland, Bishopston, and surrounding villages, response times are usually within 90 minutes. Non-emergency appointments are scheduled at a time that works for you.",
    answerJsx: null,
  },
  {
  ...
  {
    question: "What areas near Bristol do you cover?",
    answer:
      "We cover Bristol and 18 surrounding towns and villages: Clifton, Redland, Bishopston, Southville, Bedminster, Easton, Henleaze, Westbury-on-Trym, Horfield, Fishponds, Stoke Bishop, Knowle, Brislington, Keynsham, St Andrews, Clifton, Redland, and Bishopston. If you\u2019re not sure whether your area is covered, call 0333 240 8428 and we\u2019ll confirm.",
    answerJsx: (
      <>
        We cover Bristol and 18 surrounding towns and villages: Clifton, Redland,
        Bishopston, Southville, Bedminster, Easton, Henleaze,
        Westbury-on-Trym, Horfield, Fishponds, Stoke Bishop, Knowle, Brislington,
        Keynsham, St Andrews, Clifton, Redland, and Bishopston. If
...
const services = [
    ...
    keyServices: [
      {
        ...
        href: "/plumber-bristol/services/emergency-plumbing/emergency-plumber",
      },
      {
      ...
      {
        name: "Leak detection",
        href: "/plumber-bristol/services/emergency-plumbing/leak-detection-repair",
      },
    ],
    href: "/plumber-bristol/services/emergency-plumbing",
  ...
  },
  {
    ...
    keyServices: [
      { name: "Boiler repair", href: "/plumber-bristol/services/boiler-heating/boiler-repair" },
      {
      ...
      },
      {
        ...
        href: "/plumber-bristol/services/boiler-heating/central-heating-repair",
      },
    ],
    href: "/plumber-bristol/services/boiler-heating",
  ...
  },
  {
    ...
    keyServices: [
      {
        name: "Blocked drains",
        href: "/plumber-bristol/services/drain-services/blocked-drains",
      },
      {
        name: "CCTV drain survey",
        href: "/plumber-bristol/services/drain-services/cctv-drain-survey",
      },
    ],
    href: "/plumber-bristol/services/drain-services",
  ...
  },
  {
    ...
    keyServices: [
      {
        ...
        href: "/plumber-bristol/services/general-plumbing/bathroom-plumbing",
      },
      {
        name: "Tap repair",
        href: "/plumber-bristol/services/general-plumbing/tap-repair-replacement",
    ...
    href: "/plumber-bristol/services/general-plumbing",
...
const differentiators = [
  {
    ...
    description:
      "Plumbing emergencies don\u2019t wait for office hours. Our network of Bristol plumbers is available around the clock \u2014 at 3am on a Wednesday, on Christmas Day, on a bank holiday Monday. When you call 0333 240 8428, a real person answers and gets a plumber moving toward your property.",
  },
  {
    icon: ShieldCheck,
  ...
  {
    icon: MapPin,
    title: "Local to Bristol",
    description:
      "This isn\u2019t a faceless national company routing calls to whoever\u2019s cheapest. Our plumbers live and work in and around Bristol. They know the local housing stock, the common problems with Bristol properties, and they can reach your home quickly.",
  },
];
...
const steps = [
  ...
  },
  {
    ...
    description:
      "Based on your location, the type of job, and availability, we match you with a vetted, qualified plumber from our Bristol network. For emergencies, this happens immediately.",
  },
  {
    number: "03",
    ...
    <main>
        ...
        <div className="relative mx-auto max-w-7xl px-4 py-20 sm:px-6 sm:py-28 lg:px-8 lg:py-36">
          ...
          >
            ...
            >
              ...
              Bristol home, OnCall Home Repairs connects you with a vetted,
            ...
            >
              ...
              >
                <a href="/plumber-bristol/contact">
                  Get a Plumber Now
        ...
        >
          <div className="mx-auto max-w-3xl">
            <h2 className="font-heading text-3xl font-bold tracking-tight text-navy sm:text-4xl">
              Dealing With a Plumbing Emergency in Bristol?
            </h2>
            ...
            <div className="mt-8 space-y-6 text-base leading-relaxed text-muted-foreground sm:text-lg">
              ...
              <p>
                ...
                Bristol homeowners with{" "}
                <a
                  href="/plumber-bristol/about"
      ...
      <section className="bg-blue-soft py-20 sm:py-28">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          >
            <h2 className="font-heading text-3xl font-bold tracking-tight text-navy sm:text-4xl">
              Our Plumbing Services in Bristol
            </h2>
          ...
          >
            <Button asChild variant="outline" size="lg" className="rounded-xl">
              <a href="/plumber-bristol/services">
                View All Services
      ...
      <section className="bg-white py-20 sm:py-28">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          >
            <h2 className="font-heading text-3xl font-bold tracking-tight text-navy sm:text-4xl">
              Why Bristol Homeowners Choose OnCall Home Repairs
            </h2>
          </motion.div>
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="mx-auto mt-4 max-w-xl text-base text-muted-foreground sm:text-lg">
              Getting a qualified plumber to your Bristol home is simple.
            </p>
          </motion.div>
        ...
        >
          <div className="mx-auto max-w-3xl">
            <div className="mb-6 flex items-center justify-center">
              ...
              <h2 className="font-heading text-3xl font-bold tracking-tight text-navy sm:text-4xl">
                Plumber Covering Bristol and Bristol
              </h2>
            </div>

            <div className="mt-8 space-y-6 text-base leading-relaxed text-muted-foreground sm:text-lg">
              <p>
                OnCall Home Repairs connects homeowners across Bristol and the
                surrounding Bristol towns and villages with qualified
                local plumbers. Our network covers Clifton, Redland, and
                Bishopston to the south, as well as the villages of Southville,
                Bedminster, and Easton.
              </p>
              <p>
                To the west, we serve Henleaze and Westbury-on-Trym, and our
                coverage extends north to Horfield and Fishponds. We also
                cover Stoke Bishop, Knowle, Brislington, Keynsham, St Andrews,
                Clifton, Redland, and Bishopston.
              </p>
              <p>
                Wherever you are in the Bristol area, a vetted plumber from our
                network can reach your home quickly. For emergencies, response
                times are fastest within Bristol town centre and Clifton, with
            ...
            <div className="mt-10 text-center">
              <p className="text-base font-medium text-navy sm:text-lg">
                Need a plumber in Bristol or any of these areas?
              </p>
              <Button
                asChild
                size="lg"
