...
export const metadata: Metadata = {
  title: "Toilet Unblocking Bristol | OnCall Home Repairs",
  description:
    "Toilet unblocking in Bristol. Fast, hygienic clearance of blocked toilets by vetted plumbers. Call 0333 240 8428.",
  alternates: {
    canonical:
      "https://oncallhomerepairs.co.uk/plumber-bristol/services/drain-services/toilet-unblocking",
  },
};
    ...
    <ServicePage
      breadcrumbItems={[
        ...
        { name: "Drain Services", href: "/plumber-bristol/services/drain-services" },
        {
          ...
          href: "/plumber-bristol/services/drain-services/toilet-unblocking",
        },
      ]}
      h1="Toilet Unblocking in Bristol"
      heroIntro={
        <p>
          ...
          Bristol who carry out fast, hygienic toilet unblocking using
      ...
      whatWhyContent={
        <>
          ...
          <p>
            In older Bristol properties, narrow soil pipes and ageing clay
          ...
          <p>
            ...
            <a
              href="/plumber-bristol/services/drain-services/drain-unblocking"
              className="text-primary underline underline-offset-2 hover:text-primary/80"
            >
      ...
      serviceAreasHeading="Toilet Unblocking Across Bristol"
      serviceAreasContent={
        <p>
          Our plumbers attend toilet unblocking jobs across Bristol, Clifton,
          Redland, Bishopston, Knowle, Brislington, and all surrounding areas.
      ...
      ctaContent={
        <p>
          ...
          and we will connect you with a plumber in Bristol who can clear it
          quickly and discreetly &mdash; same-day where possible.
        </p>
      }
      serviceName="Toilet Unblocking"
      serviceSlug="toilet-unblocking"
      serviceDescription="Fast, hygienic toilet unblocking in Bristol. Professional clearance of blocked toilets by vetted local plumbers."
