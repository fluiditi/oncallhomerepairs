...
export const metadata: Metadata = {
  title: "Toilet Repair Bristol | OnCall Home Repairs",
  description:
    "Toilet repair in Bristol. Cisterns, flush mechanisms, seals, and installations by vetted plumbers. Call 0333 240 8428.",
  alternates: {
    canonical:
      "https://oncallhomerepairs.co.uk/plumber-bristol/services/drain-services/toilet-repair",
  },
};
    ...
    <ServicePage
      ...
      heroIntro={
        <p>
          ...
          Bristol who repair and replace toilet components, cisterns, and
      ...
      whatWhyContent={
        <>
          ...
          <p>
            In properties across Bristol, hard water deposits also play a role.
      ...
      serviceAreasHeading="Toilet Repair Across Bristol"
      serviceAreasContent={
        <p>
          Our plumbers carry out toilet repairs across Bristol, Clifton,
          Redland, Bishopston, Southville, Bedminster, and all
      ...
      ctaContent={
        <p>
          ...
          Bristol who can diagnose and fix the problem &mdash; usually in a
          single visit.
        </p>
      }
      serviceName="Toilet Repair"
      serviceSlug="toilet-repair"
      serviceDescription="Toilet repair in Bristol. Cistern mechanisms, fill valves, flush faults, and seal replacements by vetted local plumbers."
