...
export const metadata: Metadata = {
  title: "CCTV Drain Survey Bristol | OnCall Home Repairs",
  description:
    "CCTV drain survey in Bristol. Camera inspection to diagnose drainage problems accurately. Vetted engineers. Call 0333 240 8428.",
  alternates: {
    canonical:
      "https://oncallhomerepairs.co.uk/plumber-bristol/services/drain-services/cctv-drain-survey",
  },
};
...
export default function CCTVDrainSurveyPage() {
  return (
    <ServicePage
      ...
      h1="CCTV Drain Survey in Bristol"
      heroIntro={
        <p>
          ...
          engineers in Bristol who use professional camera equipment to inspect
      ...
      whatWhyContent={
        <>
          ...
          <p>
            Homebuyers in Bristol increasingly request drain surveys as part
      ...
      serviceAreasHeading="CCTV Drain Surveys Across Bristol"
      serviceAreasContent={
        <p>
          Our drain engineers carry out CCTV surveys across Bristol, Clifton,
          Redland, Bishopston, Horfield, Stoke Bishop, Knowle, and all
      ...
      faqs={[
        {
          question: "How much does a CCTV drain survey cost in Bristol?",
          answer:
      ...
      ctaContent={
        <p>
          ...
          we will connect you with a drain engineer in Bristol who can carry
      ...
      serviceDescription="CCTV drain survey in Bristol. Professional camera inspection to diagnose drainage problems, root intrusion, and pipe damage."
