...
export const metadata: Metadata = {
  title: "Blocked Drains Bristol | OnCall Home Repairs",
  description:
    "Blocked drain clearing in Bristol. Fast, effective unblocking for homes and businesses. Call 0333 240 8428.",
  alternates: {
    canonical:
      "https://oncallhomerepairs.co.uk/plumber-bristol/services/drain-services/blocked-drains",
  },
};
    ...
    <ServicePage
      ...
      heroIntro={
        <p>
          ...
          drainage plumbers in Bristol who can clear blockages quickly and
      ...
      serviceAreasHeading="Blocked Drain Clearing Across Bristol"
      serviceAreasContent={
        <p>
          Our drainage plumbers cover Bristol and every surrounding town and
          village. From terraced properties in Bristol centre with shared
          drainage runs to detached homes in Clifton, Redland, and Market
      ...
      ctaHeading="Blocked Drain in Bristol?"
      ctaContent={
        <p>
      ...
      serviceDescription="Blocked drain clearing in Bristol. Fast, effective unblocking for homes and businesses."
