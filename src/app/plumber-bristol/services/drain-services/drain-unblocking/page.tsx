...
export const metadata: Metadata = {
  title: "Drain Unblocking Bristol | OnCall Home Repairs",
  description:
    "Professional drain unblocking in Bristol. High-pressure jetting and manual rodding. Vetted plumbers. Call 0333 240 8428.",
  alternates: {
    canonical:
      "https://oncallhomerepairs.co.uk/plumber-bristol/services/drain-services/drain-unblocking",
  },
};
...
export default function DrainUnblockingPage() {
  return (
    <ServicePage
      ...
      h1="Drain Unblocking in Bristol"
      heroIntro={
        <p>
          ...
          experienced drain engineers in Bristol who use professional-grade
      ...
      whatWhyContent={
        <>
          <p>
            Most drain blockages in Bristol homes are caused by a gradual
      ...
      serviceAreasHeading="Drain Unblocking Across Bristol"
      serviceAreasContent={
        <p>
          Our drain engineers cover Bristol, Clifton, Redland, Bishopston,
          Westbury-on-Trym, Henleaze, and the surrounding area. External drain
      ...
      ctaContent={
        <p>
          ...
          Bristol who can clear the blockage and restore full flow.
        </p>
      }
      serviceName="Drain Unblocking"
      serviceSlug="drain-unblocking"
      serviceDescription="Professional drain unblocking in Bristol using high-pressure jetting and manual rodding. Fast, effective clearance for homes and businesses."
