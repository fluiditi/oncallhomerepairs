...
export const metadata: Metadata = {
  title: "Leak Detection Bristol | OnCall Home Repairs",
  description:
    "Professional leak detection and repair in Bristol. Find and fix hidden leaks fast. Transparent pricing. Call 0333 240 8428.",
  alternates: {
    canonical:
      "https://oncallhomerepairs.co.uk/plumber-bristol/services/emergency-plumbing/leak-detection-repair",
  },
};
...
export default function LeakDetectionRepairPage() {
  return (
    <ServicePage
      ...
      h1="Leak Detection and Repair in Bristol"
      heroIntro={
        <p>
          ...
          connects you with skilled plumbers in Bristol who specialise in
      ...
      whatWhyContent={
        <>
          ...
          <p>
            In Bristol, many homes are built with traditional construction
          ...
          <p>
            ...
            <Link
              href="/plumber-bristol/services/emergency-plumbing/overflow-repair"
              className="text-primary underline underline-offset-2 hover:text-primary/80"
            >
              overflowing cistern
            </Link>{" "}
      ...
      benefits={[
        ...
        },
        {
          ...
          description: (
            <p>
              Every plumber in our Bristol network is qualified, insured, and
      ...
      serviceAreasHeading="Leak Detection Across Bristol"
      serviceAreasContent={
        <p>
          Our leak detection service covers Bristol and all nearby towns and
          villages. From Victorian terraces in Bristol centre to modern estates
          in Clifton and Redland, our plumbers are experienced with the
          property types and plumbing systems found across the area. Whether
          your leak is in a ground-floor flat in Bishopston or a detached house in
          Fishponds, we can match you with someone local who can investigate
          promptly.
        </p>
      }
      faqs={[
      ...
      ctaHeading="Suspect a Leak in Your Bristol Home?"
      ctaContent={
        <p>
      ...
      serviceDescription="Professional leak detection and repair in Bristol. Find and fix hidden leaks fast."
