...
export const metadata: Metadata = {
  title: "Emergency Plumber Bristol | OnCall Home Repairs",
  description:
    "24-hour emergency plumber in Bristol. Fast response for burst pipes, leaks, flooding. Vetted, Gas Safe. Call 0333 240 8428.",
  alternates: {
    canonical:
      "https://oncallhomerepairs.co.uk/plumber-bristol/services/emergency-plumbing/emergency-plumber",
  },
};
...
export default function EmergencyPlumberPage() {
  return (
    <ServicePage
      ...
      h1="Emergency Plumber in Bristol — Available 24/7"
      heroIntro={
        <p>
          ...
          Bristol and the surrounding Bristol area. Whether it is the
      ...
      whatWhyContent={
        <>
          ...
          <p>
            ...
            plumbing firm — we are a matching network that connects Bristol
        ...
        },
        {
          ...
          description: (
            <p>
              ...
              Bristol. Because our network covers the local area, response times
      ...
      benefits={[
        ...
        },
        {
          ...
          description: (
            <p>
              Our plumbers live and work in and around Bristol. Local knowledge
      ...
      serviceAreasContent={
        <p>
          Our emergency plumber network covers Bristol and all surrounding towns
          and villages across Bristol. Whether you are in the
          centre of Bristol or in a nearby village, we can connect you with a
      ...
      faqs={[
        {
          question:
            "How much does an emergency plumber call-out in Bristol cost?",
          answer:
        ...
        },
        {
          ...
          answer:
            "Response times depend on current demand and your exact location in the Bristol area. In most cases, we aim to have a plumber with you within one to two hours of your call. For urgent situations such as major leaks or gas concerns, we prioritise the fastest possible dispatch.",
          answerJsx: (
            <p>
              Response times depend on current demand and your exact location in
              the Bristol area. In most cases, we aim to have a plumber with you
      ...
      ctaHeading="Plumbing Emergency in Bristol?"
      ctaContent={
        <p>
      ...
      serviceDescription="24-hour emergency plumber in Bristol. Fast response for burst pipes, leaks, and flooding."
