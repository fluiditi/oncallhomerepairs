...
export const metadata: Metadata = {
  title: "Overflow Repair Bristol | OnCall Home Repairs",
  description:
    "Overflow pipe repair in Bristol. Stop water leaks from tanks and cisterns. Transparent pricing. Call 0333 240 8428.",
  alternates: {
    canonical:
      "https://oncallhomerepairs.co.uk/plumber-bristol/services/emergency-plumbing/overflow-repair",
  },
};
...
export default function OverflowRepairPage() {
  return (
    <ServicePage
      ...
      h1="Overflow Pipe Repair in Bristol"
      heroIntro={
        <p>
          ...
          OnCall Home Repairs connects you with vetted Bristol plumbers who
      ...
      serviceAreasHeading="Overflow Repair Across Bristol"
      serviceAreasContent={
        <p>
          Our plumbers carry out overflow repairs across Bristol, Clifton,
          Redland, Bishopston, Henleaze, and the wider Bristol
      ...
      ctaContent={
        <p>
          Stop wasting water and prevent damp damage to your Bristol home.
      ...
      serviceDescription="Overflow pipe repair in Bristol. Diagnose and fix faulty ball valves, cisterns, and tank overflows with vetted local plumbers."
