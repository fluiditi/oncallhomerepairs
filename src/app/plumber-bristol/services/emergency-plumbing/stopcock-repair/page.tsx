...
export const metadata: Metadata = {
  title: "Stopcock Repair Bristol | OnCall Home Repairs",
  description:
    "Stopcock repair and replacement in Bristol. Regain control of your water supply. Vetted plumbers. Call 0333 240 8428.",
  alternates: {
    canonical:
      "https://oncallhomerepairs.co.uk/plumber-bristol/services/emergency-plumbing/stopcock-repair",
  },
};
...
export default function StopcockRepairPage() {
  return (
    <ServicePage
      ...
      h1="Stopcock Repair and Replacement in Bristol"
      heroIntro={
        <p>
          ...
          you with vetted plumbers in Bristol who can repair or replace faulty
      ...
      whatWhyContent={
        <>
          ...
          <p>
            In many Bristol properties, especially those built before the 1980s,
            the internal stopcock sits under the kitchen sink and has not been
            turned in years. Mineral deposits from Bristol&rsquo;s hard
      ...
      serviceAreasHeading="Stopcock Repair Across Bristol"
      serviceAreasContent={
        <p>
          We connect homeowners with plumbers who carry out stopcock repairs
          across Bristol, Clifton, Redland, Bishopston, and all surrounding
      ...
      ctaContent={
        <p>
          ...
          in Bristol who can repair or replace your stopcock &mdash; often the
          same day.
        </p>
      }
      serviceName="Stopcock Repair"
      serviceSlug="stopcock-repair"
      serviceDescription="Stopcock repair and replacement in Bristol. Regain control of your water supply with same-day service from vetted local plumbers."
