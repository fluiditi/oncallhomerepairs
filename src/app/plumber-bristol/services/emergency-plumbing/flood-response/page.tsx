...
export const metadata: Metadata = {
  title: "Flood Response Plumber Bristol | OnCall Home Repairs",
  description:
    "Emergency flood response in Bristol. Rapid water damage control by vetted plumbers, available 24/7. Call 0333 240 8428.",
  alternates: {
    canonical:
      "https://oncallhomerepairs.co.uk/plumber-bristol/services/emergency-plumbing/flood-response",
  },
};
...
export default function FloodResponsePage() {
  return (
    <ServicePage
      ...
      h1="Flood Response Plumber in Bristol"
      heroIntro={
        <p>
          ...
          experienced flood response plumbers in Bristol who can reach your
      ...
      whatWhyContent={
        <>
          ...
          <p>
            Properties across Bristol, Clifton, and the surrounding villages
      ...
      relatedServices={[
        ...
        },
        {
          ...
          href: "/plumber-bristol/services/emergency-plumbing/stopcock-repair",
        },
        {
      ...
      serviceAreasHeading="Flood Response Across Bristol and Bristol"
      serviceAreasContent={
        <p>
          Our flood response plumbers cover Bristol town centre, Clifton,
          Redland, Bishopston, Southville, and surrounding villages.
          Response times are fastest within the Bristol and Clifton area,
          with the wider Bristol area typically reached
      ...
      ctaContent={
        <p>
          ...
          will have a vetted flood response plumber heading to your Bristol
          property as quickly as possible.
        </p>
      }
      serviceName="Flood Response"
      serviceSlug="flood-response"
      serviceDescription="Emergency flood response plumber in Bristol. Rapid water damage control, source isolation, and immediate repair by vetted local plumbers."
