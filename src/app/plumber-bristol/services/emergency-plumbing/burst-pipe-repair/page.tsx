...
export const metadata: Metadata = {
  title: "Burst Pipe Repair Bristol | OnCall Home Repairs",
  description:
    "Fast burst pipe repair in Bristol. 24/7 emergency response from vetted plumbers. Transparent pricing. Call 0333 240 8428.",
  alternates: {
    canonical:
      "https://oncallhomerepairs.co.uk/plumber-bristol/services/emergency-plumbing/burst-pipe-repair",
  },
};
...
export default function BurstPipeRepairPage() {
  return (
    <ServicePage
      ...
      h1="Burst Pipe Repair in Bristol"
      heroIntro={
        <p>
          ...
          you with vetted, experienced plumbers in the Bristol area who
      ...
      whatWhyContent={
        <>
          ...
          <p>
            Our network of plumbers in Bristol arrives equipped with the
      ...
      serviceAreasHeading="Burst Pipe Repair Across Bristol"
      serviceAreasContent={
        <p>
          We connect homeowners with burst pipe repair plumbers across Bristol
          and the surrounding villages. Whether you are in Clifton, Redland,
          Bishopston, or further afield in Henleaze or Horfield, our
      ...
      ctaHeading="Burst Pipe in Bristol? Act Now"
      ctaContent={
        <p>
      ...
      serviceDescription="Fast burst pipe repair in Bristol. Emergency call-out available 24/7."
