...
export const metadata: Metadata = {
  title: "Bathroom Plumber Bristol | OnCall Home Repairs",
  description:
    "Bathroom plumbing in Bristol. Installations, repairs, full refits. Vetted plumbers, upfront quotes. Call 0333 240 8428.",
  alternates: {
    canonical:
      "https://oncallhomerepairs.co.uk/plumber-bristol/services/general-plumbing/bathroom-plumbing",
  },
};
...
export default function BathroomPlumbingPage() {
  return (
    <ServicePage
      ...
      h1="Bathroom Plumbing in Bristol"
      heroIntro={
        <p>
          ...
          vetted, experienced plumbers in Bristol who handle all aspects of
      ...
      whatWhyContent={
        <>
          ...
          <p>
            ...
            will support the{" "}
            <Link
              href="/plumber-bristol/services/general-plumbing/shower-installation-repair"
              className="text-primary underline underline-offset-2 hover:text-primary/80"
            >
              shower
            </Link>{" "}
        ...
        },
        {
          ...
          description: (
            <p>
              ...
              in Bristol properties — from Victorian terraces with old lead
      ...
      relatedServices={[
        ...
        {
          name: "Toilet Repair",
          href: "/plumber-bristol/services/drain-services/toilet-repair",
        },
        {
          name: "Kitchen Plumbing",
          href: "/plumber-bristol/services/general-plumbing/kitchen-plumbing",
        },
      ]}
      serviceAreasHeading="Bathroom Plumbing Across Bristol"
      serviceAreasContent={
        <p>
          Our bathroom plumbers serve Bristol and all surrounding areas. From
          period properties in the town centre that need careful pipework
          modifications to new-build homes in Easton, Stoke Bishop, and Knowle
          that need a shower upgrade or suite replacement, our plumbers have
          the experience to handle it. We cover Clifton, Redland, Bishopston,
          Brislington, and all villages in between.
        </p>
      }
      faqs={[
        {
      ...
      ctaHeading="Need a Bathroom Plumber in Bristol?"
      ctaContent={
        <p>
      ...
      serviceDescription="Bathroom plumbing in Bristol. Installations, repairs, and full bathroom fit-outs."
