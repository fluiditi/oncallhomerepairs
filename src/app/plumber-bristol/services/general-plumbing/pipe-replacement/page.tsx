...
export const metadata: Metadata = {
  title: "Pipe Replacement Bristol | OnCall Home Repairs",
  description:
    "Pipe replacement in Bristol. Copper, plastic, and lead pipe upgrades by vetted plumbers. Transparent pricing. Call 0333 240 8428.",
  alternates: {
    canonical:
      "https://oncallhomerepairs.co.uk/plumber-bristol/services/general-plumbing/pipe-replacement",
  },
};
...
export default function PipeReplacementPage() {
  return (
    <ServicePage
      ...
      h1="Pipe Replacement in Bristol"
      heroIntro={
        <p>
          ...
          connects you with qualified plumbers in Bristol who replace old
      ...
      whatWhyContent={
        <>
          <p>
            ...
            Bristol properties &mdash; pose a health risk and should be
      ...
      serviceAreasHeading="Pipe Replacement Across Bristol"
      serviceAreasContent={
        <p>
          Our plumbers replace pipework in properties across Bristol, Clifton,
          Redland, Bishopston, Brislington, Knowle, and all surrounding areas.
      ...
      ctaContent={
        <p>
          ...
          in Bristol who can assess your pipes and carry out replacements
          that last.
        </p>
      }
      serviceName="Pipe Replacement"
      serviceSlug="pipe-replacement"
      serviceDescription="Pipe replacement in Bristol. Copper, plastic, and lead pipe upgrades for homes and businesses by vetted local plumbers."
