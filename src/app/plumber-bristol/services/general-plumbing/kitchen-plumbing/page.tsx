...
export const metadata: Metadata = {
  title: "Kitchen Plumber Bristol | OnCall Home Repairs",
  description:
    "Kitchen plumbing in Bristol. Sink installations, dishwasher connections, waste disposal, and repairs. Call 0333 240 8428.",
  alternates: {
    canonical:
      "https://oncallhomerepairs.co.uk/plumber-bristol/services/general-plumbing/kitchen-plumbing",
  },
};
...
export default function KitchenPlumbingPage() {
  return (
    <ServicePage
      ...
      h1="Kitchen Plumbing in Bristol"
      heroIntro={
        <p>
          ...
          Bristol who install, repair, and maintain kitchen plumbing &mdash;
      ...
      whatWhyContent={
        <>
          ...
          <p>
            Blocked kitchen sinks are a regular call-out in Bristol. Grease,
      ...
      relatedServices={[
        ...
        },
        {
          ...
          href: "/plumber-bristol/services/general-plumbing/pipe-replacement",
        },
      ]}
      serviceAreasHeading="Kitchen Plumbing Across Bristol"
      serviceAreasContent={
        <p>
          Our plumbers carry out kitchen plumbing work across Bristol,
          Clifton, Redland, Bishopston, Henleaze, Westbury-on-Trym, Market
      ...
      ctaContent={
        <p>
          ...
          Repairs will match you with a qualified plumber in Bristol. Call
          for a clear, upfront quote.
        </p>
      }
      serviceName="Kitchen Plumbing"
      serviceSlug="kitchen-plumbing"
      serviceDescription="Kitchen plumbing in Bristol. Sink installations, appliance connections, waste pipe repairs, and full kitchen plumbing by vetted local plumbers."
