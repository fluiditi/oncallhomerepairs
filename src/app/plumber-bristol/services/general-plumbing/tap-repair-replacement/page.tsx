...
export const metadata: Metadata = {
  title: "Tap Repair Bristol | OnCall Home Repairs",
  description:
    "Tap repair and replacement in Bristol. Fix dripping taps and install new ones. Vetted plumbers, transparent pricing. Call 0333 240 8428.",
  alternates: {
    canonical:
      "https://oncallhomerepairs.co.uk/plumber-bristol/services/general-plumbing/tap-repair-replacement",
  },
};
...
export default function TapRepairPage() {
  return (
    <ServicePage
      ...
      h1="Tap Repair and Replacement in Bristol"
      heroIntro={
        <p>
          ...
          Home Repairs connects you with plumbers in Bristol who can fix
      ...
      whatWhyContent={
        <>
          <p>
            ...
            Bristol, the hard water supply accelerates wear on internal
      ...
      serviceAreasHeading="Tap Repair Across Bristol"
      serviceAreasContent={
        <p>
          Our plumbers repair and replace taps across Bristol, Clifton, Redland,
          Bishopston, Fishponds, Stoke Bishop, and the surrounding area. Tap
      ...
      ctaContent={
        <p>
          ...
          will connect you with a plumber in Bristol who can repair or
      ...
      serviceDescription="Tap repair and replacement in Bristol. Fix dripping taps, replace worn components, and install new taps with vetted local plumbers."
