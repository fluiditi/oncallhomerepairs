...
export const metadata: Metadata = {
  title: "Shower Installation Bristol | OnCall Home Repairs",
  description:
    "Shower installation and repair in Bristol. Electric, mixer, and thermostatic showers. Vetted plumbers. Call 0333 240 8428.",
  alternates: {
    canonical:
      "https://oncallhomerepairs.co.uk/plumber-bristol/services/general-plumbing/shower-installation-repair",
  },
};
...
export default function ShowerInstallationPage() {
  return (
    <ServicePage
      ...
      h1="Shower Installation and Repair in Bristol"
      heroIntro={
        <p>
          ...
          in Bristol who handle all types of shower work. From quick repairs
      ...
      whatWhyContent={
        <>
          ...
          <p>
            In Bristol homes with hard water, limescale build-up inside
      ...
      serviceAreasHeading="Shower Installation Across Bristol"
      serviceAreasContent={
        <p>
          Our plumbers install and repair showers across Bristol, Clifton,
          Redland, Bishopston, Southville, Easton, and surrounding
      ...
      ctaContent={
        <p>
          ...
          Repairs will match you with a qualified plumber in Bristol. Call now
          for an upfront quote.
        </p>
      }
      serviceName="Shower Installation and Repair"
      serviceSlug="shower-installation-repair"
      serviceDescription="Shower installation and repair in Bristol. Electric, mixer, and thermostatic showers fitted and repaired by vetted local plumbers."
