...
export const metadata: Metadata = {
  title: "Boiler Repair Bristol | OnCall Home Repairs",
  description:
    "Boiler repair in Bristol by Gas Safe engineers. Same-day repairs, upfront quotes. Available 24/7. Call 0333 240 8428.",
  alternates: {
    canonical:
      "https://oncallhomerepairs.co.uk/plumber-bristol/services/boiler-heating/boiler-repair",
  },
};
    ...
    <ServicePage
      ...
      heroIntro={
        <p>
          ...
          with Gas Safe registered heating engineers in Bristol who diagnose
        ...
        },
        {
          ...
          description: (
            <p>
              ...
              Bristol. For emergency breakdowns, engineers are available 24/7.
      ...
      serviceAreasHeading="Boiler Repair Across Bristol"
      serviceAreasContent={
        <p>
          Our network of Gas Safe heating engineers covers Bristol and the
          surrounding area. Whether you live in Clifton, Redland, Bishopston,
          or one of the smaller villages like Henleaze or Westbury-on-Trym, we
      ...
      ctaContent={
        <p>
          ...
          a Gas Safe registered engineer in Bristol. Upfront pricing,
      ...
      serviceDescription="Expert boiler repair in Bristol. Gas Safe registered engineers available 24/7."
