...
export const metadata: Metadata = {
  title: "Water Heater Repair Bristol | OnCall Home Repairs",
  description:
    "Water heater repair in Bristol. Immersion heaters, cylinders, and unvented systems. Vetted plumbers. Call 0333 240 8428.",
  alternates: {
    canonical:
      "https://oncallhomerepairs.co.uk/plumber-bristol/services/boiler-heating/water-heater-repair",
  },
};
    ...
    <ServicePage
      breadcrumbItems={[
        ...
        { name: "Boiler & Heating", href: "/plumber-bristol/services/boiler-heating" },
        {
          ...
          href: "/plumber-bristol/services/boiler-heating/water-heater-repair",
        },
      ]}
      h1="Water Heater Repair in Bristol"
      heroIntro={
        <p>
          ...
          you with qualified plumbers and heating engineers in Bristol who can
      ...
      whatWhyContent={
        <>
          <p>
            Hot water systems vary considerably across Bristol properties.
          ...
          <p>
            ...
            areas like Bristol, and eventually stops working. The
      ...
      serviceAreasHeading="Water Heater Repair Across Bristol"
      serviceAreasContent={
        <p>
          Our plumbers and heating engineers attend water heater repairs across
          Bristol, Clifton, Redland, Bishopston, Easton, Bedminster, and
      ...
      faqs={[
        {
          ...
          answer:
            "The most common cause is a failed heating element. Hard water areas like Bristol accelerate limescale build-up on the element, which causes it to overheat and burn out. The thermostat can also fail independently. A plumber can test both components and replace whichever has failed.",
        },
        {
          question:
      ...
      ctaContent={
        <p>
          ...
          Bristol who can restore your hot water supply.
        </p>
      }
      serviceName="Water Heater Repair"
      serviceSlug="water-heater-repair"
      serviceDescription="Water heater repair in Bristol. Immersion heaters, hot water cylinders, and unvented systems repaired by qualified local plumbers."
