...
export const metadata: Metadata = {
  title: "Boiler Servicing Bristol | OnCall Home Repairs",
  description:
    "Annual boiler servicing in Bristol. Keep your warranty valid and your boiler running efficiently. Gas Safe engineers. Call 0333 240 8428.",
  alternates: {
    canonical:
      "https://oncallhomerepairs.co.uk/plumber-bristol/services/boiler-heating/boiler-servicing",
  },
};
...
export default function BoilerServicingPage() {
  return (
    <ServicePage
      ...
      h1="Boiler Servicing in Bristol"
      heroIntro={
        <p>
          ...
          connects you with Gas Safe registered engineers in Bristol who carry
      ...
      serviceAreasHeading="Boiler Servicing Across Bristol"
      serviceAreasContent={
        <p>
          Our Gas Safe registered engineers service boilers across Bristol,
          Clifton, Redland, Bishopston, Bedminster, Southville, and
      ...
      ctaContent={
        <p>
          ...
          Gas Safe registered engineer in Bristol.
        </p>
      }
      serviceName="Boiler Servicing"
      serviceSlug="boiler-servicing"
      serviceDescription="Annual boiler servicing in Bristol by Gas Safe registered engineers. Manufacturer warranty protection, safety checks, and efficiency testing."
