...
export const metadata: Metadata = {
  title: "Central Heating Repair Bristol | OnCall Home Repairs",
  description:
    "Central heating repair in Bristol. Radiators, pumps, valves, thermostats. Gas Safe engineers. Call 0333 240 8428.",
  alternates: {
    canonical:
      "https://oncallhomerepairs.co.uk/plumber-bristol/services/boiler-heating/central-heating-repair",
  },
};
...
export default function CentralHeatingRepairPage() {
  return (
    <ServicePage
      ...
      h1="Central Heating Repair in Bristol"
      heroIntro={
        <p>
          When your central heating is not working properly, your home becomes
          uncomfortable fast — especially during a Bristol winter. Cold
          ...
          engineers in Bristol who diagnose and repair central heating faults
      ...
      whatWhyContent={
        <>
          ...
          <p>
            ...
            <Link
              href="/plumber-bristol/services/boiler-heating/power-flushing"
              className="text-primary underline underline-offset-2 hover:text-primary/80"
            >
              power flush
            </Link>{" "}
      ...
      benefits={[
        {
          ...
          description: (
            <p>
              ...
              systems and understand the common faults found in Bristol
              properties.
            </p>
          ),
        },
      ...
      relatedServices={[
        ...
        },
        {
          ...
          href: "/plumber-bristol/services/boiler-heating/radiator-repair-installation",
        },
        {
          name: "Power Flushing",
          href: "/plumber-bristol/services/boiler-heating/power-flushing",
      ...
      serviceAreasHeading="Central Heating Repair Across Bristol"
      serviceAreasContent={
        <p>
          Our heating engineers cover Bristol and the surrounding towns and
          villages throughout Bristol. From older properties
          in Bristol town centre to newer-build estates in Bishopston, Bedminster,
          and Southville, our engineers are familiar with the heating
      ...
      ctaContent={
        <p>
          ...
          a qualified heating engineer in Bristol who can diagnose and fix the
      ...
      serviceDescription="Central heating repair in Bristol. Radiators, pumps, valves, and full system diagnostics."
