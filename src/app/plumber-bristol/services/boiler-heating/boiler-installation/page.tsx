...
export const metadata: Metadata = {
  title: "Boiler Installation Bristol | OnCall Home Repairs",
  description:
    "New boiler installation in Bristol. Gas Safe engineers, competitive quotes, workmanship guarantee. Call 0333 240 8428.",
  alternates: {
    canonical:
      "https://oncallhomerepairs.co.uk/plumber-bristol/services/boiler-heating/boiler-installation",
  },
};
...
export default function BoilerInstallationPage() {
  return (
    <ServicePage
      ...
      h1="Boiler Installation in Bristol"
      heroIntro={
        <p>
          ...
          you with Gas Safe registered heating engineers in Bristol who carry
      ...
      serviceAreasHeading="Boiler Installation Across Bristol"
      serviceAreasContent={
        <p>
          We connect homeowners across Bristol and Bristol
          with qualified boiler installers. Whether you are in the centre of
          Bristol, in Clifton, Redland, or one of the surrounding
          ...
          of Bristol and can advise on the best boiler setup for your
          home.
        </p>
      }
      faqs={[
        {
          question: "How much does a new boiler installation cost in Bristol?",
          answer:
      ...
      ctaHeading="Ready for a New Boiler in Bristol?"
      ctaContent={
        <p>
      ...
      serviceDescription="New boiler installation in Bristol. Gas Safe registered, competitive pricing."
