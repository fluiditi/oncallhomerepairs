...
export const metadata: Metadata = {
  title: "Power Flushing Bristol | OnCall Home Repairs",
  description:
    "Power flushing in Bristol. Remove sludge and restore heating efficiency. Gas Safe engineers, transparent pricing. Call 0333 240 8428.",
  alternates: {
    canonical:
      "https://oncallhomerepairs.co.uk/plumber-bristol/services/boiler-heating/power-flushing",
  },
};
    ...
    <ServicePage
      ...
      heroIntro={
        <p>
          ...
          connects you with qualified engineers in Bristol who carry out
      ...
      whatWhyContent={
        <>
          ...
          <p>
            ...
            sludge. Bristol&rsquo;s hard water makes this worse by adding
      ...
      serviceAreasHeading="Power Flushing Across Bristol"
      serviceAreasContent={
        <p>
          Our engineers carry out power flushing across Bristol, Clifton, Redland,
          Bishopston, Henleaze, Horfield, and surrounding
      ...
      ctaContent={
        <p>
          ...
          Repairs and we will connect you with a qualified engineer in Bristol
          who can carry out a professional power flush on your system.
        </p>
      }
      serviceName="Power Flushing"
      serviceSlug="power-flushing"
      serviceDescription="Power flushing in Bristol. Remove sludge and limescale from your central heating system to restore efficiency and prevent boiler breakdowns."
