...
export const metadata: Metadata = {
  title: "Radiator Repair Bristol | OnCall Home Repairs",
  description:
    "Radiator repair and installation in Bristol. Fix cold spots, leaks, and add new radiators. Gas Safe engineers. Call 0333 240 8428.",
  alternates: {
    canonical:
      "https://oncallhomerepairs.co.uk/plumber-bristol/services/boiler-heating/radiator-repair-installation",
  },
};
...
export default function RadiatorRepairPage() {
  return (
    <ServicePage
      ...
      h1="Radiator Repair and Installation in Bristol"
      heroIntro={
        <p>
          ...
          Bristol who can diagnose radiator faults, carry out repairs, and
      ...
      whatWhyHeading="Common Radiator Problems in Bristol Homes"
      whatWhyContent={
        <>
          <p>
          ...
          <p>
            Bristol&rsquo;s hard water accelerates the build-up of
            limescale and sludge in central heating systems. Many homes in
            Bristol, Clifton, and the surrounding area have heating systems
      ...
      serviceAreasHeading="Radiator Repair Across Bristol"
      serviceAreasContent={
        <p>
          Our heating engineers carry out radiator repairs and installations
          across Bristol, Clifton, Redland, Bishopston, Fishponds, Stoke Bishop,
          and the wider Bristol area. Whether you need a
      ...
      ctaContent={
        <p>
          ...
          in Bristol who can get your radiators working as they should.
        </p>
      }
      serviceName="Radiator Repair and Installation"
      serviceSlug="radiator-repair-installation"
      serviceDescription="Radiator repair and installation in Bristol. Fix cold spots, leaking valves, and add new radiators with qualified heating engineers."
