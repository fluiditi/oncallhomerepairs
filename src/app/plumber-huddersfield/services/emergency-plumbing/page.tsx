...
export const metadata: Metadata = {
  title: "Emergency Plumbing Huddersfield | OnCall Home Repairs",
  description:
    "24/7 emergency plumbing in Huddersfield. Burst pipes, leaks, flooding. Vetted, Gas Safe plumbers. Call 0333 240 8428.",
  alternates: {
    canonical: "https://oncallhomerepairs.co.uk/plumber-huddersfield/services/emergency-plumbing",
  },
};
...
export default function EmergencyPlumbingPage() {
  return (
    <CategoryPage
      ...
      h1="Emergency Plumbing Services in Huddersfield"
      heroIntro={
        <>
          <p>
            ...
            registered emergency plumbers across Huddersfield and the surrounding
            villages, available 24 hours a day, 7 days a week. Whether it is a{" "}
            <a href="/plumber-huddersfield/services/emergency-plumbing/burst-pipe-repair" className="underline hover:text-white">
              burst pipe
            </a>
      ...
      overviewContent={
        <>
          <p>
            ...
            locally based plumbers who can reach properties in Huddersfield,
            Holmfirth, Marsden, and beyond — often within the hour.
          </p>
          <p>
          ...
          <p>
            From{" "}
            <a href="/plumber-huddersfield/services/emergency-plumbing/leak-detection-repair" className="text-primary underline hover:text-primary/80">
              leak detection and repair
            </a>{" "}
            to{" "}
            <a href="/plumber-huddersfield/services/emergency-plumbing/flood-response" className="text-primary underline hover:text-primary/80">
              flood response
            </a>
      ...
      services={[
        {
          ...
          description:
            "Round-the-clock emergency plumber call-out in Huddersfield. Fast attendance for urgent leaks, burst pipes, boiler failures, and any plumbing crisis that cannot wait until morning.",
          isCoreService: true,
        },
        {
      ...
      differentiators={[
        ...
        },
        {
          ...
          description: (
            <p>
              Our plumbers are based across Huddersfield and the surrounding
      ...
      serviceAreasHeading="Emergency Plumbing Across Huddersfield and Beyond"
      serviceAreasContent={
        <p>
          Our network of emergency plumbers covers Huddersfield town centre and the
          surrounding villages throughout West Yorkshire. Whether you
          are in Holmfirth, Marsden, Slaithwaite, or as far as Kirkheaton
          and Milnsbridge, we can connect you with a qualified plumber who knows
      ...
      faqs={[
        {
          question:
            "How quickly can an emergency plumber reach my property in Huddersfield?",
          answer:
      ...
      ctaContent={
        <p>
          ...
          we will connect you with a vetted emergency plumber in Huddersfield —
          available 24 hours a day, every day of the year.
        </p>
      }
      categoryName="Emergency Plumbing"
      categoryDescription="24/7 emergency plumbing services in Huddersfield — burst pipes, leaks, floods, and urgent repairs by vetted, Gas Safe registered plumbers."
