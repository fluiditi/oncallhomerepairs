...
export const metadata: Metadata = {
  title: "Boiler Breakdown Huddersfield | OnCall Home Repairs",
  description:
    "Emergency boiler repairs by Gas Safe registered engineers, 24/7. Transparent pricing. Call 0333 240 8428.",
  alternates: {
    canonical:
      "https://oncallhomerepairs.co.uk/plumber-huddersfield/services/gasfitter/boiler-breakdown",
  },
};
    ...
    <ServicePage
      breadcrumbItems={[
        ...
        { name: "Gasfitter", href: "/plumber-huddersfield/services/gasfitter" },
        {
          ...
          href: "/plumber-huddersfield/services/gasfitter/boiler-breakdown",
        },
      ]}
      h1="Boiler Breakdown in Huddersfield"
      heroIntro={
        <p>
          Need boiler breakdown in Huddersfield? OnCall Home Repairs connects you with
      ...
      whatWhyHeading="Why You Need Professional Boiler Breakdown in Huddersfield"
      whatWhyContent={
        <>
          <p>
            Boiler Breakdown is not something to leave to chance. Poorly fitted or
      ...
      processHeading="How Boiler Breakdown Works with OnCall"
      processSteps={[
        {
      ...
      relatedServices={[
        ...
        },
        {
          ...
          href: "/plumber-huddersfield/services/plumber/emergency-plumbing",
        },
        {
        ...
        {
          name: "Call Out",
          href: "/plumber-huddersfield/services/plumber/call-out",
        },
      ]}
      serviceAreasHeading="Boiler Breakdown Across Huddersfield"
      serviceAreasContent={
        <p>
      ...
      faqs={[
        {
          question: "How much does boiler breakdown cost in Huddersfield?",
          answer:
        ...
        {
          question: "How quickly can you send a plumber for boiler breakdown?",
          answer:
      ...
      ctaHeading="Need Boiler Breakdown in Huddersfield?"
      ctaContent={
        <p>
      ...
      serviceName="Boiler Breakdown"
      serviceSlug="boiler-breakdown"
      serviceDescription="Emergency boiler repairs by Gas Safe registered engineers, 24/7."
