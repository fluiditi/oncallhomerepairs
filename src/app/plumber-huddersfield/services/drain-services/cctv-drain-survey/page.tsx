...
export const metadata: Metadata = {
  title: "CCTV Drain Survey Huddersfield | OnCall Home Repairs",
  description:
    "CCTV drain survey in Huddersfield. Camera inspection to diagnose drainage problems accurately. Vetted engineers. Call 0333 240 8428.",
  alternates: {
    canonical:
      "https://oncallhomerepairs.co.uk/plumber-huddersfield/services/drain-services/cctv-drain-survey",
  },
};
...
export default function CCTVDrainSurveyPage() {
  return (
    <ServicePage
      ...
      h1="CCTV Drain Survey in Huddersfield"
      heroIntro={
        <p>
          ...
          engineers in Huddersfield who use professional camera equipment to inspect
      ...
      whatWhyContent={
        <>
          ...
          <p>
            Homebuyers in Huddersfield increasingly request drain surveys as part
      ...
      serviceAreasHeading="CCTV Drain Surveys Across Huddersfield"
      serviceAreasContent={
        <p>
          Our drain engineers carry out CCTV surveys across Huddersfield, Holmfirth,
          Marsden, Slaithwaite, Kirkheaton, Linthwaite, Golcar, and all
      ...
      faqs={[
        {
          question: "How much does a CCTV drain survey cost in Huddersfield?",
          answer:
      ...
      ctaContent={
        <p>
          ...
          we will connect you with a drain engineer in Huddersfield who can carry
      ...
      serviceDescription="CCTV drain survey in Huddersfield. Professional camera inspection to diagnose drainage problems, root intrusion, and pipe damage."
