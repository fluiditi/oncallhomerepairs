...
export const metadata: Metadata = {
  title: "Plumbing Pipe Repair Huddersfield | OnCall Home Repairs",
  description:
    "Pipe replacement in Huddersfield. Copper, plastic, and lead pipe upgrades by vetted plumbers. Transparent pricing. Call 0333 240 8428.",
  alternates: {
    canonical:
      "https://oncallhomerepairs.co.uk/plumber-huddersfield/services/plumber/plumbing-pipe-repair",
  },
};
...
export default function PipeReplacementPage() {
  return (
    <ServicePage
      ...
      h1="Pipe Replacement in Huddersfield"
      heroIntro={
        <p>
          ...
          connects you with qualified plumbers in Huddersfield who replace old
      ...
      whatWhyContent={
        <>
          <p>
            ...
            Huddersfield properties &mdash; pose a health risk and should be
      ...
      serviceAreasHeading="Pipe Replacement Across Huddersfield"
      serviceAreasContent={
        <p>
          Our plumbers replace pipework in properties across Huddersfield, Holmfirth,
          Marsden, Slaithwaite, Milnsbridge, Golcar, and all surrounding areas.
      ...
      ctaContent={
        <p>
          ...
          in Huddersfield who can assess your pipes and carry out replacements
          that last.
        </p>
      }
      serviceName="Pipe Replacement"
      serviceSlug="plumbing-pipe-repair"
      serviceDescription="Pipe replacement in Huddersfield. Copper, plastic, and lead pipe upgrades for homes and businesses by vetted local plumbers."
