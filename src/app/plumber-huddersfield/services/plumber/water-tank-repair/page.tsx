...
export const metadata: Metadata = {
  title: "Water Tank Repair Huddersfield | OnCall Home Repairs",
  description:
    "Fix leaking, corroded, or overflowing water tanks. Transparent pricing. Call 0333 240 8428.",
  alternates: {
    canonical:
      "https://oncallhomerepairs.co.uk/plumber-huddersfield/services/plumber/water-tank-repair",
  },
};
...
export default function WaterTankRepairPage() {
  return (
    <ServicePage
      ...
      h1="Water Tank Repair in Huddersfield"
      heroIntro={
        <p>
          Need water tank repair in Huddersfield? OnCall Home Repairs connects you with
      ...
      whatWhyHeading="Why You Need Professional Water Tank Repair in Huddersfield"
      whatWhyContent={
        <>
          <p>
      ...
      serviceAreasHeading="Water Tank Repair Across Huddersfield"
      serviceAreasContent={
        <p>
      ...
      faqs={[
        {
          question: "How much does water tank repair cost in Huddersfield?",
          answer:
      ...
      ctaHeading="Need Water Tank Repair in Huddersfield?"
      ctaContent={
        <p>
