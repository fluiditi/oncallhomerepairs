...
export const metadata: Metadata = {
  title: "Blocked Toilets Huddersfield | OnCall Home Repairs",
  description:
    "Toilet unblocking in Huddersfield. Fast, hygienic clearance of blocked toilets by vetted plumbers. Call 0333 240 8428.",
  alternates: {
    canonical:
      "https://oncallhomerepairs.co.uk/plumber-huddersfield/services/plumber/blocked-toilets",
  },
};
...
export default function ToiletUnblockingPage() {
  return (
    <ServicePage
      ...
      h1="Toilet Unblocking in Huddersfield"
      heroIntro={
        <p>
          ...
          Huddersfield who carry out fast, hygienic toilet unblocking using
      ...
      whatWhyContent={
        <>
          ...
          <p>
            In older Huddersfield properties, narrow soil pipes and ageing clay
      ...
      serviceAreasHeading="Toilet Unblocking Across Huddersfield"
      serviceAreasContent={
        <p>
          Our plumbers attend toilet unblocking jobs across Huddersfield, Holmfirth,
          Marsden, Slaithwaite, Golcar, Milnsbridge, and all surrounding areas.
      ...
      ctaContent={
        <p>
          ...
          and we will connect you with a plumber in Huddersfield who can clear it
          quickly and discreetly &mdash; same-day where possible.
        </p>
      }
      serviceName="Toilet Unblocking"
      serviceSlug="blocked-toilets"
      serviceDescription="Fast, hygienic toilet unblocking in Huddersfield. Professional clearance of blocked toilets by vetted local plumbers."
