...
export const metadata: Metadata = {
  title: "Central Heating Repair Huddersfield | OnCall Home Repairs",
  description:
    "Central heating repair in Huddersfield. Radiators, pumps, valves, thermostats. Gas Safe engineers. Call 0333 240 8428.",
  alternates: {
    canonical:
      "https://oncallhomerepairs.co.uk/plumber-huddersfield/services/plumber/central-heating-repair",
  },
};
...
export default function CentralHeatingRepairPage() {
  return (
    <ServicePage
      ...
      h1="Central Heating Repair in Huddersfield"
      heroIntro={
        <p>
          When your central heating is not working properly, your home becomes
          uncomfortable fast — especially during a West Yorkshire winter. Cold
          ...
          engineers in Huddersfield who diagnose and repair central heating faults
      ...
      whatWhyContent={
        <>
          <p>
            ...
            <Link
              href="/plumber-huddersfield/services/plumber/boiler-repair"
          ...
          <p>
            ...
            <Link
              href="/plumber-huddersfield/services/plumber/power-flushing"
              className="text-primary underline underline-offset-2 hover:text-primary/80"
            >
              power flush
            </Link>{" "}
      ...
      benefits={[
        {
          ...
          description: (
            <p>
              ...
              systems and understand the common faults found in Huddersfield
              properties.
            </p>
          ),
        },
      ...
      relatedServices={[
        ...
        },
        {
          ...
          href: "/plumber-huddersfield/services/plumber/radiator-repair-installation",
        },
        {
          name: "Power Flushing",
          href: "/plumber-huddersfield/services/plumber/power-flushing",
        },
        {
          ...
          href: "/plumber-huddersfield/services/plumber/boiler-servicing",
        },
      ]}
      serviceAreasHeading="Central Heating Repair Across Huddersfield"
      serviceAreasContent={
        <p>
          Our heating engineers cover Huddersfield and the surrounding towns and
          villages throughout West Yorkshire. From older properties
          in Huddersfield town centre to newer-build estates in Slaithwaite, Honley,
          and Meltham, our engineers are familiar with the heating
      ...
      ctaContent={
        <p>
          ...
          a qualified heating engineer in Huddersfield who can diagnose and fix the
      ...
      serviceDescription="Central heating repair in Huddersfield. Radiators, pumps, valves, and full system diagnostics."
