...
export const metadata: Metadata = {
  title: "Boiler And Heating Huddersfield | OnCall Home Repairs",
  description:
    "Repairs, installations, and servicing by Gas Safe engineers. Transparent pricing. Call 0333 240 8428.",
  alternates: {
    canonical:
      "https://oncallhomerepairs.co.uk/plumber-huddersfield/services/plumber/boiler-and-heating",
  },
};

export default function BoilerAndHeatingPage() {
  return (
    <ServicePage
      breadcrumbItems={[
      ...
      h1="Boiler And Heating in Huddersfield"
      heroIntro={
        <p>
          Need boiler and heating in Huddersfield? OnCall Home Repairs connects you with
      ...
      whatWhyHeading="Why You Need Professional Boiler And Heating in Huddersfield"
      whatWhyContent={
        <>
          <p>
            Boiler And Heating is not something to leave to chance. Poorly fitted or
      ...
      processHeading="How Boiler And Heating Works with OnCall"
      processSteps={[
        {
      ...
      serviceAreasHeading="Boiler And Heating Across Huddersfield"
      serviceAreasContent={
        <p>
      ...
      faqs={[
        {
          question: "How much does boiler and heating cost in Huddersfield?",
          answer:
        ...
        {
          question: "How quickly can you send a plumber for boiler and heating?",
          answer:
      ...
      ctaHeading="Need Boiler And Heating in Huddersfield?"
      ctaContent={
        <p>
      ...
      serviceName="Boiler And Heating"
      serviceSlug="boiler-and-heating"
      serviceDescription="Repairs, installations, and servicing by Gas Safe engineers."
