...
export const metadata: Metadata = {
  title: "Boiler Servicing Huddersfield | OnCall Home Repairs",
  description:
    "Annual boiler servicing in Huddersfield. Keep your warranty valid and your boiler running efficiently. Gas Safe engineers. Call 0333 240 8428.",
  alternates: {
    canonical:
      "https://oncallhomerepairs.co.uk/plumber-huddersfield/services/plumber/boiler-servicing",
  },
};
...
export default function BoilerServicingPage() {
  return (
    <ServicePage
      ...
      h1="Boiler Servicing in Huddersfield"
      heroIntro={
        <p>
          ...
          connects you with Gas Safe registered engineers in Huddersfield who carry
      ...
      serviceAreasHeading="Boiler Servicing Across Huddersfield"
      serviceAreasContent={
        <p>
          Our Gas Safe registered engineers service boilers across Huddersfield,
          Holmfirth, Marsden, Slaithwaite, Honley, Meltham, and
      ...
      ctaContent={
        <p>
          ...
          Gas Safe registered engineer in Huddersfield.
        </p>
      }
      serviceName="Boiler Servicing"
      serviceSlug="boiler-servicing"
      serviceDescription="Annual boiler servicing in Huddersfield by Gas Safe registered engineers. Manufacturer warranty protection, safety checks, and efficiency testing."
