...
export const metadata: Metadata = {
  title: "Plumbing Leak Repair Huddersfield | OnCall Home Repairs",
  description:
    "Fast fixes for leaking pipes, joints, and fittings. Transparent pricing. Call 0333 240 8428.",
  alternates: {
    canonical:
      "https://oncallhomerepairs.co.uk/plumber-huddersfield/services/plumber/plumbing-leak-repair",
  },
};
...
export default function PlumbingLeakRepairPage() {
  return (
    <ServicePage
      ...
      h1="Plumbing Leak Repair in Huddersfield"
      heroIntro={
        <p>
          Need plumbing leak repair in Huddersfield? OnCall Home Repairs connects you with
      ...
      whatWhyHeading="Why You Need Professional Plumbing Leak Repair in Huddersfield"
      whatWhyContent={
        <>
          <p>
            Plumbing Leak Repair is not something to leave to chance. Poorly fitted or
      ...
      processHeading="How Plumbing Leak Repair Works with OnCall"
      processSteps={[
        {
      ...
      relatedServices={[
        ...
        {
          name: "Leak",
          href: "/plumber-huddersfield/services/plumber/leak",
        },
        {
          name: "Burst Pipes",
      ...
      serviceAreasHeading="Plumbing Leak Repair Across Huddersfield"
      serviceAreasContent={
        <p>
      ...
      faqs={[
        {
          question: "How much does plumbing leak repair cost in Huddersfield?",
          answer:
        ...
        {
          question: "How quickly can you send a plumber for plumbing leak repair?",
          answer:
      ...
      ctaHeading="Need Plumbing Leak Repair in Huddersfield?"
      ctaContent={
        <p>
      ...
      serviceSlug="plumbing-leak-repair"
      serviceDescription="Fast fixes for leaking pipes, joints, and fittings."
