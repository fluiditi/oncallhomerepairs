...
export const metadata: Metadata = {
  title: "Water Heater Repair Huddersfield | OnCall Home Repairs",
  description:
    "Water heater repair in Huddersfield. Immersion heaters, cylinders, and unvented systems. Vetted plumbers. Call 0333 240 8428.",
  alternates: {
    canonical:
      "https://oncallhomerepairs.co.uk/plumber-huddersfield/services/plumber/water-heater-repair",
  },
};
    ...
    <ServicePage
      breadcrumbItems={[
        ...
        { name: "Boiler & Heating", href: "/plumber-huddersfield/services/boiler-heating" },
        {
          ...
          href: "/plumber-huddersfield/services/plumber/water-heater-repair",
        },
      ]}
      h1="Water Heater Repair in Huddersfield"
      heroIntro={
        <p>
          ...
          you with qualified plumbers and heating engineers in Huddersfield who can
      ...
      whatWhyContent={
        <>
          <p>
            Hot water systems vary considerably across Huddersfield properties.
      ...
      serviceAreasHeading="Water Heater Repair Across Huddersfield"
      serviceAreasContent={
        <p>
          Our plumbers and heating engineers attend water heater repairs across
          Huddersfield, Holmfirth, Marsden, Slaithwaite, Almondbury, Honley, and
      ...
      faqs={[
        {
          ...
          answer:
            "The most common cause is a failed heating element. Hard water areas like Huddersfield accelerate limescale build-up on the element, which causes it to overheat and burn out. The thermostat can also fail independently. A plumber can test both components and replace whichever has failed.",
        },
        {
          question:
      ...
      ctaContent={
        <p>
          ...
          Huddersfield who can restore your hot water supply.
        </p>
      }
      serviceName="Water Heater Repair"
      serviceSlug="water-heater-repair"
      serviceDescription="Water heater repair in Huddersfield. Immersion heaters, hot water cylinders, and unvented systems repaired by qualified local plumbers."
