...
export const metadata: Metadata = {
  title: "Drain Unblocking Huddersfield | OnCall Home Repairs",
  description:
    "Professional drain unblocking in Huddersfield. High-pressure jetting and manual rodding. Vetted plumbers. Call 0333 240 8428.",
  alternates: {
    canonical:
      "https://oncallhomerepairs.co.uk/plumber-huddersfield/services/plumber/drain-unblocking",
  },
};
...
export default function DrainUnblockingPage() {
  return (
    <ServicePage
      ...
      h1="Drain Unblocking in Huddersfield"
      heroIntro={
        <p>
          ...
          experienced drain engineers in Huddersfield who use professional-grade
      ...
      whatWhyContent={
        <>
          <p>
            Most drain blockages in Huddersfield homes are caused by a gradual
      ...
      serviceAreasHeading="Drain Unblocking Across Huddersfield"
      serviceAreasContent={
        <p>
          Our drain engineers cover Huddersfield, Holmfirth, Marsden, Slaithwaite,
          Birkby, Lindley, and the surrounding area. External drain
      ...
      ctaContent={
        <p>
          ...
          Huddersfield who can clear the blockage and restore full flow.
        </p>
      }
      serviceName="Drain Unblocking"
      serviceSlug="drain-unblocking"
      serviceDescription="Professional drain unblocking in Huddersfield using high-pressure jetting and manual rodding. Fast, effective clearance for homes and businesses."
