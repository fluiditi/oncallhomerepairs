...
export const metadata: Metadata = {
  title: "Commercial Gas Engineers Huddersfield | OnCall Home Repairs",
  description:
    "Gas Safe registered engineers for business premises. Transparent pricing. Call 0333 240 8428.",
  alternates: {
    canonical:
      "https://oncallhomerepairs.co.uk/plumber-huddersfield/services/plumber/commercial-gas-engineers",
  },
};

export default function CommercialGasEngineersPage() {
  return (
    <ServicePage
      breadcrumbItems={[
        ...
        { name: "Plumber", href: "/plumber-huddersfield/services/plumber" },
        {
          ...
          href: "/plumber-huddersfield/services/plumber/commercial-gas-engineers",
        },
      ]}
      h1="Commercial Gas Engineers in Huddersfield"
      heroIntro={
        <p>
          Need commercial gas engineers in Huddersfield? OnCall Home Repairs connects you with
      ...
      whatWhyHeading="Why You Need Professional Commercial Gas Engineers in Huddersfield"
      whatWhyContent={
        <>
          <p>
            Commercial Gas Engineers is not something to leave to chance. Poorly fitted or
      ...
      processHeading="How Commercial Gas Engineers Works with OnCall"
      processSteps={[
        {
      ...
      relatedServices={[
        {
          name: "Commercial Gas",
          href: "/plumber-huddersfield/services/plumber/commercial-gas",
        },
        {
          name: "Domestic And Commercial",
          href: "/plumber-huddersfield/services/plumber/domestic-and-commercial",
        },
        {
          name: "Gas Safety Certificate",
          href: "/plumber-huddersfield/services/plumber/gas-safety-certificate",
        },
        {
          name: "Heating And Gas",
          href: "/plumber-huddersfield/services/plumber/heating-and-gas",
        },
      ]}
      serviceAreasHeading="Commercial Gas Engineers Across Huddersfield"
      serviceAreasContent={
        <p>
      ...
      faqs={[
        {
          question: "How much does commercial gas engineers cost in Huddersfield?",
          answer:
        ...
        {
          question: "How quickly can you send a plumber for commercial gas engineers?",
          answer:
      ...
      ctaHeading="Need Commercial Gas Engineers in Huddersfield?"
      ctaContent={
        <p>
      ...
      serviceName="Commercial Gas Engineers"
      serviceSlug="commercial-gas-engineers"
      serviceDescription="Gas Safe registered engineers for business premises."
