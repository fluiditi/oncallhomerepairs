...
export const metadata: Metadata = {
  title: "Domestic And Commercial Huddersfield | OnCall Home Repairs",
  description:
    "Full plumbing services for homes and businesses. Transparent pricing. Call 0333 240 8428.",
  alternates: {
    canonical:
      "https://oncallhomerepairs.co.uk/plumber-huddersfield/services/plumber/domestic-and-commercial",
  },
};
...
export default function DomesticAndCommercialPage() {
  return (
    <ServicePage
      ...
      h1="Domestic And Commercial in Huddersfield"
      heroIntro={
        <p>
          Need domestic and commercial in Huddersfield? OnCall Home Repairs connects you with
      ...
      whatWhyHeading="Why You Need Professional Domestic And Commercial in Huddersfield"
      whatWhyContent={
        <>
          <p>
      ...
      serviceAreasHeading="Domestic And Commercial Across Huddersfield"
      serviceAreasContent={
        <p>
      ...
      faqs={[
        {
          question: "How much does domestic and commercial cost in Huddersfield?",
          answer:
      ...
      ctaHeading="Need Domestic And Commercial in Huddersfield?"
      ctaContent={
        <p>
