...
export const metadata: Metadata = {
  title: "Water System Repairs Huddersfield | OnCall Home Repairs",
  description:
    "Tanks, pipes, cylinders, and plumbing system fixes. Transparent pricing. Call 0333 240 8428.",
  alternates: {
    canonical:
      "https://oncallhomerepairs.co.uk/plumber-huddersfield/services/plumber/water-system-repairs",
  },
};

export default function WaterSystemRepairsPage() {
  return (
    <ServicePage
      breadcrumbItems={[
      ...
      h1="Water System Repairs in Huddersfield"
      heroIntro={
        <p>
          Need water system repairs in Huddersfield? OnCall Home Repairs connects you with
      ...
      whatWhyHeading="Why You Need Professional Water System Repairs in Huddersfield"
      whatWhyContent={
        <>
          <p>
            Water System Repairs is not something to leave to chance. Poorly fitted or
      ...
      processHeading="How Water System Repairs Works with OnCall"
      processSteps={[
        {
      ...
      serviceAreasHeading="Water System Repairs Across Huddersfield"
      serviceAreasContent={
        <p>
      ...
      faqs={[
        {
          question: "How much does water system repairs cost in Huddersfield?",
          answer:
        ...
        {
          question: "How quickly can you send a plumber for water system repairs?",
          answer:
      ...
      ctaHeading="Need Water System Repairs in Huddersfield?"
      ctaContent={
        <p>
      ...
      serviceName="Water System Repairs"
      serviceSlug="water-system-repairs"
      serviceDescription="Tanks, pipes, cylinders, and plumbing system fixes."
