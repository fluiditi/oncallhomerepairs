...
export const metadata: Metadata = {
  title: "Power Flushing Huddersfield | OnCall Home Repairs",
  description:
    "Power flushing in Huddersfield. Remove sludge and restore heating efficiency. Gas Safe engineers, transparent pricing. Call 0333 240 8428.",
  alternates: {
    canonical:
      "https://oncallhomerepairs.co.uk/plumber-huddersfield/services/plumber/power-flushing",
  },
};
...
export default function PowerFlushingPage() {
  return (
    <ServicePage
      ...
      h1="Power Flushing in Huddersfield"
      heroIntro={
        <p>
          ...
          connects you with qualified engineers in Huddersfield who carry out
      ...
      serviceAreasHeading="Power Flushing Across Huddersfield"
      serviceAreasContent={
        <p>
          Our engineers carry out power flushing across Huddersfield, Holmfirth, Marsden,
          Slaithwaite, Lindley, Kirkheaton, and surrounding
      ...
      ctaContent={
        <p>
          ...
          Repairs and we will connect you with a qualified engineer in Huddersfield
          who can carry out a professional power flush on your system.
        </p>
      }
      serviceName="Power Flushing"
      serviceSlug="power-flushing"
      serviceDescription="Power flushing in Huddersfield. Remove sludge and limescale from your central heating system to restore efficiency and prevent boiler breakdowns."
