...
export const metadata: Metadata = {
  title: "Landlord Certificate Huddersfield | OnCall Home Repairs",
  description:
    "CP12 certificates issued by Gas Safe registered engineers. Transparent pricing. Call 0333 240 8428.",
  alternates: {
    canonical:
      "https://oncallhomerepairs.co.uk/plumber-huddersfield/services/plumber/landlord-certificate",
  },
};
...
export default function LandlordCertificatePage() {
  return (
    <ServicePage
      ...
      h1="Landlord Certificate in Huddersfield"
      heroIntro={
        <p>
          Need landlord certificate in Huddersfield? OnCall Home Repairs connects you with
      ...
      whatWhyHeading="Why You Need Professional Landlord Certificate in Huddersfield"
      whatWhyContent={
        <>
          <p>
            Landlord Certificate is not something to leave to chance. Poorly fitted or
      ...
      processHeading="How Landlord Certificate Works with OnCall"
      processSteps={[
        {
      ...
      serviceAreasHeading="Landlord Certificate Across Huddersfield"
      serviceAreasContent={
        <p>
      ...
      faqs={[
        {
          question: "How much does landlord certificate cost in Huddersfield?",
          answer:
        ...
        {
          question: "How quickly can you send a plumber for landlord certificate?",
          answer:
      ...
      ctaHeading="Need Landlord Certificate in Huddersfield?"
      ctaContent={
        <p>
      ...
      serviceName="Landlord Certificate"
      serviceSlug="landlord-certificate"
      serviceDescription="CP12 certificates issued by Gas Safe registered engineers."
