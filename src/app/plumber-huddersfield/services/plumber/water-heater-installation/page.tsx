...
export const metadata: Metadata = {
  title: "Water Heater Installation Huddersfield | OnCall Home Repairs",
  description:
    "Immersion heaters, cylinders, and unvented systems fitted. Transparent pricing. Call 0333 240 8428.",
  alternates: {
    canonical:
      "https://oncallhomerepairs.co.uk/plumber-huddersfield/services/plumber/water-heater-installation",
  },
};
...
export default function WaterHeaterInstallationPage() {
  return (
    <ServicePage
      ...
      h1="Water Heater Installation in Huddersfield"
      heroIntro={
        <p>
          Need water heater installation in Huddersfield? OnCall Home Repairs connects you with
      ...
      whatWhyHeading="Why You Need Professional Water Heater Installation in Huddersfield"
      whatWhyContent={
        <>
          <p>
            Water Heater Installation is not something to leave to chance. Poorly fitted or
      ...
      processHeading="How Water Heater Installation Works with OnCall"
      processSteps={[
        {
      ...
      serviceAreasHeading="Water Heater Installation Across Huddersfield"
      serviceAreasContent={
        <p>
      ...
      faqs={[
        {
          question: "How much does water heater installation cost in Huddersfield?",
          answer:
        ...
        {
          question: "How quickly can you send a plumber for water heater installation?",
          answer:
      ...
      ctaHeading="Need Water Heater Installation in Huddersfield?"
      ctaContent={
        <p>
      ...
      serviceDescription="Immersion heaters, cylinders, and unvented systems fitted."
