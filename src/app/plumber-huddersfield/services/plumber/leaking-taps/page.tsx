...
export const metadata: Metadata = {
  title: "Leaking Taps Huddersfield | OnCall Home Repairs",
  description:
    "Stop dripping taps fast with a vetted local plumber. Transparent pricing. Call 0333 240 8428.",
  alternates: {
    canonical:
      "https://oncallhomerepairs.co.uk/plumber-huddersfield/services/plumber/leaking-taps",
  },
};
  ...
  return (
    <ServicePage
      breadcrumbItems={[
        ...
        {
          name: "Leaking Taps",
          href: "/plumber-huddersfield/services/plumber/leaking-taps",
        },
      ]}
      h1="Leaking Taps in Huddersfield"
      heroIntro={
        <p>
          Need leaking taps in Huddersfield? OnCall Home Repairs connects you with
      ...
      whatWhyHeading="Why You Need Professional Leaking Taps in Huddersfield"
      whatWhyContent={
        <>
          <p>
      ...
      serviceAreasHeading="Leaking Taps Across Huddersfield"
      serviceAreasContent={
        <p>
      ...
      faqs={[
        {
          question: "How much does leaking taps cost in Huddersfield?",
          answer:
      ...
      ctaHeading="Need Leaking Taps in Huddersfield?"
      ctaContent={
        <p>
