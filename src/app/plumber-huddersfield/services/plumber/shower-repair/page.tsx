...
export const metadata: Metadata = {
  title: "Shower Repair Huddersfield | OnCall Home Repairs",
  description:
    "Fix leaks, low pressure, temperature issues, and broken valves. Transparent pricing. Call 0333 240 8428.",
  alternates: {
    canonical:
      "https://oncallhomerepairs.co.uk/plumber-huddersfield/services/plumber/shower-repair",
  },
};
  ...
  return (
    <ServicePage
      breadcrumbItems={[
        ...
        {
          name: "Shower Repair",
          href: "/plumber-huddersfield/services/plumber/shower-repair",
        },
      ]}
      h1="Shower Repair in Huddersfield"
      heroIntro={
        <p>
          Need shower repair in Huddersfield? OnCall Home Repairs connects you with
      ...
      whatWhyHeading="Why You Need Professional Shower Repair in Huddersfield"
      whatWhyContent={
        <>
          <p>
      ...
      serviceAreasHeading="Shower Repair Across Huddersfield"
      serviceAreasContent={
        <p>
      ...
      faqs={[
        {
          question: "How much does shower repair cost in Huddersfield?",
          answer:
      ...
      ctaHeading="Need Shower Repair in Huddersfield?"
      ctaContent={
        <p>
