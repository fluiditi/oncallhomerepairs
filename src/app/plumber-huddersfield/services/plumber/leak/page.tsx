...
export const metadata: Metadata = {
  title: "Leak Huddersfield | OnCall Home Repairs",
  description:
    "Leaking pipes, toilets, radiators, and taps fixed by vetted plumbers. Transparent pricing. Call 0333 240 8428.",
  alternates: {
    canonical:
      "https://oncallhomerepairs.co.uk/plumber-huddersfield/services/plumber/leak",
  },
};
...
export default function LeakPage() {
  return (
    <ServicePage
      ...
      h1="Leak in Huddersfield"
      heroIntro={
        <p>
          Need leak in Huddersfield? OnCall Home Repairs connects you with
      ...
      whatWhyHeading="Why You Need Professional Leak in Huddersfield"
      whatWhyContent={
        <>
          <p>
            Leak is not something to leave to chance. Poorly fitted or
      ...
      processHeading="How Leak Works with OnCall"
      processSteps={[
        {
      ...
      serviceAreasHeading="Leak Across Huddersfield"
      serviceAreasContent={
        <p>
      ...
      faqs={[
        {
          question: "How much does leak cost in Huddersfield?",
          answer:
        ...
        {
          question: "How quickly can you send a plumber for leak?",
          answer:
      ...
      ctaHeading="Need Leak in Huddersfield?"
      ctaContent={
        <p>
      ...
      serviceName="Leak"
      serviceSlug="leak"
      serviceDescription="Leaking pipes, toilets, radiators, and taps fixed by vetted plumbers."
