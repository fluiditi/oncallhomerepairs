...
export const metadata: Metadata = {
  title: "Boiler Installation Huddersfield | OnCall Home Repairs",
  description:
    "New boiler installation in Huddersfield. Gas Safe engineers, competitive quotes, workmanship guarantee. Call 0333 240 8428.",
  alternates: {
    canonical:
      "https://oncallhomerepairs.co.uk/plumber-huddersfield/services/plumber/boiler-installation",
  },
};
...
export default function BoilerInstallationPage() {
  return (
    <ServicePage
      ...
      h1="Boiler Installation in Huddersfield"
      heroIntro={
        <p>
          ...
          you with Gas Safe registered heating engineers in Huddersfield who carry
      ...
      serviceAreasHeading="Boiler Installation Across Huddersfield"
      serviceAreasContent={
        <p>
          We connect homeowners across Huddersfield and West Yorkshire
          with qualified boiler installers. Whether you are in the centre of
          Huddersfield, in Holmfirth, Marsden, or one of the surrounding
          ...
          of West Yorkshire and can advise on the best boiler setup for your
          home.
        </p>
      }
      faqs={[
        {
          question: "How much does a new boiler installation cost in Huddersfield?",
          answer:
      ...
      ctaHeading="Ready for a New Boiler in Huddersfield?"
      ctaContent={
        <p>
      ...
      serviceDescription="New boiler installation in Huddersfield. Gas Safe registered, competitive pricing."
