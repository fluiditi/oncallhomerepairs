...
export const metadata: Metadata = {
  title: "Heating Engineer Huddersfield | OnCall Home Repairs",
  description:
    "Central heating repairs, installations, and servicing. Transparent pricing. Call 0333 240 8428.",
  alternates: {
    canonical:
      "https://oncallhomerepairs.co.uk/plumber-huddersfield/services/plumber/heating-engineer",
  },
};
...
export default function HeatingEngineerPage() {
  return (
    <ServicePage
      ...
      h1="Heating Engineer in Huddersfield"
      heroIntro={
        <p>
          Need heating engineer in Huddersfield? OnCall Home Repairs connects you with
      ...
      whatWhyHeading="Why You Need Professional Heating Engineer in Huddersfield"
      whatWhyContent={
        <>
          <p>
            Heating Engineer is not something to leave to chance. Poorly fitted or
      ...
      processHeading="How Heating Engineer Works with OnCall"
      processSteps={[
        {
      ...
      relatedServices={[
        ...
        {
          name: "Radiator Repair Installation",
          href: "/plumber-huddersfield/services/plumber/radiator-repair-installation",
        },
      ]}
      serviceAreasHeading="Heating Engineer Across Huddersfield"
      serviceAreasContent={
        <p>
      ...
      faqs={[
        {
          question: "How much does heating engineer cost in Huddersfield?",
          answer:
        ...
        {
          question: "How quickly can you send a plumber for heating engineer?",
          answer:
      ...
      ctaHeading="Need Heating Engineer in Huddersfield?"
      ctaContent={
        <p>
      ...
      serviceSlug="heating-engineer"
      serviceDescription="Central heating repairs, installations, and servicing."
