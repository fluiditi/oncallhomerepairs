...
export const metadata: Metadata = {
  ...
  description:
    "24/7 emergency plumber response for burst pipes, leaks, and flooding. Transparent pricing. Call 0333 240 8428.",
  alternates: {
    canonical:
      "https://oncallhomerepairs.co.uk/plumber-huddersfield/services/plumber/emergency-plumbing",
  },
};
...
export default function EmergencyPlumbingPage() {
  return (
    <ServicePage
      ...
      h1="Emergency Plumbing in Huddersfield"
      heroIntro={
        <p>
          Need emergency plumbing in Huddersfield? OnCall Home Repairs connects you with
      ...
      whatWhyHeading="Why You Need Professional Emergency Plumbing in Huddersfield"
      whatWhyContent={
        <>
          <p>
            Emergency Plumbing is not something to leave to chance. Poorly fitted or
      ...
      processHeading="How Emergency Plumbing Works with OnCall"
      processSteps={[
        {
      ...
      serviceAreasHeading="Emergency Plumbing Across Huddersfield"
      serviceAreasContent={
        <p>
      ...
      faqs={[
        {
          question: "How much does emergency plumbing cost in Huddersfield?",
          answer:
        ...
        {
          question: "How quickly can you send a plumber for emergency plumbing?",
          answer:
      ...
      ctaHeading="Need Emergency Plumbing in Huddersfield?"
      ctaContent={
        <p>
      ...
      serviceDescription="24/7 emergency plumber response for burst pipes, leaks, and flooding."
