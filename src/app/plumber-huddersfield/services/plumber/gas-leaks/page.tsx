...
export const metadata: Metadata = {
  title: "Gas Leaks Huddersfield | OnCall Home Repairs",
  description:
    "24/7 emergency response from Gas Safe engineers for gas leaks. Transparent pricing. Call 0333 240 8428.",
  alternates: {
    canonical:
      "https://oncallhomerepairs.co.uk/plumber-huddersfield/services/plumber/gas-leaks",
  },
};

export default function GasLeaksPage() {
  return (
    <ServicePage
      breadcrumbItems={[
        ...
        {
          name: "Gas Leaks",
          href: "/plumber-huddersfield/services/plumber/gas-leaks",
        },
      ]}
      h1="Gas Leaks in Huddersfield"
      heroIntro={
        <p>
          Need gas leaks in Huddersfield? OnCall Home Repairs connects you with
      ...
      whatWhyHeading="Why You Need Professional Gas Leaks in Huddersfield"
      whatWhyContent={
        <>
          <p>
            Gas Leaks is not something to leave to chance. Poorly fitted or
      ...
      processHeading="How Gas Leaks Works with OnCall"
      processSteps={[
        {
      ...
      serviceAreasHeading="Gas Leaks Across Huddersfield"
      serviceAreasContent={
        <p>
      ...
      faqs={[
        {
          question: "How much does gas leaks cost in Huddersfield?",
          answer:
        ...
        {
          question: "How quickly can you send a plumber for gas leaks?",
          answer:
      ...
      ctaHeading="Need Gas Leaks in Huddersfield?"
      ctaContent={
        <p>
      ...
      serviceName="Gas Leaks"
      serviceSlug="gas-leaks"
      serviceDescription="24/7 emergency response from Gas Safe engineers for gas leaks."
