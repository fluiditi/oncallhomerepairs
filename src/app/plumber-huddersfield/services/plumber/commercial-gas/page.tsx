...
export const metadata: Metadata = {
  title: "Commercial Gas Huddersfield | OnCall Home Repairs",
  description:
    "Gas Safe engineers for restaurants, offices, and commercial premises. Transparent pricing. Call 0333 240 8428.",
  alternates: {
    canonical:
      "https://oncallhomerepairs.co.uk/plumber-huddersfield/services/plumber/commercial-gas",
  },
};

export default function CommercialGasPage() {
  return (
    <ServicePage
      breadcrumbItems={[
      ...
      h1="Commercial Gas in Huddersfield"
      heroIntro={
        <p>
          Need commercial gas in Huddersfield? OnCall Home Repairs connects you with
      ...
      whatWhyHeading="Why You Need Professional Commercial Gas in Huddersfield"
      whatWhyContent={
        <>
          <p>
            Commercial Gas is not something to leave to chance. Poorly fitted or
      ...
      processHeading="How Commercial Gas Works with OnCall"
      processSteps={[
        {
      ...
      serviceAreasHeading="Commercial Gas Across Huddersfield"
      serviceAreasContent={
        <p>
      ...
      faqs={[
        {
          question: "How much does commercial gas cost in Huddersfield?",
          answer:
        ...
        {
          question: "How quickly can you send a plumber for commercial gas?",
          answer:
      ...
      ctaHeading="Need Commercial Gas in Huddersfield?"
      ctaContent={
        <p>
      ...
      serviceName="Commercial Gas"
      serviceSlug="commercial-gas"
      serviceDescription="Gas Safe engineers for restaurants, offices, and commercial premises."
