...
export const metadata: Metadata = {
  title: "Safety Certificates Huddersfield | OnCall Home Repairs",
  description:
    "Gas safety, landlord CP12, and compliance certificates from Gas Safe engineers. Transparent pricing. Call 0333 240 8428.",
  alternates: {
    canonical:
      "https://oncallhomerepairs.co.uk/plumber-huddersfield/services/plumber/safety-certificates",
  },
};
    ...
    <ServicePage
      breadcrumbItems={[
        ...
        { name: "Plumber", href: "/plumber-huddersfield/services/plumber" },
        {
          ...
          href: "/plumber-huddersfield/services/plumber/safety-certificates",
        },
      ]}
      h1="Safety Certificates in Huddersfield"
      heroIntro={
        <p>
          Need safety certificates in Huddersfield? OnCall Home Repairs connects you with
      ...
      whatWhyHeading="Why You Need Professional Safety Certificates in Huddersfield"
      whatWhyContent={
        <>
          <p>
            Safety Certificates is not something to leave to chance. Poorly fitted or
      ...
      processHeading="How Safety Certificates Works with OnCall"
      processSteps={[
        {
      ...
      relatedServices={[
        ...
        },
        {
          ...
          href: "/plumber-huddersfield/services/plumber/landlord-certificate",
        },
        {
          name: "Commercial Gas",
      ...
      serviceAreasHeading="Safety Certificates Across Huddersfield"
      serviceAreasContent={
        <p>
      ...
      faqs={[
        {
          question: "How much does safety certificates cost in Huddersfield?",
          answer:
        ...
        {
          question: "How quickly can you send a plumber for safety certificates?",
          answer:
      ...
      ctaHeading="Need Safety Certificates in Huddersfield?"
      ctaContent={
        <p>
      ...
      serviceName="Safety Certificates"
      serviceSlug="safety-certificates"
      serviceDescription="Gas safety, landlord CP12, and compliance certificates from Gas Safe engineers."
