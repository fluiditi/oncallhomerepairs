...
export const metadata: Metadata = {
  title: "Call Out Huddersfield | OnCall Home Repairs",
  description:
    "Emergency and same-day plumber call-outs, 24/7 availability. Transparent pricing. Call 0333 240 8428.",
  alternates: {
    canonical:
      "https://oncallhomerepairs.co.uk/plumber-huddersfield/services/plumber/call-out",
  },
};
...
export default function CallOutPage() {
  return (
    <ServicePage
      ...
      h1="Call Out in Huddersfield"
      heroIntro={
        <p>
          Need call out in Huddersfield? OnCall Home Repairs connects you with
      ...
      whatWhyHeading="Why You Need Professional Call Out in Huddersfield"
      whatWhyContent={
        <>
          <p>
            Call Out is not something to leave to chance. Poorly fitted or
      ...
      processHeading="How Call Out Works with OnCall"
      processSteps={[
        {
      ...
      serviceAreasHeading="Call Out Across Huddersfield"
      serviceAreasContent={
        <p>
      ...
      faqs={[
        {
          question: "How much does call out cost in Huddersfield?",
          answer:
        ...
        {
          question: "How quickly can you send a plumber for call out?",
          answer:
      ...
      ctaHeading="Need Call Out in Huddersfield?"
      ctaContent={
        <p>
      ...
      serviceName="Call Out"
      serviceSlug="call-out"
      serviceDescription="Emergency and same-day plumber call-outs, 24/7 availability."
