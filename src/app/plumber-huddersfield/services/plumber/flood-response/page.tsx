...
export const metadata: Metadata = {
  title: "Flood Response Plumber Huddersfield | OnCall Home Repairs",
  description:
    "Emergency flood response in Huddersfield. Rapid water damage control by vetted plumbers, available 24/7. Call 0333 240 8428.",
  alternates: {
    canonical:
      "https://oncallhomerepairs.co.uk/plumber-huddersfield/services/plumber/flood-response",
  },
};
...
export default function FloodResponsePage() {
  return (
    <ServicePage
      ...
      h1="Flood Response Plumber in Huddersfield"
      heroIntro={
        <p>
          ...
          experienced flood response plumbers in Huddersfield who can reach your
      ...
      whatWhyContent={
        <>
          ...
          <p>
            Properties across Huddersfield, Holmfirth, and the surrounding villages
      ...
      relatedServices={[
        ...
        },
        {
          ...
          href: "/plumber-huddersfield/services/plumber/stopcock-repair",
        },
        {
          name: "Leak Detection and Repair",
          href: "/plumber-huddersfield/services/plumber/plumbing-leak-detection",
        },
      ]}
      serviceAreasHeading="Flood Response Across Huddersfield and West Yorkshire"
      serviceAreasContent={
        <p>
          Our flood response plumbers cover Huddersfield town centre, Holmfirth,
          Marsden, Slaithwaite, Meltham, and surrounding villages.
          Response times are fastest within the Huddersfield and Holmfirth area,
      ...
      ctaContent={
        <p>
          ...
          will have a vetted flood response plumber heading to your Huddersfield
          property as quickly as possible.
        </p>
      }
      serviceName="Flood Response"
      serviceSlug="flood-response"
      serviceDescription="Emergency flood response plumber in Huddersfield. Rapid water damage control, source isolation, and immediate repair by vetted local plumbers."
