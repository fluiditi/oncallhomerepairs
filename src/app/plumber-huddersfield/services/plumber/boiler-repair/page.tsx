...
export const metadata: Metadata = {
  title: "Boiler Repair Huddersfield | OnCall Home Repairs",
  description:
    "Boiler repair in Huddersfield by Gas Safe engineers. Same-day repairs, upfront quotes. Available 24/7. Call 0333 240 8428.",
  alternates: {
    canonical:
      "https://oncallhomerepairs.co.uk/plumber-huddersfield/services/plumber/boiler-repair",
  },
};
...
export default function BoilerRepairPage() {
  return (
    <ServicePage
      ...
      h1="Boiler Repair in Huddersfield"
      heroIntro={
        <p>
          ...
          with Gas Safe registered heating engineers in Huddersfield who diagnose
        ...
        },
        {
          ...
          description: (
            <p>
              ...
              Huddersfield. For emergency breakdowns, engineers are available 24/7.
      ...
      serviceAreasHeading="Boiler Repair Across Huddersfield"
      serviceAreasContent={
        <p>
          Our network of Gas Safe heating engineers covers Huddersfield and the
          surrounding area. Whether you live in Holmfirth, Marsden, Slaithwaite,
          or one of the smaller villages like Lindley or Birkby, we
      ...
      ctaContent={
        <p>
          ...
          a Gas Safe registered engineer in Huddersfield. Upfront pricing,
      ...
      serviceDescription="Expert boiler repair in Huddersfield. Gas Safe registered engineers available 24/7."
