...
export const metadata: Metadata = {
  title: "Waste Disposal Installation Huddersfield | OnCall Home Repairs",
  description:
    "Kitchen waste disposal units fitted by qualified plumbers. Transparent pricing. Call 0333 240 8428.",
  alternates: {
    canonical:
      "https://oncallhomerepairs.co.uk/plumber-huddersfield/services/plumber/waste-disposal-installation",
  },
};
    ...
    <ServicePage
      breadcrumbItems={[
        ...
        { name: "Plumber", href: "/plumber-huddersfield/services/plumber" },
        {
          ...
          href: "/plumber-huddersfield/services/plumber/waste-disposal-installation",
        },
      ]}
      h1="Waste Disposal Installation in Huddersfield"
      heroIntro={
        <p>
          Need waste disposal installation in Huddersfield? OnCall Home Repairs connects you with
      ...
      whatWhyHeading="Why You Need Professional Waste Disposal Installation in Huddersfield"
      whatWhyContent={
        <>
          <p>
      ...
      serviceAreasHeading="Waste Disposal Installation Across Huddersfield"
      serviceAreasContent={
        <p>
      ...
      faqs={[
        {
          question: "How much does waste disposal installation cost in Huddersfield?",
          answer:
      ...
      ctaHeading="Need Waste Disposal Installation in Huddersfield?"
      ctaContent={
        <p>
