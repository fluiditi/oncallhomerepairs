...
export const metadata: Metadata = {
  title: "Stopcock Repair Huddersfield | OnCall Home Repairs",
  description:
    "Stopcock repair and replacement in Huddersfield. Regain control of your water supply. Vetted plumbers. Call 0333 240 8428.",
  alternates: {
    canonical:
      "https://oncallhomerepairs.co.uk/plumber-huddersfield/services/plumber/stopcock-repair",
  },
};
...
export default function StopcockRepairPage() {
  return (
    <ServicePage
      ...
      h1="Stopcock Repair and Replacement in Huddersfield"
      heroIntro={
        <p>
          ...
          you with vetted plumbers in Huddersfield who can repair or replace faulty
      ...
      whatWhyContent={
        <>
          ...
          <p>
            In many Huddersfield properties, especially those built before the 1980s,
      ...
      serviceAreasHeading="Stopcock Repair Across Huddersfield"
      serviceAreasContent={
        <p>
          We connect homeowners with plumbers who carry out stopcock repairs
          across Huddersfield, Holmfirth, Marsden, Slaithwaite, and all surrounding
      ...
      ctaContent={
        <p>
          ...
          in Huddersfield who can repair or replace your stopcock &mdash; often the
          same day.
        </p>
      }
      serviceName="Stopcock Repair"
      serviceSlug="stopcock-repair"
      serviceDescription="Stopcock repair and replacement in Huddersfield. Regain control of your water supply with same-day service from vetted local plumbers."
