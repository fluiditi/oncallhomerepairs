...
export const metadata: Metadata = {
  title: "Gas Safety Check Huddersfield | OnCall Home Repairs",
  description:
    "Gas safety checks and CP12 certificates in Huddersfield. For landlords and homeowners. Gas Safe registered engineers. Call 0333 240 8428.",
  alternates: {
    canonical:
      "https://oncallhomerepairs.co.uk/plumber-huddersfield/services/plumber/gas-safety-certificate",
  },
};
...
export default function GasSafetyChecksPage() {
  return (
    <ServicePage
      ...
      h1="Gas Safety Checks in Huddersfield"
      heroIntro={
        <p>
          ...
          Huddersfield who carry out thorough inspections of your boiler, gas
      ...
      serviceAreasHeading="Gas Safety Checks Across Huddersfield"
      serviceAreasContent={
        <p>
          Our Gas Safe registered engineers carry out gas safety checks across
          Huddersfield, Holmfirth, Marsden, Slaithwaite, Meltham, Mirfield,
          Golcar, Milnsbridge, and all surrounding areas. Landlords with multiple
      ...
      faqs={[
        {
          question: "How much does a gas safety check cost in Huddersfield?",
          answer:
      ...
      ctaContent={
        <p>
          ...
          engineer in Huddersfield for your annual gas safety check.
        </p>
      }
      serviceName="Gas Safety Checks"
      serviceSlug="gas-safety-certificate"
      serviceDescription="Gas safety checks and CP12 certificates in Huddersfield. Annual inspections for landlords and homeowners by Gas Safe registered engineers."
