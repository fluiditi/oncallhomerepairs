...
export const metadata: Metadata = {
  title: "Frozen Pipe Repair Huddersfield | OnCall Home Repairs",
  description:
    "Frozen pipe repair in Huddersfield. Prevent burst pipes this winter. Vetted plumbers, 24/7. Call 0333 240 8428.",
  alternates: {
    canonical:
      "https://oncallhomerepairs.co.uk/plumber-huddersfield/services/plumber/frozen-pipe-repair",
  },
};
    ...
    <ServicePage
      breadcrumbItems={[
        ...
        { name: "Emergency Plumbing", href: "/plumber-huddersfield/services/emergency-plumbing" },
        {
          ...
          href: "/plumber-huddersfield/services/plumber/frozen-pipe-repair",
        },
      ]}
      h1="Frozen Pipe Repair in Huddersfield"
      heroIntro={
        <p>
      ...
      whatWhyHeading="Why Frozen Pipes Are a Serious Risk in Huddersfield"
      whatWhyContent={
        <>
          <p>
            Huddersfield sits in the East Midlands where winter temperatures
          ...
          <p>
            ...
            and{" "}
            <a
              href="/plumber-huddersfield/services/plumber/flood-response"
              className="text-primary underline underline-offset-2 hover:text-primary/80"
            >
              flood response
            </a>{" "}
      ...
      serviceAreasHeading="Frozen Pipe Repair Across Huddersfield"
      serviceAreasContent={
        <p>
          Our plumbers attend frozen pipe emergencies across Huddersfield, Holmfirth,
          Marsden, Slaithwaite, and the surrounding villages. Properties in
      ...
      faqs={[
        ...
        {
          question:
            "How much does frozen pipe repair cost in Huddersfield?",
          answer:
      ...
      ctaContent={
        <p>
          ...
          Home Repairs and we will connect you with a vetted plumber in Huddersfield
      ...
      serviceDescription="Frozen pipe thawing and repair in Huddersfield. Prevent burst pipes this winter with safe, professional pipe repair from vetted local plumbers."
