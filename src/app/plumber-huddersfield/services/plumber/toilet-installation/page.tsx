...
export const metadata: Metadata = {
  title: "Toilet Installation Huddersfield | OnCall Home Repairs",
  description:
    "New toilet fitting, replacements, and upgrades by qualified plumbers. Transparent pricing. Call 0333 240 8428.",
  alternates: {
    canonical:
      "https://oncallhomerepairs.co.uk/plumber-huddersfield/services/plumber/toilet-installation",
  },
};
    ...
    <ServicePage
      breadcrumbItems={[
        ...
        { name: "Plumber", href: "/plumber-huddersfield/services/plumber" },
        {
          ...
          href: "/plumber-huddersfield/services/plumber/toilet-installation",
        },
      ]}
      h1="Toilet Installation in Huddersfield"
      heroIntro={
        <p>
          Need toilet installation in Huddersfield? OnCall Home Repairs connects you with
      ...
      whatWhyHeading="Why You Need Professional Toilet Installation in Huddersfield"
      whatWhyContent={
        <>
          <p>
            Toilet Installation is not something to leave to chance. Poorly fitted or
      ...
      processHeading="How Toilet Installation Works with OnCall"
      processSteps={[
        {
      ...
      relatedServices={[
        {
          name: "Toilet Repair",
          href: "/plumber-huddersfield/services/plumber/toilet-repair",
        },
        {
          name: "Blocked Toilets",
          href: "/plumber-huddersfield/services/plumber/blocked-toilets",
        },
        {
      ...
      serviceAreasHeading="Toilet Installation Across Huddersfield"
      serviceAreasContent={
        <p>
      ...
      faqs={[
        {
          question: "How much does toilet installation cost in Huddersfield?",
          answer:
        ...
        {
          question: "How quickly can you send a plumber for toilet installation?",
          answer:
      ...
      ctaHeading="Need Toilet Installation in Huddersfield?"
      ctaContent={
        <p>
      ...
      serviceDescription="New toilet fitting, replacements, and upgrades by qualified plumbers."
