...
export const metadata: Metadata = {
  title: "Radiator Repair Huddersfield | OnCall Home Repairs",
  description:
    "Radiator repair and installation in Huddersfield. Fix cold spots, leaks, and add new radiators. Gas Safe engineers. Call 0333 240 8428.",
  alternates: {
    canonical:
      "https://oncallhomerepairs.co.uk/plumber-huddersfield/services/plumber/radiator-repair-installation",
  },
};
...
export default function RadiatorRepairPage() {
  return (
    <ServicePage
      ...
      h1="Radiator Repair and Installation in Huddersfield"
      heroIntro={
        <p>
          ...
          Huddersfield who can diagnose radiator faults, carry out repairs, and
      ...
      whatWhyHeading="Common Radiator Problems in Huddersfield Homes"
      whatWhyContent={
        <>
          <p>
          ...
          <p>
            West Yorkshire&rsquo;s hard water accelerates the build-up of
            limescale and sludge in central heating systems. Many homes in
            Huddersfield, Holmfirth, and the surrounding area have heating systems
      ...
      serviceAreasHeading="Radiator Repair Across Huddersfield"
      serviceAreasContent={
        <p>
          Our heating engineers carry out radiator repairs and installations
          across Huddersfield, Holmfirth, Marsden, Slaithwaite, Mirfield, Linthwaite,
          and the wider West Yorkshire area. Whether you need a
      ...
      ctaContent={
        <p>
          ...
          in Huddersfield who can get your radiators working as they should.
        </p>
      }
      serviceName="Radiator Repair and Installation"
      serviceSlug="radiator-repair-installation"
      serviceDescription="Radiator repair and installation in Huddersfield. Fix cold spots, leaking valves, and add new radiators with qualified heating engineers."
