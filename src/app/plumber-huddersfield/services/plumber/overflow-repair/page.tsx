...
export const metadata: Metadata = {
  title: "Overflow Repair Huddersfield | OnCall Home Repairs",
  description:
    "Overflow pipe repair in Huddersfield. Stop water leaks from tanks and cisterns. Transparent pricing. Call 0333 240 8428.",
  alternates: {
    canonical:
      "https://oncallhomerepairs.co.uk/plumber-huddersfield/services/plumber/overflow-repair",
  },
};
...
export default function OverflowRepairPage() {
  return (
    <ServicePage
      ...
      h1="Overflow Pipe Repair in Huddersfield"
      heroIntro={
        <p>
          ...
          OnCall Home Repairs connects you with vetted Huddersfield plumbers who
      ...
      serviceAreasHeading="Overflow Repair Across Huddersfield"
      serviceAreasContent={
        <p>
          Our plumbers carry out overflow repairs across Huddersfield, Holmfirth,
          Marsden, Slaithwaite, Lindley, and the wider West Yorkshire
      ...
      ctaContent={
        <p>
          Stop wasting water and prevent damp damage to your Huddersfield home.
      ...
      serviceDescription="Overflow pipe repair in Huddersfield. Diagnose and fix faulty ball valves, cisterns, and tank overflows with vetted local plumbers."
