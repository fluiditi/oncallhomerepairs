...
export const metadata: Metadata = {
  title: "Water Tank Installation Huddersfield | OnCall Home Repairs",
  description:
    "Cold water tanks, header tanks, and storage tank fitting. Transparent pricing. Call 0333 240 8428.",
  alternates: {
    canonical:
      "https://oncallhomerepairs.co.uk/plumber-huddersfield/services/plumber/water-tank-installation",
  },
};

export default function WaterTankInstallationPage() {
  return (
    <ServicePage
      breadcrumbItems={[
        ...
        { name: "Plumber", href: "/plumber-huddersfield/services/plumber" },
        {
          ...
          href: "/plumber-huddersfield/services/plumber/water-tank-installation",
        },
      ]}
      h1="Water Tank Installation in Huddersfield"
      heroIntro={
        <p>
          Need water tank installation in Huddersfield? OnCall Home Repairs connects you with
      ...
      whatWhyHeading="Why You Need Professional Water Tank Installation in Huddersfield"
      whatWhyContent={
        <>
          <p>
            Water Tank Installation is not something to leave to chance. Poorly fitted or
      ...
      processHeading="How Water Tank Installation Works with OnCall"
      processSteps={[
        {
      ...
      relatedServices={[
        {
          ...
          href: "/plumber-huddersfield/services/plumber/water-tank-repair",
        },
        {
          name: "Water Heater Installation",
          href: "/plumber-huddersfield/services/plumber/water-heater-installation",
        },
        {
        ...
        },
        {
          ...
          href: "/plumber-huddersfield/services/plumber/hot-water-systems",
        },
      ]}
      serviceAreasHeading="Water Tank Installation Across Huddersfield"
      serviceAreasContent={
        <p>
      ...
      faqs={[
        {
          question: "How much does water tank installation cost in Huddersfield?",
          answer:
        ...
        {
          question: "How quickly can you send a plumber for water tank installation?",
          answer:
      ...
      ctaHeading="Need Water Tank Installation in Huddersfield?"
      ctaContent={
        <p>
      ...
      serviceSlug="water-tank-installation"
      serviceDescription="Cold water tanks, header tanks, and storage tank fitting."
