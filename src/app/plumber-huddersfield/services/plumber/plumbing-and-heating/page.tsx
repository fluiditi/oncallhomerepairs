...
export const metadata: Metadata = {
  title: "Plumbing And Heating Huddersfield | OnCall Home Repairs",
  description:
    "Full-service plumbing and central heating by vetted engineers. Transparent pricing. Call 0333 240 8428.",
  alternates: {
    canonical:
      "https://oncallhomerepairs.co.uk/plumber-huddersfield/services/plumber/plumbing-and-heating",
  },
};
...
export default function PlumbingAndHeatingPage() {
  return (
    <ServicePage
      ...
      h1="Plumbing And Heating in Huddersfield"
      heroIntro={
        <p>
          Need plumbing and heating in Huddersfield? OnCall Home Repairs connects you with
      ...
      whatWhyHeading="Why You Need Professional Plumbing And Heating in Huddersfield"
      whatWhyContent={
        <>
          <p>
      ...
      serviceAreasHeading="Plumbing And Heating Across Huddersfield"
      serviceAreasContent={
        <p>
      ...
      faqs={[
        {
          question: "How much does plumbing and heating cost in Huddersfield?",
          answer:
      ...
      ctaHeading="Need Plumbing And Heating in Huddersfield?"
      ctaContent={
        <p>
