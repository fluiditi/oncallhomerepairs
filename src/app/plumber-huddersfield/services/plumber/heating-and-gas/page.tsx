...
export const metadata: Metadata = {
  title: "Heating And Gas Huddersfield | OnCall Home Repairs",
  description:
    "Boilers, central heating, and gas appliance work by Gas Safe engineers. Transparent pricing. Call 0333 240 8428.",
  alternates: {
    canonical:
      "https://oncallhomerepairs.co.uk/plumber-huddersfield/services/plumber/heating-and-gas",
  },
};

export default function HeatingAndGasPage() {
  return (
    <ServicePage
      breadcrumbItems={[
      ...
      h1="Heating And Gas in Huddersfield"
      heroIntro={
        <p>
          Need heating and gas in Huddersfield? OnCall Home Repairs connects you with
      ...
      whatWhyHeading="Why You Need Professional Heating And Gas in Huddersfield"
      whatWhyContent={
        <>
          <p>
            Heating And Gas is not something to leave to chance. Poorly fitted or
      ...
      processHeading="How Heating And Gas Works with OnCall"
      processSteps={[
        {
      ...
      relatedServices={[
        {
          ...
          href: "/plumber-huddersfield/services/plumber/heating-engineer",
        },
        {
          name: "Boiler And Heating",
          href: "/plumber-huddersfield/services/plumber/boiler-and-heating",
        },
        {
          name: "Plumbing And Heating",
          href: "/plumber-huddersfield/services/plumber/plumbing-and-heating",
        },
        {
      ...
      serviceAreasHeading="Heating And Gas Across Huddersfield"
      serviceAreasContent={
        <p>
      ...
      faqs={[
        {
          question: "How much does heating and gas cost in Huddersfield?",
          answer:
        ...
        {
          question: "How quickly can you send a plumber for heating and gas?",
          answer:
      ...
      ctaHeading="Need Heating And Gas in Huddersfield?"
      ctaContent={
        <p>
      ...
      serviceName="Heating And Gas"
      serviceSlug="heating-and-gas"
      serviceDescription="Boilers, central heating, and gas appliance work by Gas Safe engineers."
