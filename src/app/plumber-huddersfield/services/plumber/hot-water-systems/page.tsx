...
export const metadata: Metadata = {
  title: "Hot Water Systems Huddersfield | OnCall Home Repairs",
  description:
    "Cylinders, immersions, and unvented systems repair and installation. Transparent pricing. Call 0333 240 8428.",
  alternates: {
    canonical:
      "https://oncallhomerepairs.co.uk/plumber-huddersfield/services/plumber/hot-water-systems",
  },
};
...
export default function HotWaterSystemsPage() {
  return (
    <ServicePage
      ...
      h1="Hot Water Systems in Huddersfield"
      heroIntro={
        <p>
          Need hot water systems in Huddersfield? OnCall Home Repairs connects you with
      ...
      whatWhyHeading="Why You Need Professional Hot Water Systems in Huddersfield"
      whatWhyContent={
        <>
          <p>
            Hot Water Systems is not something to leave to chance. Poorly fitted or
      ...
      processHeading="How Hot Water Systems Works with OnCall"
      processSteps={[
        {
      ...
      serviceAreasHeading="Hot Water Systems Across Huddersfield"
      serviceAreasContent={
        <p>
      ...
      faqs={[
        {
          question: "How much does hot water systems cost in Huddersfield?",
          answer:
        ...
        {
          question: "How quickly can you send a plumber for hot water systems?",
          answer:
      ...
      ctaHeading="Need Hot Water Systems in Huddersfield?"
      ctaContent={
        <p>
      ...
      serviceDescription="Cylinders, immersions, and unvented systems repair and installation."
