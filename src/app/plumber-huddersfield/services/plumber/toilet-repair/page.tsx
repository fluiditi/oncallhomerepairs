...
export const metadata: Metadata = {
  title: "Toilet Repair Huddersfield | OnCall Home Repairs",
  description:
    "Toilet repair in Huddersfield. Cisterns, flush mechanisms, seals, and installations by vetted plumbers. Call 0333 240 8428.",
  alternates: {
    canonical:
      "https://oncallhomerepairs.co.uk/plumber-huddersfield/services/plumber/toilet-repair",
  },
};
...
export default function ToiletRepairPage() {
  return (
    <ServicePage
      ...
      h1="Toilet Repair in Huddersfield"
      heroIntro={
        <p>
          ...
          Huddersfield who repair and replace toilet components, cisterns, and
      ...
      whatWhyContent={
        <>
          ...
          <p>
            In properties across Huddersfield, hard water deposits also play a role.
      ...
      serviceAreasHeading="Toilet Repair Across Huddersfield"
      serviceAreasContent={
        <p>
          Our plumbers carry out toilet repairs across Huddersfield, Holmfirth,
          Marsden, Slaithwaite, Meltham, Honley, and all
      ...
      ctaContent={
        <p>
          ...
          Huddersfield who can diagnose and fix the problem &mdash; usually in a
          single visit.
        </p>
      }
      serviceName="Toilet Repair"
      serviceSlug="toilet-repair"
      serviceDescription="Toilet repair in Huddersfield. Cistern mechanisms, fill valves, flush faults, and seal replacements by vetted local plumbers."
