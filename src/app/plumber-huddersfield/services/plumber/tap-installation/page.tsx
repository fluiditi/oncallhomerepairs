...
export const metadata: Metadata = {
  title: "Tap Installation Huddersfield | OnCall Home Repairs",
  description:
    "Kitchen and bathroom taps fitted by vetted local plumbers. Transparent pricing. Call 0333 240 8428.",
  alternates: {
    canonical:
      "https://oncallhomerepairs.co.uk/plumber-huddersfield/services/plumber/tap-installation",
  },
};
    ...
    <ServicePage
      breadcrumbItems={[
        ...
        { name: "Plumber", href: "/plumber-huddersfield/services/plumber" },
        {
          ...
          href: "/plumber-huddersfield/services/plumber/tap-installation",
        },
      ]}
      h1="Tap Installation in Huddersfield"
      heroIntro={
        <p>
          Need tap installation in Huddersfield? OnCall Home Repairs connects you with
      ...
      whatWhyHeading="Why You Need Professional Tap Installation in Huddersfield"
      whatWhyContent={
        <>
          <p>
      ...
      relatedServices={[
        ...
        },
        {
          ...
          href: "/plumber-huddersfield/services/plumber/shower-installation",
        },
      ]}
      serviceAreasHeading="Tap Installation Across Huddersfield"
      serviceAreasContent={
        <p>
      ...
      faqs={[
        {
          question: "How much does tap installation cost in Huddersfield?",
          answer:
      ...
      ctaHeading="Need Tap Installation in Huddersfield?"
      ctaContent={
        <p>
