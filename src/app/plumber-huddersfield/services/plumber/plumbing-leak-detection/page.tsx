...
export const metadata: Metadata = {
  title: "Leak Detection Huddersfield | OnCall Home Repairs",
  description:
    "Professional leak detection and repair in Huddersfield. Find and fix hidden leaks fast. Transparent pricing. Call 0333 240 8428.",
  alternates: {
    canonical:
      "https://oncallhomerepairs.co.uk/plumber-huddersfield/services/plumber/plumbing-leak-detection",
  },
};
...
export default function LeakDetectionRepairPage() {
  return (
    <ServicePage
      ...
      h1="Leak Detection and Repair in Huddersfield"
      heroIntro={
        <p>
          ...
          connects you with skilled plumbers in Huddersfield who specialise in
      ...
      whatWhyContent={
        <>
          ...
          <p>
            In Huddersfield, many homes are built with traditional construction
          ...
          <p>
            ...
            <Link
              href="/plumber-huddersfield/services/plumber/overflow-repair"
              className="text-primary underline underline-offset-2 hover:text-primary/80"
            >
              overflowing cistern
            </Link>{" "}
      ...
      benefits={[
        ...
        },
        {
          ...
          description: (
            <p>
              Every plumber in our Huddersfield network is qualified, insured, and
      ...
      serviceAreasHeading="Leak Detection Across Huddersfield"
      serviceAreasContent={
        <p>
          Our leak detection service covers Huddersfield and all nearby towns and
          villages. From Victorian terraces in Huddersfield centre to modern estates
          in Holmfirth and Marsden, our plumbers are experienced with the
          property types and plumbing systems found across the area. Whether
          your leak is in a ground-floor flat in Slaithwaite or a detached house in
          Mirfield, we can match you with someone local who can investigate
          promptly.
        </p>
      }
      faqs={[
      ...
      ctaHeading="Suspect a Leak in Your Huddersfield Home?"
      ctaContent={
        <p>
      ...
      serviceSlug="plumbing-leak-detection"
      serviceDescription="Professional leak detection and repair in Huddersfield. Find and fix hidden leaks fast."
