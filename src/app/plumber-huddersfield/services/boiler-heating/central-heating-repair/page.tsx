...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical:
      "https://oncallhomerepairs.co.uk/plumber-huddersfield/services/boiler-heating/central-heating-repair",
  },
};
    ...
    <ServicePage
      ...
      whatWhyContent={
        <>
          ...
          <p>
            ...
            <Link
              href="/plumber-huddersfield/services/boiler-heating/power-flushing"
              className="text-primary underline underline-offset-2 hover:text-primary/80"
            >
              power flush
            </Link>{" "}
      ...
      relatedServices={[
        ...
        },
        {
          ...
          href: "/plumber-huddersfield/services/boiler-heating/radiator-repair-installation",
        },
        {
          name: "Power Flushing",
          href: "/plumber-huddersfield/services/boiler-heating/power-flushing",
        },
        {
          ...
          href: "/plumber-huddersfield/services/boiler-heating/boiler-servicing",
        },
      ]}
