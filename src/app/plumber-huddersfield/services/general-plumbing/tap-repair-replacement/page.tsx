...
export const metadata: Metadata = {
  title: "Tap Repair Huddersfield | OnCall Home Repairs",
  description:
    "Tap repair and replacement in Huddersfield. Fix dripping taps and install new ones. Vetted plumbers, transparent pricing. Call 0333 240 8428.",
  alternates: {
    canonical:
      "https://oncallhomerepairs.co.uk/plumber-huddersfield/services/general-plumbing/tap-repair-replacement",
  },
};
...
export default function TapRepairPage() {
  return (
    <ServicePage
      ...
      h1="Tap Repair and Replacement in Huddersfield"
      heroIntro={
        <p>
          ...
          Home Repairs connects you with plumbers in Huddersfield who can fix
      ...
      serviceAreasHeading="Tap Repair Across Huddersfield"
      serviceAreasContent={
        <p>
          Our plumbers repair and replace taps across Huddersfield, Holmfirth, Marsden,
          Slaithwaite, Mirfield, Linthwaite, and the surrounding area. Tap
      ...
      ctaContent={
        <p>
          ...
          will connect you with a plumber in Huddersfield who can repair or
      ...
      serviceDescription="Tap repair and replacement in Huddersfield. Fix dripping taps, replace worn components, and install new taps with vetted local plumbers."
