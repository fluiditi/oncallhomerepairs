...
export const metadata: Metadata = {
  title: "Bathroom Plumber Huddersfield | OnCall Home Repairs",
  description:
    "Bathroom plumbing in Huddersfield. Installations, repairs, full refits. Vetted plumbers, upfront quotes. Call 0333 240 8428.",
  alternates: {
    canonical:
      "https://oncallhomerepairs.co.uk/plumber-huddersfield/services/general-plumbing/bathroom-plumbing",
  },
};
...
export default function BathroomPlumbingPage() {
  return (
    <ServicePage
      ...
      h1="Bathroom Plumbing in Huddersfield"
      heroIntro={
        <p>
          ...
          vetted, experienced plumbers in Huddersfield who handle all aspects of
      ...
      whatWhyContent={
        <>
          ...
          <p>
            ...
            will support the{" "}
            <Link
              href="/plumber-huddersfield/services/general-plumbing/shower-installation-repair"
              className="text-primary underline underline-offset-2 hover:text-primary/80"
            >
              shower
            </Link>{" "}
        ...
        },
        {
          ...
          description: (
            <p>
              ...
              in Huddersfield properties — from Victorian terraces with old lead
      ...
      relatedServices={[
        ...
        {
          name: "Toilet Repair",
          href: "/plumber-huddersfield/services/drain-services/toilet-repair",
        },
        {
          name: "Kitchen Plumbing",
          href: "/plumber-huddersfield/services/general-plumbing/kitchen-plumbing",
        },
      ]}
      serviceAreasHeading="Bathroom Plumbing Across Huddersfield"
      serviceAreasContent={
        <p>
          Our bathroom plumbers serve Huddersfield and all surrounding areas. From
          period properties in the town centre that need careful pipework
          modifications to new-build homes in Almondbury, Linthwaite, and Golcar
          that need a shower upgrade or suite replacement, our plumbers have
          the experience to handle it. We cover Holmfirth, Marsden, Slaithwaite,
          Milnsbridge, and all villages in between.
        </p>
      }
      faqs={[
        {
      ...
      ctaHeading="Need a Bathroom Plumber in Huddersfield?"
      ctaContent={
        <p>
      ...
      serviceDescription="Bathroom plumbing in Huddersfield. Installations, repairs, and full bathroom fit-outs."
